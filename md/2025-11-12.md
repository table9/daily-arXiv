---
title: "arXiv Daily · 2025-11-12 · 56 papers"
date: 2025-11-12
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2025-11-12 · 56 papers
...
- **arXiv**: [2511.08335](https://arxiv.org/abs/2511.08335)  ·  [PDF](https://arxiv.org/pdf/2511.08335.pdf)
- **Title (EN)**: An Improved High-order Adaptive Mesh Refinement Framework for Shock-turbulence Interaction Problems based on cell-centered finite difference schemes
- **Authors**: Yuqi Wang, Yadong Zeng, Ralf Deiterding, Jinhui Yang, Jianhan Liang
- **Categories**: physics.comp-ph
- **TL;DR**: 提出了一个用于激波-湍流相互作用问题的高阶有限差分自适应网格细化框架，采用交错网格布局解决边界守恒问题，并开发了混合插值策略来缓解数值不稳定性。
...
- **arXiv**: [2511.07433](https://arxiv.org/abs/2511.07433)  ·  [PDF](https://arxiv.org/pdf/2511.07433.pdf)
- **Title (EN)**: Benchmarking Simulacra AI's Quantum Accurate Synthetic Data Generation for Chemical Sciences
...
- **TL;DR**: Simulacra的LWM管道结合VMC采样算法，将数据生成成本降低15-50倍，同时保持能量精度，比传统CCSD方法快2-3倍。
...
- **arXiv**: [2511.08330](https://arxiv.org/abs/2511.08330)  ·  [PDF](https://arxiv.org/pdf/2511.08330.pdf)
- **Title (EN)**: Machine-learning interatomic potential for AlN for epitaxial simulation
- **Authors**: Nicholas Taormina, Emir Bilgili, Jason Gibson, Richard Hennig, Simon Phillpot, Youping Chen
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 开发了基于UF3方法的AlN机器学习势函数，在结构、力学性能和位错结构方面与DFT计算结果高度一致，成功重现了AlN同质外延生长中的纤锌矿结构和逐层生长模式。
...
- **arXiv**: [2511.07527](https://arxiv.org/abs/2511.07527)  ·  [PDF](https://arxiv.org/pdf/2511.07527.pdf)
- **Title (EN)**: Parametric Instabilities of Correlated Quantum Matter
- **Authors**: Gal Shavit, Gil Refael
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 开发了参数驱动集体玻色激发的理论框架，通过微观参数周期性调制产生共振双玻色过程，可用于非平衡控制相关量子材料的有序相
...
- **arXiv**: [2511.07566](https://arxiv.org/abs/2511.07566)  ·  [PDF](https://arxiv.org/pdf/2511.07566.pdf)
- **Title (EN)**: Superconductivity in the two-dimensional Hubbard model revealed by neural quantum states
...
- **TL;DR**: 该论文通过扩展隐藏费米子行列式态到Pfaffian态的新型神经网络量子态，研究了方晶格Hubbard模型中的超导性、条纹相和金属相，发现在强耦合和低空穴掺杂下条纹相占主导，而负次近邻跃迁可稳定超导与部分填充条纹的共存态。
...
- **arXiv**: [2511.07618](https://arxiv.org/abs/2511.07618)  ·  [PDF](https://arxiv.org/pdf/2511.07618.pdf)
- **Title (EN)**: Nanorod Pair Complexes Manipulated via Magnetic Casimir Forces
- **Authors**: S Pal, L. M. Woods, C. Persson, I. Brevik, U. De Giovannini, M. Boström
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过磁性流体调控各向异性纳米粒子间的卡西米尔-利夫希茨相互作用，利用磁导率变化实现从排斥到吸引的相互作用调节，预测了可测量的磁性卡西米尔陷阱。
...
- **arXiv**: [2511.07531](https://arxiv.org/abs/2511.07531)  ·  [PDF](https://arxiv.org/pdf/2511.07531.pdf)
- **Title (EN)**: High-speed antiferromagnetic domain walls driven by coherent spin waves
- **Authors**: Kyle L. Seyler, Hantao Zhang, Daniel Van Beveren, Costel R. Rotundu, Young S. Lee, Ran Cheng, David Hsieh
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 实验实现了利用相干自旋波驱动反铁磁畴壁运动，在Sr2Cu3O4Cl2材料中观测到高达~50 km/s的畴壁速度，并可通过泵浦激光手性和畴壁缠绕数控制运动方向。
...
- **arXiv**: [2511.07664](https://arxiv.org/abs/2511.07664)  ·  [PDF](https://arxiv.org/pdf/2511.07664.pdf)
- **Title (EN)**: Random initial data and average shock time in the Fermi-Pasta-Ulam-Tsingou chain
- **Authors**: Matteo Gallone, Ricardo Grande, Antonio Ponno, Stefano Ruffo, Erwan Druais
- **Categories**: cond-mat.stat-mech, math-ph, nlin.SI, physics.flu-dyn
- **TL;DR**: 研究了Fermi-Pasta-Ulam-Tsingou链在长波长随机初始条件下的动力学，发现系统在低能量下进入预热化状态，形成Burgers型激波和湍流谱，并推导出激波时间的渐近表达式。
...
- **arXiv**: [2511.07528](https://arxiv.org/abs/2511.07528)  ·  [PDF](https://arxiv.org/pdf/2511.07528.pdf)
- **Title (EN)**: Non-Reciprocal Zone Boundary Magnon Propagation in Cu$_2$OSeO$_3$
- **Authors**: Tobias Weber, Niclas Heinsdorf, Michal Stekiel, Paul Steffens, Andreas Schnyder, Christian Pfleiderer
- **Categories**: cond-mat.str-el
- **TL;DR**: 在Cu₂OSeO₃手性磁体中，中子散射实验发现布里渊区边界存在强非互易性磁振子传播效应，这是首次在高动量区域观测到非互易现象。
...
- **arXiv**: [2511.08249](https://arxiv.org/abs/2511.08249)  ·  [PDF](https://arxiv.org/pdf/2511.08249.pdf)
- **Title (EN)**: Cuprate Twistronics for Quantum Hardware
- **Authors**: Tommaso Confalone, Flavia Lo Sardo, Yejin Lee, Sanaz Shokri, Giuseppe Serpico, Alessandro Coppo, Valerii M. Vinokur, Luca Chirolli, Valentina Brosco, Uri Vool, Domenico Montemurro, Francesco Tafuri, Golam Haider, Kornelius Nielsch, Nicola Poccia
- **Categories**: cond-mat.supr-con
- **TL;DR**: 回顾了铜酸盐扭转电子学领域30多年的研究进展，重点探讨了原子级薄铜酸盐超导薄膜的纳米工程和扭曲铜酸盐异质结构在调控超导性和量子态方面的突破。
...
- **arXiv**: [2511.07723](https://arxiv.org/abs/2511.07723)  ·  [PDF](https://arxiv.org/pdf/2511.07723.pdf)
- **Title (EN)**: Control of Spontaneous Orientation Polarization in Organic Semiconductors: The Role of Molecular Structure and Film Growth Conditions
- **Authors**: Albin Cakaj, Markus Schmid, Alexander Hofmann, Wolfgang Brütting
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文讨论了有机半导体中自发取向极化(SOP)的控制方法及其在有机发光器件中的应用
...
- **arXiv**: [2511.08161](https://arxiv.org/abs/2511.08161)  ·  [PDF](https://arxiv.org/pdf/2511.08161.pdf)
- **Title (EN)**: Coherence enhanced by detrained oscillators: Breaking $π$-reflection symmetry
- **Authors**: Hyunsuk Hong, Jae Sung Lee, Hyunggyu Park
- **Categories**: cond-mat.stat-mech, nlin.AO
- **TL;DR**: 研究广义Kuramoto模型中携带两个耦合相位变量的振荡器系统，发现了一种打破π反射对称性的有界振荡运动模式，这种对称性破坏增强了全局相干性并产生了非平凡混合态。
...
- **arXiv**: [2511.08466](https://arxiv.org/abs/2511.08466)  ·  [PDF](https://arxiv.org/pdf/2511.08466.pdf)
- **Title (EN)**: Kinetic Inductance of Few-Layer NbSe$_2$ in the Two-Dimensional Limit
...
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该研究表征了二维范德华超导体NbSe2的动电感特性，发现动电感随层数减少而增加，在单层极限达到1.2 nH/□，并观察到从清洁极限到脏极限的厚度依赖性交叉行为。
...
- **arXiv**: [2511.07804](https://arxiv.org/abs/2511.07804)  ·  [PDF](https://arxiv.org/pdf/2511.07804.pdf)
- **Title (EN)**: Short-range order influences H distribution in Fe-Ni-Cr austenitic stainless steels
- **Authors**: Tianyu Su, Brian J. Blankenau, Namhoon Kim, Kshitij Vijayvargia, Petros Sofronis, Jessica A. Krogstad, Elif Ertekin
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究氢与短程有序在奥氏体不锈钢中的相互作用，发现氢对合金固有有序性影响轻微，但预存在的短程有序会显著促进氢的局部富集，这可能加剧氢脆现象。
...
- **arXiv**: [2511.07638](https://arxiv.org/abs/2511.07638)  ·  [PDF](https://arxiv.org/pdf/2511.07638.pdf)
- **Title (EN)**: Optimized tandem catalyst patterning for CO$_2$ reduction flow reactors
...
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究通过将连续介质输运模型与设计优化相结合，在二维电化学CO2还原流动反应器中优化Ag/Cu催化剂表面图案，以最大化高价值产物（如乙烯）的电流密度。
...
- **arXiv**: [2511.07579](https://arxiv.org/abs/2511.07579)  ·  [PDF](https://arxiv.org/pdf/2511.07579.pdf)
- **Title (EN)**: Magnetic structure evolution and magnetoelastic coupling across the spin reorientation transition in TmCrO3
...
- **TL;DR**: 对正交晶系TmCrO3中自旋重取向转变的磁性结构演化进行了全面研究，揭示了复杂的磁相变过程、补偿点行为以及磁弹性耦合效应。
...
- **arXiv**: [2511.07962](https://arxiv.org/abs/2511.07962)  ·  [PDF](https://arxiv.org/pdf/2511.07962.pdf)
- **Title (EN)**: Angular Patterns of Photoluminescence in Quantum Dot Spherical Superparticles Mediated by Whispering-Gallery Modes
- **Authors**: Yu. E. Geints
- **Categories**: cond-mat.mes-hall, physics.optics
- **TL;DR**: 研究量子点超粒子（由CdS量子点自组装形成的微球结构）的光致发光角度分布特性，发现其发射具有强烈的后向不对称性，且谐振模式的激发会增强发射强度并降低后向不对称程度。
...
- **arXiv**: [2511.08492](https://arxiv.org/abs/2511.08492)  ·  [PDF](https://arxiv.org/pdf/2511.08492.pdf)
- **Title (EN)**: Polarization Controlled Supercurrent in Ferroelectric Josephson Junction
- **Authors**: Yaozu Tang, Mazhar N. Ali, Gerrit E. W. Bauer, Yaroslav M. Blanter
- **Categories**: cond-mat.supr-con
- **TL;DR**: 本文提出了一种通过铁电材料调控约瑟夫森结超电流的方法，利用不对称绝缘层设计实现非易失性电控超导电流开关。
...
- **arXiv**: [2511.07844](https://arxiv.org/abs/2511.07844)  ·  [PDF](https://arxiv.org/pdf/2511.07844.pdf)
- **Title (EN)**: Inhomogeneous dynamic state in the double trillium lattice antiferromagnet KBaFe$_2$(PO$_4$)$_3$
- **Authors**: S. J. Sebastian, S. S. Islam, R. Kolay, S. Mohanty, Q. P. Ding, Y. Skourski, J. Sichelschmidt, M. Baenitz, Jonas A. Krieger, T. J. Hicken, H. Luetkens, A. A. Tsirlin, Y. Furukawa, R. Nath
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: KBaFe2(PO4)3在三维双螺旋晶格中表现出强几何阻挫，尽管具有大的居里-外斯温度(-70K)，但在30mK以下仍无磁长程有序，形成动态自旋相关和微观不均匀的自旋动力学。
...
- **arXiv**: [2511.07686](https://arxiv.org/abs/2511.07686)  ·  [PDF](https://arxiv.org/pdf/2511.07686.pdf)
- **Title (EN)**: Kolmogorov-Arnold Chemical Reaction Neural Networks for learning pressure-dependent kinetic rate laws
- **Authors**: Benjamin C. Koenig, Sili Deng
- **Categories**: physics.chem-ph, cs.LG
- **TL;DR**: KA-CRNNs扩展了化学反应神经网络，通过Kolmogorov-Arnold激活函数将动力学参数建模为系统压力的可学习函数，从而能够直接从数据中推断压力依赖性反应动力学，同时保持物理一致性和可解释性。
...
- **arXiv**: [2511.07606](https://arxiv.org/abs/2511.07606)  ·  [PDF](https://arxiv.org/pdf/2511.07606.pdf)
- **Title (EN)**: Hidden symmetry-breaking in a kagome Ising ferromagnet
...
- **Categories**: cond-mat.str-el
- **TL;DR**: 在kagome金属TbV₆Sn₆中发现了时间反演对称性破缺，这种破缺源于kagome层内的交错磁矩，与Ising铁磁性共存。
...
- **arXiv**: [2511.07992](https://arxiv.org/abs/2511.07992)  ·  [PDF](https://arxiv.org/pdf/2511.07992.pdf)
- **Title (EN)**: High and Magnetic-field-dependent Surface Carriers Mobility in 3D Topological Insulators without Bulk States
- **Authors**: M. V. Pugachev, A. E. Borisov, A. V. Shupletsov, V. O. Sakhin, E. F. Kukovitsky, A. Yu. Kuntsevich
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 通过应用传统的双流体模型分析磁阻张量，在Sn-Bi1.1Sb0.9Te2S拓扑绝缘体的块状晶体和薄片中发现了创纪录的表面态载流子迁移率（~20000 cm²/Vs）。
...
- **arXiv**: [2511.08511](https://arxiv.org/abs/2511.08511)  ·  [PDF](https://arxiv.org/pdf/2511.08511.pdf)
- **Title (EN)**: Interband pairing as the origin of the sublattice dichotomy in monolayer FeSe/SrTiO_3
- **Authors**: Zhipeng Xu, Shengshan Qin, Kun Jiang, Jiangping Hu
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该论文提出带间配对是单层FeSe/SrTiO3中亚晶格二分性的起源，无论对称性破缺发生在正常态还是配对态。带间配对被认为是理解该体系超导性的关键要素。
...
- **arXiv**: [2511.08002](https://arxiv.org/abs/2511.08002)  ·  [PDF](https://arxiv.org/pdf/2511.08002.pdf)
- **Title (EN)**: Implementation and application of a DFT$+U$$+V$ approach within the all-electron FLAPW method
- **Authors**: Wejdan Beida, Gustav Bihlmayer, Christoph Friedrich, Gregor Michalicek, Daniel Wortmann, Stefan Blügel
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 在FLEUR代码中实现了DFT+U+V方法，通过引入位点间库仑相互作用V来改进局域关联效应的描述，提高了共价键材料、半导体和电荷转移绝缘体的计算精度。
...
- **arXiv**: [2511.07771](https://arxiv.org/abs/2511.07771)  ·  [PDF](https://arxiv.org/pdf/2511.07771.pdf)
- **Title (EN)**: Quantum-centric machine learning for molecular dynamics
...
- **TL;DR**: 提出了一种量子中心机器学习(QCML)框架，结合参数化量子电路和Transformer模型，直接预测分子波函数和量子可观测量，无需迭代变分优化。
...
- **arXiv**: [2511.07625](https://arxiv.org/abs/2511.07625)  ·  [PDF](https://arxiv.org/pdf/2511.07625.pdf)
- **Title (EN)**: Topological Metal-Insulator Transition within the Ferromagnetic state
...
- **arXiv**: [2511.08053](https://arxiv.org/abs/2511.08053)  ·  [PDF](https://arxiv.org/pdf/2511.08053.pdf)
- **Title (EN)**: Localization transitions in an open quasiperiodic ladder
- **Authors**: Suparna Sarkar, Soumya Satpathi, Swapan K. Pati
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文研究了开放准周期梯子中的局域化转变，发现耗散可以在仅包含最近邻相互作用的一维系统中诱导混合相区，而无需对准周期势或跃迁参数施加任何显式约束。
...
- **arXiv**: [2511.08584](https://arxiv.org/abs/2511.08584)  ·  [PDF](https://arxiv.org/pdf/2511.08584.pdf)
- **Title (EN)**: Steady-states and response functions of the periodically driven O(N) scalar field theory
- **Authors**: Oriana K. Diessel, Subir Sachdev, Pietro M. Bonetti
- **Categories**: cond-mat.str-el, cond-mat.mes-hall, cond-mat.supr-con
- **TL;DR**: 本文研究了相对论性参数驱动O(N)对称理论在马尔可夫热浴中的相图，发现了多种对称破缺相，包括均匀和空间调制的有序态，其中一些具有以驱动频率一半振荡的序参量。在电磁势背景下，这些相表现出迈斯纳效应，但序参量振荡较小时会出现部分磁场穿透的迈斯纳极化激元。在对称破缺临界点附近，强涨落会产生类超导响应。
...
- **arXiv**: [2511.08038](https://arxiv.org/abs/2511.08038)  ·  [PDF](https://arxiv.org/pdf/2511.08038.pdf)
- **Title (EN)**: Tuning Stability of AB3-Type Alloys by Suppressing Magnetism
- **Authors**: Hung Ba Tran, Toyoto Sato, Ryuhei Sato, Hiroyuki Saitoh, Shin-ichi Orimo, Hao Li
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理计算和蒙特卡洛模拟分析AB3型金属间化合物（A = Ca, Y, Mg; B = Co, Ni）及其三元合金的氢存储性能，发现磁性控制是克服稳定性与容量权衡的关键。
...
- **arXiv**: [2511.08235](https://arxiv.org/abs/2511.08235)  ·  [PDF](https://arxiv.org/pdf/2511.08235.pdf)
- **Title (EN)**: Insights into Symmetry and Substitution Patterns Governing Singlet-Triplet Energy Gap in the Chemical Space of Azaphenalenes
- **Authors**: Atreyee Majumdar, Raghunathan Ramakrishnan
- **Categories**: physics.chem-ph
- **TL;DR**: 本研究系统分析了104种独特的氮杂菲衍生物(APs)，发现其中3种具有倒置的单重态-三重态能隙(STG)，即S1低于T1，违反洪特规则，可作为高效第五代发光材料。
...
- **arXiv**: [2511.07726](https://arxiv.org/abs/2511.07726)  ·  [PDF](https://arxiv.org/pdf/2511.07726.pdf)
- **Title (EN)**: The pseudogap and strange metal states in the square-lattice Hubbard model: a comprehensive study
- **Authors**: Arata Tanaka
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过研究哈伯德模型，发现赝能隙和奇异金属态的出现需要满足特定条件：Mott-Heisenberg和Slater机制导致的电子局域化特征空穴浓度p_MS与范霍夫奇点(VHS)接近费米能级的空穴浓度几乎重合。
...
- **arXiv**: [2511.08148](https://arxiv.org/abs/2511.08148)  ·  [PDF](https://arxiv.org/pdf/2511.08148.pdf)
- **Title (EN)**: Carrier-envelope phase control of ultrafast photocurrents in layered MoS$_2$
- **Authors**: Johannes Schmuck, Björn Sinz, Nina Pettinger, Sergey Zherebtsov, Alexander W. Holleitner
- **Categories**: cond-mat.mes-hall, physics.optics
- **TL;DR**: 本文展示了在单层、双层和三层MoS$_2$中，通过少周期激光脉冲驱动的载波包络相位(CEP)控制的光电流。光电流与场振幅呈二次方关系，表明在弱场区域存在微扰载流子动力学，与强场隧穿不同。
...
- **arXiv**: [2511.08044](https://arxiv.org/abs/2511.08044)  ·  [PDF](https://arxiv.org/pdf/2511.08044.pdf)
- **Title (EN)**: Attosecond-resolved coherent control of zone-folded acoustic phonons in silicon carbide
- **Authors**: Hiromu Matsumoto, Tsukasa Maruhashi, Yosuke Kayanuma, Yadong Han, Jianbo Hu, Kazutaka G. Nakamura
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过飞秒激光在4H碳化硅中激发区域折叠声子，并利用阿秒精度的相干控制技术研究电子和声子的干涉效应。
...
- **arXiv**: [2511.08517](https://arxiv.org/abs/2511.08517)  ·  [PDF](https://arxiv.org/pdf/2511.08517.pdf)
- **Title (EN)**: Nuclear spin relaxation in zero- to ultralow-field magnetic resonance spectroscopy
...
- **TL;DR**: 本文研究了零场至超低场核磁共振中不同共振频率显示不同弛豫速率的现象，并建立了理论框架来解释这些效应和提取分子特性。
...
- **arXiv**: [2511.08176](https://arxiv.org/abs/2511.08176)  ·  [PDF](https://arxiv.org/pdf/2511.08176.pdf)
- **Title (EN)**: Growth-Controlled Twinning and Magnetic Anisotropy in CeSb$_2$
- **Authors**: Jan T. Weber, Kristin Kliemt, Sergey L. Bud'ko, Paul C. Canfield, Cornelius Krellner
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过控制晶体生长和磁测量技术，解决了CeSb₂中由结构孪晶引起的面内各向异性争议，揭示了其本征磁各向异性特征，并建立了更准确的磁相图。
...
- **arXiv**: [2511.08342](https://arxiv.org/abs/2511.08342)  ·  [PDF](https://arxiv.org/pdf/2511.08342.pdf)
- **Title (EN)**: Cooling of electrons via superconducting tunnel junctions and their arrays exhibiting nodal lines
- **Authors**: Linus Aliani, Viktoriia Kornich
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究使用具有π相位差的超导隧道结和中间绝缘体或铁电体来冷却电子的过程，以及由铁电层组成的结阵列。这些结构由于节线而具有复杂的熵结构，态密度可能发散或大于自由电子气体。通过小电流从电子浴中提取热量实现冷却。
...
- **arXiv**: [2511.08062](https://arxiv.org/abs/2511.08062)  ·  [PDF](https://arxiv.org/pdf/2511.08062.pdf)
- **Title (EN)**: Non-destructive 3D characterization of microtextured regions in the bulk of Ti-6Al-4V alloy
- **Authors**: Mads Carlsen, Xiaohan Zeng, Haixing Fang, Moritz Frewein, Tilman A. Grünewald, Joao Quinta da Fonseca, Wolfgang Ludwig
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: Error
...
- **arXiv**: [2511.08564](https://arxiv.org/abs/2511.08564)  ·  [PDF](https://arxiv.org/pdf/2511.08564.pdf)
- **Title (EN)**: Genetically encoding stimulated Raman-scattering probes for cell imaging using infrared fluorescent proteins
...
- **Categories**: physics.chem-ph, physics.bio-ph, q-bio.BM
- **TL;DR**: 本文展示了红外荧光蛋白（IRFPs）可作为基因编码的受激拉曼散射（SRS）探针，利用电子预共振SRS增强效应实现哺乳动物细胞核成像，为基于拉曼的细胞成像开辟了新途径。
...
- **arXiv**: [2511.08179](https://arxiv.org/abs/2511.08179)  ·  [PDF](https://arxiv.org/pdf/2511.08179.pdf)
- **Title (EN)**: Non-linear spin wave theory in the strong easy-axis limit of the triangular XXZ model
- **Authors**: Achille Mauri, Siebe Roose, Frédéric Mila
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文研究了最近邻三角XXZ模型在强易轴各向异性极限下的能谱，通过1/S展开将自旋模型简化为蜂窝晶格上的有效玻色子模型，分析了量子有序-无序效应和赝戈德斯通模。
...
- **arXiv**: [2511.08357](https://arxiv.org/abs/2511.08357)  ·  [PDF](https://arxiv.org/pdf/2511.08357.pdf)
- **Title (EN)**: D-Wave Phonon Angular Momentum Texture in Altermagnets by Magnon-Phonon-Hybridization
- **Authors**: Hannah Bendin, Alexander Mook, Ingrid Mertig, Robin R. Neumann
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文研究了二维方晶格d波交变磁体中由自旋-晶格相互作用耦合的磁振子和声子，发现界面Dzyaloshinskii-Moriya相互作用可导致声子手性选择性磁振子-声子杂化，产生具有有限声子角动量的混合准粒子——磁振子极化子。
...
- **arXiv**: [2511.08131](https://arxiv.org/abs/2511.08131)  ·  [PDF](https://arxiv.org/pdf/2511.08131.pdf)
- **Title (EN)**: On the Role of Interlayer Electrons on the Frictional Behavior of Two-Dimensional Electrides
- **Authors**: Jingcheng Qi, Giuliana Materzanini, Gian-Marco Rignanese, Maria Clelia Righi, Junjie Wang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 二维电晶体Ba2N展现出比石墨烯更低的层间摩擦，通过电子重分布作为主要能量耗散途径，在非公度扭转界面实现结构超润滑，临界载荷下可实现无势垒滑动，为节能摩擦学提供了新平台。
...
- **arXiv**: [2511.08541](https://arxiv.org/abs/2511.08541)  ·  [PDF](https://arxiv.org/pdf/2511.08541.pdf)
- **Title (EN)**: Information Thermodynamics in a Quantum Dot Szilard Engine - Experimentally Investigating Fluctuation Theorems and Thermodynamic Uncertainty Relations
- **Authors**: David Barker, Sebastian Lehmann, Kimberly A. Dick, Peter Samuelsson, Ville Maisi, Patrick P. Potts
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 实验研究了Szilard引擎的热力学，通过实现两种不同的反向实验协议，验证了相应的涨落定理和热力学不确定性关系，发现可测量的熵产生可能比互信息更能有效量化信息。
...
- **arXiv**: [2511.08141](https://arxiv.org/abs/2511.08141)  ·  [PDF](https://arxiv.org/pdf/2511.08141.pdf)
- **Title (EN)**: Suppression of magnetism in Co$_3$Sn$_2$S$_2$ under external pressure
- **Authors**: A. Chmeruk, D. Jones, R. Balducci, J. Ebad-Allah, F. Beiuşeanu, F. Schilberth, M. A. Kassem, U. Schade, A. Veber, L. Puskar, Y. Tabata, T. Waki, H. Nakamura, C. A. Kuntscher, A. Östlin, L. Chioncel
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过实验和理论研究，探索了在高达10.8 GPa外部压力下铁磁态的演化，发现标准DFT计算高估了磁化强度，提出了两种修正机制。
...
- **arXiv**: [2511.08166](https://arxiv.org/abs/2511.08166)  ·  [PDF](https://arxiv.org/pdf/2511.08166.pdf)
- **Title (EN)**: Control of ultrafast excitonic shift current induced THz emission efficiency of layered MoS2 crystals
- **Authors**: Neetesh Dhakar, Sunil Kumar
- **Categories**: cond-mat.mtrl-sci, physics.optics
- **TL;DR**: 飞秒激光激发在低温下诱导MoS2晶体产生瞬态激子位移电流，增强了太赫兹发射。当激发密度超过临界值时，激子贡献显著下降，表明形成了电子-空穴液体量子凝聚态。
...
- **arXiv**: [2511.08187](https://arxiv.org/abs/2511.08187)  ·  [PDF](https://arxiv.org/pdf/2511.08187.pdf)
- **Title (EN)**: Quasi-amorphous crystal
- **Authors**: Oguz Umut Salman, Aylin Ahadi, Lev Truskinovsky
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall, nlin.PS
- **TL;DR**: Error
...
- **arXiv**: [2511.08253](https://arxiv.org/abs/2511.08253)  ·  [PDF](https://arxiv.org/pdf/2511.08253.pdf)
- **Title (EN)**: Ferroelectric Order and Enhanced Interfacial Superconductivity in Lightly-Doped Quantum Paraelectric KTa$_{1-x}$Nb$_x$O$_3$
- **Authors**: F. Yang, L. Q. Chen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文研究了铌掺杂KTaO3中的铁电量子临界性和界面超导性，发现通过掺杂诱导的局域畸变可产生长程铁电序，并预测在量子临界组成下(111)表面的超导性会显著增强
...
- **arXiv**: [2511.08264](https://arxiv.org/abs/2511.08264)  ·  [PDF](https://arxiv.org/pdf/2511.08264.pdf)
- **Title (EN)**: Effect of W in Cu-Zr-W thin films: Molecular dynamics simulations and experimental verification
- **Authors**: Hassan Ataalite, Jiri Houska, Deepika Thakur, Michaela Cervena, Petr Zeman
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过分子动力学模拟和磁控溅射实验研究W元素对Cu-Zr薄膜金属玻璃结构和力学性能的影响，发现W的掺入能改善材料性能并预测最优成分。
...
- **arXiv**: [2511.08324](https://arxiv.org/abs/2511.08324)  ·  [PDF](https://arxiv.org/pdf/2511.08324.pdf)
- **Title (EN)**: Sliding properties of Transition Metal Dichalcogenide bilayers
- **Authors**: Pier Luigi Silvestrelli, S. Subashchandrabose, Alberto Ambrosetti, Maria Clelia Righi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究通过DFT计算分析了多种TMD双层材料的滑动性能，发现vdW相互作用主导层间结合，大多数TMD比MoS2具有更强的层间结合和更大波纹度，但TiS2、VS2和ZrS2例外。
...
- **arXiv**: [2511.08350](https://arxiv.org/abs/2511.08350)  ·  [PDF](https://arxiv.org/pdf/2511.08350.pdf)
- **Title (EN)**: Revealing the Hidden Third Dimension of Point Defects in Two-Dimensional MXenes
...
- **TL;DR**: 使用AI引导的电子显微镜工作流程，首次实现了对多层二维材料中原子空位三维排列的大规模映射，揭示了从孤立空位到纳米孔的分级缺陷结构。
...
- **arXiv**: [2511.08424](https://arxiv.org/abs/2511.08424)  ·  [PDF](https://arxiv.org/pdf/2511.08424.pdf)
- **Title (EN)**: Identification of Empirical Constitutive Models for Age-Hardenable Aluminium Alloy and High-Chromium Martensitic Steel Using Symbolic Regression
- **Authors**: Evgeniya Kabliman, Gabriel Kronberger
- **Categories**: cond-mat.mtrl-sci, cs.LG
- **TL;DR**: 本文展示了符号回归在推导金属合金塑性变形本构模型中的应用，使用两种材料（时效硬化铝合金和高铬马氏体钢）和两种测试方法（压缩和拉伸）来获取应力-应变数据。
...
- **arXiv**: [2511.08426](https://arxiv.org/abs/2511.08426)  ·  [PDF](https://arxiv.org/pdf/2511.08426.pdf)
- **Title (EN)**: Critical temperatures of two dimensional magnets beyond linear spin wave theory: application to CrI$_3$, MPS$_3$ (M=Ni, Mn, Fe) and CrSBr
- **Authors**: Varun Rajeev Pavizhakumari, Thomas Olsen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文研究了二维材料中单Q磁序系统的临界温度计算方法，比较了Holstein-Primakoff方法和格林函数方法在处理单离子各向异性时的表现，发现格林函数方法更可靠，且Callen解耦修正在大各向异性情况下更准确。
...
- **arXiv**: [2511.08442](https://arxiv.org/abs/2511.08442)  ·  [PDF](https://arxiv.org/pdf/2511.08442.pdf)
- **Title (EN)**: Porous-B$_{18}$: An Ideal Topological Semimetal with Symmetry-Enforced Orthogonal Nodal-Line and Nodal-Surface States
- **Authors**: Xiao-jing Gao, Yanfeng Ge, Yan Gao
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 预测了一种新型多孔硼同素异形体Porous-B18，作为同时包含节线(NL)和节面(NS)的拓扑半金属，具有理想的电子能带结构和优异的稳定性。
...
- **arXiv**: [2511.08449](https://arxiv.org/abs/2511.08449)  ·  [PDF](https://arxiv.org/pdf/2511.08449.pdf)
- **Title (EN)**: Synergetic Enhancement on Bulk and Grain Boundary Ionic Conduction of Mg Doped High-Entropy NASICON-Type Solid Electrolyte for Solid-State Na+ Batteries by Spray Flame Synthesis
- **Authors**: Tianyi Wu, Yiyang Zhang, Zhu Fang, Shuting Lei, Xing Jin, Shuiqing Li
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究采用旋流喷雾火焰合成法制备Mg掺杂NASICON固态电解质纳米颗粒，通过高效掺杂和均匀混合实现纳米级高熵混合，显著降低原子迁移距离，在高温烧结后获得致密NASICON结构。Mg0.25NZSP在室温下表现出1.91 mS/cm的最佳离子电导率和0.200 eV的活化能。
...
- **arXiv**: [2511.08540](https://arxiv.org/abs/2511.08540)  ·  [PDF](https://arxiv.org/pdf/2511.08540.pdf)
- **Title (EN)**: Low-Field Ferroelectricity in 10 nm AlBScN Thin Films
- **Authors**: Xiaolei Tong, Pedram Yousefian, Ziyi Wang, Meenakshi A. Saravanan, Rajeev Kumar Rai, Giovanni Esteves, Eric A. Stach, Roy H. Olsson
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 10 nm AlBScN薄膜展示了稳健的铁电开关特性，具有低矫顽场和比AlScN低约两个数量级的漏电流，适用于CMOS后端兼容的铁电应用。
