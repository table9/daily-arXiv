---
title: "arXiv Daily · 2025-11-21 · 67 papers"
date: 2025-11-21
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2025-11-21 · 67 papers

### Implicit and explicit treatments of model error in numerical simulation
- **arXiv**: [2511.15934](https://arxiv.org/abs/2511.15934)  ·  [PDF](https://arxiv.org/pdf/2511.15934.pdf)
- **Title (EN)**: Implicit and explicit treatments of model error in numerical simulation
- **Authors**: Danny Smyl
- **Categories**: physics.comp-ph
- **TL;DR**: 本文综述了过去20年发展的模型误差近似与处理方法，涵盖隐式和显式误差处理技术，旨在提高计算物理和工程模拟中的预测性能和不确定性量化。
...
- **arXiv**: [2511.16441](https://arxiv.org/abs/2511.16441)  ·  [PDF](https://arxiv.org/pdf/2511.16441.pdf)
- **Title (EN)**: A physics-inspired momentum-based gradient method
- **Authors**: Jianing Zhang, Rumei Liu
- **Categories**: physics.comp-ph, physics.optics
- **TL;DR**: 提出了一种非线性动量方法，通过类比非牛顿力学系统动力学，改进动量梯度优化算法的收敛性能。
...
- **arXiv**: [2511.16614](https://arxiv.org/abs/2511.16614)  ·  [PDF](https://arxiv.org/pdf/2511.16614.pdf)
- **Title (EN)**: Deep Learning Framework for Enhanced Neutrino Reconstruction of Single-line Events in the ANTARES Telescope
...
- **TL;DR**: N-Fit算法通过深度学习改进ANTARES水下望远镜单线中微子事件的重建，显著提升方向角估计精度，并首次实现可靠的方位角预测，同时通过迁移学习改善能量估计和事件分类。
...
- **arXiv**: [2511.16569](https://arxiv.org/abs/2511.16569)  ·  [PDF](https://arxiv.org/pdf/2511.16569.pdf)
- **Title (EN)**: Li-P-S Electrolyte Materials as a Benchmark for Machine-Learned Interatomic Potentials
- **Authors**: Natascia L. Fragapane, Volker L. Deringer
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 本文介绍了LiPS-25基准数据集和评估套件，用于评估机器学习原子间势能模型在固态电解质材料上的性能，重点关注图神经网络架构。
...
- **arXiv**: [2511.15944](https://arxiv.org/abs/2511.15944)  ·  [PDF](https://arxiv.org/pdf/2511.15944.pdf)
- **Title (EN)**: Conventional superconductivity in single-crystalline BiPt
...
- **TL;DR**: BiPt是一种弱II型超导体，Tc为1.2K，具有各向异性超导特性，属于传统s波超导且保持时间反演对称性。
...
- **arXiv**: [2511.15783](https://arxiv.org/abs/2511.15783)  ·  [PDF](https://arxiv.org/pdf/2511.15783.pdf)
- **Title (EN)**: Automorphism in Gauge Theories: Higher Symmetries and Transversal Non-Clifford Logical Gates
- **Authors**: Po-Shen Hsin, Ryohei Kobayashi
- **Categories**: cond-mat.str-el, hep-th, quant-ph
- **TL;DR**: 该论文研究了规范群自同构诱导的规范理论对称性，发现这些对称性可以扩展为高阶群对称性和/或非可逆对称性，并应用于构建拓扑量子码中的新横向非Clifford逻辑门。
...
- **arXiv**: [2511.15845](https://arxiv.org/abs/2511.15845)  ·  [PDF](https://arxiv.org/pdf/2511.15845.pdf)
- **Title (EN)**: Effects of Non-reciprocity on Coupled Kuramoto Oscillators
- **Authors**: Shaon Mandal Chakraborty, Bibhut Sahoo, Rituparno Mandal, Peter Sollich
- **Categories**: cond-mat.stat-mech, cond-mat.soft, nlin.CD
- **TL;DR**: 研究非互易耦合振子系统的动力学行为，特别是对嵌合体状态的影响，发现非互易性会显著改变状态图并产生新的动力学状态。
...
- **arXiv**: [2511.16089](https://arxiv.org/abs/2511.16089)  ·  [PDF](https://arxiv.org/pdf/2511.16089.pdf)
- **Title (EN)**: Structure and Spectroscopy of Criegee Intermediates in Gas- and Aqueous Environments
- **Authors**: Cangtao Yin, Meenu Upadhyay, Markus Meuwly
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究使用验证的能量函数分析了小分子(H2COO)和大分子(CH3CHOO)克里吉中间体在不同水环境中的动力学和光谱特性，发现它们在液滴中易于扩散但在低温ASW上不扩散，光谱位移与蛋白质环境中观察到的斯塔克效应类似。
...
- **arXiv**: [2511.15754](https://arxiv.org/abs/2511.15754)  ·  [PDF](https://arxiv.org/pdf/2511.15754.pdf)
- **Title (EN)**: Electrical Modulation and Probing of Antiferromagnetism in Hybrid Multiferroic Heterostructures
...
- **TL;DR**: 该研究展示了在室温下通过全电学方式控制和探测铁磁/反铁磁绝缘体异质结构中的反铁磁序，利用反常霍尔效应进行检测，并通过铁电场效应和压电效应进行调控，实现了33%的反常霍尔效应调制。
...
- **arXiv**: [2511.15804](https://arxiv.org/abs/2511.15804)  ·  [PDF](https://arxiv.org/pdf/2511.15804.pdf)
- **Title (EN)**: Floquet Bosonic Kitaev Chain
- **Authors**: Raditya Weda Bomantara
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 提出了周期性驱动的修正玻色子Kitaev链模型，展示了非厄米Floquet拓扑现象，包括非厄米趋肤效应、拓扑零模和π模的共存与调控。
...
- **arXiv**: [2511.16603](https://arxiv.org/abs/2511.16603)  ·  [PDF](https://arxiv.org/pdf/2511.16603.pdf)
- **Title (EN)**: Charge-Ordered States and the Phase Diagram of the Extended Hubbard Model on the Bethe lattice
- **Authors**: Aleksey Alekseev, Konrad Jerzy Kapcia
- **Categories**: cond-mat.str-el, cond-mat.other, cond-mat.quant-gas, cond-mat.stat-mech, physics.comp-ph
- **TL;DR**: 使用Hartree平均场近似研究扩展哈伯德模型，发现系统在基态可处于电荷有序绝缘态、电荷有序金属态或非电荷有序态。增加在位排斥会抑制电荷有序并使系统从绝缘性转变为金属性。
...
- **arXiv**: [2511.16241](https://arxiv.org/abs/2511.16241)  ·  [PDF](https://arxiv.org/pdf/2511.16241.pdf)
- **Title (EN)**: Preserving the Josephson Coupling of Twisted Cuprate Junctions via Tailored Silicon Nitride Circuits Boards
- **Authors**: Tommaso Confalone, Flavia Lo Sardo, Domenico Montemurro, Davide Massarotti, Valerii M. Vinokur, Genda Gu, Francesco Tafuri, Kornelius Nielsch, Golam Haider, Nicola Poccia
- **Categories**: cond-mat.supr-con
- **TL;DR**: 提出了一种干式、惰性、低温组装方法，结合氮化硅纳米膜和低温堆叠技术，用于制造高质量扭曲BSCCO约瑟夫森结，解决了空气敏感材料制造中的可重复性问题。
...
- **arXiv**: [2511.15811](https://arxiv.org/abs/2511.15811)  ·  [PDF](https://arxiv.org/pdf/2511.15811.pdf)
- **Title (EN)**: Magnetostriction in the $J$-$K$-$Γ$ model: Application of the numerical linked cluster expansion
- **Authors**: Alexander Schwenke, Wolfram Brenig
- **Categories**: cond-mat.str-el
- **TL;DR**: 应用数值链簇展开(NLCE)研究近Kitaev磁体α-RuCl₃在磁场中的热力学性质，包括内能、比热、磁化强度和磁致伸缩系数。
...
- **arXiv**: [2511.15901](https://arxiv.org/abs/2511.15901)  ·  [PDF](https://arxiv.org/pdf/2511.15901.pdf)
- **Title (EN)**: Boltzmann-Kolmogorov equation
- **Authors**: Mário J. de Oliveira
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文研究了相空间中概率分布时间演化的Kolmogorov方程性质，该方程适用于孤立系统，稳态为Gibbs微正则分布，能预测熵增，并可从单粒子分布近似推导出Boltzmann方程。
...
- **arXiv**: [2511.16439](https://arxiv.org/abs/2511.16439)  ·  [PDF](https://arxiv.org/pdf/2511.16439.pdf)
- **Title (EN)**: Black-Box Uncertainty Estimation for Deep Learning Models in Atomistic Simulations
- **Authors**: Idan Fonea, Amir Peles, Sivan Niv, Goren Gordon, Amir Natan
- **Categories**: physics.chem-ph
- **TL;DR**: 提出一种基于集成学习的原子神经网络不确定性量化方法，无需修改多输出回归神经网络架构，适用于黑盒模型，在钠和铝分子系统中验证了其检测分布外数据的能力。
...
- **arXiv**: [2511.16010](https://arxiv.org/abs/2511.16010)  ·  [PDF](https://arxiv.org/pdf/2511.16010.pdf)
- **Title (EN)**: Quantum Reorientational Excitations in the Raman Spectrum of Hydrogen
...
- **TL;DR**: 在2-174 GPa和13-300 K条件下，氢中观察到低于250 cm-1的低频拉曼峰，这些特征源于各向异性分子间相互作用引起的重新取向跃迁，与S0分支行为相似，并在相III中转变为光学声子。
...
- **arXiv**: [2511.15824](https://arxiv.org/abs/2511.15824)  ·  [PDF](https://arxiv.org/pdf/2511.15824.pdf)
- **Title (EN)**: Exciton and trion formation in systems with van Hove singularities
- **Authors**: Lewis J. Burke, Mark T. Greenaway, Joseph J. Betouras
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 研究了范霍夫奇点在电子能带结构中对激子和三子形成及性质的影响，发现墨西哥帽型价带越窄越有利于三子形成，高阶范霍夫奇点会改变束缚态粒子的态密度并产生新态。
...
- **arXiv**: [2511.16385](https://arxiv.org/abs/2511.16385)  ·  [PDF](https://arxiv.org/pdf/2511.16385.pdf)
- **Title (EN)**: Berezinskii-Kosterlitz-Thouless transition with enhanced phase stiffness in $d$-wave strongly coupled two-dimensional superconductors
- **Authors**: Sathish Kumar Paramasivam, Andrea Perali, Milorad V. Milošević
- **Categories**: cond-mat.supr-con
- **TL;DR**: d波对称性超导间隙在强耦合二维超导体中显著增强相刚度，提升BKT转变温度，相比无节点s波超导体具有优势。
...
- **arXiv**: [2511.16359](https://arxiv.org/abs/2511.16359)  ·  [PDF](https://arxiv.org/pdf/2511.16359.pdf)
- **Title (EN)**: Topological transition in spectrum of skyrmion crystal with uniaxial anisotropy
- **Authors**: V. E. Timofeev, D. A. Bedyaev, D. N. Aristov
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 研究了具有Dzyaloshinskii-Moriya相互作用和单轴磁各向异性的薄铁磁薄膜中斯格明子晶体的基本激发能带结构，发现在一定各向异性范围内存在拓扑转变。
...
- **arXiv**: [2511.16234](https://arxiv.org/abs/2511.16234)  ·  [PDF](https://arxiv.org/pdf/2511.16234.pdf)
- **Title (EN)**: Nonequilibrium phase transition in single-file transport at high crowding
- **Authors**: Annika Vonhusen, Sören Schweers, Artem Ryabov, Philipp Maass
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文报告了在周期性结构高粒子密度下发生的非平衡相变，该相变将热激活输运的弱电流相与孤立波传播的高电流相分开，并伴随着粒子电流涨落相关性的普适性类别变化。
...
- **arXiv**: [2511.16461](https://arxiv.org/abs/2511.16461)  ·  [PDF](https://arxiv.org/pdf/2511.16461.pdf)
- **Title (EN)**: Connecting Collisional and Photofragmentation Resonances in the H$_2$ Ungerade Symmetry
- **Authors**: Dávid Hvizdoš, Roman Čurík, Chris H. Greene
- **Categories**: physics.chem-ph
- **TL;DR**: 扩展了能量依赖的框架变换理论，用于处理H2分子的非对称态，涵盖解离复合和基态光吸收过程，包含转动自由度并与高精度二维模型和实验数据进行对比。
...
- **arXiv**: [2511.16057](https://arxiv.org/abs/2511.16057)  ·  [PDF](https://arxiv.org/pdf/2511.16057.pdf)
- **Title (EN)**: High-Throughput Exploration of Refractory High-Entropy Alloys for Strength and Plasticity
- **Authors**: Stephen A. Giles, Hugh Shortt, Peter K. Liaw, Debasis Sengupta
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用深度学习模型预测了10万多种难熔高熵合金的高温强度和室温塑性，识别出多个性能优异的候选材料，实验验证其性能超过以往报道的所有难熔高熵合金。
...
- **arXiv**: [2511.15922](https://arxiv.org/abs/2511.15922)  ·  [PDF](https://arxiv.org/pdf/2511.15922.pdf)
- **Title (EN)**: Selective Shuttling of Electrons on Helium Using a CMOS Control Platform
- **Authors**: K. E. Castoria, H. Byeon, N. R. Beysengulov, E. O. Glen, M. Sammon, J. Pollanen, D. G. Rees, S. A. Lyon
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文演示了在CMOS控制芯片上的液氦薄膜中实现二维电子穿梭传输，能够以包含数十到单个电子的包形式进行选择性传输，为量子计算平台提供了可扩展的解决方案。
...
- **arXiv**: [2511.16481](https://arxiv.org/abs/2511.16481)  ·  [PDF](https://arxiv.org/pdf/2511.16481.pdf)
- **Title (EN)**: Effect of a magnetic field up to 9 T on the temperature dependence of the pseudogap in YBa$_2$Cu$_3$O$_{7-δ}$ films
- **Authors**: A. S. Kolisnyk, M. V. Shytov, E. V. Petrenko, A. V. Terekhov, L. V. Bludova, A. Sedda, E. Lähderanta, A. L. Solovjov
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究分析了沿c轴方向的磁场对YBa2Cu3O7-δ薄膜的电阻率、涨落电导率和赝能隙的影响，发现磁场增强了样品的相互作用，导致BEC-BCS转变温度降低，赝能隙最大值减小，并证实了磁场诱导涡旋态形成的可能性。
...
- **arXiv**: [2511.16429](https://arxiv.org/abs/2511.16429)  ·  [PDF](https://arxiv.org/pdf/2511.16429.pdf)
- **Title (EN)**: Order-by-disorder from Schwinger bosons in a frustrated honeycomb ferromagnet
...
- **arXiv**: [2511.16286](https://arxiv.org/abs/2511.16286)  ·  [PDF](https://arxiv.org/pdf/2511.16286.pdf)
- **Title (EN)**: Collective Buckling in Metal-Organic Framework Materials
- **Authors**: Nico Hahn, Lars Öhrström, R. Matthias Geilhufe
- **Categories**: cond-mat.stat-mech, cond-mat.other, cond-mat.soft
- **TL;DR**: 开发了一个描述金属有机框架中集体屈曲的理论框架，通过偶极-偶极相互作用耦合有机连接体，分析有序-无序相变并计算临界温度，以MOF-5为例验证理论。
...
- **arXiv**: [2511.16059](https://arxiv.org/abs/2511.16059)  ·  [PDF](https://arxiv.org/pdf/2511.16059.pdf)
- **Title (EN)**: Extending SLUSCHI for Automated Diffusion Calculations
- **Authors**: Qi-Jun Hong, Qing Chen, Ligen Wang, Dallin Fisher, Audrey CampBell, Si-Da Xue, Linqin Mu, Noemi Leick, Seetharaman Sridhar
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 扩展SLUSCHI包以支持基于第一性原理分子动力学的自动化扩散计算，从熔点预测扩展到输运性质评估
...
- **arXiv**: [2511.15930](https://arxiv.org/abs/2511.15930)  ·  [PDF](https://arxiv.org/pdf/2511.15930.pdf)
- **Title (EN)**: Nonlocal Transport in Cr-doped (Bi,Sb)2Te3: Absence of Nonchiral Edge States
- **Authors**: Valery Ortiz Jimenez, Paul M. Haney, Farzad Mahfouzi, Ngoch Thanh Mai Tran, Albert F. Rigosi, Curt A. Richter
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过15个独立输运测量与不同模型对比，发现量子反常霍尔系统在2K下的行为可用简单连续欧姆定律模型描述，非手性边缘态模型并未显著改善拟合效果，表明这些态可能不存在。
...
- **arXiv**: [2511.16610](https://arxiv.org/abs/2511.16610)  ·  [PDF](https://arxiv.org/pdf/2511.16610.pdf)
- **Title (EN)**: Quantifying Twist Angles in Cuprate Heterostructures with Anisotropic Raman Signatures
...
- **Categories**: cond-mat.supr-con
- **TL;DR**: 提出了一种完全非侵入性的偏振分辨拉曼光谱方法，用于确定人工堆叠BSCCO异质结构中的扭转角，解决了传统表征工具对材料造成损伤的问题。
...
- **arXiv**: [2511.16446](https://arxiv.org/abs/2511.16446)  ·  [PDF](https://arxiv.org/pdf/2511.16446.pdf)
- **Title (EN)**: Multi-scale competition in the Majorana-Kondo system
- **Authors**: Yun Chen, Haojie Shen, Wei Su, Rui Wang
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文研究了Kondo系统中侧耦合Majorana零模的筛选过程和边界条件演化，重点关注自旋-电荷纠缠筛选在对称性破坏和拓扑简并竞争下的行为。
...
- **arXiv**: [2511.16362](https://arxiv.org/abs/2511.16362)  ·  [PDF](https://arxiv.org/pdf/2511.16362.pdf)
- **Title (EN)**: Resolving Speed and Encoding Bottlenecks in Fast Heteromeric Self-Assembly
- **Authors**: Félix Benoist, Pablo Sartori
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文研究了细胞质中蛋白质自组装的动力学机制，发现通过控制少量关键结合事件的动力学可以克服自组装过程中的速度和编码瓶颈，为理解组装因子的作用提供了统一原理。
...
- **arXiv**: [2511.16071](https://arxiv.org/abs/2511.16071)  ·  [PDF](https://arxiv.org/pdf/2511.16071.pdf)
- **Title (EN)**: Elucidating the High-Pressure Phases of MAPbBr3 Using a Machine Learning Force Field
- **Authors**: Rashid Rafeek V Valappil, Sayan Maity, Varadharajan Srinivasan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用机器学习力场研究MAPbBr3高压相变，揭示了从α到β再到γ相的相变序列，以及各相中的结构特征和动力学行为。
...
- **arXiv**: [2511.15972](https://arxiv.org/abs/2511.15972)  ·  [PDF](https://arxiv.org/pdf/2511.15972.pdf)
- **Title (EN)**: Nonreciprocal spin wave in room-temperature van der Waals ferromagnet $(\rm Fe_{0.78}Co_{0.22})_{5}GeTe_{2}$
- **Authors**: Guofu Xu, Feihao Pan, Jiyang Ou, Wenjun Ma, Xu Zhang, Xiling Li, Guoqiang Yu, Peng Cheng, Hongjun Xu, Guozhi Chai
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过布里渊光散射技术研究了室温范德华铁磁体(Fe0.78Co0.22)5GeTe2中的自旋波，发现偶极相互作用在自旋波中起关键作用，并观察到厚片中的非互易自旋波，归因于体Dzyaloshinskii-Moriya相互作用。
...
- **arXiv**: [2511.16337](https://arxiv.org/abs/2511.16337)  ·  [PDF](https://arxiv.org/pdf/2511.16337.pdf)
- **Title (EN)**: Improvement of the Simmons model for tunnel junctions
- **Authors**: Ilmo Räisänen, Ilari Maasilta
- **Categories**: cond-mat.mes-hall, cond-mat.supr-con
- **TL;DR**: 提出了对Simmons隧道电流模型的改进，推导了更精确的有限电压和温度下的隧道电流密度和电导解析公式。
...
- **arXiv**: [2511.16496](https://arxiv.org/abs/2511.16496)  ·  [PDF](https://arxiv.org/pdf/2511.16496.pdf)
- **Title (EN)**: $c=-2$ conformal field theory in quadratic band touching
- **Authors**: Rintaro Masaoka
- **Categories**: cond-mat.str-el, cond-mat.stat-mech, hep-th
- **TL;DR**: 本文证明了具有二次能带接触的自由费米子模型展现空间共形不变性，其基态关联函数可由辛费米子理论精确描述，并在二维系统中识别出源于该理论的任意子激发。
...
- **arXiv**: [2511.16443](https://arxiv.org/abs/2511.16443)  ·  [PDF](https://arxiv.org/pdf/2511.16443.pdf)
- **Title (EN)**: Height distribution of elastic interfaces in quenched random media
- **Authors**: Tuuli Sillanpää, Sanni Nousiainen, Lasse Laurson
- **Categories**: cond-mat.stat-mech, cond-mat.dis-nn
- **TL;DR**: 本文研究了弹性界面在淬火随机介质中受外力驱动时的脱钉相变，发现局部界面高度分布在脱钉点呈现负偏态特征，且该特征在不同弹性类型和热力学极限下具有鲁棒性。
...
- **arXiv**: [2511.16086](https://arxiv.org/abs/2511.16086)  ·  [PDF](https://arxiv.org/pdf/2511.16086.pdf)
- **Title (EN)**: Chiral Spin-Split Magnons in the Metallic Altermagnet CrSb
...
- **TL;DR**: CrSb是一种金属性交变磁体，在733K以下表现为完美补偿的伊辛交变磁体，具有高度各向异性的反铁磁自旋波和手性自旋分裂特征。
...
- **arXiv**: [2511.15999](https://arxiv.org/abs/2511.15999)  ·  [PDF](https://arxiv.org/pdf/2511.15999.pdf)
- **Title (EN)**: Skyrmionium meta-matter: a topologically heterogeneous magnetic crystal with emergent hybrid dynamics
- **Authors**: Andrey O. Leonov, Kaito Nakamura
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 本文系统研究了一种新型拓扑磁结构——斯格明子元物质，由斯格明子(Sk)和斯格明子(Skm)组成的周期性晶格，具有丰富的结构和动力学特性。
...
- **arXiv**: [2511.16578](https://arxiv.org/abs/2511.16578)  ·  [PDF](https://arxiv.org/pdf/2511.16578.pdf)
- **Title (EN)**: Pervasive spin-triplet superconductivity in rhombohedral graphene
...
- **TL;DR**: 在七层菱面体石墨烯中发现了由面内磁场诱导和稳定的超导现象，临界磁场远超泡利顺磁极限，表现出自旋三重态超导特性。
...
- **arXiv**: [2511.16457](https://arxiv.org/abs/2511.16457)  ·  [PDF](https://arxiv.org/pdf/2511.16457.pdf)
- **Title (EN)**: Distinguishing thermal versus quantum annealing using probability-flux signatures across interaction networks
- **Authors**: Yoshiaki Horiike, Yuki Kawaguchi
- **Categories**: cond-mat.stat-mech, cond-mat.dis-nn, cond-mat.quant-gas, physics.data-an, quant-ph
- **TL;DR**: 该研究通过分析7个自旋以内的所有可能相互作用网络，揭示了热退火和量子退火在特定网络结构下的差异，发现能量景观结构是区分两种动力学的关键因素。
...
- **arXiv**: [2511.16167](https://arxiv.org/abs/2511.16167)  ·  [PDF](https://arxiv.org/pdf/2511.16167.pdf)
- **Title (EN)**: Synthesis and optical characterization of Mn-doped ZnS nanocrystalline thin films prepared via chemical bath deposition
- **Authors**: Himal Pokhrel, Urvashi Verma
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过低温化学浴沉积法合成了锰掺杂硫化锌纳米晶薄膜，表征显示形成了立方闪锌矿结构，平均晶粒尺寸约37nm。锰掺杂导致吸收边红移，带隙约为3.70eV，表明该材料适用于光电子和光伏应用。
...
- **arXiv**: [2511.16053](https://arxiv.org/abs/2511.16053)  ·  [PDF](https://arxiv.org/pdf/2511.16053.pdf)
- **Title (EN)**: A simple quantum dot: numerical and variational solutions
- **Authors**: Connor Walsh, Ian MacPherson, Davidson Joseph, Suyash Kabra, Ripanjeet Singh Toor, Mason Protter, Frank Marsiglio
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文介绍了一种由两个交叉凹槽构成的简单量子点结构，该结构虽然没有传统势阱，但能在交叉点产生束缚态。作者回顾了现有数值方法，并推荐了一种特别优雅且精确的解法。
...
- **arXiv**: [2511.16634](https://arxiv.org/abs/2511.16634)  ·  [PDF](https://arxiv.org/pdf/2511.16634.pdf)
- **Title (EN)**: Non-Abelian operator size distribution in charge-conserving many-body systems
- **Authors**: Mina Tarakemeh, Shenglong Xu
- **Categories**: cond-mat.str-el, quant-ph
- **TL;DR**: 本文构建了U(1)对称系统中算子动力学的非阿贝尔算子大小基，揭示了算子增长由角动量减少表征，并在布朗SYK模型中推导出控制大小分布的精确主方程。
...
- **arXiv**: [2511.16509](https://arxiv.org/abs/2511.16509)  ·  [PDF](https://arxiv.org/pdf/2511.16509.pdf)
- **Title (EN)**: Comment on: "Scaling and Universality at Noisy Quench Dynamical Quantum Phase Transitions"
- **Authors**: J. Sirker
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, quant-ph
- **TL;DR**: 本文严格证明在二维希尔伯特空间中，两个密度矩阵的Loschmidt回波只有在两个密度矩阵都是纯态时才能为零。因此，在非零噪声情况下，Ansari等人论文中报道的动力学量子相变(DQPTs)的存在被严格排除。
...
- **arXiv**: [2511.16168](https://arxiv.org/abs/2511.16168)  ·  [PDF](https://arxiv.org/pdf/2511.16168.pdf)
- **Title (EN)**: Following the Long-Term Evolution of sp$^3$-type Defects in Tritiated Graphene using Raman Spectroscopy
- **Authors**: Genrich Zeller, Magnus Schlösser, Helmut H. Telle
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过比较同一石墨烯样品在不同时间点的大面积拉曼图谱，研究发现氚诱导的sp³缺陷在约两年内几乎完全消失，远超过仅由氚衰变预期的年减少率。
...
- **arXiv**: [2511.16065](https://arxiv.org/abs/2511.16065)  ·  [PDF](https://arxiv.org/pdf/2511.16065.pdf)
- **Title (EN)**: Nature of 2D XY antiferromagnetism in a van der Waals monolayer
- **Authors**: Cheol-Yeon Cheon, Volodymyr Multian, Kenji Watanabe, Takashi Taniguchi, Alberto F. Morpurgo, Dmitry Lebedev
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 通过磁输运测量发现NiPS3单层表现出与厚层样品不同的磁性行为，经历两个磁性相变，低温相由面内六角磁各向异性主导，与六态钟模型和2D-XY模型的理论预测一致。
...
- **arXiv**: [2511.16641](https://arxiv.org/abs/2511.16641)  ·  [PDF](https://arxiv.org/pdf/2511.16641.pdf)
- **Title (EN)**: Stabilizing Fractional Chern States in Twisted MoTe2: Multi-band Correlations via Non-perturbative Renormalization Group
- **Authors**: Run Hou, Andriy H. Nevidomskyy
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文发现扭曲MoTe2中的分数量子霍尔态受到高能带间强相互作用影响，传统单带对角化方法不准确。作者引入量子化学中的DSRG方法，证明在ν=1/3时能隙显著减小，在ν=2/3时动态关联稳定了分数陈绝缘相。
...
- **arXiv**: [2511.16510](https://arxiv.org/abs/2511.16510)  ·  [PDF](https://arxiv.org/pdf/2511.16510.pdf)
- **Title (EN)**: Out-of-equilibrium spinodal-like scaling behaviors at the thermal first-order transitions of three-dimensional q-state Potts models
- **Authors**: Andrea Pelissetto, Davide Rossini, Ettore Vicari
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 研究三维q态Potts系统在热力学极限下跨越一级相变时的非平衡自旋odal动力学，发现能量密度在慢速驱动下呈现标度行为，标度变量为t(ln t)^κ/t_s，其中κ≈3/2，表明有序区域的初始成核是相变的主要机制。
...
- **arXiv**: [2511.16197](https://arxiv.org/abs/2511.16197)  ·  [PDF](https://arxiv.org/pdf/2511.16197.pdf)
- **Title (EN)**: Transfer of Freestanding Fluoropolymer Films for Advanced Semiconductor Devices
- **Authors**: Mohammad Monish, Koki Hino, Yosuke Sasama, Masato Urakami, Takehiro Ota, Kenji Sakamoto, Kenichiro Takakura, Yamaguchi Takahide
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 开发了一种无损转移独立氟聚合物绝缘薄膜的方法，可在多种基底上形成高质量介电层，在氢终端金刚石场效应晶体管中表现出优异的电学性能。
...
- **arXiv**: [2511.16141](https://arxiv.org/abs/2511.16141)  ·  [PDF](https://arxiv.org/pdf/2511.16141.pdf)
- **Title (EN)**: Phonon Dichroisms Revealing Unusual Electronic Quantum Geometry
- **Authors**: Ding Li, Guoao Yang, Tao Qin, Jianhui Zhou, Yugui Yao
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 量子几何张量通过电子-声子相互作用显著改变声子二色性，圆声子二色性主要由热磁矩主导，线声子二色性依赖于热Drude权重。建立了热磁矩的f-求和规则，并在铁磁二维电子气模型中验证了这些发现。
...
- **arXiv**: [2511.16667](https://arxiv.org/abs/2511.16667)  ·  [PDF](https://arxiv.org/pdf/2511.16667.pdf)
- **Title (EN)**: Strained hyperbolic Dirac fermions: Zero modes, flat bands, and competing orders
- **Authors**: Christopher A. Leong, Bitan Roy
- **Categories**: cond-mat.str-el, cond-mat.mes-hall, cond-mat.mtrl-sci, hep-th
- **TL;DR**: 在双曲晶格中通过空间调制的跃迁模式引入轴向磁场，产生平带并诱导电荷密度波、Haldane相和磁性相变，同时探讨了非厄米性对这些序参量的增强效应。
...
- **arXiv**: [2511.16263](https://arxiv.org/abs/2511.16263)  ·  [PDF](https://arxiv.org/pdf/2511.16263.pdf)
- **Title (EN)**: Prediction of atomic H adsorption energies in metalloid doped MSSe (M = Mo/W) Janus layers: A combined DFT and machine learning study
- **Authors**: G. Tejaswini, Anjana E Sudheer, Amrendra Kumar, M. Vallinayagam, Pavan Kumar Perepu, Attila Cangi, Mani Lokamani, M. Posselt, M. Zschornak, C. Kamal, D. Amaranatha Reddy, D. Murali
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究通过密度泛函理论计算和机器学习模型，分析了金属掺杂对Janus MSSe（M=Mo/W; X=S/Se）层氢吸附性能的影响，发现原子位点掺杂可使氢吸附过程自发进行，并开发了预测氢吸附能的神经网络模型。
...
- **arXiv**: [2511.16155](https://arxiv.org/abs/2511.16155)  ·  [PDF](https://arxiv.org/pdf/2511.16155.pdf)
- **Title (EN)**: Synthetic Spatiotemporal Plasmonic Vortices On Chip
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文介绍了一种新型时空等离子体涡旋（STPVs），通过时域延迟的等离子体本征涡旋的时序干涉生成，具有非平凡拓扑自旋纹理，可在纳米-阿秒尺度上直接成像和控制。
...
- **arXiv**: [2511.16269](https://arxiv.org/abs/2511.16269)  ·  [PDF](https://arxiv.org/pdf/2511.16269.pdf)
- **Title (EN)**: van der Waals epitaxy of lead monoxide - PbO and application as a virtual substrate for oxide membranes
- **Authors**: Marcel S. Claro, Francisco Rivadulla
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 成功生长了范德华PbO多晶型外延层，并用作虚拟衬底生长高质量钙钛矿和尖晶石薄膜，可实现自发剥离或胶带法转移，为制备自支撑氧化物膜提供新方法
...
- **arXiv**: [2511.16165](https://arxiv.org/abs/2511.16165)  ·  [PDF](https://arxiv.org/pdf/2511.16165.pdf)
- **Title (EN)**: Ultrafast μeV-Precision Bandgap Engineering in Low-Dimensional Topological Insulators
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过低温瞬态反射光谱在拓扑绝缘体α-Bi₄Br₄中实现微电子伏特精度的动态带隙调控，利用拓扑载流子和相干声子的协同作用实现电子结构的精确控制。
...
- **arXiv**: [2511.16313](https://arxiv.org/abs/2511.16313)  ·  [PDF](https://arxiv.org/pdf/2511.16313.pdf)
- **Title (EN)**: Quasiparticle states of hexagonal BN: A van der Waals density functional study
- **Authors**: Raul Quintero-Monsebaiz, Per Hyldgaard
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过结合vdW-DF-cx交换关联泛函和Koopmans整数DFT框架，开发了KI-CX方法，用于研究六方氮化硼(h-BN)体系中的非局域关联效应对准粒子能带结构的影响。
...
- **arXiv**: [2511.16219](https://arxiv.org/abs/2511.16219)  ·  [PDF](https://arxiv.org/pdf/2511.16219.pdf)
- **Title (EN)**: Geometrical properties of strained and twisted moiré heterostructures
- **Authors**: Federico Escudero, Francisco Guinea, Zhen Zhan
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 这篇综述系统介绍了应变在莫尔超晶格中的几何学原理和应用，包括应变理论、特殊莫尔几何结构的理论预测以及实验实现技术。
...
- **arXiv**: [2511.16382](https://arxiv.org/abs/2511.16382)  ·  [PDF](https://arxiv.org/pdf/2511.16382.pdf)
- **Title (EN)**: Quantifying Phase Transformations in Alloying Anodes via In-Situ Liquid Cell Hard X-ray Spectroscopy and Cryogenic Microscopy
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究通过多模态表征技术揭示了铂基合金负极在锂化过程中的相变机制和界面演化，发现了Li2Pt到LiPt的固溶体反应路径，以及SEI膜从碳酸盐到LiF的稳定化转变。
...
- **arXiv**: [2511.16328](https://arxiv.org/abs/2511.16328)  ·  [PDF](https://arxiv.org/pdf/2511.16328.pdf)
- **Title (EN)**: Failure of the Goldstone Theorem for Vector Fields and Boundary-Mode Proliferation in Hyperbolic Lattices
- **Authors**: Daniel Sela, Nan Cheng, Kai Sun
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在双曲晶格中研究矢量场时发现，戈德斯通定理失效，声子模式出现能隙，这与欧几里得晶体中的无间隙声子模式形成鲜明对比。
...
- **arXiv**: [2511.16421](https://arxiv.org/abs/2511.16421)  ·  [PDF](https://arxiv.org/pdf/2511.16421.pdf)
- **Title (EN)**: Linear magneto-birefringence as a probe of altermagnetism
- **Authors**: V. Sunko, J. Orenstein
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文提出线性磁双折射(LMB)是检测交变磁体(altermagnets)序参数的自然且广泛应用的方法，通过动量空间非相对论自旋分裂与实空间磁多极子序的对应关系，展示了d波和g波NRSS纹理产生不同的LMB响应。
...
- **arXiv**: [2511.16474](https://arxiv.org/abs/2511.16474)  ·  [PDF](https://arxiv.org/pdf/2511.16474.pdf)
- **Title (EN)**: The Plastic Origin of van der Waals material GaGeTe
- **Authors**: Qiao Wang, Ping-An Hu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 发现三元锗基单晶GaGeTe具有高塑性，突破了传统二元锗基硫族化合物的脆性限制，填补了锗基塑性半导体研究空白。
...
- **arXiv**: [2511.16422](https://arxiv.org/abs/2511.16422)  ·  [PDF](https://arxiv.org/pdf/2511.16422.pdf)
- **Title (EN)**: Dissipation-Shaped Quantum Geometry in Nonlinear Transport
- **Authors**: Zhichao Guo, Xing-Yuan Liu, Hua Wang, Li-kun Shi, Kai Chang
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文澄清了本征非线性霍尔效应理论中的模糊性，指出其电导率与耗散机制密切相关，而非布洛赫哈密顿量的唯一性质。
...
- **arXiv**: [2511.16513](https://arxiv.org/abs/2511.16513)  ·  [PDF](https://arxiv.org/pdf/2511.16513.pdf)
- **Title (EN)**: Leveraging the Bi$_2$O$_3$--Fe$_2$O$_3$ Phase Diagram to Tailor BiFeO$_3$ Structure and Dielectric Response
- **Authors**: Subir Majumder, Paul Ben Ishai, Gilad Orr
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过优化Bi2O3:Fe2O3前驱体比例为55:45并在775°C烧结，成功制备出相纯的BFO多铁材料，显著提高了介电性能和电导率。
...
- **arXiv**: [2511.16433](https://arxiv.org/abs/2511.16433)  ·  [PDF](https://arxiv.org/pdf/2511.16433.pdf)
- **Title (EN)**: Observation of Magnetostatic Surface Spin Wave Solitons in Yttrium Iron Garnet Thin Film
- **Authors**: Simin Pang, Zhengyi Li, Ziyu Wang, Yanpei Lv, Feilong Song, Peng Yan, Jun Zhang
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过时间分辨布里渊光散射光谱观测到磁静表面自旋波孤子，揭示了其准粒子行为、模式拍频和周期性调制，证实了MSSW孤子的存在。
...
- **arXiv**: [2511.16480](https://arxiv.org/abs/2511.16480)  ·  [PDF](https://arxiv.org/pdf/2511.16480.pdf)
- **Title (EN)**: Adiabatic charge transport through non-Bloch bands
- **Authors**: Dharana Joshi, Tanay Nag
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 本文研究了扩展SSH模型中非互易胞内跳跃介导的非厄米拓扑相，通过非布洛赫动量分析相边界，建立了非布洛赫能带与拓扑相的联系，验证了体边对应关系，并探讨了非厄米情况下的绝热电荷输运。
...
- **arXiv**: [2511.16646](https://arxiv.org/abs/2511.16646)  ·  [PDF](https://arxiv.org/pdf/2511.16646.pdf)
- **Title (EN)**: Revealing Phonon Bridge Effect for Amorphous vs Crystalline Metal-Silicide Layers at Si/Ti Interfaces by a Machine Learning Potential
- **Authors**: Mayur Singh, Lokanath Patra, Chengyang Zhang, Greg MacDougall, Suman Datta, David Cahill, Satish Kumar
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了Si-Ti系统的统一神经进化势函数(NEP)，用于准确预测硅-钛界面的热边界电阻(TBR)，并通过非平衡分子动力学模拟和实验测量验证了结果。
...
- **arXiv**: [2511.16539](https://arxiv.org/abs/2511.16539)  ·  [PDF](https://arxiv.org/pdf/2511.16539.pdf)
- **Title (EN)**: Probing moire excitons in MoSe2/WSe2 heterobilayers by combined micro-photoluminescence and lateral force microscopy
- **Authors**: L. Caussou, H. Moutaabbid, M. Bernard, F. Margaillan, T. Taniguchi, K. Watanabe, C. Lagoin, F. Dubin, V. Voliotis
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过结合横向力显微镜和微光致发光光谱研究MoSe2/WSe2异质双层中的层间激子，揭示莫尔超晶格空间分布与光学活性态的相关性。
