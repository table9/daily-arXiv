---
title: "arXiv Daily · 2025-11-25 · 100 papers"
date: 2025-11-25
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2025-11-25 · 100 papers

### $Δ$-ML Ensembles for Selecting Quantum Chemistry Methods to Compute Intermolecular Interactions
- **arXiv**: [2511.17753](https://arxiv.org/abs/2511.17753)  ·  [PDF](https://arxiv.org/pdf/2511.17753.pdf)
- **Title (EN)**: $Δ$-ML Ensembles for Selecting Quantum Chemistry Methods to Compute Intermolecular Interactions
- **Authors**: Austin M. Wallace, C. David Sherrill, Giri P. Krishnan
- **Categories**: physics.chem-ph, cs.AI
- **TL;DR**: 提出基于Δ-ML模型集成框架，预测量子化学方法相对于CCSD(T)/CBS标准的误差，以选择计算效率最高的方法
...
- **arXiv**: [2511.17767](https://arxiv.org/abs/2511.17767)  ·  [PDF](https://arxiv.org/pdf/2511.17767.pdf)
- **Title (EN)**: Benchmarking Hartree-Fock and DFT for Molecular Hyperpolarizability: Implications for Evolutionary Design
- **Authors**: Dominic Mashak, S. A. Alexander
- **Categories**: physics.chem-ph
- **TL;DR**: 系统评估HF和DFT方法预测分子第一超极化率β的性能，发现所有30种函数/基组组合都能保持完美的分子对排序，适合作为进化算法的适应度函数。
...
- **arXiv**: [2511.17810](https://arxiv.org/abs/2511.17810)  ·  [PDF](https://arxiv.org/pdf/2511.17810.pdf)
- **Title (EN)**: Unbiased molecular dynamics for the direct determination of catalytic reaction times : paving the way beyond transition state theory
- **Authors**: Thomas Pigeon, Manuel Corral Valero, Pascal Raybaud
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究开发了一种超越传统过渡态理论的催化反应速率计算方法，通过结合Hill关系和自适应多级分裂算法，能够精确计算随机动力学中的速率常数，解决了TST在复杂系统中的局限性。
...
- **arXiv**: [2511.18046](https://arxiv.org/abs/2511.18046)  ·  [PDF](https://arxiv.org/pdf/2511.18046.pdf)
- **Title (EN)**: Quantifying the Spin-Orbital Entanglement in $5d^1$ Quantum Materials
- **Authors**: V. García-Rojas, J. F. Pérez-Torres
- **Categories**: physics.chem-ph
- **TL;DR**: 本文通过自旋-轨道冯·诺依曼熵量化了双钙钛矿中5d^1过渡金属离子的自旋-轨道纠缠，发现较大的有效磁偶极矩源于更强的自旋-轨道纠缠而非更大的自旋-轨道耦合常数。
...
- **arXiv**: [2511.17551](https://arxiv.org/abs/2511.17551)  ·  [PDF](https://arxiv.org/pdf/2511.17551.pdf)
- **Title (EN)**: H3PC: Hypersonic, High-Order, High-Performance Code with Adaptive Mesh Refinement and Real Chemistry
- **Authors**: Ahmad Peyvan, Khemraj Shukla, George Em Karniadakis
- **Categories**: physics.comp-ph, physics.flu-dyn
- **TL;DR**: 开发了基于Trixi.jl框架的高超声速高阶高性能代码H³PC，用于模拟复杂三维几何中的可压缩欧拉和纳维-斯托克斯方程，支持化学反应建模和并行自适应网格细化
...
- **arXiv**: [2511.17684](https://arxiv.org/abs/2511.17684)  ·  [PDF](https://arxiv.org/pdf/2511.17684.pdf)
- **Title (EN)**: On the uniqueness of the coupled entropy
- **Authors**: Kenric P. Nelson
- **Categories**: cond-mat.stat-mech, cs.IT, physics.data-an
- **TL;DR**: 本文证明了耦合熵是唯一满足广义熵等价于尺度-形状分布在尺度上密度的要求。其最大化分布——耦合拉伸指数分布，能够量化复杂系统中尺度的线性不确定性和形状的非线性不确定性。
...
- **arXiv**: [2511.18736](https://arxiv.org/abs/2511.18736)  ·  [PDF](https://arxiv.org/pdf/2511.18736.pdf)
- **Title (EN)**: Microscopic parameters of a type-II superconductor measured by small-angle neutron scattering
- **Authors**: D. Alba Venero, A. -M. Valente-Feliciano, O. O. Bernal, V. Kozhevnikov
- **Categories**: cond-mat.supr-con
- **TL;DR**: 首次通过小角中子散射测量II型超导体（铌）中控制超导性质的微观参数，包括库珀对轨道半径、场致电流半径和库珀对数密度
...
- **arXiv**: [2511.17661](https://arxiv.org/abs/2511.17661)  ·  [PDF](https://arxiv.org/pdf/2511.17661.pdf)
- **Title (EN)**: Floquet-engineered Valley Topology with Anisotropic Response in 1T'-WSe2 and Janus WSeTe monolayers
- **Authors**: Zhe Li, Haijun Cao, Lijuan Li, Huixia Fu, Mengxue Guan, Sheng Meng
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 研究各向异性1T'-WSe2及其Janus衍生物WSeTe单层中的Floquet工程拓扑相变，揭示了两种材料在光场调控下不同的拓扑相变路径和性质。
...
- **arXiv**: [2511.17697](https://arxiv.org/abs/2511.17697)  ·  [PDF](https://arxiv.org/pdf/2511.17697.pdf)
- **Title (EN)**: Functional renormalization with interaction flows: A single-boson exchange perspective and application to electron-phonon systems
- **Authors**: Aiman Al-Eryani, Marcel Gievers, Kilian Fraboulet
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文提出了一种新的功能重整化群(fRG)方法，允许同时对裸传播子和裸相互作用进行重整化，扩展了传统fRG方法的应用范围。
...
- **arXiv**: [2511.17760](https://arxiv.org/abs/2511.17760)  ·  [PDF](https://arxiv.org/pdf/2511.17760.pdf)
- **Title (EN)**: When Active Learning Fails, Uncalibrated Out of Distribution Uncertainty Quantification Might Be the Problem
...
- **TL;DR**: 评估不同不确定性估计和校准方法在材料发现主动学习中的效果，发现校准后的不确定性在分布外数据上通常无法减少主动学习所需的数据量。
...
- **arXiv**: [2511.18233](https://arxiv.org/abs/2511.18233)  ·  [PDF](https://arxiv.org/pdf/2511.18233.pdf)
- **Title (EN)**: Analytical Excited-State Gradients and Derivative Couplings in TDDFT with Minimal Auxiliary Basis Set Approximation and GPU Acceleration
- **Authors**: Zhichen Pu, Xiaojie Wu, Yuanheng Wang, Cheng Fan, Wen Yan, Zehao Zhou, Yiqin Gao, Qiming Sun
- **Categories**: physics.chem-ph
- **TL;DR**: 本文实现了TDDFT-ris框架下的激发态梯度和导数耦合分析导数，相比标准TDDFT方法实现了2-3倍加速，在大多数情况下提供可靠近似。
...
- **arXiv**: [2511.18224](https://arxiv.org/abs/2511.18224)  ·  [PDF](https://arxiv.org/pdf/2511.18224.pdf)
- **Title (EN)**: Generation of Granular Deposition Interfaces using conditional Generative Adversarial Network (cGAN)
- **Authors**: Seyed Feyzelloh Ghavami Mirmahalle, Seyed Ehsan Nedaaee Oskoee, Maniya Maleki
...
- **arXiv**: [2511.17851](https://arxiv.org/abs/2511.17851)  ·  [PDF](https://arxiv.org/pdf/2511.17851.pdf)
- **Title (EN)**: Dissipation anomaly in gradient-driven nonequilibrium steady states
- **Authors**: Hiroyoshi Nakano, Yuki Minami
- **Categories**: cond-mat.stat-mech, physics.flu-dyn
- **TL;DR**: 本文发现耗散异常现象不仅存在于湍流中，也存在于简单的梯度驱动非平衡稳态系统中。通过数值模拟和理论分析，揭示了这种异常源于由梯度放大的巨型长程非平衡涨落。
...
- **arXiv**: [2511.18753](https://arxiv.org/abs/2511.18753)  ·  [PDF](https://arxiv.org/pdf/2511.18753.pdf)
- **Title (EN)**: Strain-induced Berry phase in chiral superconductors
- **Authors**: Canon Sun, Marcel Franz, Joseph Maciejko
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 研究在应变作用下$p_x+ip_y$超导体中，超导态与时间反演对称性破缺态之间的中间相的拓扑性质。应变降低晶体对称性，导致$p_x$和$p_y$轨道临界温度简并解除，在热力学相图中形成狄拉克锥结构。
...
- **arXiv**: [2511.18053](https://arxiv.org/abs/2511.18053)  ·  [PDF](https://arxiv.org/pdf/2511.18053.pdf)
- **Title (EN)**: Minimizing energy dissipation during programming of resistive switching memory devices using their dynamical attractor states
- **Authors**: Valeriy A. Slipko, Alon Ascoli, Fernando Corinto, Yuriy V. Pershin
- **Categories**: cond-mat.mes-hall, cs.ET
- **TL;DR**: 提出了一种基于理论的能量最小化策略，通过设计特定的电压脉冲序列来最小化将忆阻器编程到期望动态吸引子状态所需的能量。
...
- **arXiv**: [2511.18059](https://arxiv.org/abs/2511.18059)  ·  [PDF](https://arxiv.org/pdf/2511.18059.pdf)
- **Title (EN)**: Many-body electronic structure in pyrochlore superconductor CsBi2 and spin liquid Pr2Ir2O7
...
- **TL;DR**: 对烧绿石超导体CsBi2和自旋液体Pr2Ir2O7进行扫描隧道显微镜测量，首次获得原子级分辨图像，揭示了六角晶格或Kagome晶格结构，并观察到与烧绿石晶格几何相关的多种电子现象。
...
- **arXiv**: [2511.17868](https://arxiv.org/abs/2511.17868)  ·  [PDF](https://arxiv.org/pdf/2511.17868.pdf)
- **Title (EN)**: Appraising the absolute limits of nanotubes and nanospheres to preserve high-pressure materials
- **Authors**: Yin L. Xu, Guang F. Yang, Yi Sun, Hong X. Song, Yu S. Huang, Hao Wang, Xiao Z. Yan, Hua Y. Geng
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall, cond-mat.supr-con, physics.app-ph, physics.comp-ph
- **TL;DR**: 提出了一个理论模型来评估纳米管/纳米球保存高压材料的绝对理论极限，发现石墨烯纳米结构具有最佳承压能力，可用于在常压下保存高压相材料如LaH10和金属氢。
...
- **arXiv**: [2511.18512](https://arxiv.org/abs/2511.18512)  ·  [PDF](https://arxiv.org/pdf/2511.18512.pdf)
- **Title (EN)**: Neural network approximation of regularized density functionals
- **Authors**: Mihály A. Csirik, Andre Laestadius, Mathias Oster
- **Categories**: physics.chem-ph, cond-mat.dis-nn, math-ph, math.NA, quant-ph
- **TL;DR**: 本文提出了一种基于Moreau-Yosida正则化和神经网络的密度泛函理论近似方法，该方法保持了精确泛函的正性和凸性，且可微分，可直接用于Kohn-Sham计算。
...
- **arXiv**: [2511.18433](https://arxiv.org/abs/2511.18433)  ·  [PDF](https://arxiv.org/pdf/2511.18433.pdf)
- **Title (EN)**: A fast-converging and asymptotic-preserving method for adjoint shape optimization of rarefied gas flows
- **Authors**: Yanbing Zhang, Ruifeng Yuan, Lei Wu
- **Categories**: physics.comp-ph
- **TL;DR**: 提出了一种基于伴随方程的快速收敛形状优化方法，用于稀薄气体流动的优化问题，显著降低了计算成本。
...
- **arXiv**: [2511.18109](https://arxiv.org/abs/2511.18109)  ·  [PDF](https://arxiv.org/pdf/2511.18109.pdf)
- **Title (EN)**: Spectral mechanism and nearly reducible transfer matrices for pseudotransitions in one-dimensional systems
- **Authors**: Onofre Rojas
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文研究了在一维短程相互作用系统中出现的伪相变现象，通过转移矩阵的谱分析揭示了这种尖锐但解析的热力学异常行为的机制。
...
- **arXiv**: [2511.18938](https://arxiv.org/abs/2511.18938)  ·  [PDF](https://arxiv.org/pdf/2511.18938.pdf)
- **Title (EN)**: Giant Domain Walls and Intrinsic Heterogeneity in 214 Cuprate Superconductors
- **Authors**: Mark S. Senn, Evie Ladbrook, Jon Wright
- **Categories**: cond-mat.supr-con, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 使用扫描三维X射线衍射技术研究La1.675Eu0.2Sr0.125CuO4中的结构异质性，发现在正交相中存在类四方相畴壁区域，在四方相中存在类正交相条纹，揭示了结构畸变如何影响超导性与电荷密度波序的竞争。
...
- **arXiv**: [2511.18143](https://arxiv.org/abs/2511.18143)  ·  [PDF](https://arxiv.org/pdf/2511.18143.pdf)
- **Title (EN)**: Interface-engineered voltage-driven magnetic tunnel junctions with ultra-low-energy magnetization switching
...
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 通过远程掺杂技术在MgO-CoFeB界面精确控制铱浓度，实现了高能效的电压驱动磁化翻转，在纳米级磁隧道结中达到每比特3.5 fJ的极低开关能量，同时保持160%的隧道磁阻比。
...
- **arXiv**: [2511.18341](https://arxiv.org/abs/2511.18341)  ·  [PDF](https://arxiv.org/pdf/2511.18341.pdf)
- **Title (EN)**: Interplay of Power-Law correlated Disorder and Long-Range Hopping in One Dimension: Mobility Edges, Criticality, and ML-Based Phase Identification
- **Authors**: Mohammad Pouranvari
- **Categories**: cond-mat.str-el
- **TL;DR**: 研究一维紧束缚模型中具有幂律空间关联的局域势和长程跳跃的相图，揭示了多种局域化、扩展态、共振态和临界态的共存区域，并建立了统一的迁移率边表征框架。
...
- **arXiv**: [2511.17940](https://arxiv.org/abs/2511.17940)  ·  [PDF](https://arxiv.org/pdf/2511.17940.pdf)
- **Title (EN)**: Hexagonal polymorphism induced structural disorder and dielectric anomalies of Ca/Mn modified BaTiO3
- **Authors**: P. Maneesha, Dilip Sasmal, Rakhi Saha, Kiran Baraik, Soma Banik, R. Mittal, Mayanak K. Gupta, Abdelkrim Mekki, Khalil Harrabi, Somaditya Sen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过EXAFS、TEM、UV-DRS、PES和理论计算研究Ca和Mn掺杂BaTiO3的结构变化、能带调控和介电性能
...
- **arXiv**: [2511.18837](https://arxiv.org/abs/2511.18837)  ·  [PDF](https://arxiv.org/pdf/2511.18837.pdf)
- **Title (EN)**: \emph{Ab initio} derivation of the crystal field parameters for lanthanide ions: The f$^1$ case
- **Authors**: Dumitru-Claudiu Sergentu, Gwenhaël Duplaix-Rata, Ionel Humelnicu, Boris Le Guennic, Rémi Maurice
- **Categories**: physics.chem-ph
- **TL;DR**: 提出了一种新的理论方法来确定晶体场参数，该方法考虑了完整的|J,MJ&gt;空间，首次证明了唯一的CFP集合可以描述J能级的劈裂和混合，并发现自旋轨道耦合对CFP值没有影响。
...
- **arXiv**: [2511.19061](https://arxiv.org/abs/2511.19061)  ·  [PDF](https://arxiv.org/pdf/2511.19061.pdf)
- **Title (EN)**: Fast-Converging and Asymptotic-Preserving DSMC
- **Authors**: Bin Hu, Liyan Luo, Kaiyuan Wang, Lei Wu
- **Categories**: physics.comp-ph, physics.flu-dyn
- **TL;DR**: 提出DIG方案改进DSMC方法效率，在近连续流区域实现快速收敛，当Kn=0.01时比传统DSMC快两个数量级
...
- **arXiv**: [2511.18256](https://arxiv.org/abs/2511.18256)  ·  [PDF](https://arxiv.org/pdf/2511.18256.pdf)
- **Title (EN)**: First-Passage Times for the Space Fractional Fokker-Planck Equation
- **Authors**: Christopher N. Angstmann, Daniel S. Han, Bruce I. Henry, Boris Z. Huang
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文将随机游走框架扩展到包含复合步长，为一类新的超扩散过程提供了首通时间特性，这些过程由空间分数谱Fokker-Planck方程控制。
...
- **arXiv**: [2511.18951](https://arxiv.org/abs/2511.18951)  ·  [PDF](https://arxiv.org/pdf/2511.18951.pdf)
- **Title (EN)**: Superconducting spintronics with electron symmetry filtering and interfacial spin-orbit coupling
- **Authors**: Pablo Tuero, César González-Ruano, Igor Žutić, Yuan Lu, Coriolan Tiusan, Farkhad G. Aliev
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该论文综述了基于电子对称性过滤和界面自旋轨道耦合的超导自旋电子学，重点研究了MgO晶体屏障在V(100)/Fe(100)异质结中选择性传输特定电子态的作用，以及界面SOC如何实现对称性混合和自旋单重态到三重态库珀对的转换。
...
- **arXiv**: [2511.18147](https://arxiv.org/abs/2511.18147)  ·  [PDF](https://arxiv.org/pdf/2511.18147.pdf)
- **Title (EN)**: Effect of two-dimensional nonlocal screening on mobility of electrons in transition-metal dichalcogenide monolayers
- **Authors**: Aram Manaselyan, Vram Mughnetsyan, Anna Asatryan, Albert Kirakosyan
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 提出了过渡金属二硫化物单层中电荷载流子散射的新机制，考虑非局域屏蔽效应，显著提高了电子迁移率
...
- **arXiv**: [2511.18442](https://arxiv.org/abs/2511.18442)  ·  [PDF](https://arxiv.org/pdf/2511.18442.pdf)
- **Title (EN)**: A non-equilibrium quantum transport framework for spintronic devices with dynamical correlations
- **Authors**: Declan Nell, Milos Radonjic, Ivan Rungger, Liviu Chioncel, Stefano Sanvito, Andrea Droghetti
- **Categories**: cond-mat.str-el
- **TL;DR**: 提出了一个结合DFT、NEGF和DMFT的框架，用于模拟双端自旋电子器件在非平衡态下的量子输运，解决了现有方法无法同时处理偏压依赖输运和动态相关性的问题。
...
- **arXiv**: [2511.17966](https://arxiv.org/abs/2511.17966)  ·  [PDF](https://arxiv.org/pdf/2511.17966.pdf)
- **Title (EN)**: 2D-RIXS: Resonant inelastic x-ray scattering microscopy with high energy and spatial resolutions
- **Authors**: Kohei Yamamoto, Hakuto Suzuki, Jun Miyawaki
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了二维共振非弹性X射线散射显微镜系统，结合Wolter I型镜面实现微米级空间分辨率和超高能量分辨率，用于量子材料和功能器件中元素激发的定位探测。
...
- **arXiv**: [2511.19001](https://arxiv.org/abs/2511.19001)  ·  [PDF](https://arxiv.org/pdf/2511.19001.pdf)
- **Title (EN)**: Tuning Domain-Based Charge Transfer in Organic Dyes: Impact of Heteroatom Doping in the pi-linker of Carbazole-Based Systems
- **Authors**: Ram Dhari Pandey, Marta Galynska, Katharina Boguslawski, Pawel Tecmer
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究利用pCCD的局域轨道开发了一种计算域间电荷转移的方法，应用于新型咔唑基有机染料，通过在不同位置掺杂氮、氧、硫原子来增强电荷转移效率。
...
- **arXiv**: [2511.19338](https://arxiv.org/abs/2511.19338)  ·  [PDF](https://arxiv.org/pdf/2511.19338.pdf)
- **Title (EN)**: Electrochemical Interfaces at Constant Potential: Data-Efficient Transfer Learning for Machine-Learning-Based Molecular Dynamics
...
- **TL;DR**: TRECI是一种数据高效的工作流，用于构建机器学习力场，在电子大正则分子动力学中实现从头算级别的精度，显著降低了恒定电势模拟的成本。
...
- **arXiv**: [2511.18361](https://arxiv.org/abs/2511.18361)  ·  [PDF](https://arxiv.org/pdf/2511.18361.pdf)
- **Title (EN)**: Inertia-chirality interplay in active Brownian motion: exact dynamics and phase maps
- **Authors**: Anweshika Pattanayak, Sandip Roy, Abhishek Chaudhuri
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 提出了一个精确的二维手性活性布朗粒子理论，包含平动惯性效应，推导了速度、位移等统计量的解析表达式，揭示了手性如何影响活性粒子的动力学行为。
...
- **arXiv**: [2511.18990](https://arxiv.org/abs/2511.18990)  ·  [PDF](https://arxiv.org/pdf/2511.18990.pdf)
- **Title (EN)**: Anomalous phase shift and superconducting diode effect in Josephson junctions via thin films of rare-earth intermetallic magnets
- **Authors**: G. A. Bobkov, I. A. Shvets, I. V. Bobkova, A. M. Bobkov, S. V. Eremeev, E. V. Chulkov
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall
- **TL;DR**: 研究了基于GdIr2Si2磁性材料的S/F/S约瑟夫森结，实现了非零基态相位偏移φ0和约瑟夫森二极管效应，二极管效率可达0.3，且可通过磁化方向控制。
...
- **arXiv**: [2511.18332](https://arxiv.org/abs/2511.18332)  ·  [PDF](https://arxiv.org/pdf/2511.18332.pdf)
- **Title (EN)**: Real-space formulation of the Chern invariant and topological phases in a disordered Chern insulator
- **Authors**: Kiminori Hattori, Shinji Nakata
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文提出了在超胞框架下定义实空间陈数的方法，通过布里渊区边界上的Wilson loop计算陈数，并证明其与Bott指数等价但计算更高效。该方法用于研究无序陈绝缘体中的拓扑相变。
...
- **arXiv**: [2511.18526](https://arxiv.org/abs/2511.18526)  ·  [PDF](https://arxiv.org/pdf/2511.18526.pdf)
- **Title (EN)**: Ab initio modeling of resonant inelastic x-ray scattering from Ca2RuO4
- **Authors**: D. A. Kukusta, L. V. Bekenov, P. F. Perndorfer, D. V. Vyalikh, P. A. Buczek, A. Ernst, V. N. Antonov
- **Categories**: cond-mat.str-el
- **TL;DR**: 使用DFT+SO+U方法研究Ca2RuO4的电子结构，重点关注RIXS光谱，计算结果与实验数据吻合良好，为类似强关联材料提供了可靠的理论建模方法。
...
- **arXiv**: [2511.17969](https://arxiv.org/abs/2511.17969)  ·  [PDF](https://arxiv.org/pdf/2511.17969.pdf)
- **Title (EN)**: Density functional theory for core-level X-ray absorption
- **Authors**: Seokkyu An, Taisuke Ozaki
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种基于密度泛函理论(DFT)的严格框架，用于核心能级X射线吸收光谱(XAS)计算，通过约束搜索核心激发态和利用偶极选择规则，将计算复杂度从O(N^4)降低到O(N^3)，无需经验性位移即可准确预测光谱。
...
- **arXiv**: [2511.19002](https://arxiv.org/abs/2511.19002)  ·  [PDF](https://arxiv.org/pdf/2511.19002.pdf)
- **Title (EN)**: CHAOS - A Consistent Large-scale Database for Sigma-Profiles and Other Molecular Descriptors
- **Authors**: Dominik Gond, Justus Arweiler, Thomas Specht, Hans Hasse, Fabian Jirasek
- **Categories**: physics.chem-ph
- **TL;DR**: CHAOS数据库提供了53,091个分子的sigma-profiles和其他量子化学可观测数据，采用标准化计算流程，显著扩展了公开可用的sigma-profiles数量。
...
- **arXiv**: [2511.18462](https://arxiv.org/abs/2511.18462)  ·  [PDF](https://arxiv.org/pdf/2511.18462.pdf)
- **Title (EN)**: Evolving criticality in iterative bicolored percolation
- **Authors**: Shuo Wei, Haoyu Liu, Xin Sun, Youjin Deng, Ming Li
- **Categories**: cond-mat.stat-mech, math-ph
- **TL;DR**: 本文介绍了一种二维迭代双色渗流过程，能够保持和转变临界性。从临界配置开始，通过连续粗粒化生成不同但都保持临界性的层次结构。
...
- **arXiv**: [2511.19030](https://arxiv.org/abs/2511.19030)  ·  [PDF](https://arxiv.org/pdf/2511.19030.pdf)
- **Title (EN)**: Temperature-Induced Superconductivity Enhancement under Large Exchange Field
- **Authors**: Xusheng Wang, Lianyi He, Shuai-hua Ji
- **Categories**: cond-mat.supr-con
- **TL;DR**: 通过自由能分析发现，在强交换场作用下，有限温度可能同时削弱超导性并减轻自旋极化引起的配对破坏，导致超导性出现非单调的温度依赖行为。当塞曼能量超过超导序参数时，温度反而可能增强超导性。
...
- **arXiv**: [2511.18357](https://arxiv.org/abs/2511.18357)  ·  [PDF](https://arxiv.org/pdf/2511.18357.pdf)
- **Title (EN)**: Observation of topological phases without crystalline counterparts
- **Authors**: Mou Yan, Yu-Liang Tao, Yichong Hu, Zhenxing Cui, Jiong-Hao Wang, Gang Chen, Yong Xu
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文首次实验观测了准晶体中不存在于晶体中的拓扑相，在Ammann-Beenker准晶格上实现了具有八个零能角模式的高阶拓扑相，并发现了拓扑平庸相中的对称性保护零能模式。
...
- **arXiv**: [2511.18644](https://arxiv.org/abs/2511.18644)  ·  [PDF](https://arxiv.org/pdf/2511.18644.pdf)
- **Title (EN)**: Competition between charge-density-wave and superconducting orders on eight-leg square Hubbard cylinders
- **Authors**: Hong-Chen Jiang, Thomas P. Devereaux, Steven A. Kivelson
- **Categories**: cond-mat.str-el
- **TL;DR**: 该研究通过变分方法研究了方形晶格Hubbard模型中的d波超导问题，发现在t'≤0时系统呈现电荷密度波态，超导关联极短程；t'&gt;0时结果强烈依赖于边界条件，难以确定二维极限下超导或电荷密度波关联哪个占主导。
...
- **arXiv**: [2511.17972](https://arxiv.org/abs/2511.17972)  ·  [PDF](https://arxiv.org/pdf/2511.17972.pdf)
- **Title (EN)**: PyAPX: Python toolkit for atomic configuration pattern exploration
- **Authors**: Akira Kusaba, Tetsuji Kuboyama, Karol Kawka, Pawel Kempisty, Yoshihiro Kangawa
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: PyAPX是一个用于原子构型贝叶斯搜索的Python工具包，通过引入适合构型搜索的编码方法，在h-BCN系统中表现出比常用one-hot编码更优的收敛性能。
...
- **arXiv**: [2511.18490](https://arxiv.org/abs/2511.18490)  ·  [PDF](https://arxiv.org/pdf/2511.18490.pdf)
- **Title (EN)**: Lévy noise drives an exponential acceleration in transition rates within metastable systems
- **Authors**: Shenglan Yuan
- **Categories**: cond-mat.stat-mech, math.DS
- **TL;DR**: 本文提出了一个统一框架来分析Lévy噪声对亚稳态系统逃逸过程的影响，发现Lévy噪声能普遍增强逃逸效率，即使很弱的噪声也能指数级提高逃逸率。
...
- **arXiv**: [2511.19050](https://arxiv.org/abs/2511.19050)  ·  [PDF](https://arxiv.org/pdf/2511.19050.pdf)
- **Title (EN)**: Boost of critical current density near quantum critical points in FeSe-Based superconductors with two superconducting domes
...
- **TL;DR**: 在FeSe基超导体中发现两个超导穹顶，每个穹顶对应不同的向列量子临界点。研究发现临界电流密度Jc在超导穹顶内出现三个峰值，其中两个尖锐峰值位于向列相端点处，揭示了量子临界涨落对Jc的调制作用。
...
- **arXiv**: [2511.18480](https://arxiv.org/abs/2511.18480)  ·  [PDF](https://arxiv.org/pdf/2511.18480.pdf)
- **Title (EN)**: Rapid fabrication of clean van der Waals nanochannels using Mask and Stack method
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 提出了一种名为Mask & Stack的聚合物污染方法，利用氮化硅模板掩膜和干转移堆叠技术，在数小时内快速制造超洁净的范德华纳米通道。
...
- **arXiv**: [2511.18969](https://arxiv.org/abs/2511.18969)  ·  [PDF](https://arxiv.org/pdf/2511.18969.pdf)
- **Title (EN)**: Web of Non-invertible Dualities for (2+1) Dimensional Models with Subsystem Symmetries
- **Authors**: Avijit Maity, Vikram Tripathi, Andriy H. Nevidomskyy
- **Categories**: cond-mat.str-el, hep-th, quant-ph
- **TL;DR**: 将非可逆对偶概念从一维扩展到二维，构建了具有子系统对称性的晶格模型的非可逆对偶网络，包括子系统Kramers-Wannier对偶和子系统Kennedy-Tasaki变换，这些对偶在开放边界条件下是幺正可逆的，但在闭流形上成为非幺正非可逆的。
...
- **arXiv**: [2511.18069](https://arxiv.org/abs/2511.18069)  ·  [PDF](https://arxiv.org/pdf/2511.18069.pdf)
- **Title (EN)**: Hydrogen diffusion in TiCr$_2$H$_x$ Laves phases: A combined ab initio and machine-learning-potential study
- **Authors**: Pranav Kumar, Fritz Körmann, Kaveh Edalati, Blazej Grabowski, Yuji Ikeda
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用DFT和机器学习原子间势研究TiCr2Hx Laves相储氢合金中氢扩散动力学，发现氢扩散系数与浓度呈非单调关系，扩散主要发生在需要断裂Cr-H键的六边形环内路径。
...
- **arXiv**: [2511.19347](https://arxiv.org/abs/2511.19347)  ·  [PDF](https://arxiv.org/pdf/2511.19347.pdf)
- **Title (EN)**: Artificial Intelligence Driven Workflow for Accelerating Design of Novel Photosensitizers
- **Authors**: Hongyi Wang, Xiuli Zheng, Weimin Liu, Zitian Tang, Sheng Gong
- **Categories**: cond-mat.mtrl-sci, cs.LG, physics.chem-ph
- **TL;DR**: AAPSI是一个集成专家知识、基于支架的分子生成和贝叶斯优化的闭环工作流，用于加速新型光敏剂的设计。该方法通过AI-实验迭代循环，发现了性能优异的新型光敏剂候选物。
...
- **arXiv**: [2511.18495](https://arxiv.org/abs/2511.18495)  ·  [PDF](https://arxiv.org/pdf/2511.18495.pdf)
- **Title (EN)**: A Generalized Grassmann-Pfaffian Framework for Monomer-Dimer and Spanning Trees
- **Authors**: E. A. Ramirez Trino, M. A. Seifi MirJafarlou, M. A. Rajabpour
- **Categories**: cond-mat.stat-mech, hep-th, math-ph, math.CO
...
- **arXiv**: [2511.19054](https://arxiv.org/abs/2511.19054)  ·  [PDF](https://arxiv.org/pdf/2511.19054.pdf)
- **Title (EN)**: Depairing critical current density and the vortex-free state in FeSe nanobridges
- **Authors**: Yue Sun, Yuling Xiang, Zhixiang Shi, Tsuyoshi Tamegai
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 通过几何约束在FeSe超导体中实现了退配对极限和无涡旋态，窄桥宽度小于穿透深度时临界电流密度在高达1 kOe磁场下保持稳定。
...
- **arXiv**: [2511.18520](https://arxiv.org/abs/2511.18520)  ·  [PDF](https://arxiv.org/pdf/2511.18520.pdf)
- **Title (EN)**: Light-engineered Multichannel Quantum Anomalous Hall Effect in High-order Topological Plumbene
- **Authors**: Zhe Li, Fangyang Zhan, Haijun Cao, Jingjing Cao, Huisheng Zhang, Sheng Meng
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 通过Floquet工程在铅烯中实现了高阶拓扑绝缘体向高陈数量子反常霍尔态的可控相变，预测了陈数从-8到-6再到-3的三阶段拓扑相变，并在非范德华衬底上获得了C=+3的Γ点量子反常霍尔态。
...
- **arXiv**: [2511.18974](https://arxiv.org/abs/2511.18974)  ·  [PDF](https://arxiv.org/pdf/2511.18974.pdf)
- **Title (EN)**: Clustering-Enhanced Time- and Angle-Resolved Photoemission Study of LaTe$_3$: Absence of a Photoinduced Secondary CDW in the Electronic Structure
- **Authors**: Gesa-R. Siemann, Davide Curcio, Anders S. Mortensen, Charlotte E. Sanders, Yu Zhang, Jennifer Rigden, Paulina Majchrzak, Deepnarayan Biswas, Emma Springate, Ratnadwip Singha, Leslie M. Schoop, Philip Hofmann
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 通过时间分辨角分辨光电子能谱研究LaTe₃中电荷密度波(CDW)的瞬态行为，发现光激发可以熔化主要CDW，但未观察到次级CDW在电子结构中的特征。
...
- **arXiv**: [2511.18160](https://arxiv.org/abs/2511.18160)  ·  [PDF](https://arxiv.org/pdf/2511.18160.pdf)
- **Title (EN)**: Tuning Breakdown-to-Coercive Field Ratio in Ultra-Thin Al1-xScxN Films via Reactive Nitrogen Atmosphere
- **Authors**: Yinuo Zhang, Walter J. Smith, Giovanni Esteves, Eric A. Stach, Thomas E. Beechem, Roy H. Olsson
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 通过调控溅射沉积过程中的氮气流量来优化超薄Al1-xScxN薄膜的击穿场强和矫顽场强，以扩大铁电存储器件的操作窗口。
...
- **arXiv**: [2511.18510](https://arxiv.org/abs/2511.18510)  ·  [PDF](https://arxiv.org/pdf/2511.18510.pdf)
- **Title (EN)**: Three faces of random walks in hyperbolic domain: BKT, Lifshitz tails, and KPZ
- **Authors**: Daniil Fedotov, Sergei Nechaev
- **Categories**: cond-mat.stat-mech, hep-th
- **TL;DR**: 该论文展示了双曲上半平面中的连续随机游走（扩散）为三个看似无关的现象提供了统一框架：BKT相变、KPZ指数和Lifshitz尾。
...
- **arXiv**: [2511.19058](https://arxiv.org/abs/2511.19058)  ·  [PDF](https://arxiv.org/pdf/2511.19058.pdf)
- **Title (EN)**: Increase of critical current density in FeSe superconductor by strain effect
- **Authors**: Han Luo, Xinyue Wang, Xin Zhou, Longfei Sun, Mengqin Liu, Ran Guo, Sheng Li, Yue Sun, Zhixiang Shi
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 通过使用玻璃纤维增强塑料基底在冷却过程中施加压缩应变，显著增强了FeSe单晶的临界电流密度J_c，在零场下增加约4倍，在5T磁场下实现一个数量级的提升。
...
- **arXiv**: [2511.18795](https://arxiv.org/abs/2511.18795)  ·  [PDF](https://arxiv.org/pdf/2511.18795.pdf)
- **Title (EN)**: Impedance-matched High-Overtone Thickness-Shear Bulk Acoustic Resonators with Scalable Mode Volume
- **Authors**: Zi-Dong Zhang, Zhen-Hui Qin, Yi-Han He, Yun-Fei Cheng, Hao Yan, Si-Yuan Yu, Ming-Hui Lu, Yan-Feng Chen
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 提出了一种横向激发的高次谐波厚度剪切体声波谐振器(X HTBAR)，采用全平面激发方案解决了传统设计的阻抗匹配、杂散模式干扰和可扩展性限制问题。
...
- **arXiv**: [2511.19193](https://arxiv.org/abs/2511.19193)  ·  [PDF](https://arxiv.org/pdf/2511.19193.pdf)
- **Title (EN)**: Bound states for systems with quartic energy-momentum dispersion
- **Authors**: E. V. Gorbar, B. E. Grinyuk, V. P. Gusynin
- **Categories**: cond-mat.str-el
- **TL;DR**: 研究具有四次能量-动量色散E(p)~p^4的系统在多项式势中的束缚态及其能量，发现四次色散系统的波函数在经典禁区有节点，一维薛定谔方程的振荡定理不适用。
...
- **arXiv**: [2511.18168](https://arxiv.org/abs/2511.18168)  ·  [PDF](https://arxiv.org/pdf/2511.18168.pdf)
- **Title (EN)**: Comparison of the Electronic Structures of V$X_3$ ($X$ = Br, and I) using High-resolution X-ray Scattering
- **Authors**: Chamini S. Pathiraja, Deniz Wong, Christian Schulz, Yi-De Chuang, Yu-Cheng Shao, Byron Freelon
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 使用高分辨率RIXS和配体场多重态计算研究了VX3（X=Br和I）的电子结构，确定了晶体场分裂、三角畸变和Racah参数，揭示了从Br到I共价性增加的趋势。
...
- **arXiv**: [2511.18596](https://arxiv.org/abs/2511.18596)  ·  [PDF](https://arxiv.org/pdf/2511.18596.pdf)
- **Title (EN)**: Dual thermal pseudo-critical features in a spin-1/2 Ising chain with twin-diamond geometry
- **Authors**: Onofre Rojas
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 通过精确映射到有效伊辛链，研究了耦合双钻石链的热力学性质，揭示了五个不同的基态相，包括两个具有广泛简并性的受挫区域，这些区域在低温下表现出伪相变行为。
...
- **arXiv**: [2511.19064](https://arxiv.org/abs/2511.19064)  ·  [PDF](https://arxiv.org/pdf/2511.19064.pdf)
- **Title (EN)**: Expansion of Momentum Space and Full 2$π$ Solid Angle Photoelectron Collection in Laser-Based Angle-Resolved Photoemission Spectroscopy by Applying Sample Bias
...
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 本文提出了一种偏压ARPES技术，通过在样品上施加偏压来扩展可探测的动量范围，实现全2π立体角收集，同时保持能量和角度分辨率。
...
- **arXiv**: [2511.19128](https://arxiv.org/abs/2511.19128)  ·  [PDF](https://arxiv.org/pdf/2511.19128.pdf)
- **Title (EN)**: Dispersive detection of single microwave photons with quantum dots
- **Authors**: Stephanie Matern, Alberto Biella, Pasquale Scarlino, Iacopo Carusotto, Gianluca Rastelli
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在电路量子电动力学架构中，通过双量子点与微波腔的色散相互作用，实现了单微波光子的非吸收性探测。
...
- **arXiv**: [2511.19209](https://arxiv.org/abs/2511.19209)  ·  [PDF](https://arxiv.org/pdf/2511.19209.pdf)
- **Title (EN)**: Projected Density Matrix Sampling for Lattice Hamiltonians
- **Authors**: Abhishek Karna, Hansen S. Wu, Shailesh Chandrasekharan, Ribhu K. Kaul
- **Categories**: cond-mat.str-el, hep-lat, nucl-th
- **TL;DR**: 本文提出了一种连续时间路径积分蒙特卡洛方法，用于计算量子哈密顿量的低能谱，通过投影子空间方法避免了Trotter离散化误差，并在有/无符号问题的情况下都能提供低能谱信息。
...
- **arXiv**: [2511.18195](https://arxiv.org/abs/2511.18195)  ·  [PDF](https://arxiv.org/pdf/2511.18195.pdf)
- **Title (EN)**: Engineering the Magnetocaloric Effect in Nd$T_4$B
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 对NdT4B系统（T=Fe、Co、Ni）的磁热效应进行了全面研究，通过构建三元相图优化成分，发现该系统在宽温区（10-650K）具有显著的熵变，某些成分甚至表现出双峰磁热效应，适用于多级冷却应用。
...
- **arXiv**: [2511.18648](https://arxiv.org/abs/2511.18648)  ·  [PDF](https://arxiv.org/pdf/2511.18648.pdf)
- **Title (EN)**: Failure of LMC statistical complexity in identifying structural order in the XY model
- **Authors**: Dario Javier Zamora
- **Categories**: cond-mat.stat-mech, nlin.AO
- **TL;DR**: LMC统计复杂性度量在XY模型中无法准确识别高结构复杂性状态，常将接近平衡态配置评为最大复杂性，而低估富含涡旋的中间态。
...
- **arXiv**: [2511.19197](https://arxiv.org/abs/2511.19197)  ·  [PDF](https://arxiv.org/pdf/2511.19197.pdf)
- **Title (EN)**: YBa$_2$Cu$_3$O$_7$ nano-constriction Josephson junctions and SQUIDs fabricated by focused helium-ion-beam irradiation
...
- **TL;DR**: 通过30 keV氦离子束辐照，可以将外延生长的YBCO薄膜从超导态转变为绝缘态。适当剂量的辐照可在保持晶体结构的同时抑制超导性，用于制造纳米级电阻分流收缩型约瑟夫森结。
...
- **arXiv**: [2511.19239](https://arxiv.org/abs/2511.19239)  ·  [PDF](https://arxiv.org/pdf/2511.19239.pdf)
- **Title (EN)**: Spin-Flux Skyrmions: Anomalous Electron Dynamics and Spin-Hall Currents
- **Authors**: Sandip Bera, Sajeev John
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文提出了一种拓扑结构不同的斯格明子——自旋通量斯格明子，它与传统斯格明子具有相同的实空间磁化分布，但在SO(3)群流形中的旋转矩阵路径不同，导致非平凡的旋量相位和额外的霍尔电导项。
...
- **arXiv**: [2511.19311](https://arxiv.org/abs/2511.19311)  ·  [PDF](https://arxiv.org/pdf/2511.19311.pdf)
- **Title (EN)**: Diagnosis of mixed-state topological phases in strongly correlated systems via disorder parameters
- **Authors**: Shao-Hang Shi, Xiao-Qi Sun, Zi-Xiang Li
- **Categories**: cond-mat.str-el
- **TL;DR**: 提出了一个通过U(1)电荷算符的失序参数来诊断强相互作用系统中混合态拓扑相的一般数值框架，并开发了高效的量子蒙特卡罗算法来评估拓扑标度指标。
...
- **arXiv**: [2511.18280](https://arxiv.org/abs/2511.18280)  ·  [PDF](https://arxiv.org/pdf/2511.18280.pdf)
- **Title (EN)**: Terahertz oscillation of $180^{\circ}$ domain walls in ferroelectric membranes
...
- **TL;DR**: 本文通过动力学相场模拟发现了一种新型铁电畴壁滑动模式，该模式具有非零共振频率和动态变化的内部结构，与传统畴壁滑动模式不同。
...
- **arXiv**: [2511.18947](https://arxiv.org/abs/2511.18947)  ·  [PDF](https://arxiv.org/pdf/2511.18947.pdf)
- **Title (EN)**: Conservation laws and slow dynamics determine the universality class of interfaces in active matter
- **Authors**: Raphaël Maire, Andrea Plati, Frank Smallenburg, Giuseppe Foffi
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 该论文发现了一种活性硬盘模型，首次观测到非平衡界面标度行为，揭示了|q|KPZ、湿|q|KPZ以及一个新的由慢结晶或玻璃动力学产生的普适性类别。
...
- **arXiv**: [2511.19215](https://arxiv.org/abs/2511.19215)  ·  [PDF](https://arxiv.org/pdf/2511.19215.pdf)
- **Title (EN)**: Compact stationary fluxons in the Josephson junction ladder
- **Authors**: Andrii O. Prykhodko, Ivan O. Starodub, Yaroslav Zolotaryuk
- **Categories**: cond-mat.supr-con, nlin.PS
- **TL;DR**: 该论文证明了在电感耦合和直流偏置的约瑟夫森结梯形电路中，存在精确的紧凑通量子解，这些解在标准的离散正弦-戈登方程描述的并行约瑟夫森结阵列中不存在。
...
- **arXiv**: [2511.19389](https://arxiv.org/abs/2511.19389)  ·  [PDF](https://arxiv.org/pdf/2511.19389.pdf)
- **Title (EN)**: Kondo screening and random-singlet formation in highly disordered systems
- **Authors**: Lucas G. Rabelo, Igor C. Almeida, Eduardo Miranda, Vladimir Dobrosavljević, Eric C. Andrade
- **Categories**: cond-mat.str-el, cond-mat.dis-nn
- **TL;DR**: 提出了一个最小模型来描述掺杂半导体在金属-绝缘体转变过程中的异常低温热力学行为，重点关注局域磁矩与无序电子浴之间的相互作用。
...
- **arXiv**: [2511.18311](https://arxiv.org/abs/2511.18311)  ·  [PDF](https://arxiv.org/pdf/2511.18311.pdf)
- **Title (EN)**: Possibilities of the X-ray Diffraction Data Processing Method for Detecting Reflections with Intensity Below the Background Noise Component
- **Authors**: S. V. Gabielkov, I. V. Zhyganiuk, A. D. Skorbun, V. G. Kudlai, B. S. Savchenko, P. E. Parkhomchuk, S. O. Chikolovets
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文确定了信噪比阈值，在该阈值下X射线衍射数据处理方法能够检测到强度低于背景噪声分量的反射信号。该方法在α-石英的弱反射上进行了验证，可将X射线相分析的检测能力提升至多相材料中含量低至0.1wt.%的多个相（最多八个）的定性分析。
...
- **arXiv**: [2511.19082](https://arxiv.org/abs/2511.19082)  ·  [PDF](https://arxiv.org/pdf/2511.19082.pdf)
- **Title (EN)**: Phase Diagrams of the YK Surface-Reaction Model on 2D lattices with Exchange Diffusion
- **Authors**: Henrique A. Fernandes, Roberto da Silva, Paulo F. Gomes
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 研究了Yaldram和Khan催化表面模型在允许CO和N原子交换扩散时，在方形和六边形晶格上的相图。发现扩散促进了活性相的出现，系统存在连续和不连续相变。
...
- **arXiv**: [2511.19409](https://arxiv.org/abs/2511.19409)  ·  [PDF](https://arxiv.org/pdf/2511.19409.pdf)
- **Title (EN)**: Chiral spin liquid instability of the Kitaev honeycomb model with crystallographic defects
- **Authors**: Arnab Seth, Fay Borhani, Itamar Kimchi
- **Categories**: cond-mat.str-el, cond-mat.dis-nn, cond-mat.mes-hall
- **TL;DR**: 在自旋-1/2 Kitaev蜂窝晶格无能隙自旋液体中引入Stone-Wales型局部晶格缺陷，发现有限缺陷密度可诱导出真正的相变，产生非阿贝尔手性量子自旋液体。
...
- **arXiv**: [2511.18398](https://arxiv.org/abs/2511.18398)  ·  [PDF](https://arxiv.org/pdf/2511.18398.pdf)
- **Title (EN)**: Predicting the Thermal Behavior of Semiconductor Defects with Equivariant Neural Networks
- **Authors**: Xiangzhou Zhu, Patrick Rinke, David A. Egger
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出基于神经网络框架，使用MACE和DeepH-E3等变图神经网络，高效预测缺陷半导体在有限温度下的电子性质，在GaAs点缺陷案例中达到与DFT相当的精度但计算成本大幅降低。
...
- **arXiv**: [2511.19110](https://arxiv.org/abs/2511.19110)  ·  [PDF](https://arxiv.org/pdf/2511.19110.pdf)
- **Title (EN)**: Fate of diffusion under integrability breaking of classical integrable magnets
- **Authors**: Jiaozi Wang, Sourav Nandy, Markus Kraft, Tomaž Prosen, Robin Steinigeweg
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 研究经典可积系统中自旋扩散的微观机制，发现在可积性破坏时扩散常数发生突变，且磁化转移统计从非高斯变为高斯分布
...
- **arXiv**: [2511.18443](https://arxiv.org/abs/2511.18443)  ·  [PDF](https://arxiv.org/pdf/2511.18443.pdf)
- **Title (EN)**: High accuracy Spin Hall Effect Induced Spin Accumulation detection in MOKE Measurements
- **Authors**: Emanuele Longo, Josep Fontcuberta, Paolo Vavassori
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文开发了一种新的磁光克尔旋转（MOKE）测量方法，解决了已知的瓶颈问题，并测量了铂（Pt）薄膜中的电荷到自旋（轨道）动量转换现象。
...
- **arXiv**: [2511.19288](https://arxiv.org/abs/2511.19288)  ·  [PDF](https://arxiv.org/pdf/2511.19288.pdf)
- **Title (EN)**: Tilings of a bounded region of the plane by maximal one-dimensional tiles
- **Authors**: Eduardo J. Aguilar, Valmir C. Barbosa, Raul Donangelo, Welles A. M. Morgado, Sergio R. Souza
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 研究二维区域使用不同长度K-mer（K个单元格的一维瓦片）进行铺砌，引入最大性约束使每个K-mer在其周围环境中尽可能长，以限制铺砌多样性同时保持有趣的统计物理行为。
...
- **arXiv**: [2511.18778](https://arxiv.org/abs/2511.18778)  ·  [PDF](https://arxiv.org/pdf/2511.18778.pdf)
- **Title (EN)**: WSe2 p-MOSFETs with Nb-Doped WS2 Contacts Deposited using Atomic Layer Deposition
...
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 展示了使用原子层沉积形成的Nb掺杂WS2接触的WSe2 p-MOSFET，通过选择性氧化工艺实现接触金属化与掺杂接触的对准，在0.15μm源漏间距下获得103μA/μm的导通电流。
...
- **arXiv**: [2511.18586](https://arxiv.org/abs/2511.18586)  ·  [PDF](https://arxiv.org/pdf/2511.18586.pdf)
- **Title (EN)**: High-throughput computation of electric polarization in solids via Berry flux diagonalization
- **Authors**: Abigail N. Poteshman, Francesco Ricci, Jeffrey B. Neaton
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文评估了Berry flux对角化方法在计算极化中的应用，开发了启发式方法确保分支对齐，并验证了该方法在高通量计算中的有效性和可靠性。
...
- **arXiv**: [2511.18697](https://arxiv.org/abs/2511.18697)  ·  [PDF](https://arxiv.org/pdf/2511.18697.pdf)
- **Title (EN)**: Quantized Polarization Redefines Polar Interfaces
- **Authors**: Hongsheng Pang, Lixin He
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文提出量化极化（QP）是晶体材料中受对称性保护的体态不变量，当具有不同QP的材料形成界面时，会强制产生显著的界面响应，如金属态、束缚电荷或晶格畸变。
...
- **arXiv**: [2511.19025](https://arxiv.org/abs/2511.19025)  ·  [PDF](https://arxiv.org/pdf/2511.19025.pdf)
- **Title (EN)**: Growth driven phase transitions in Zinc Oxide nanoparticles through machine-learning assisted simulations
- **Authors**: Quentin Gromoff, Magali Benoit, Jacek Goniakowski, Carlos R. Salazar, Julien Lam
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 通过原子沉积模拟研究ZnO纳米颗粒形成过程，发现虽然BCT结构在热力学上稳定，但沉积过程会诱导相变至更稳定的WRZ相，这种转变通过离子重分布补偿极性晶面实现。
...
- **arXiv**: [2511.19092](https://arxiv.org/abs/2511.19092)  ·  [PDF](https://arxiv.org/pdf/2511.19092.pdf)
- **Title (EN)**: Observation of a phonon bottleneck effect on the thermal depopulation from a photoexcited shallow defect in silicon
...
- **TL;DR**: 在硅中观察到声子瓶颈效应影响浅缺陷的热去占据过程，通过时间分辨太赫兹光谱发现光激发载流子被浅陷阱暂时捕获，导致光电导出现时间延迟。
...
- **arXiv**: [2511.18796](https://arxiv.org/abs/2511.18796)  ·  [PDF](https://arxiv.org/pdf/2511.18796.pdf)
- **Title (EN)**: Detecting Linear Dichroism with Atomic Resolution
- **Authors**: Roger Guzman, Ján Rusz, Ang Li, Juan Carlos Idrobo, Wu Zhou, Jaume Gazquez
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 开发了一种电子线性二色性方法，通过扫描透射电子显微镜实现原子级轨道极化探测，在La0.7Sr0.3MnO3薄膜中直接可视化了Mn-3d eg轨道占据情况。
...
- **arXiv**: [2511.18862](https://arxiv.org/abs/2511.18862)  ·  [PDF](https://arxiv.org/pdf/2511.18862.pdf)
- **Title (EN)**: Observation of Dicke cooperativity between strongly coupled phonons and crystal-field excitations in a rare-earth orthoferrite
...
- **TL;DR**: 在ErFeO3中观察到了由声子和非简并晶体场跃迁耦合产生的Dicke型协同效应，其耦合强度随有效基态粒子数的平方根变化，证实了局域Jahn-Teller离子与长程声子之间的协同相互作用。
...
- **arXiv**: [2511.18915](https://arxiv.org/abs/2511.18915)  ·  [PDF](https://arxiv.org/pdf/2511.18915.pdf)
- **Title (EN)**: Device-Scale Atomistic Simulations of Heat Transport in Advanced Field-Effect Transistors
- **Authors**: Ke Xu, Gang Wang, Ting Liang, Yang Xiao, Dongliang Ding, Haichang Guo, Xiang Gao, Lei Tong, Xi Wan, Gang Zhang, Jianbin Xu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: NEP-FET是一个基于机器学习的热输运模拟框架，用于场效应晶体管的器件尺度热传输分析，结合神经进化势能和主动学习工作流，能够模拟包含数百万原子的亚微米级晶体管结构。
...
- **arXiv**: [2511.18970](https://arxiv.org/abs/2511.18970)  ·  [PDF](https://arxiv.org/pdf/2511.18970.pdf)
- **Title (EN)**: Al$_{1-x}$Hf$_{x}$N Thin Films with Enhanced Piezoelectric Responses for GHz Surface Acoustic Wave Devices
- **Authors**: Laura I. Wagner, Verena Streibel, Esperanza Luna, Katarina S. Flashar, Walid Anders, Nicole Volkmer, Doreen Steffen, Frans Munnik, Tsedenia A. Zewdie, Saswati Santra, Ian D. Sharp, Mingyun Yuan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文研究了铝铪氮化物(Al1-xHfxN)作为Al1-xScxN的替代材料，通过反应共溅射制备了具有强c轴织构的薄膜，观察到压电系数d33相对于AlN提高了近两倍，并展示了增强性能的GHz表面声波谐振器。
...
- **arXiv**: [2511.19029](https://arxiv.org/abs/2511.19029)  ·  [PDF](https://arxiv.org/pdf/2511.19029.pdf)
- **Title (EN)**: Light-induced photomechanical patterning of ferroelectric polarization
- **Authors**: Alban Degezelle, Jonas Strobelt, Sarah Loebner, Moussa Mebarki, Stephane Fusil, Vincent Garcia, Bruno Berini, Vincent Polewczyk, Yves Dumont, Sylvia Matzen, Philippe Lecoeur, Svetlana Santer, Thomas Maroutian
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种基于光敏聚合物辅助图案化的光学方法，用于在铁电薄膜中精确控制弯曲应变和极化景观，实现了90°和180°的确定性极化旋转。
...
- **arXiv**: [2511.19053](https://arxiv.org/abs/2511.19053)  ·  [PDF](https://arxiv.org/pdf/2511.19053.pdf)
- **Title (EN)**: Fostering Innovation: Streamlining Magnetocaloric Materials Research by Digitalization
- **Authors**: Simon Bekemeier, Moritz Blum, Luana Caron, Alisa Chirkova, Philipp Cimiano, Basil Ell, Inga Ennen, Michael Feige, Maik Gaerner, Thomas Hilbig, Andreas Hütten, Günter Reiss, Tapas Samanta, Sonja Schöning, Christian Schröder, Lennart Schwan, Chris Taake, Martin Wortmann
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究展示了如何数字化磁热合金的合成、表征和应用过程链，开发了基于本体的知识表示和机器学习模型，用于预测新材料性能并自动化数据处理。
...
- **arXiv**: [2511.19060](https://arxiv.org/abs/2511.19060)  ·  [PDF](https://arxiv.org/pdf/2511.19060.pdf)
- **Title (EN)**: A Combined Theoretical and Experimental Study of Oxygen Vacancies in Co$_3$O$_4$ for Liquid-Phase Oxidation Catalysis
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究结合理论和实验方法，研究了Co3O4中氧空位在体相和液相乙二醇氧化条件下的行为。研究发现氧空位会还原相邻Co3+离子并缩小带隙，但在乙二醇氧化条件下催化剂反而被氧化，预先存在的氧空位被重新填充。
...
- **arXiv**: [2511.19077](https://arxiv.org/abs/2511.19077)  ·  [PDF](https://arxiv.org/pdf/2511.19077.pdf)
- **Title (EN)**: Atomistic Origin of Photoluminescence Quenching in Colloidal MoS2 and WS2 Nanoplatelets
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究揭示了TMD纳米片中亚皮秒激子衰减的机制源于边缘光学亮空穴陷阱，这些固有陷阱状态来自金属d轨道，即使氢钝化后仍存在。WS2比MoS2具有更强的局域化光学活性边缘态，锯齿形边缘比扶手椅边缘具有更高的陷阱密度。
...
- **arXiv**: [2511.19104](https://arxiv.org/abs/2511.19104)  ·  [PDF](https://arxiv.org/pdf/2511.19104.pdf)
- **Title (EN)**: Micrometer thick single crystal iron-garnet films on a diamagnetic buffer layer for cryogenic applications
...
- **TL;DR**: 通过使用缓冲层隔离顺磁性衬底，开发了具有极低阻尼的单晶微米厚YIG薄膜，在4K和16mK下实现了创纪录的低铁磁共振线宽。
...
- **arXiv**: [2511.19158](https://arxiv.org/abs/2511.19158)  ·  [PDF](https://arxiv.org/pdf/2511.19158.pdf)
- **Title (EN)**: Effect of FABr Over-Stoichiometry on the Morphology and Optoelectronic Properties of Wide-Bandgap FAPbBr_3 Films
- **Authors**: G. Ammirati, F. Martelli, F. Toschi, S. Turchini, P. O'Keeffe, A. Paladini, F. Matteocci, J. Barichello, S. Piccirillo, A. Di Carlo, D. Catone
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究发现甲脒溴化铅(FAPbBr₃)前驱体溶液中甲脒溴化物(FABr)过量可优化薄膜光电性能，5%FABr过量时获得最佳平衡，实现最高光电转换效率6.26%、平均可见光透过率61.6%和光利用效率3.85%。
...
- **arXiv**: [2511.19222](https://arxiv.org/abs/2511.19222)  ·  [PDF](https://arxiv.org/pdf/2511.19222.pdf)
- **Title (EN)**: Velocity dependence of kinetic friction by multi-scale Quantum Mechanics/Green's Function molecular dynamics
- **Authors**: Alberto Pacini, Seiji Kajita, Gabriele Losi, Maria Clelia Righi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究应用QM-GF混合方法研究滑动速度对动摩擦的影响，发现摩擦力随速度增加而减小，揭示了低速和高速两种不同的滑动机制。
...
- **arXiv**: [2511.19228](https://arxiv.org/abs/2511.19228)  ·  [PDF](https://arxiv.org/pdf/2511.19228.pdf)
- **Title (EN)**: Communication: Modeling layered mosaic perovskite alloy microstructures across length scales via a packing algorithm
- **Authors**: Murray Skolnick, Salvatore Torquato
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了一种高效的硬粒子堆积算法来模拟层状金属卤化物钙钛矿材料，能够准确预测B位点排列的几何和拓扑特性，避免了昂贵的从头计算方法。
...
- **arXiv**: [2511.19280](https://arxiv.org/abs/2511.19280)  ·  [PDF](https://arxiv.org/pdf/2511.19280.pdf)
- **Title (EN)**: What is the signature of a trion in photoemission?
- **Authors**: Jinyuan Wu, Zachary H. Withers, Thomas K. Allison, Diana Y. Qiu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了单层过渡金属二硫化物中trion的ARPES信号理论，模拟了正负trion的光电子能谱特征，揭示了trion与激子相比的大能量偏移和独特光谱特征。
...
- **arXiv**: [2511.19298](https://arxiv.org/abs/2511.19298)  ·  [PDF](https://arxiv.org/pdf/2511.19298.pdf)
- **Title (EN)**: E-coherent crystalline interfaces: coherency enhanced by discohesion arrays
...
- **arXiv**: [2511.19335](https://arxiv.org/abs/2511.19335)  ·  [PDF](https://arxiv.org/pdf/2511.19335.pdf)
- **Title (EN)**: High-throughput validation of phase formability and simulation accuracy of Cantor alloys
...
- **Categories**: cond-mat.mtrl-sci, cs.LG
- **TL;DR**: 提出了一种定量置信度指标来评估计算预测与实验观察之间的一致性，为基于DFT或CALPHAD的机器学习模型提供置信度度量。
