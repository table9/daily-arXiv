---
title: "arXiv Daily · 2026-01-09 · 71 papers"
date: 2026-01-09
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-01-09 · 71 papers
...
- **arXiv**: [2601.04412](https://arxiv.org/abs/2601.04412)  ·  [PDF](https://arxiv.org/pdf/2601.04412.pdf)
- **Title (EN)**: Interactive Analysis of Static, Dynamic, and Crystalline SDTrimSP Simulations: Application to Nitrogen Ion Implantation into Vanadium
- **Authors**: Miroslav Lebeda, Jan Drahokoupil, Vojtěch Smola, Petr Vlčák
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了一个基于Web的SDTrimSP模拟后处理界面，专注于深度分布曲线的交互式可视化和分析，支持多模拟比较、单位转换和晶体结构输入格式转换。
...
- **arXiv**: [2601.04418](https://arxiv.org/abs/2601.04418)  ·  [PDF](https://arxiv.org/pdf/2601.04418.pdf)
- **Title (EN)**: Oxygen in diamond: thermal stability of ST1 spin centres and creation of oxygen-pair complexes
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究通过氧离子注入实验，揭示了金刚石中氧相关缺陷（特别是ST1中心）的形成条件、热稳定性和光学特性，为理解其原子结构提供了关键实验数据。
...
- **arXiv**: [2601.04445](https://arxiv.org/abs/2601.04445)  ·  [PDF](https://arxiv.org/pdf/2601.04445.pdf)
- **Title (EN)**: SpectraFormer: an Attention-Based Raman Unmixing Tool for Accessing the Graphene Buffer-Layer Signature on SiC
...
- **TL;DR**: 提出SpectraFormer，一种基于Transformer的深度学习模型，用于从石墨烯/碳化硅混合拉曼光谱中重建碳化硅基底信号，无需参考测量，从而揭示缓冲层石墨烯的弱振动特征。
...
- **arXiv**: [2601.04460](https://arxiv.org/abs/2601.04460)  ·  [PDF](https://arxiv.org/pdf/2601.04460.pdf)
- **Title (EN)**: Discovery of Correlated Electron Molecular Orbital Materials using Graph Representations
- **Authors**: Md. Rajbanul Akhond, Alexandru B. Georgescu
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el, cond-mat.supr-con
- **TL;DR**: 开发了基于图论的框架，从无机固体中系统识别、分类和组织过渡金属团簇基序，发现了5306种含团簇材料，建立了可系统发现的CEMO材料类别。
...
- **arXiv**: [2601.04621](https://arxiv.org/abs/2601.04621)  ·  [PDF](https://arxiv.org/pdf/2601.04621.pdf)
- **Title (EN)**: Classical solution of the FeMo-cofactor model to chemical accuracy and its implications
...
- **TL;DR**: 该研究展示了如何使用经典计算方法（而非量子算法）精确计算FeMo-cofactor的电子结构，达到了化学精度（~1 kcal/mol），并开发了简化计算流程用于更真实的辅因子模型。
...
- **arXiv**: [2601.04898](https://arxiv.org/abs/2601.04898)  ·  [PDF](https://arxiv.org/pdf/2601.04898.pdf)
- **Title (EN)**: A joint voxel flow - phase field framework for ultra-long microstructure evolution prediction with physical regularization
- **Authors**: Ao Zhou, Salma Zahran, Chi Chen, Zhengyang Zhang, Yanming Wang
- **Categories**: physics.comp-ph, cond-mat.mtrl-sci
- **TL;DR**: 提出结合体素流网络与相场模拟的联合框架，用于超长时间尺度微结构演化的预测，相比传统方法具有更高速度、更好泛化能力和更长预测时间
...
- **arXiv**: [2601.04308](https://arxiv.org/abs/2601.04308)  ·  [PDF](https://arxiv.org/pdf/2601.04308.pdf)
- **Title (EN)**: Fluctuation conductivity in ultraclean multicomponent superconductors
- **Authors**: Sondre Duna Lundemo, Asle Sudbø
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究多分量超导体在临界点附近的本征涨落电导率，发现在无杂质系统中有限频率纵向电导率非零的条件
...
- **arXiv**: [2601.04296](https://arxiv.org/abs/2601.04296)  ·  [PDF](https://arxiv.org/pdf/2601.04296.pdf)
- **Title (EN)**: The thermodynamics of liquid-vapor coexistence for a van der Waals fluid. Analytical solution of the Clausius-Clapeyron equation
- **Authors**: J. L. Cardoso, V. G. Ibarra-Sierra, J. C. Sandoval-Santana, A. Kunold
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文从统计力学角度推导范德瓦尔斯流体的热力学，通过分子间相互作用和粒子有限尺寸，从Lennard-Jones势出发得到第二维里系数，恢复范德瓦尔斯方程，并解析求解Clausius-Clapeyron方程获得液-汽共存曲线。
...
- **arXiv**: [2601.04419](https://arxiv.org/abs/2601.04419)  ·  [PDF](https://arxiv.org/pdf/2601.04419.pdf)
- **Title (EN)**: Hidden dynamics in fast force curves: Transient Damping and Brownian-Driven Contact Resonance
- **Authors**: Roger Proksch
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过分析原子力显微镜快速力距离曲线中的瞬态振荡，提取局部刚度和耗散信息，实现高分辨率机械对比度映射
...
- **arXiv**: [2601.04303](https://arxiv.org/abs/2601.04303)  ·  [PDF](https://arxiv.org/pdf/2601.04303.pdf)
- **Title (EN)**: Altermagnetic and dipolar splitting of magnons in FeF$_2$
- **Authors**: J. Sears, V. O. Garlea, D. Lederman, J. M. Tranquada, I. A. Zaliznyak
- **Categories**: cond-mat.str-el
- **TL;DR**: FeF₂中磁振子分裂主要源于长程偶极相互作用，而非交替磁交换作用，仅在偶极分裂消失处观察到约35μeV的交替磁手性分裂。
...
- **arXiv**: [2601.04565](https://arxiv.org/abs/2601.04565)  ·  [PDF](https://arxiv.org/pdf/2601.04565.pdf)
- **Title (EN)**: Breaking Four-Point and Three-Point Bending Tests
- **Authors**: Subhrangsu Saha, Jeffery R. Roesler, Oscar Lopez-Pamies
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 利用相场断裂理论对四点弯曲和三点弯曲试验进行3D定量分析，揭示断裂起始位置和扩展过程，解释为何四点弯曲试验通常得到更小的弯曲强度
...
- **arXiv**: [2601.05086](https://arxiv.org/abs/2601.05086)  ·  [PDF](https://arxiv.org/pdf/2601.05086.pdf)
- **Title (EN)**: DMRG/FQ: a Polarizable Embedding Approach Combining Density Matrix Renormalization Group and Fluctuating Charges
- **Authors**: Matteo Rinaldi, Chiara Sepali, Alicia Marie Kirk, Claudio Amovilli, Chiara Cappelli
- **Categories**: physics.chem-ph
- **TL;DR**: 提出结合密度矩阵重整化群与极化涨落电荷力场的多尺度框架，用于模拟溶液中的电子激发态
...
- **arXiv**: [2601.04363](https://arxiv.org/abs/2601.04363)  ·  [PDF](https://arxiv.org/pdf/2601.04363.pdf)
- **Title (EN)**: Fast Phase Logic Family for Achieving Very Large Scale Integration in Superconductor Electronics
- **Authors**: Sasan Razmkhah, Massoud Pedram
- **Categories**: cond-mat.supr-con, cs.ET
- **TL;DR**: FPL是一种新型超导数字逻辑家族，通过使用0-JJ和π-JJ堆栈替代传统SFQ逻辑中的笨重电感，实现集成密度提升2个数量级、偏置电流降低5倍、延迟减少和吞吐量增加，并具有更高输出电压和阻抗以更好匹配CMOS电路。
...
- **arXiv**: [2601.04337](https://arxiv.org/abs/2601.04337)  ·  [PDF](https://arxiv.org/pdf/2601.04337.pdf)
- **Title (EN)**: Unifying Kibble-Zurek Mechanism in Weakly Driven Processes
- **Authors**: Pierre Nazé
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 提出新框架描述Kibble-Zurek机制，无需ad hoc假设，获得接近2/5的过剩功标度律
...
- **arXiv**: [2601.04421](https://arxiv.org/abs/2601.04421)  ·  [PDF](https://arxiv.org/pdf/2601.04421.pdf)
- **Title (EN)**: Quantum Geometric Origin of Orbital Magnetization
- **Authors**: Xiao-Bin Qiang, Tianyu Liu, Hai-Zhou Lu, X. C. Xie
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该视角论文探讨了量子几何如何为理解磁化现象提供新途径，包括平衡磁化和动力学磁化的几何起源。
...
- **arXiv**: [2601.04451](https://arxiv.org/abs/2601.04451)  ·  [PDF](https://arxiv.org/pdf/2601.04451.pdf)
- **Title (EN)**: Dynamical instability in a Floquet-Driven Dissipative System
- **Authors**: Takuya Okugawa, Jens Paaske, Martin Eckstein, Michael A. Sentef, Angel Rubio, Andrew J. Millis
- **Categories**: cond-mat.str-el
- **TL;DR**: 分析Floquet驱动的Hubbard模型反铁磁相中的磁振子谱和分布函数，发现超过临界驱动强度会出现动力学不稳定性
...
- **arXiv**: [2601.04586](https://arxiv.org/abs/2601.04586)  ·  [PDF](https://arxiv.org/pdf/2601.04586.pdf)
- **Title (EN)**: Spatial resolution(s) in atom probe tomography
- **Authors**: Baptiste Gault, Frédéric De Geuser, Christoph Freysoldt, Benjamin Klaes, François Vurpillot
- **Categories**: cond-mat.mtrl-sci, physics.ins-det
- **TL;DR**: 本文回顾了原子探针层析成像（APT）空间分辨率的定义与测量方法，指出纯金属中报道的极高分辨率（如20 pm）在大多数材料表征中并不适用，强调了考虑有效分辨率的重要性，并讨论了未来提高空间准确性的概念。
...
- **arXiv**: [2601.04558](https://arxiv.org/abs/2601.04558)  ·  [PDF](https://arxiv.org/pdf/2601.04558.pdf)
- **Title (EN)**: Studies of superconductivity of Fe chalcogenides in films grown by PLD technique
- **Authors**: Atsutaka Maeda, Tomoki Kobayashi, Fuyuki Nabeshima
- **Categories**: cond-mat.supr-con
- **TL;DR**: 综述了PLD技术生长Fe基硫族化合物超导薄膜的研究，包括电子相图、正常态和超导态性质，并与块体、MBE薄膜和剥离晶体进行比较，同时探讨提高Tc的挑战
...
- **arXiv**: [2601.04358](https://arxiv.org/abs/2601.04358)  ·  [PDF](https://arxiv.org/pdf/2601.04358.pdf)
- **Title (EN)**: Energy-Time-Accuracy Tradeoffs in Thermodynamic Computing
- **Authors**: Alberto Rolandi, Paolo Abiuso, Patryk Lipka-Bartosik, Maxwell Aifer, Patrick J. Coles, Martí Perarnau-Llobet
- **Categories**: cond-mat.stat-mech, cs.AR, cs.ET
- **TL;DR**: 该论文分析了热力学计算中计算精度、能量耗散和时间之间的基本权衡关系，推导出能量-延迟-缺陷乘积（EDDP）的一般极限，并开发了无需先验信息的准最优控制方案。
...
- **arXiv**: [2601.04578](https://arxiv.org/abs/2601.04578)  ·  [PDF](https://arxiv.org/pdf/2601.04578.pdf)
- **Title (EN)**: Anisotropic magnon transport in an antiferromagnetic trilayer heterostructure: is BiFeO$_3$ an altermagnet?
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在LaFeO₃夹层中受限的BiFeO₃层中观察到各向异性磁振子输运，通过电场可调控自旋输运，并发现非平凡反铁磁态具有类似交变磁体的特征。
...
- **arXiv**: [2601.04560](https://arxiv.org/abs/2601.04560)  ·  [PDF](https://arxiv.org/pdf/2601.04560.pdf)
- **Title (EN)**: Artificial Gauge Field Engineered Excited-State Topology: Control of Dynamical Evolution of Localized Spinons
- **Authors**: Jie Ren, Yi-Ran Xue, Run-Jia Luo, Rui Wang, Baigeng Wang
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 提出人工规范场方案，在量子自旋模型中实现单个自旋子的可控工程化，首次直接可视化局域在体相中的单个自旋子，并展示其在里德堡原子中的实验可行性。
...
- **arXiv**: [2601.04606](https://arxiv.org/abs/2601.04606)  ·  [PDF](https://arxiv.org/pdf/2601.04606.pdf)
- **Title (EN)**: Crystal Generation using the Fully Differentiable Pipeline and Latent Space Optimization
- **Authors**: Osman Goni Ridwan, Gilles Frapper, Hongfei Xue, Qiang Zhu
- **Categories**: cond-mat.mtrl-sci, cs.AI, cs.LG, physics.atm-clus
- **TL;DR**: 提出一个结合对称条件变分自编码器和可微分SO(3)功率谱目标函数的材料生成框架，用于在晶体约束下引导候选结构朝向指定局部环境
...
- **arXiv**: [2601.04594](https://arxiv.org/abs/2601.04594)  ·  [PDF](https://arxiv.org/pdf/2601.04594.pdf)
- **Title (EN)**: Direct Observation of the Spillover of High Magnetic Field-induced SC3 Superconductivity Outside the Spin-Polarized State in UTe2
...
- **TL;DR**: UTe₂超导材料在45T磁场下，SC3超导相溢出到自旋极化态相边界之外，支持量子临界涨落介导的电子配对机制
...
- **arXiv**: [2601.04640](https://arxiv.org/abs/2601.04640)  ·  [PDF](https://arxiv.org/pdf/2601.04640.pdf)
- **Title (EN)**: Construction of asymptotic quantum many-body scar states in the SU($N$) Hubbard model
...
- **arXiv**: [2601.04635](https://arxiv.org/abs/2601.04635)  ·  [PDF](https://arxiv.org/pdf/2601.04635.pdf)
- **Title (EN)**: Optical Signatures and Quantum Geometry in Proximity-Induced Topological Superconductors
- **Authors**: Myungjun Kang, Yogeshwar Prasad, Nikhil Danny Babu, Rasoul Ghadimi, Jae Hoon Kim, Sangmo Cheon
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文提出利用太赫兹/红外光谱测量拓扑绝缘体-超导体异质结构的界面电导，作为探测界面超导间隙和Majorana边界态的非侵入式诊断方法。
...
- **arXiv**: [2601.04729](https://arxiv.org/abs/2601.04729)  ·  [PDF](https://arxiv.org/pdf/2601.04729.pdf)
- **Title (EN)**: Probing quantum critical crossover via impurity renormalization group
- **Authors**: Tao Yang, Z. Y. Xie, Rui Wang, Baigeng Wang
- **Categories**: cond-mat.str-el
- **TL;DR**: 提出一种结合张量网络与数值重整化群截断方案的杂质重整化群方法，用于处理具有相互作用的量子杂质系统，揭示了杂质诱导的分数化磁矩和量子临界区交叉等新奇现象。
...
- **arXiv**: [2601.04615](https://arxiv.org/abs/2601.04615)  ·  [PDF](https://arxiv.org/pdf/2601.04615.pdf)
- **Title (EN)**: High mobility holes at germanane/Ge(111) allotropic cross-dimensional heterointerface
- **Authors**: Yumiko Katayama, Daiki Kobayashi, Hikaru Okuma, Yuhsuke Yasutake, Susumu Fukatsu, Kazunori Ueno
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 德国烷（GeH）作为石墨烯的氢终止锗类似物，具有直接带隙（~1.6 eV）。研究发现，在单种同素异形跨维异质界面中，15 K时获得了创纪录的空穴迁移率μ_h~67,000 cm²/Vs，这通过拓扑转换的2D GeH层与3D体Ge(111)接触实现。
...
- **arXiv**: [2601.04655](https://arxiv.org/abs/2601.04655)  ·  [PDF](https://arxiv.org/pdf/2601.04655.pdf)
- **Title (EN)**: Condensation mechanism of high-$T_c$ cuprates: the key role of pairon excitations
- **Authors**: Yves Noat, Alain Mauger, William Sacks
- **Categories**: cond-mat.supr-con, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 该论文提出铜氧化物超导体的凝聚机制涉及凝聚态与pairon激发态的强耦合，建立了能量依赖的能隙函数理论，发现临界温度Tc与凝聚能βc成正比而非能隙Δp，表明存在统一的"全电子"机制。
...
- **arXiv**: [2601.04924](https://arxiv.org/abs/2601.04924)  ·  [PDF](https://arxiv.org/pdf/2601.04924.pdf)
- **Title (EN)**: Short-time statistics of extinction and blowup in reaction kinetics
- **Authors**: Rotem Degany, Michael Assaf, Baruch Meerson
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文研究随机反应粒子系统中灭绝时间和爆炸时间的短时统计特性，提出通过WKB近似和匹配渐近方法计算分布函数中的大前指数因子。
...
- **arXiv**: [2601.04772](https://arxiv.org/abs/2601.04772)  ·  [PDF](https://arxiv.org/pdf/2601.04772.pdf)
- **Title (EN)**: Single-enantiomer spin polarisers in superconducting junctions
- **Authors**: Lorenz Meyer, Nicolas Néel, Jörg Kröger
- **Categories**: cond-mat.mes-hall, cond-mat.supr-con
- **TL;DR**: 该研究通过扫描隧道显微镜结合锰原子簇探针，首次在无铁磁电极和磁化反转条件下，为单分子手性诱导自旋选择性效应提供了明确实验证据。
...
- **arXiv**: [2601.04811](https://arxiv.org/abs/2601.04811)  ·  [PDF](https://arxiv.org/pdf/2601.04811.pdf)
- **Title (EN)**: Switching magnetization of quantum antiferromagnets: Schwinger boson mean-field theory compared to exact diagonalization
- **Authors**: Florian Johannesmann, Asliddin Khudoyberdiev, Götz S. Uhrig
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文通过精确对角化方法研究小团簇量子反铁磁体中的亚晶格磁化翻转，验证了Schwinger玻色子平均场理论的可靠性，两种方法在短时标上结果一致（偏差约12.5%）。
...
- **arXiv**: [2601.04721](https://arxiv.org/abs/2601.04721)  ·  [PDF](https://arxiv.org/pdf/2601.04721.pdf)
- **Title (EN)**: How semiconducting are ferroelectrics: The fundamental, optical and transport gaps of Na$_{0.5}$Bi$_{0.5}$TiO$_3$-BaTiO$_3$ and NaNbO$_{3}$
- **Authors**: Pengcheng Hu, Nicole Bein, Chinmay Chandan Parhi, Tadej Rojac, Barbara Malič, Mohammad Amirabbasi, Anton Volodin, Karsten Albe, Jurij Koruza, Andreas Klein
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 铁电材料中存在三种不同的能隙：基本能隙、光学能隙和输运能隙，它们之间存在显著差异，需要区分测量。
...
- **arXiv**: [2601.04712](https://arxiv.org/abs/2601.04712)  ·  [PDF](https://arxiv.org/pdf/2601.04712.pdf)
- **Title (EN)**: Multigap nodeless superconductivity in Dirac semimetal PdTe
...
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: PdTe单晶的点接触谱研究表明其超导行为偏离单能隙模型，更适合用双能隙模型描述，表明存在两个不同的超导能隙。
...
- **arXiv**: [2601.04951](https://arxiv.org/abs/2601.04951)  ·  [PDF](https://arxiv.org/pdf/2601.04951.pdf)
- **Title (EN)**: Microscopic and hydrodynamic correlation in 1d hard rod gas
- **Authors**: Indranil Mukherjee, Seema Chahal, Anupam Kundu
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文计算了一维硬棒气体在微观和宏观尺度上的质量密度关联，通过精确微观计算和BMFT宏观理论验证了流体力学理论假设
...
- **arXiv**: [2601.04787](https://arxiv.org/abs/2601.04787)  ·  [PDF](https://arxiv.org/pdf/2601.04787.pdf)
- **Title (EN)**: Intrinsic Gyrotropic Magnetic Current of Orbital Origin
- **Authors**: Koushik Ghorai, Sankar Sarkar, Amit Agarwal
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文在旋光晶体中发现了轨道驱动的磁位移电流，完善了旋光磁电流的理论框架，揭示了其在PT对称反铁磁体中的本征特性及对反铁磁序的探测能力。
...
- **arXiv**: [2601.04832](https://arxiv.org/abs/2601.04832)  ·  [PDF](https://arxiv.org/pdf/2601.04832.pdf)
- **Title (EN)**: Affordable Five-Orbital Dynamical Mean-Field Theory for Layered Iridates and Rhodates
...
- **arXiv**: [2601.04724](https://arxiv.org/abs/2601.04724)  ·  [PDF](https://arxiv.org/pdf/2601.04724.pdf)
- **Title (EN)**: K-ion intercalation memristors in prussian blue analogs revealed by C-AFM for Non-Volatile memory and Neuromorphic Computing
- **Authors**: L. B. Avila, O. Leuve, M. Pohlitz, M. A Villena, Ramón Torres-Cavalillas, C. Ducarme, A. Lopes Temporao, T. G. Coppée, A. Moureaux, S. Arib, Eugenio Coronado, C. K. Müller, J. B. Roldán, B. Hackens, F. Abreu Araujo
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 首次在普鲁士蓝类似物中实现钾离子插层驱动的阻变开关，通过C-AFM在纳米尺度可视化并控制该过程，展示了高速、可扩展的插层忆阻器
...
- **arXiv**: [2601.05147](https://arxiv.org/abs/2601.05147)  ·  [PDF](https://arxiv.org/pdf/2601.05147.pdf)
- **Title (EN)**: Low-loss Material for Infrared Protection of Cryogenic Quantum Applications
...
- **TL;DR**: 利用Mie散射原理设计了一种新型滤波器，可在红外波段高效阻挡辐射，同时在GHz频段保持高透射率，适用于低温量子应用
...
- **arXiv**: [2601.05079](https://arxiv.org/abs/2601.05079)  ·  [PDF](https://arxiv.org/pdf/2601.05079.pdf)
- **Title (EN)**: Full counting statistics in the sine--Gordon model
- **Authors**: Botond C. Nagy, Marton Kormos, Gabor Takacs
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文通过扩展热力学Bethe Ansatz方法，对sine-Gordon场论中三个最低电荷的完整计数统计和累积量进行了全面的数值研究
...
- **arXiv**: [2601.04837](https://arxiv.org/abs/2601.04837)  ·  [PDF](https://arxiv.org/pdf/2601.04837.pdf)
- **Title (EN)**: Floquet-driven tunneling control in monolayer MoS$_2$
- **Authors**: Rachid El Aitouni, Aotmane En Naciri, Clarence Cortes, David Laroze, Ahmed Jellal
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 研究MoS₂中费米子在激光场和静态势垒下的传输概率，发现传输概率随自旋振荡，中央能带传输最高，激光强度和势垒宽度增加会降低传输，激光调控可用于通道化和滤波。
...
- **arXiv**: [2601.04908](https://arxiv.org/abs/2601.04908)  ·  [PDF](https://arxiv.org/pdf/2601.04908.pdf)
- **Title (EN)**: Coupled sawtooth chain exchange network in olivine Mn$_2$GeO$_4$
...
- **Categories**: cond-mat.str-el
- **TL;DR**: Mn₂GeO₄橄榄石表现出复杂的磁性相变，从共线相到多铁性共线+非共线相。通过非弹性中子散射和有效哈密顿量分析，揭示了其三维交换网络由耦合的锯齿链组成，其中第三和第四近邻相互作用主导，而次近邻相互作用和Dzyaloshinskii-Moriya相互作用对非共线性至关重要。
...
- **arXiv**: [2601.04725](https://arxiv.org/abs/2601.04725)  ·  [PDF](https://arxiv.org/pdf/2601.04725.pdf)
- **Title (EN)**: Towards understanding the defect properties in the multivalent A-site Na$_{0.5}$Bi$_{0.5}$TiO$_3$-based perovskite ceramics
- **Authors**: Pengcheng Hu, Chinmay Chandan Parhi, Jurij Koruza, Andreas Klein
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文提出了一种缺陷模型来解释Na0.5Bi0.5TiO3基钙钛矿氧化物的非化学计量比，并通过实验验证了不同A位非化学计量比对电导率的影响。
...
- **arXiv**: [2601.05198](https://arxiv.org/abs/2601.05198)  ·  [PDF](https://arxiv.org/pdf/2601.05198.pdf)
- **Title (EN)**: Fluctuation-response relation for a nonequilibrium system with resolved Markovian embedding
- **Authors**: Rémi Goerlich, Antoine Tartar, Yael Roichman, Igor M Sokolov
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 实验证明，通过显式解析非马尔可夫动力学的适当马尔可夫嵌入，可以定量恢复非平衡系统的涨落-响应关系
...
- **arXiv**: [2601.05100](https://arxiv.org/abs/2601.05100)  ·  [PDF](https://arxiv.org/pdf/2601.05100.pdf)
- **Title (EN)**: Quantum Spin Transfer of Spin-Correlated Electron Pairs
- **Authors**: Seongmun Hwang, Jung Hyun Oh, Paul M. Haney, Mark D. Stiles, Kyung-Jin Lee
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 量子自旋转移：自旋相关电子对通过量子涨落将角动量传递给局域自旋，即使净自旋为零的电子对也能实现自旋转移，相干系统中自旋单态可直接转换为等自旋三重态。
...
- **arXiv**: [2601.05001](https://arxiv.org/abs/2601.05001)  ·  [PDF](https://arxiv.org/pdf/2601.05001.pdf)
- **Title (EN)**: Kitaev interactions in the van der Waals antiferromagnet VBr3
...
- **TL;DR**: VBr3是一种新型Kitaev磁体，具有蜂窝晶格结构和zigzag磁序，其自旋激发谱可通过包含显著Kitaev和双二次相互作用的哈密顿量描述。
...
- **arXiv**: [2601.04755](https://arxiv.org/abs/2601.04755)  ·  [PDF](https://arxiv.org/pdf/2601.04755.pdf)
- **Title (EN)**: Scalable Dielectric Tensor Predictions for Inorganic Materials using Equivariant Graph Neural Networks
- **Authors**: Haowei Hua, Chen Liang, Ding Pan, Shengchao Liu, Irwin King, Koji Tsuda, Wanyu Lin
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出GoeCTP框架，通过帧平均方法实现O(3)等变介电张量预测，无需对骨干网络施加结构限制，在材料筛选中表现出色。
...
- **arXiv**: [2601.05238](https://arxiv.org/abs/2601.05238)  ·  [PDF](https://arxiv.org/pdf/2601.05238.pdf)
- **Title (EN)**: How many-body chaos emerges in the presence of quasiparticles
- **Authors**: Sibaram Ruidas, Sthitadhi Roy, Subhro Bhattacharjee, Roderich Moessner
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, nlin.CD
- **TL;DR**: 该论文研究了经典海森堡链在低温下从近可积行为到多体混沌的交叉过程，通过定义混沌诊断器（经典解关联器）揭示了由弱相互作用自旋波散射引发的光锥级联现象。
...
- **arXiv**: [2601.05234](https://arxiv.org/abs/2601.05234)  ·  [PDF](https://arxiv.org/pdf/2601.05234.pdf)
- **Title (EN)**: When and why non-Hermitian eigenvalues miss eigenstates in topological physics
- **Authors**: Lucien Jezequel, Loïc Herviou, Jens Bardarson
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 非厄米系统存在本征值和本征态谱的分离现象，Hatano-Nelson模型展示了本征值无法探测的隐藏模式，这解释了非厄米拓扑中体边对应关系的"失效"。
...
- **arXiv**: [2601.05126](https://arxiv.org/abs/2601.05126)  ·  [PDF](https://arxiv.org/pdf/2601.05126.pdf)
- **Title (EN)**: Acoustic signatures of the field-induced electronic-topological transitions in YbNi$_4$P$_2$
- **Authors**: E. -O. Eljaouhari, B. V. Schwarze, K. Kliemt, C. Krellner, F. Husstedt, J. Wosnitza, S. Zherlitsyn, G. Zwicknagl, J. Sourd
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过声速测量研究YbNi4P2单晶在低温磁场下的磁弹性性质，发现与费米面拓扑转变相关的强异常，并利用声学模式对称性解析不同转变
...
- **arXiv**: [2601.04762](https://arxiv.org/abs/2601.04762)  ·  [PDF](https://arxiv.org/pdf/2601.04762.pdf)
- **Title (EN)**: Berry Phase of Bloch States through Modular Symmetries
- **Authors**: Emanuele Maggio
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文提出了一种基于高斯型轨道构建解析Bloch态的方法来计算Berry相位，并建立了模对称性与Zak相位之间的对应关系，在非中心对称空间群F222中进行了验证。
...
- **arXiv**: [2601.05123](https://arxiv.org/abs/2601.05123)  ·  [PDF](https://arxiv.org/pdf/2601.05123.pdf)
- **Title (EN)**: A First-principles Study of Weyl Nodal Loop and Multiple Sets of Weyl Points in Trigonal PtBi$_2$
- **Authors**: Lin-Lin Wang
- **Categories**: cond-mat.mtrl-sci, cond-mat.supr-con
- **TL;DR**: 通过第一性原理计算发现γ-PtBi₂中存在Weyl节点环和多组Weyl点，其拓扑特性对Bi层弯曲结构敏感，预测了更高能量的费米弧特征
...
- **arXiv**: [2601.05140](https://arxiv.org/abs/2601.05140)  ·  [PDF](https://arxiv.org/pdf/2601.05140.pdf)
- **Title (EN)**: Enhanced Electron Reflectionat Mott-Insulator Interfaces
- **Authors**: Jan Verlage, Peter Kratzer
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文提出了一种凝聚态异质结构系统，可以模拟克莱因悖论中的电子-正电子对产生现象，通过强关联和弱关联电子材料的异质结构，实现了增强的电子反射和双粒子-空穴对产生。
...
- **arXiv**: [2601.04771](https://arxiv.org/abs/2601.04771)  ·  [PDF](https://arxiv.org/pdf/2601.04771.pdf)
- **Title (EN)**: Tuning Excitonic Properties and Charge Carrier Dynamics by Halide Alloying in Cs3Bi2(Br1-xIx)9 semiconductors
- **Authors**: He Zhao, Eline M. Hutter
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过机械化学合成Cs3Bi2(Br1-xIx)9，用碘部分取代溴，改善了钙钛矿型铋卤化物半导体的光吸收和激子解离性能。
...
- **arXiv**: [2601.05185](https://arxiv.org/abs/2601.05185)  ·  [PDF](https://arxiv.org/pdf/2601.05185.pdf)
- **Title (EN)**: Surface chiral Abelian topological order on multilayer cluster Mott insulators
- **Authors**: Xu-Ping Yao, Chao-Kai Li, Gang v. Chen
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 该论文提出在多层堆叠簇莫特绝缘系统中存在手性阿贝尔拓扑序的表面态，通过第一性原理计算和slave-rotor平均场理论研究，并建议用角分辨光电子能谱测量表面分数化现象。
...
- **arXiv**: [2601.04816](https://arxiv.org/abs/2601.04816)  ·  [PDF](https://arxiv.org/pdf/2601.04816.pdf)
- **Title (EN)**: Electric-Field Modulated Optical Transitions in Monolayer CrI3 and Its Nanoribbons
- **Authors**: Xianzhe Zhu, Pu Liu, Wence Ding, Benhu Zhou, Xiaoying Zhou, Guanghui Zhou
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 该研究开发了一个28带紧束缚模型结合线性响应理论，系统研究单层CrI3及其纳米带的光电响应，揭示了电场选择性调控能隙、动态调控光学跃迁峰、以及边缘设计对电子性质的影响。
...
- **arXiv**: [2601.05196](https://arxiv.org/abs/2601.05196)  ·  [PDF](https://arxiv.org/pdf/2601.05196.pdf)
- **Title (EN)**: Chiral Graviton Modes in Fermionic Fractional Chern Insulators
...
- **TL;DR**: 该论文通过理论和数值研究证明了分数陈绝缘体中手性引力子模式的存在，尽管晶格破坏了连续对称性，但这些模式仍然是长寿命的激发态。
...
- **arXiv**: [2601.04838](https://arxiv.org/abs/2601.04838)  ·  [PDF](https://arxiv.org/pdf/2601.04838.pdf)
- **Title (EN)**: Lateral Graphene-Metallene Interfaces at the Nanoscale
- **Authors**: Mohammad Bagheri, Pekka Koskinen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究结合密度泛函理论和机器学习势函数，系统研究了45种金属烯与石墨烯的横向界面性质，发现几何形状平滑的过渡金属界面最稳定。
...
- **arXiv**: [2601.04935](https://arxiv.org/abs/2601.04935)  ·  [PDF](https://arxiv.org/pdf/2601.04935.pdf)
- **Title (EN)**: Exploring the Potential of Two-dimensional Borospherene for Toxic Gas Sensing and Capture: A DFT Study
- **Authors**: Nicolas F. Martins, José A. dos S. Laranjeira, Kleuton A. L. Lima, Luiz A. Ribeiro, Julio R. Sambrano
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 2D硼基材料B40用于有毒气体捕获与检测，CO为弱物理吸附，NO、NH3、SO2为强化学吸附，SO2在室温下自发分解，具有传感和环境修复双重功能
...
- **arXiv**: [2601.05236](https://arxiv.org/abs/2601.05236)  ·  [PDF](https://arxiv.org/pdf/2601.05236.pdf)
- **Title (EN)**: Stability of the Local Ni$^{2+}$ Electronic Structure to $A$-site Disorder in the Pyrochlore Antiferromagnet NaCaNi$_2$F$_7$
...
- **arXiv**: [2601.04846](https://arxiv.org/abs/2601.04846)  ·  [PDF](https://arxiv.org/pdf/2601.04846.pdf)
- **Title (EN)**: Triple-well ferroelectricity and kagome-like Chern flat band in two-dimensional multiferroic CuVP$_2$Se$_6$
...
- **TL;DR**: 单层CuVP₂Se₆是一种二维多铁材料，结合了可调三重势阱铁电相变和自旋极化的陈平带，具有电可调平带关联和拓扑磁性的潜力。
...
- **arXiv**: [2601.04952](https://arxiv.org/abs/2601.04952)  ·  [PDF](https://arxiv.org/pdf/2601.04952.pdf)
- **Title (EN)**: Goldene monolayer as a highly effective catalyst for polysulfide anchoring and conversion: A theoretical study
- **Authors**: Nicolas F. Martins, José A. dos S. Laranjeira, Bill D. A. Huacarpuma, Kleuton A. L. Lima, Luiz A. Ribeiro, Julio R. Sambrano
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 使用第一性原理密度泛函理论研究锂硫化物和多硫化物簇在新型二维金同素异形体Goldene上的吸附行为，发现Goldene能有效锚定和介导锂多硫化物反应
...
- **arXiv**: [2601.04916](https://arxiv.org/abs/2601.04916)  ·  [PDF](https://arxiv.org/pdf/2601.04916.pdf)
- **Title (EN)**: Discovery of a new weberite-type antiferroelectric: La3NbO7
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过大规模第一性原理计算筛选发现了一种新型无铅weberite结构反铁电材料La₃NbO₇，并通过实验验证了其反铁电特性，为能量存储应用提供了新机会。
...
- **arXiv**: [2601.04971](https://arxiv.org/abs/2601.04971)  ·  [PDF](https://arxiv.org/pdf/2601.04971.pdf)
- **Title (EN)**: Three-dimensional Moiré crystallography
- **Authors**: Ilya Popov, Elena Besley
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文建立了三维莫尔晶体的基本数学原理，并提出了一种使用有理数域上的克利福德代数构建三维莫尔晶体的通用方法。
...
- **arXiv**: [2601.05003](https://arxiv.org/abs/2601.05003)  ·  [PDF](https://arxiv.org/pdf/2601.05003.pdf)
- **Title (EN)**: Stable Machine Learning Potentials for Liquid Metals via Dataset Engineering
- **Authors**: Alex Tai, Jason Ogbebor, Rodrigo Freitas
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出一种基于物理动机的数据集工程策略，通过系统扰动晶体参考结构生成"合成液体"训练数据，解决机器学习势在液体模拟中的采样不足问题，实现稳定、准确的液态金属热物理性质预测。
...
- **arXiv**: [2601.05018](https://arxiv.org/abs/2601.05018)  ·  [PDF](https://arxiv.org/pdf/2601.05018.pdf)
- **Title (EN)**: Correlative Ultrafast Imaging of a Propagating Photo-Driven Phase Transition Using 4D STEM
- **Authors**: Arthur Niedermayr, Jianyu Wu, Bertina Fisher, Ido Kaminer, Jonas Weissenrieder
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 利用超快四维扫描透射电镜直接观测VO₂激光激发相变的空间时间传播，揭示原子尺度对称性破缺如何产生晶格畸变并传播到宏观性质变化。
...
- **arXiv**: [2601.05142](https://arxiv.org/abs/2601.05142)  ·  [PDF](https://arxiv.org/pdf/2601.05142.pdf)
- **Title (EN)**: Prediction of Magnetic Topological Materials Combining Spin and Magnetic Space Groups
- **Authors**: Liangliang Huang, Xiangang Wan, Feng Tang
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 提出结合自旋空间群和磁空间群的新方案，系统诊断484种实验合成的共线磁体拓扑性质，发现传统方法无法识别的拓扑特征
...
- **arXiv**: [2601.05061](https://arxiv.org/abs/2601.05061)  ·  [PDF](https://arxiv.org/pdf/2601.05061.pdf)
- **Title (EN)**: Electronic structure of Sn(1-x)Mn(x)Te semiconducting solid solution: a resonant photoemission study
- **Authors**: Elzbieta Guziewicz, Bronislaw A. Orlowski, Bogdan J. Kowalski
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过共振光电子能谱研究Mn掺杂SnTe的电子能带结构，发现Mn3d电子对价带边缘有贡献，并引起Sn5p和Te5p电子态重整化
...
- **arXiv**: [2601.05064](https://arxiv.org/abs/2601.05064)  ·  [PDF](https://arxiv.org/pdf/2601.05064.pdf)
- **Title (EN)**: Electrically Switchable Flat Band in Two-Dimensional Electron Gases under Nonuniform Magnetic Fields
- **Authors**: You-Ting Huang, Chao-Cheng Kaun, Ching-Hao Chang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文研究了二维电子气在磁场梯度和横向电场下的能带调控，发现特定电场强度下能带会变平，并具有量子化霍尔电导和增强态密度等传输特性。
...
- **arXiv**: [2601.05097](https://arxiv.org/abs/2601.05097)  ·  [PDF](https://arxiv.org/pdf/2601.05097.pdf)
- **Title (EN)**: Hierarchical Crystal Structure Prediction of Zeolitic Imidazolate Frameworks Using DFT and Machine-Learned Interatomic Potentials
...
- **TL;DR**: 使用机器学习原子间势能进行高通量晶体结构预测，探索锌咪唑酸盐的晶体能量景观，发现了大量新拓扑结构，并验证了CSP方法在实验相关ZIF结构采样中的有效性。
...
- **arXiv**: [2601.05179](https://arxiv.org/abs/2601.05179)  ·  [PDF](https://arxiv.org/pdf/2601.05179.pdf)
- **Title (EN)**: Local Multimodal Dynamics in Mixed Ionic-Electronic Conductors and Their Fingerprints in Organic Electrochemical Transistor Operation
...
- **TL;DR**: 该研究通过原位多模态扫描介电显微镜，揭示了有机电化学晶体管转移曲线中的空间局域电化学转变，建立了局部静电力作为混合导体多模态动力学的观测指标。
...
- **arXiv**: [2601.05197](https://arxiv.org/abs/2601.05197)  ·  [PDF](https://arxiv.org/pdf/2601.05197.pdf)
- **Title (EN)**: Control of the MoTe$_2$ Fermi Surface by Nb Doping
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过化学势调控（Nb掺杂和碱金属沉积）改变MoTe₂的体相和表面电子结构，实现多个Lifshitz转变，展示该层状材料的多重电子性质可调性。
