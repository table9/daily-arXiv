---
title: "arXiv Daily · 2026-01-13 · 103 papers"
date: 2026-01-13
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-01-13 · 103 papers

### Emergence of Kugel-Khomskii physics in quarter-filled bilayer correlated systems
- **arXiv**: [2601.06440](https://arxiv.org/abs/2601.06440)  ·  [PDF](https://arxiv.org/pdf/2601.06440.pdf)
- **Title (EN)**: Emergence of Kugel-Khomskii physics in quarter-filled bilayer correlated systems
- **Authors**: Guijing Duan, Yunlong Wang, Zhiguang Liao, Changle Liu, Rong Yu
- **Categories**: cond-mat.str-el
- **TL;DR**: 该理论研究双层过渡金属系统中四分之一空穴填充的双轨道Hubbard模型，揭示了由几何结构驱动的复合纠缠机制，发现了包含隐藏复合自旋-层序的新型最大自旋-层纠缠相。
...
- **arXiv**: [2601.06511](https://arxiv.org/abs/2601.06511)  ·  [PDF](https://arxiv.org/pdf/2601.06511.pdf)
- **Title (EN)**: Altermagnetism in exactly solvable model: the Ising-Kondo lattice model
- **Authors**: Miaomiao Zhao, Wei-Wei Yang, Yin Zhong
- **Categories**: cond-mat.str-el
- **TL;DR**: 该研究通过蒙特卡洛模拟在Ising-Kondo晶格模型中发现了类altermagnet相，证实了d波对称性的稳定性及其在重费米子材料中的潜在存在。
...
- **arXiv**: [2601.06549](https://arxiv.org/abs/2601.06549)  ·  [PDF](https://arxiv.org/pdf/2601.06549.pdf)
- **Title (EN)**: Topological $Z_4$ spin-orbital liquid on the honeycomb lattice
- **Authors**: Masahiko G. Yamada
- **Categories**: cond-mat.str-el
- **TL;DR**: 将DMRG方法扩展到SU(N_c)对称性系统，特别是SU(4)海森堡模型，揭示了量子自旋轨道液体基态
...
- **arXiv**: [2601.07083](https://arxiv.org/abs/2601.07083)  ·  [PDF](https://arxiv.org/pdf/2601.07083.pdf)
- **Title (EN)**: Ferromagnetic Insulator to Metal Transition in Non-Centrosymmetric Graphene Nanoribbons
...
- **TL;DR**: 通过自下而上合成非中心对称石墨烯纳米带，实现所有零模位于多数亚晶格位点，强电子关联导致铁磁绝缘基态，高温下发生绝缘体-金属相变并淬灭铁磁序。
...
- **arXiv**: [2601.06083](https://arxiv.org/abs/2601.06083)  ·  [PDF](https://arxiv.org/pdf/2601.06083.pdf)
- **Title (EN)**: Theoretical Prediction of optimal $T_c$ for Nickelate $\mathrm{La_{3-x}Sm_{x}Ni_{2}O_{7-δ}}$
- **Authors**: Xiuqing Huang
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该论文基于量子阱振荡器假说，预测镍基超导体La₃₋ₓSmₓNi₂O₇₋δ的Tc可达97K，与实验值96K高度吻合，并指出其与铜基超导体YBCO具有相似的八面体量子阱结构，统一了两类超导体系。
...
- **arXiv**: [2601.06099](https://arxiv.org/abs/2601.06099)  ·  [PDF](https://arxiv.org/pdf/2601.06099.pdf)
- **Title (EN)**: Co-doping of silicate bioceramics as a potential strategy to further enhance mono-doping consequences
...
- **TL;DR**: 本文综述了共掺杂硅酸盐生物陶瓷在硬组织再生中的应用，重点探讨了共掺杂剂与硅酸盐主成分之间的化学相互作用对生物行为的影响，并展望了未来研究方向。
...
- **arXiv**: [2601.06246](https://arxiv.org/abs/2601.06246)  ·  [PDF](https://arxiv.org/pdf/2601.06246.pdf)
- **Title (EN)**: Topological phonons in anomalous Hall crystals
- **Authors**: Mark R. Hirsbrunner, Félix Desrochers, Joe Huxford, Yong Baek Kim
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 该论文研究反常霍尔晶体（AHCs）的集体模式拓扑性质，发现从维格纳晶体到AHCs的相变过程中，声子和激子发生能带反转，产生拓扑声子和激子，声子陈数在AHC相发生符号反转，这为实验探测AHCs提供了新的特征。
...
- **arXiv**: [2601.06291](https://arxiv.org/abs/2601.06291)  ·  [PDF](https://arxiv.org/pdf/2601.06291.pdf)
- **Title (EN)**: Confinement-controlled chase-escape dynamics
- **Authors**: R. G. Rossatto, H. Ariel Alvarez, C. Manuel Carlevaro, José Rafael Bordin
- **Categories**: cond-mat.stat-mech, physics.app-ph
- **TL;DR**: 研究二维方格上障碍物密度如何影响追逃效率，发现几何无序通过连通性控制集体追逃动力学，呈现非单调依赖关系。
...
- **arXiv**: [2601.06079](https://arxiv.org/abs/2601.06079)  ·  [PDF](https://arxiv.org/pdf/2601.06079.pdf)
- **Title (EN)**: Efficient GPU-computing simulation platform JAX-PF for differentiable phase field model
- **Authors**: Fanglei Hu, Jiachen Guo, Stephen Niezgoda, Wing Kam Liu, Jian Cao
- **Categories**: physics.comp-ph, cs.CE
- **TL;DR**: JAX-PF是一个基于JAX的开源、GPU加速、可微分相场软件包，支持显式和隐式时间步进方案，提供高性能计算和自动微分功能，用于正向模拟和逆向设计。
...
- **arXiv**: [2601.06080](https://arxiv.org/abs/2601.06080)  ·  [PDF](https://arxiv.org/pdf/2601.06080.pdf)
- **Title (EN)**: Fluoride doping into SiO2-MgO-CaO bioactive glass nanoparticles: bioactivity, biodegradation and biocompatibility assessments
...
- **TL;DR**: 首次研究不同氟化物掺杂水平的SiO2-MgO-CaO玻璃的结构、生物活性、生物降解性和生物相容性，发现存在最佳氟化物掺杂水平以实现最高生物活性和生物相容性。
...
- **arXiv**: [2601.07138](https://arxiv.org/abs/2601.07138)  ·  [PDF](https://arxiv.org/pdf/2601.07138.pdf)
- **Title (EN)**: Revealing altermagnetic Fermi surfaces with two Kondo impurities
- **Authors**: Qiong Qin, Toshihiro Sato, Marcin Raczkowski, Jeroen van den Brink, Congjun Wu, Fakher F. Assaad
- **Categories**: cond-mat.str-el
- **TL;DR**: 提出一种基于双杂质近藤效应研究交变磁性的相位敏感方法，利用自旋分辨扫描隧道显微镜探测交变磁金属上的杂质间距和取向变化。
...
- **arXiv**: [2601.06326](https://arxiv.org/abs/2601.06326)  ·  [PDF](https://arxiv.org/pdf/2601.06326.pdf)
- **Title (EN)**: Coexistence of superconductivity and charge density wave in a correlated regime
- **Authors**: E. J. Calegari, L. C. Prauchner, A. C. Lausmann, S. G. Magalhaes
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 研究关联体系中超导与电荷密度波（CDW）的共存问题，采用格林函数方法和Hubbard-I近似引入库仑排斥相互作用U，并考察次近邻跃迁t₁对纯CDW态的影响。
...
- **arXiv**: [2601.06190](https://arxiv.org/abs/2601.06190)  ·  [PDF](https://arxiv.org/pdf/2601.06190.pdf)
- **Title (EN)**: Theoretical investigation of non-Förster exciton transfer mechanisms in perylene diimide donor, phenylene bridge, and terrylene diimide acceptor systems
- **Authors**: Lei Yang, Seogjoo J. Jang
- **Categories**: physics.chem-ph, cond-mat.mtrl-sci, quant-ph
- **TL;DR**: 该研究通过计算和理论分析解释了PDI-TDI二聚体中激子转移速率与Förster理论显著偏差的原因，发现激子在桥部分的离域增强了电子耦合，而共同振动模式是偏离Förster光谱重叠表达的主要来源。
...
- **arXiv**: [2601.06274](https://arxiv.org/abs/2601.06274)  ·  [PDF](https://arxiv.org/pdf/2601.06274.pdf)
- **Title (EN)**: Spin Hall effect in van der Waals ferromagnet Fe$_{5}$GeTe$_{2}$
...
- **TL;DR**: 研究vdW铁磁体Fe5GeTe2的自旋霍尔效应，发现铁磁相变下SHE显著增强，但其温度依赖性与反常霍尔效应不同，反映了复杂磁序下的能带结构变化。
...
- **arXiv**: [2601.06638](https://arxiv.org/abs/2601.06638)  ·  [PDF](https://arxiv.org/pdf/2601.06638.pdf)
- **Title (EN)**: A Lindblad and Non-Hermitian Spectral Framework for Fragmentation Dynamics and Particle Size Distributions
- **Authors**: Juan J. Segura
- **Categories**: cond-mat.stat-mech, math-ph
- **TL;DR**: 将自相似破碎的群体平衡方程映射到量子主方程，建立谱字典连接PSD形状与对数尺寸空间势能，提出从数据推断有效势的反演方法
...
- **arXiv**: [2601.06433](https://arxiv.org/abs/2601.06433)  ·  [PDF](https://arxiv.org/pdf/2601.06433.pdf)
- **Title (EN)**: Slowdown and saturation of internal time according to the statistics of information input: a minimal model of response systems
- **Authors**: Tatsuaki Tsuruyama
- **Categories**: physics.comp-ph
- **TL;DR**: 该论文研究响应系统的内部时间概念，定义为到给定时间为止至少观察到一次的代码种类数。分析了信息输入的统计特性（到达率和代码分布）如何决定内部时间的推进方式，并探讨了内部时间与物理时间的关系。
...
- **arXiv**: [2601.06260](https://arxiv.org/abs/2601.06260)  ·  [PDF](https://arxiv.org/pdf/2601.06260.pdf)
- **Title (EN)**: An assessment of mechanism-based plasticity models for polycrystalline magnesium alloys
- **Authors**: R. Vigneshwaran, Showren Datta, A. A. Benzerga, Shailendra P. Joshi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 评估计算高效的粗粒度塑性模型与高保真晶体塑性模拟在镁多晶材料中的性能对比，关注模型捕捉演化塑性各向异性和拉压不对称性的能力。
...
- **arXiv**: [2601.07255](https://arxiv.org/abs/2601.07255)  ·  [PDF](https://arxiv.org/pdf/2601.07255.pdf)
- **Title (EN)**: Interplay of Charge and Magnetic Orders in SmNiC$_2$ Mediated by Electron-Phonon Interaction
...
- **arXiv**: [2601.06504](https://arxiv.org/abs/2601.06504)  ·  [PDF](https://arxiv.org/pdf/2601.06504.pdf)
- **Title (EN)**: Superconductivity in epitaxial PtSb(0001) thin films
...
- **TL;DR**: 在SrF2(111)衬底上生长的外延PtSb(0001)薄膜中观察到超导性，临界温度Tc=1.72K，具有II型超导特性，相干长度ξ_ab≈55nm，ξ_c≈14nm，临界电流密度J_c≈6×10^4 A/cm²
...
- **arXiv**: [2601.06995](https://arxiv.org/abs/2601.06995)  ·  [PDF](https://arxiv.org/pdf/2601.06995.pdf)
- **Title (EN)**: Cation Dominated but Negatively Charged Na2SO4,aq-Graphene Interfaces
- **Authors**: Ademola Soyemi, Tibor Szilvasi
- **Categories**: physics.chem-ph, cond-mat.mtrl-sci
- **TL;DR**: 该研究通过机器学习原子势模拟和SFG光谱模拟，揭示了Na₂SO₄水溶液-石墨烯界面离子分布的分子机制，解决了实验观察到的SO₄²⁻优先积累与通常阳离子积累趋势之间的矛盾。
...
- **arXiv**: [2601.06778](https://arxiv.org/abs/2601.06778)  ·  [PDF](https://arxiv.org/pdf/2601.06778.pdf)
- **Title (EN)**: Charged moiré phonons in twisted bilayer graphene
- **Authors**: Alejandro Ramos-Alonso, Hector Ochoa
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 扭曲双层石墨烯中的莫尔声子在掺杂时变为红外活性，产生新的光学吸收峰，其中声子类似模式获得电荷，导致类Drude电导率
...
- **arXiv**: [2601.06751](https://arxiv.org/abs/2601.06751)  ·  [PDF](https://arxiv.org/pdf/2601.06751.pdf)
- **Title (EN)**: Transport Regimes in Random Walks in Random Environments
- **Authors**: Mihir Metkar, Neha Sah, Zoey Zhou
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文综述了随机环境中随机游走（RWRE）模型，涵盖离散和连续时间表述，识别主要输运机制，并回顾一维和高维的核心分析方法。
...
- **arXiv**: [2601.07346](https://arxiv.org/abs/2601.07346)  ·  [PDF](https://arxiv.org/pdf/2601.07346.pdf)
- **Title (EN)**: Curvature-driven shifts of the Potts transition on spherical Fibonacci graphs: a graph-convolutional transfer-learning study
- **Authors**: Zheng Zhou, Xu-Yang Hou, Hao Guo
- **Categories**: cond-mat.stat-mech, physics.comp-ph
- **TL;DR**: 研究球形斐波那契图上铁磁q态Potts模型，结合Swendsen-Wang蒙特卡洛和图卷积网络，开发适用于规则平面格子和弯曲不规则球形图的统一相分类框架。
...
- **arXiv**: [2601.06267](https://arxiv.org/abs/2601.06267)  ·  [PDF](https://arxiv.org/pdf/2601.06267.pdf)
- **Title (EN)**: Sizes of Ferroelectricity Appearance and Disappearence in Nanosized Hafnia-Zirconia:Landau-type Theory
- **Authors**: Anna N. Morozovska, Eugene A. Eliseev, Sergei V. Kalinin, Maksym V. Strikha
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文研究了纳米尺度氧化铪锆（HfxZr1-xO2）薄膜、多层结构和异质结中的铁电性临界尺寸效应，通过Landau-Ginzburg-Devonshire理论分析了应变对铁电性出现和消失临界尺寸的影响。
...
- **arXiv**: [2601.07275](https://arxiv.org/abs/2601.07275)  ·  [PDF](https://arxiv.org/pdf/2601.07275.pdf)
- **Title (EN)**: Field-induced magnetic phase transitions and transport anomalies in GdAlSi
- **Authors**: Zheng Li, Sheng Xu, Yi-Yan Wang, Tian-Hao Li, Shu-Xiang Li, Jin-Jin Wang, Jun-Jian Mi, Qian Tao, Zhu-An Xu
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 成功合成高质量GdAlSi单晶，发现其具有复杂的磁性相变和磁输运异常，为研究关联拓扑态和通过磁对称性操纵调控Weyl半金属拓扑相变提供了平台。
...
- **arXiv**: [2601.06632](https://arxiv.org/abs/2601.06632)  ·  [PDF](https://arxiv.org/pdf/2601.06632.pdf)
- **Title (EN)**: Magnetic exchange coupled nonreciprocal devices for cryogenic memory
...
- **Categories**: cond-mat.supr-con
- **TL;DR**: 提出基于铁磁绝缘体/超导体异质结的非易失性超导存储器平台，利用磁化方向调控超导性开关，实现低功耗存储并展示超导二极管效应
...
- **arXiv**: [2601.07078](https://arxiv.org/abs/2601.07078)  ·  [PDF](https://arxiv.org/pdf/2601.07078.pdf)
- **Title (EN)**: Ab Initio Characterization of C2H4N2 Isomers: Structures, electronic energies, spectroscopic parameters and formation pathways
- **Authors**: Oko Emmanuel Godwin, Natalia Inostroza, Diego Mardones, Luca Bizzocchi, Edgar Mendoza, María Luisa Senent, Miguel Carvajal
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究使用高精度量子化学方法系统研究了C2H4N2的关键异构体，发现甲基氰胺是最稳定的异构体，具有大偶极矩和独特的旋转特征，适合天文观测检测。
...
- **arXiv**: [2601.06927](https://arxiv.org/abs/2601.06927)  ·  [PDF](https://arxiv.org/pdf/2601.06927.pdf)
- **Title (EN)**: Cryogenic interface-state filling and tunneling mechanisms in strained Ge/SiGe heterostructures
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究应变Ge/SiGe异质结构中界面态陷阱的低温行为，通过霍尔棒场效应晶体管实验和理论建模，揭示了界面态填充过程和隧穿电流机制从陷阱辅助隧穿到Fowler-Nordheim隧穿的转变。
...
- **arXiv**: [2601.06984](https://arxiv.org/abs/2601.06984)  ·  [PDF](https://arxiv.org/pdf/2601.06984.pdf)
- **Title (EN)**: Fluctuation-Dissipation Limits in Quantum Thermoelectric Transport
- **Authors**: Ousi Pan, Zhiqiang Fan, Shunjie Zhang, Jie Li, Jincan Chen, Shanhe Su
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文建立了连接能量流涨落与熵产率和稳态输运电流的普适涨落-耗散界限，适用于任意温度和化学势梯度下的量子散射理论框架，为纳米和量子热器件设计提供了统一热力学指导。
...
- **arXiv**: [2601.07583](https://arxiv.org/abs/2601.07583)  ·  [PDF](https://arxiv.org/pdf/2601.07583.pdf)
- **Title (EN)**: Machine learning nonequilibrium phase transitions in charge-density wave insulators
- **Authors**: Yunhao Fan, Sheng Zhang, Gia-Wei Chern
- **Categories**: cond-mat.str-el, cs.LG, physics.comp-ph
- **TL;DR**: 提出机器学习框架预测非平衡电子力，用于模拟电压驱动相变中的晶格动力学，相比传统NEGF方法计算效率提升数个数量级。
...
- **arXiv**: [2601.06365](https://arxiv.org/abs/2601.06365)  ·  [PDF](https://arxiv.org/pdf/2601.06365.pdf)
- **Title (EN)**: Dynamic nanoscale spatial heterogeneity in a perovskite to brownmillerite topotactic phase transformation
...
- **TL;DR**: 利用布拉格X射线光子关联谱技术，在恒定还原条件下观察到LSCO薄膜中钙钛矿到褐针石拓扑相变的纳米尺度时空异质性，揭示了畴壁运动和去钉扎过程的双时间尺度动力学。
...
- **arXiv**: [2601.07379](https://arxiv.org/abs/2601.07379)  ·  [PDF](https://arxiv.org/pdf/2601.07379.pdf)
- **Title (EN)**: Role of Disorder in Governing the Magnetic Properties of Cu2IrO3
...
- **Categories**: cond-mat.str-el
- **TL;DR**: Cu₂IrO₃中约25%的位点无序和Cu/Ir混合价态导致竞争性反铁磁相互作用和磁阻挫，形成动态AFM团簇，最终在29K以下冻结。
...
- **arXiv**: [2601.06668](https://arxiv.org/abs/2601.06668)  ·  [PDF](https://arxiv.org/pdf/2601.06668.pdf)
- **Title (EN)**: Two-Level System Microwave Losses in Chemically Pure Bulk Niobium Oxide Samples
- **Authors**: Vishal Ganesan, Jiankun Zhang, Drew G. Wild, Alexey Bezryadin
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究发现Nb2O5是铌超导谐振器中双能级系统损耗的主要来源，而NbO2则没有可检测的TLS损耗特征
...
- **arXiv**: [2601.07098](https://arxiv.org/abs/2601.07098)  ·  [PDF](https://arxiv.org/pdf/2601.07098.pdf)
- **Title (EN)**: Electric field gradient in accurate quantum chemical calculations
- **Authors**: Andrei Derevianko, U. C. Perera, Marek Krośnicki, Kamil Nalikowski, H. W. T. Morgan, Valera Veryazov
- **Categories**: physics.chem-ph
- **TL;DR**: 该论文系统研究了电场梯度(EFG)的计算方法，分析了不同计算参数对EFG值的影响，并澄清了文献中EFG符号约定和定义的差异，为EFG作为电子结构和化学环境定量描述符提供了实用指南。
...
- **arXiv**: [2601.06963](https://arxiv.org/abs/2601.06963)  ·  [PDF](https://arxiv.org/pdf/2601.06963.pdf)
- **Title (EN)**: Tunable cornerlike states in topological type-II hyperbolic lattices
- **Authors**: Zheng-Rong Liu, Tan Peng, Xiao-Xia Yi, Chun-Bo Hua, Rui Chen, Bin Zhou
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在II型双曲晶格中发现了高阶拓扑相，其特征是广义四极矩，零能量角态同时存在于内外边界，且对弱无序具有鲁棒性。
...
- **arXiv**: [2601.07024](https://arxiv.org/abs/2601.07024)  ·  [PDF](https://arxiv.org/pdf/2601.07024.pdf)
- **Title (EN)**: Largest connected component in duplication-divergence growing graphs with symmetric coupled divergence
- **Authors**: Dario Borrelli
- **Categories**: cond-mat.stat-mech, nlin.AO, physics.soc-ph, q-bio.MN
- **TL;DR**: 研究对称耦合分歧的复制-分歧增长图中最大连通分量的相变行为，发现分歧率δ_c处的相变，该点接近有限尺寸图的欧拉特征为零的位置。
...
- **arXiv**: [2601.07680](https://arxiv.org/abs/2601.07680)  ·  [PDF](https://arxiv.org/pdf/2601.07680.pdf)
- **Title (EN)**: A density functional theory study of amino acids on Mg and Mg-based alloys
- **Authors**: John Bolin, Amanda Goold, Olof Hildeberg, Alva Limbäck, Elsebeth Schröder
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph, physics.med-ph
- **TL;DR**: DFT研究三种氨基酸（甘氨酸、脯氨酸、羟脯氨酸）在Mg(0001)表面的吸附行为，探索合金化（锌、锂、铝）和水环境对吸附的影响，旨在开发生物相容性可降解镁基植入物。
...
- **arXiv**: [2601.06384](https://arxiv.org/abs/2601.06384)  ·  [PDF](https://arxiv.org/pdf/2601.06384.pdf)
- **Title (EN)**: Mechanisms of alkali ionic transport in amorphous oxyhalides solid state conductors
- **Authors**: Luca Binci, KyuJung Jun, Bowen Deng, Gerbrand Ceder
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究使用机器学习原子间势进行大规模分子动力学模拟，发现非晶态氧卤化物中碱金属离子的扩散受限于金属-阴离子四面体上的氧阴离子，离子电导率主要由非相关自扩散主导，且扩散性质对化学组成变化不敏感。
...
- **arXiv**: [2601.07417](https://arxiv.org/abs/2601.07417)  ·  [PDF](https://arxiv.org/pdf/2601.07417.pdf)
- **Title (EN)**: Sliding Charge Density Wave observed through Band Structure
- **Authors**: S. Mandal, D. Ghoneim, A. A. Sinchenko, V. L. R. Jacques, K. Wang, L. Ortega, J. Avila, P. Dudin, A. Tejeda, D. Le Bolloch
- **Categories**: cond-mat.str-el
- **TL;DR**: ARPES观测到TbTe₃中滑动电荷密度波在k空间中的对称性破缺，与理论预测一致
...
- **arXiv**: [2601.06682](https://arxiv.org/abs/2601.06682)  ·  [PDF](https://arxiv.org/pdf/2601.06682.pdf)
- **Title (EN)**: Aharonov-Casher Effect and the Coherent Flux Tunneling in the Hybrid Charge Quantum Interference Device
- **Authors**: J. W. Dunstan, R. Shaikhaidarov, K. H. Kim, A. Shesterikov, I. Antonov, S. Linzen, E. V. Il'ichev, V. N. Antonov, O. V. Astafiev
- **Categories**: cond-mat.supr-con
- **TL;DR**: 利用Aharonov-Casher效应抑制混合电荷量子干涉器件中的磁通隧穿
...
- **arXiv**: [2601.07193](https://arxiv.org/abs/2601.07193)  ·  [PDF](https://arxiv.org/pdf/2601.07193.pdf)
- **Title (EN)**: Full symmetry-breaking of electronic and nuclear dynamics for low attosecond timescale electronic chirality reversal
- **Authors**: Tianlv Xu, Jiawen Kong, Tianjing Zhou, Yan Wang, Jingqin Tu, Alireza Azizi, Steven R. Kirk, Samantha Jenkins
- **Categories**: physics.chem-ph
- **TL;DR**: 该论文展示了通过两束超快圆偏振激光脉冲诱导碘乙炔分子产生3.87阿秒级电子手性反转，这是目前最快的连续值S/R手性赋值反转。
...
- **arXiv**: [2601.07300](https://arxiv.org/abs/2601.07300)  ·  [PDF](https://arxiv.org/pdf/2601.07300.pdf)
- **Title (EN)**: Self-oscillations induced by self-induced torque in magnetic double tunnel junction
- **Authors**: R. Arun, R. Gopal, V. K. Chandrasekar, M. Lakshmanan
- **Categories**: cond-mat.mes-hall, nlin.SI
- **TL;DR**: 研究磁性双隧道结中自诱导力矩引起的磁化自振荡，分析场式力矩对振荡频率、功率和Q因子的影响。
...
- **arXiv**: [2601.07096](https://arxiv.org/abs/2601.07096)  ·  [PDF](https://arxiv.org/pdf/2601.07096.pdf)
- **Title (EN)**: Dynamic redundancy and mortality in stochastic search
- **Authors**: Samantha Linn, Aanjaneya Kumar
- **Categories**: cond-mat.stat-mech, math.PR, physics.data-an, physics.soc-ph
- **TL;DR**: 本文提出了一个动态冗余与死亡率（DRM）框架，用于研究搜索者数量动态变化的随机搜索过程，揭示了与随机重置的意外联系，并在一维布朗运动DRM搜索中进行了详细分析。
...
- **arXiv**: [2601.06398](https://arxiv.org/abs/2601.06398)  ·  [PDF](https://arxiv.org/pdf/2601.06398.pdf)
- **Title (EN)**: Reaction-Diffusion Driven Patterns in Immiscible Alloy Thin Films
- **Authors**: Vivek C. Peddiraju, Shourya Dutta-Gupta, Subhradeep Chatterjee
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过薄膜-基底相互作用实现局部微结构调控，在FIB预图案化Si基底上沉积亚稳态Ag-Cu薄膜，退火后图案周围形成由铜硅化物和纯Ag组成的"光环"微结构。
...
- **arXiv**: [2601.07418](https://arxiv.org/abs/2601.07418)  ·  [PDF](https://arxiv.org/pdf/2601.07418.pdf)
- **Title (EN)**: Collinear $p$-wave magnetism and hidden orbital ferrimagnetism
- **Authors**: Valentin Leeb, Johannes Knolle
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文挑战了传统观点，证明了在无自旋轨道耦合情况下，共线磁体可以具有反演对称性破缺的能带结构，从而存在奇波共线磁体，其独特特征是磁场诱导的Edelstein效应。
...
- **arXiv**: [2601.06735](https://arxiv.org/abs/2601.06735)  ·  [PDF](https://arxiv.org/pdf/2601.06735.pdf)
- **Title (EN)**: Altermagnetism-driven FFLO superconductivity in finite-filling 2D lattices
- **Authors**: Xia-Ji Liu, Hui Hu
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 该研究系统探讨了在具有有限填充的方晶格哈伯德模型中，由d_{xy}波或d_{x^2-y^2}波交变磁性驱动的有限动量FFLO超导性的出现机制。
...
- **arXiv**: [2601.07614](https://arxiv.org/abs/2601.07614)  ·  [PDF](https://arxiv.org/pdf/2601.07614.pdf)
- **Title (EN)**: A directly observable, Zeeman-insensitive nuclear spin coherence in solution
...
- **TL;DR**: 在[1-13C]-富马酸盐中发现了一种时钟型核自旋避免交叉，在超低磁场下产生长寿命相干性，具有磁场扰动一阶免疫和25秒寿命
...
- **arXiv**: [2601.07443](https://arxiv.org/abs/2601.07443)  ·  [PDF](https://arxiv.org/pdf/2601.07443.pdf)
- **Title (EN)**: Hexagonal Warping Control of Exceptional Points in Topological Insulator--Ferromagnetic Heterojunctions
- **Authors**: Md Afsar Reja, Awadhesh Narayan
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该研究探讨了六角形扭曲对拓扑绝缘体-铁磁体界面处异常点的影响，发现扭曲项决定异常点位置，且异常点数量和位置可通过外加磁场调控。
...
- **arXiv**: [2601.07231](https://arxiv.org/abs/2601.07231)  ·  [PDF](https://arxiv.org/pdf/2601.07231.pdf)
- **Title (EN)**: Derivation and Analysis of Amplitude Equation for Generalized AMB+ in Presence of Chemical Reaction
- **Authors**: Sayantan Mondal, Prasenjit Das
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 该论文推导并分析了广义Active Model B+（AMB+）在化学反应存在下的振幅方程，研究了不同参数条件下从超临界到亚临界转变的相变行为。
...
- **arXiv**: [2601.06422](https://arxiv.org/abs/2601.06422)  ·  [PDF](https://arxiv.org/pdf/2601.06422.pdf)
- **Title (EN)**: Weakly spin-dependent band structures of antiferromagnetic perovskite LaMO$_3$ (M = Cr, Mn, Fe)
- **Authors**: Takuya Okugawa, Kaoru Ohno, Yusuke Noda, Shinichiro Nakamura
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过自旋极化DFT+U研究三种反铁磁材料的电子态，发现能带结构中自旋分裂/简并的简单对称性规则，最稳定结构的自旋分裂很小，可能有利于电极应用中的自旋电流方向无关性。
...
- **arXiv**: [2601.07562](https://arxiv.org/abs/2601.07562)  ·  [PDF](https://arxiv.org/pdf/2601.07562.pdf)
- **Title (EN)**: Magnons in multiorbital Hubbard models, from Lieb to kagome
- **Authors**: Teng-Fei Ying, Hugo U. R. Strand, Benjamin T. Zhou, Erik G. C. P. van Loon
- **Categories**: cond-mat.str-el
- **TL;DR**: 研究Lieb-kagome晶格中Hubbard模型的磁序和激发，发现除了无能隙Goldstone磁振子外，铁磁和反铁磁对称破缺相还存在有能隙的Higgs磁振子带。
...
- **arXiv**: [2601.07018](https://arxiv.org/abs/2601.07018)  ·  [PDF](https://arxiv.org/pdf/2601.07018.pdf)
- **Title (EN)**: Van der Waals superconducting electronics: materials, devices and circuit integration
- **Authors**: Angelo Di Bernardo, Elke Scheer
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall
- **TL;DR**: 这篇综述回顾了范德华超导体的独特性质及其在超导电子学和量子技术中的应用前景，重点讨论了其物理机制、器件功能以及规模化制备的挑战。
...
- **arXiv**: [2601.07494](https://arxiv.org/abs/2601.07494)  ·  [PDF](https://arxiv.org/pdf/2601.07494.pdf)
- **Title (EN)**: Reconfigurable Oxide Nanoelectronics by Tip-induced Electron Delocalization
- **Authors**: Chengyuan Huang, Changjian Ma, Mengke Ha, Longbing Shang, Zhenlan Chen, Qing Xiao, Zhiyuan Qin, Danqing Liu, Haoyuan Wang, Dawei Qiu, Qianyi Zhao, Ziliang Guo, Yanling Liu, Dingbang Chen, Chengxuan Ye, Zhenhao Li, Chang-Kui Duan, Guanglei Cheng
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 开发了一种兼容真空和低温环境的"无水"cAFM光刻技术，在mK温度下实现了LaAlO₃/SrTiO₃界面纳米尺度极化子-电子液体相变的非易失性可重构控制，分辨率达0.85nm。
...
- **arXiv**: [2601.06509](https://arxiv.org/abs/2601.06509)  ·  [PDF](https://arxiv.org/pdf/2601.06509.pdf)
- **Title (EN)**: The role of ZnO/ZnS nanostructures decoration of Ni foam on the electrochemical energy storage process
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究通过水热法在镍泡沫上生长ZnO/ZnS纳米结构用于电化学储能，发现其在镍泡沫上表现出显著的赝电容行为，而在石墨烯纸上仅显示有限的电容性能。
...
- **arXiv**: [2601.07380](https://arxiv.org/abs/2601.07380)  ·  [PDF](https://arxiv.org/pdf/2601.07380.pdf)
- **Title (EN)**: Decoupled interband pairing in a bilayer iron-based superconductor evidenced by ultrahigh-resolution ARPES
...
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 实验发现双层铁基超导体ACa₂Fe₄As₄F₂中存在弱耦合多带超导态，K化合物显示两个不同转变温度，Cs化合物显示单一转变温度。
...
- **arXiv**: [2601.06510](https://arxiv.org/abs/2601.06510)  ·  [PDF](https://arxiv.org/pdf/2601.06510.pdf)
- **Title (EN)**: Effect of substrate mismatch, orientation, and flexibility on heterogeneous ice nucleation
...
- **TL;DR**: 通过分子模拟研究冰异相成核中结构失配的影响，发现1%的结构失配增加会导致成核温度下降约4K，基底取向影响不大，而晶格柔性基底因能适应冰结构而更有效。
...
- **arXiv**: [2601.07615](https://arxiv.org/abs/2601.07615)  ·  [PDF](https://arxiv.org/pdf/2601.07615.pdf)
- **Title (EN)**: Observation of exceptional topology and nonlocal skin effect in Klein bottle electric circuits
- **Authors**: Pengtao Lai, Xiangru Chen, Yugan Tang, Yejian Hu, Zhenhang Pu, Hui Liu, Weiyin Deng, Hua Cheng, Zhengyou Liu, Shuqi Chen
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文研究了非厄米系统中投影对称性（动量空间非简单反射对称）如何诱导异常拓扑和非局域趋肤效应，通过二维非厄米电路实验观测到布里渊克莱因瓶流形上的拓扑电荷现象。
...
- **arXiv**: [2601.07829](https://arxiv.org/abs/2601.07829)  ·  [PDF](https://arxiv.org/pdf/2601.07829.pdf)
- **Title (EN)**: Interface roughening in the 3-D Ising model with tensor networks
...
- **TL;DR**: 研究3D Ising模型界面粗糙化转变，使用张量网络方法分析无限xy平面、有限z方向的非对称晶格，发现不同边界条件导致不同的相变行为。
...
- **arXiv**: [2601.07800](https://arxiv.org/abs/2601.07800)  ·  [PDF](https://arxiv.org/pdf/2601.07800.pdf)
- **Title (EN)**: Rigorous Anderson-type lower bounds on the ground-state energy of the pyrochlore Heisenberg antiferromagnet
- **Authors**: Péter Kránitz, Karlo Penc
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文为自旋S海森堡反铁磁体在烧绿石晶格上的基态能量构建了严格的安德森型下界，通过优化局部团簇层次结构得到紧致下界，并推广到更复杂的相互作用模型。
...
- **arXiv**: [2601.07460](https://arxiv.org/abs/2601.07460)  ·  [PDF](https://arxiv.org/pdf/2601.07460.pdf)
- **Title (EN)**: Observation of Time-Reversal Symmetry Breaking in the Type-I Superconductor YbSb$_2$
...
- **Categories**: cond-mat.supr-con
- **TL;DR**: 在传统上被认为是I型超导体的YbSb₂中发现了时间反演对称性破缺，表明其具有非常规超导性，结合拓扑金属特性和三重态配对，成为独特的拓扑超导体平台。
...
- **arXiv**: [2601.06880](https://arxiv.org/abs/2601.06880)  ·  [PDF](https://arxiv.org/pdf/2601.06880.pdf)
- **Title (EN)**: Size Dependent Ternary Halide Solid Solutions in Perovskite Nanocrystals
- **Authors**: Shai Levy, Lotte Kortstee, Georgy Dosovitskiy, Emma H. Massasa, Yaron Kauffmann, Juan Maria García-Lastra, Ivano E. Castelli, Yehonadav Bekenstein
- **Categories**: cond-mat.mtrl-sci, physics.chem-ph
- **TL;DR**: 研究发现纳米晶体中三元卤化物钙钛矿的溶解度边界扩展，小尺寸纳米晶体能稳定Cl:Br:I固溶体并抑制缺陷
...
- **arXiv**: [2601.07717](https://arxiv.org/abs/2601.07717)  ·  [PDF](https://arxiv.org/pdf/2601.07717.pdf)
- **Title (EN)**: Effects of random vacancies on the spin-dependent thermoelectric properties of silicene nanoribbon
- **Authors**: D. Zambrano, C. D. Núñez, P. A. Orellana, J. P. Ramos-Andrade, L. Rosales
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究硅烯纳米带异质结构的自旋相关热电性质，发现含随机空位的缺陷结构能显著提升热电效率和自旋热功率，突破经典维德曼-弗朗兹定律限制。
...
- **arXiv**: [2601.06529](https://arxiv.org/abs/2601.06529)  ·  [PDF](https://arxiv.org/pdf/2601.06529.pdf)
- **Title (EN)**: On unconstrained solidification of spherical metallic drops
- **Authors**: Priti Ranjan Panda, Harish Singh Dhami, Koushik Viswanathan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究系统分析了金属液滴在受限曲率系统中的凝固过程，揭示了曲率和边界条件如何影响成核路径、生长动力学和界面稳定性，提出了适用于球形域的稳定性理论。
...
- **arXiv**: [2601.07810](https://arxiv.org/abs/2601.07810)  ·  [PDF](https://arxiv.org/pdf/2601.07810.pdf)
- **Title (EN)**: Ising Supercriticality and Universal Magnetocalorics in Spiral Antiferromagnet Nd$_3$BWO$_9$
...
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 该研究将液-气系统的相图类比扩展到高度阻挫的Kagome层状螺旋伊辛反铁磁体Nd₃BWO₉，发现了临界终点和伊辛超临界区域，并观察到遵循3D伊辛普适类的格吕奈森比发散行为。
...
- **arXiv**: [2601.07493](https://arxiv.org/abs/2601.07493)  ·  [PDF](https://arxiv.org/pdf/2601.07493.pdf)
- **Title (EN)**: Magnetic field decouples nodeless surface and nodal bulk orders
- **Authors**: Atanu Mishra, Ghulam Mohmad, Kiran Bansal, Mohd Monish, Pankaj Kumar, Chandrasekhar Yadav, Goutam Sheet
- **Categories**: cond-mat.supr-con
- **TL;DR**: 利用磁场依赖的Andreev反射光谱分离PdTe拓扑超导体中的表面和体超导态，发现表面为无节点能隙而体为有节点能隙，弱磁场即可抑制表面超导但体超导持续到更高磁场
...
- **arXiv**: [2601.07012](https://arxiv.org/abs/2601.07012)  ·  [PDF](https://arxiv.org/pdf/2601.07012.pdf)
- **Title (EN)**: Case study of an exploratory high voltage NASICON-based Na$_4$NiCr(PO$_4$)$_3$ cathode material for sodium-ion batteries
- **Authors**: Madhav Sharma, Pooja Sindhu, Rajendra S. Dhaka
- **Categories**: cond-mat.mtrl-sci, physics.app-ph, physics.chem-ph
- **TL;DR**: 新型NASICON型Na₄NiCr(PO₄)₃材料用于钠离子电池，具有高电压和多电子反应特性，但存在放电容量低和可逆性差的问题。
...
- **arXiv**: [2601.07781](https://arxiv.org/abs/2601.07781)  ·  [PDF](https://arxiv.org/pdf/2601.07781.pdf)
- **Title (EN)**: Resonant magnetic proximity hot spots in Co/hBN/graphene
- **Authors**: Klaus Zollner, Lukas Cvitkovich, Riccardo Silvioli, Andreas V. Stier, Jaroslav Fabian
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过第一性原理计算系统分析Co/hBN/石墨烯异质结构中的磁邻近效应，发现石墨烯狄拉克态的自旋极化具有显著局域空间变化，交换耦合强度取决于界面原子排列，自旋劈裂范围1-100meV，最强效应出现在轨道最大重叠的"邻近热点"处。
...
- **arXiv**: [2601.06571](https://arxiv.org/abs/2601.06571)  ·  [PDF](https://arxiv.org/pdf/2601.06571.pdf)
- **Title (EN)**: Beyond Predicted ZT: Machine Learning Strategies for the Experimental Discovery of Thermoelectric Materials
- **Authors**: Shoeb Athar, Philippe Jund
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该综述分析了机器学习在热电材料设计中预测准确性与实验验证之间的差距，指出模型泛化性差、数据量小、验证方法偏差等主要障碍，并提出结合主动学习与高通量实验的解决方案。
...
- **arXiv**: [2601.07710](https://arxiv.org/abs/2601.07710)  ·  [PDF](https://arxiv.org/pdf/2601.07710.pdf)
- **Title (EN)**: From perovskite to infinite-layer nickelates: hole concentration from x-ray absorption
...
- **TL;DR**: 通过软X射线吸收光谱研究PrNiO_x薄膜，发现即使最大还原的样品也不存在纯d^9构型，超导样品镍3d空穴数更高，且存在氧2p空穴，表明复杂的空穴掺杂机制。
...
- **arXiv**: [2601.07719](https://arxiv.org/abs/2601.07719)  ·  [PDF](https://arxiv.org/pdf/2601.07719.pdf)
- **Title (EN)**: Geometric theory of constrained Schrödinger dynamics with application to time-dependent density-functional theory on a finite lattice
- **Authors**: Eric Cancès, Théo Duez, Jari van Gog, Asbjørn Bækgaard Lauritsen, Mathieu Lewin, Julien Toulouse
- **Categories**: cond-mat.mtrl-sci, math-ph, physics.chem-ph
- **TL;DR**: 该论文为TDDFT建立了一个几何框架，提出了两种不同的约束薛定谔动力学定义，并推导出新的Kohn-Sham方案，在Hubbard二聚体上进行了数值验证。
...
- **arXiv**: [2601.07798](https://arxiv.org/abs/2601.07798)  ·  [PDF](https://arxiv.org/pdf/2601.07798.pdf)
- **Title (EN)**: Nonlinear interaction theory for parametrically-excited spin-wave modes in confined micromagnetic systems
- **Authors**: Massimiliano d'Aquino, Salvatore Perna, Hugo Merbouche, Grégoire De Loubens
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 提出了一种用于定量描述受限微磁系统中自旋波模式参数激励的理论方法，通过双频平行泵浦激发两个共振模式，研究其非线性相互作用产生的准周期性、滞后和非对易性等复杂动力学行为。
...
- **arXiv**: [2601.06583](https://arxiv.org/abs/2601.06583)  ·  [PDF](https://arxiv.org/pdf/2601.06583.pdf)
- **Title (EN)**: A Rechargeable Chromium Battery
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过开发富含铬的高熵合金，克服了铬金属自发氧化形成钝化层的问题，实现了可逆的铬离子电池
...
- **arXiv**: [2601.07729](https://arxiv.org/abs/2601.07729)  ·  [PDF](https://arxiv.org/pdf/2601.07729.pdf)
- **Title (EN)**: Prediction of superconductivity in mass-asymmetric electron-hole bilayers
- **Authors**: Luca Nashabeh, Liang Fu
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 研究密度平衡、质量不对称的电子-空穴双层结构作为可调谐的量子相平台，发现了包括激子凝聚、维格纳晶体以及电子-液体空穴-晶体混合相等丰富相图，并预测了由声学等离子体介导的电子间吸引相互作用导致的BCS超导。
...
- **arXiv**: [2601.07724](https://arxiv.org/abs/2601.07724)  ·  [PDF](https://arxiv.org/pdf/2601.07724.pdf)
- **Title (EN)**: Geometric Time-Dependent Density Functional Theory
- **Authors**: Éric Cancès, Théo Duez, Jari van Gog, Asbjørn Bækgaard Lauritsen, Mathieu Lewin, Julien Toulouse
- **Categories**: cond-mat.mtrl-sci, math-ph, physics.chem-ph
- **TL;DR**: 提出基于固定密度约束态几何结构的新TDDFT公式，引入密度-电流泛函映射，通过非局域算符实现Kohn-Sham方程中的密度重现
...
- **arXiv**: [2601.06585](https://arxiv.org/abs/2601.06585)  ·  [PDF](https://arxiv.org/pdf/2601.06585.pdf)
- **Title (EN)**: Influence of Surface Functionalization on the Colloidal Stability and Magnetic Properties of Ferrite Nanoparticles
- **Authors**: Arif Iqbal Sheikh, Radha Srinivasan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究通过化学共沉淀法合成了未涂层和表面修饰的Fe3O4纳米颗粒，系统研究了PEG和柠檬酸表面功能化对纳米颗粒结构、光谱、磁性和胶体性质的影响。
...
- **arXiv**: [2601.06791](https://arxiv.org/abs/2601.06791)  ·  [PDF](https://arxiv.org/pdf/2601.06791.pdf)
- **Title (EN)**: Absence of magnetic order in epitaxial RuO2 revealed by X-ray linear dichroism
...
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 通过X射线线性二色性(XLD)结合光电子发射显微镜和多散射计算，证明RuO2薄膜中不存在磁序，其XLD信号源于低对称性晶体场而非磁性。
...
- **arXiv**: [2601.06646](https://arxiv.org/abs/2601.06646)  ·  [PDF](https://arxiv.org/pdf/2601.06646.pdf)
- **Title (EN)**: Deterministic domain selection of antiferromagnets via magnetic fields
- **Authors**: Sophie F. Weber, Veronika Sunko
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 表面磁交换减弱使反铁磁体可通过磁场实现确定性畴切换，为实验观测提供解释
...
- **arXiv**: [2601.06659](https://arxiv.org/abs/2601.06659)  ·  [PDF](https://arxiv.org/pdf/2601.06659.pdf)
- **Title (EN)**: Detecting the Onset and Progression of Spinodal Decomposition using Transient Grating Spectroscopy
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究证明瞬态光栅光谱技术（TGS）可非破坏性地检测Fe-Cr合金中的调幅分解，通过弹性模量硬化现象实现早期预警。
...
- **arXiv**: [2601.06669](https://arxiv.org/abs/2601.06669)  ·  [PDF](https://arxiv.org/pdf/2601.06669.pdf)
- **Title (EN)**: A phase field model of the effects of dislocation microstructure on grain boundary motion during recrystallization
- **Authors**: Yufan Zhang, Michael Zaiser
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 相场模型模拟强变形晶体中位错微结构与再结晶晶界运动的相互作用
...
- **arXiv**: [2601.06691](https://arxiv.org/abs/2601.06691)  ·  [PDF](https://arxiv.org/pdf/2601.06691.pdf)
- **Title (EN)**: Higher order magnetoelasticity energy corrections in bcc and fcc systems
- **Authors**: Jakub Šebesta, Ondřej Faiman, Dominik Legut
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究立方晶体结构中高阶应变项对磁致伸缩各向异性行为的影响，发现这些高阶项的影响可以忽略不计。
...
- **arXiv**: [2601.06716](https://arxiv.org/abs/2601.06716)  ·  [PDF](https://arxiv.org/pdf/2601.06716.pdf)
- **Title (EN)**: Synthesis of epitaxial \ce{TaO2} thin films on \ce{Al2O3} by suboxide molecular-beam epitaxy and thermal laser epitaxy
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过分子束外延和热激光外延在蓝宝石衬底上稳定生长了亚稳态TaO2薄膜，证实了其四价态和0.3eV的Mott带隙，揭示了潜在的金属-绝缘体相变可能性。
...
- **arXiv**: [2601.07578](https://arxiv.org/abs/2601.07578)  ·  [PDF](https://arxiv.org/pdf/2601.07578.pdf)
- **Title (EN)**: Anisotropic anomalous Hall effect in distorted kagome GdTi3Bi4
...
- **TL;DR**: GdTi3Bi4 kagome磁体表现出方向选择性的反常霍尔效应：当磁场平行于c轴时出现显著反常霍尔电导，而平行于a轴时完全消失，这与通常反常霍尔效应随磁化强度变化的规律相矛盾。
...
- **arXiv**: [2601.06721](https://arxiv.org/abs/2601.06721)  ·  [PDF](https://arxiv.org/pdf/2601.06721.pdf)
- **Title (EN)**: Influence of CaO and SiO2 additives on the sintering behavior of Cr,Ca:YAG ceramics prepared by solid-state reaction sintering
- **Authors**: . A. Chaika, G. Mancardi, O. M. Vovk
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究探讨了SiO2和CaO烧结助剂对Cr,Ca:YAG陶瓷光学性能和微观结构的影响，发现CaO浓度降低会导致透明度下降和异常晶粒生长。
...
- **arXiv**: [2601.06738](https://arxiv.org/abs/2601.06738)  ·  [PDF](https://arxiv.org/pdf/2601.06738.pdf)
- **Title (EN)**: Electric field switching of altermagnetic spin-splitting in multiferroic skyrmions
...
- **TL;DR**: 在BiFeO3多铁材料中，通过反阻尼自旋轨道力矩实现了从自旋螺旋到奈尔型斯格明子的室温转变，并发现其具有可电场调控的反铁磁自旋分裂特性。
...
- **arXiv**: [2601.06820](https://arxiv.org/abs/2601.06820)  ·  [PDF](https://arxiv.org/pdf/2601.06820.pdf)
- **Title (EN)**: Bgolearn: a Unified Bayesian Optimization Framework for Accelerating Materials Discovery
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: Bgolearn是一个用于材料科学的Python贝叶斯优化框架，通过直观接口和材料导向工作流，将实验需求减少40-60%，加速材料发现。
...
- **arXiv**: [2601.06846](https://arxiv.org/abs/2601.06846)  ·  [PDF](https://arxiv.org/pdf/2601.06846.pdf)
- **Title (EN)**: Nanoindentation induced plasticity in equiatomic MoTaW alloys by experimentally guided machine learning molecular dynamics simulations
- **Authors**: F. J. Dominguez-Gutierrez, T. Stasiak, G. Markovic, A. Kosinska, K. Mulewska
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过实验与原子模拟结合，研究MoTaW难熔复合浓缩合金的纳米压痕响应，揭示其塑性变形机制与晶体取向、位错网络演化的关系。
...
- **arXiv**: [2601.06960](https://arxiv.org/abs/2601.06960)  ·  [PDF](https://arxiv.org/pdf/2601.06960.pdf)
- **Title (EN)**: Dislocation distribution near a wall within the framework of the continuum theory of curved dislocations
- **Authors**: István Groma, Dénes Berta, Lóránt Sándli, Péter Dusán Ispánovity
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过离散位错动力学模拟验证连续介质位错理论的关键参数，使用不可穿透壁几何结构作为基准测试
...
- **arXiv**: [2601.06971](https://arxiv.org/abs/2601.06971)  ·  [PDF](https://arxiv.org/pdf/2601.06971.pdf)
- **Title (EN)**: A survey of active learning in materials science: Data-driven paradigm for accelerating the research pipeline
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 这篇综述论文回顾了主动学习在材料科学中的应用，重点关注其在有限预算下提高数据效率的方法、应用和挑战。
...
- **arXiv**: [2601.07115](https://arxiv.org/abs/2601.07115)  ·  [PDF](https://arxiv.org/pdf/2601.07115.pdf)
- **Title (EN)**: Percolation-Driven Magnetotransport due to Structural and Microstructural Evolution in Ultrathin Si/Fe Bilayers
- **Authors**: S. S. Das, M. Senthil Kumar
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究Si/Fe双层膜中铁层厚度变化对结构、微观结构及磁输运性质的影响，发现30Å附近存在渗流阈值，导致AHE机制从混合本征/侧跳散射转变为偏斜散射主导。
...
- **arXiv**: [2601.07128](https://arxiv.org/abs/2601.07128)  ·  [PDF](https://arxiv.org/pdf/2601.07128.pdf)
- **Title (EN)**: Hidden half-metallicity
- **Authors**: San-Dong Guo, Pan Zhou
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出"隐藏半金属性"新概念：在净磁化强度为零的对称性保护磁体中，全局电子结构非半金属，但两个对称相关子体系各自为半金属，通过层自由度实现100%自旋极化。
...
- **arXiv**: [2601.07188](https://arxiv.org/abs/2601.07188)  ·  [PDF](https://arxiv.org/pdf/2601.07188.pdf)
- **Title (EN)**: Improvement of a focused ion beam fabricated diamond pillar for scanning ensemble nitrogen-vacancy magnetometry probe using an ultrapure diamond
- **Authors**: Dwi Prananto, Yifei Wang, Yuta Kainuma, Kunitaka Hayashi, Masahiko Tomitori, Toshu An
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种改进金刚石氮空位扫描探针显微镜(SNVM)探针质量的方法，通过PVA和Pt/Pd覆盖层结合UV/臭氧处理，制备出直径800纳米的超纯金刚石探针，显著提升了探针性能。
...
- **arXiv**: [2601.07207](https://arxiv.org/abs/2601.07207)  ·  [PDF](https://arxiv.org/pdf/2601.07207.pdf)
- **Title (EN)**: Thermodynamic Driving Force Activated Phonon Scattering in InN
- **Authors**: Zaheer Ahmad, Osama A. Rana, Shakeel Ahmad, Mark Vernon, Brendan Cross, Alexander Kozhanov
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究者开发了一个基于热力学驱动力的统一坐标来描述InN的等离子体辅助MOCVD生长，该坐标能整合生长动力学、缺陷敏感拉曼响应和结构相干性，为缺陷稀疏生长条件提供了定量方法。
...
- **arXiv**: [2601.07216](https://arxiv.org/abs/2601.07216)  ·  [PDF](https://arxiv.org/pdf/2601.07216.pdf)
- **Title (EN)**: Emergent Cooperative Superstructures via Order-Disorder Kinetics in Molecule-Intercalated NbSe2
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 在分子插层NbSe₂中发现合作超结构相，其中分子有序化诱导无机晶格产生伴随超结构，形成摩尔图案，具有异常缓慢的动力学特性。
...
- **arXiv**: [2601.07266](https://arxiv.org/abs/2601.07266)  ·  [PDF](https://arxiv.org/pdf/2601.07266.pdf)
- **Title (EN)**: Effect of the parameters of bimodal microstructure on the mechanical properties of alumina: A case of sintering regime effects
- **Authors**: M. S. Boldin, E. A. Isupova, E. A. Lantcev, T. S. Pozdova, M. D. Nazmutdinov, D. A. Permin, A. A. Murashov, A. N. Sysoev, A. V. Nokhrin, V. N. Chuvil'deev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究不同烧结制度对Al2O3及Al2O3+0.25%MgO陶瓷的密度、微观结构和力学性能的影响，确定获得双峰分布微观结构的最佳参数。
...
- **arXiv**: [2601.07270](https://arxiv.org/abs/2601.07270)  ·  [PDF](https://arxiv.org/pdf/2601.07270.pdf)
- **Title (EN)**: Analysis of contributions of plastic deformation and intergranular corrosion to corrosion-fatigue failure of Al-Mg alloys
- **Authors**: Oleg Belkin, Vladimir Chuvil'deev, Mikhail Chegurov, Aleksey Nokhrin, Anatoly Sysoev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究工业Al-Mg合金在空气和3% NaCl溶液中的腐蚀疲劳行为，发现低应力下点蚀和晶间腐蚀主导失效，高应力下塑性变形起主要作用
...
- **arXiv**: [2601.07478](https://arxiv.org/abs/2601.07478)  ·  [PDF](https://arxiv.org/pdf/2601.07478.pdf)
- **Title (EN)**: High isothermal magnetocaloric effect in La(Fe,Si)13 based alloys
- **Authors**: A. P. Kamantsev, Yu. S. Koshkid`ko, O. E. Kovalev, N. Yu. Nyrkov, A. V. Golovchan, A. A. Amirov, A. M. Aliev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究LaFeSi基合金的磁热效应，发现LaFeMnSiH合金在1.8T磁场下具有高达3400J/kg的等温磁热效应值，比纯Gd高2.5倍，且循环稳定性好。
...
- **arXiv**: [2601.07554](https://arxiv.org/abs/2601.07554)  ·  [PDF](https://arxiv.org/pdf/2601.07554.pdf)
- **Title (EN)**: Structure-Property Relationship in Zinc Sulphide Nanoparticles Synthesized by Hydrothermal and Co-precipitation Methods
- **Authors**: Rao Uzair Ahmad, Nasir Javed
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 比较水热法和共沉淀法合成ZnS量子点，发现室温共沉淀法可制备单分散小尺寸量子点（~2.03 nm），具有可调光学带隙和良好稳定性
...
- **arXiv**: [2601.07699](https://arxiv.org/abs/2601.07699)  ·  [PDF](https://arxiv.org/pdf/2601.07699.pdf)
- **Title (EN)**: Noise2Void for Denoising Atomic Resolution Scanning Transmission Electron Microscopy Images
...
- **TL;DR**: Noise2Void技术成功应用于原子分辨率STEM图像去噪，在石墨烯液胞中的金原子图像和视频上表现出色，优于传统方法，无需人工干预和先验知识，支持实时处理。
...
- **arXiv**: [2601.07703](https://arxiv.org/abs/2601.07703)  ·  [PDF](https://arxiv.org/pdf/2601.07703.pdf)
- **Title (EN)**: Spin-lattice model simulations of tetragonal FePt system
- **Authors**: Jakub Šebesta, Dominik Legut
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种具有四方对称性的自旋晶格模型，用于模拟L1₀ FePt系统的磁弹性特性
...
- **arXiv**: [2601.07742](https://arxiv.org/abs/2601.07742)  ·  [PDF](https://arxiv.org/pdf/2601.07742.pdf)
- **Title (EN)**: PFT: Phonon Fine-tuning for Machine Learned Interatomic Potentials
- **Authors**: Teddy Koker, Abhijeet Gangan, Mit Kotak, Jaime Marian, Tess Smidt
- **Categories**: cond-mat.mtrl-sci, cs.LG
- **TL;DR**: 提出Phonon Fine-Tuning (PFT)方法，通过直接监督二阶力常数来改进机器学习原子间势的振动性质预测，在MDR Phonon基准上提升55%性能
...
- **arXiv**: [2601.07753](https://arxiv.org/abs/2601.07753)  ·  [PDF](https://arxiv.org/pdf/2601.07753.pdf)
- **Title (EN)**: Ultrafast control of spin order by linearly polarized light in noncollinear antiferromagnetic metals
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文报道了在线性偏振飞秒激光脉冲驱动下，非共线反铁磁材料Mn3NiN和Mn3GaN中的超快非热自旋序控制，实现了高达95%的线性偏振依赖性响应。
...
- **arXiv**: [2601.07755](https://arxiv.org/abs/2601.07755)  ·  [PDF](https://arxiv.org/pdf/2601.07755.pdf)
- **Title (EN)**: Resolving the energy alignment between methylammonium lead iodide and C60: an in-situ photoelectron spectroscopy study
- **Authors**: Alberto García-Fernández, Karen Radetzky, Stefania Riva, Birgit Kammlander, Brian Rydgren, Evelyn Johannesson, Rahul Mahavir Varma, Håkan Rensmo, Ute B. Cappel
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究发现C60在MAPbI3单晶表面形成界面时发生向下能级偏移，不利于电荷提取，但偏移幅度对表面成分敏感；高覆盖度下C60 LUMO位于MAPbI3导带下方0.25eV，有利于电荷提取。
...
- **arXiv**: [2601.07770](https://arxiv.org/abs/2601.07770)  ·  [PDF](https://arxiv.org/pdf/2601.07770.pdf)
- **Title (EN)**: A DFT study of B-doped graphene as a metal-anchor: effects of oxidation and strain
- **Authors**: Nikola Veličković, Natalia V. Skorodumova, Ana S. Dobrota
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究通过DFT计算系统分析了硼掺杂石墨烯与四种金属（Mg、Zn、Cu、Pt）的相互作用，考察了掺杂浓度、双轴应变和表面氧化对吸附性能的影响，为能源转换和存储应用中的材料设计提供指导。
