---
title: "arXiv Daily · 2026-02-24 · 91 papers"
date: 2026-02-24
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-02-24 · 91 papers

### Transport in close-packed solids with stacking defects
- **arXiv**: [2602.18574](https://arxiv.org/abs/2602.18574)  ·  [PDF](https://arxiv.org/pdf/2602.18574.pdf)
- **Title (EN)**: Transport in close-packed solids with stacking defects
- **Authors**: C. M. Wilson, R. Ganesh, K. V. Samokhin
- **Categories**: cond-mat.mes-hall, cond-mat.dis-nn
- **TL;DR**: 研究锂和钠在低温下无序相中的电子输运特性，发现当电子仅能在相邻层间跃迁时，所有密堆积结构具有相同的电导率；只有考虑次近邻层跃迁时，电导率才对堆垛层错敏感，并表现出安德森局域化行为。
...
- **arXiv**: [2602.18748](https://arxiv.org/abs/2602.18748)  ·  [PDF](https://arxiv.org/pdf/2602.18748.pdf)
- **Title (EN)**: Nonabelian Anyons attached to Superconducting Islands in FQH Liquids
- **Authors**: Hisham Sati, Urs Schreiber
- **Categories**: cond-mat.mes-hall, cond-mat.str-el, math-ph, math.AT, quant-ph
- **TL;DR**: 该论文重新审视了2D分数量子霍尔系统中的任意子理论，利用Hopfion和2-Cohomotopy中的通量量子化新定理，预测了超导岛可能诱导的非阿贝尔任意子态。
...
- **arXiv**: [2602.18890](https://arxiv.org/abs/2602.18890)  ·  [PDF](https://arxiv.org/pdf/2602.18890.pdf)
- **Title (EN)**: Prediction of the atomistic Hubbard U interaction from moiré system STM-images using image recognition
- **Authors**: Nachiket Tanksale, Tobias Stauber
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 使用机器学习从扫描隧道显微镜图像中提取Hubbard U参数的新方法
...
- **arXiv**: [2602.18893](https://arxiv.org/abs/2602.18893)  ·  [PDF](https://arxiv.org/pdf/2602.18893.pdf)
- **Title (EN)**: Atomistic substrate relaxation effects in the band gaps of graphene on hexagonal boron nitride
- **Authors**: Jiaqi An, Nicolas Leconte, Srivani Javvaji, Youngju Park, Jeil Jung
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究石墨烯/六方氮化硼异质结中原子级衬底晶格弛豫对能隙的影响，发现弛豫显著影响主能隙大小，且主能隙在~0.6°转角附近出现最大值，而次价带能隙在~1°转角后消失。
...
- **arXiv**: [2602.18561](https://arxiv.org/abs/2602.18561)  ·  [PDF](https://arxiv.org/pdf/2602.18561.pdf)
- **Title (EN)**: Analytic continuation of Green's functions with a neural network
- **Authors**: Fakher Assaad, Johanna Erdmenger, Anika Götz, René Meyer, Martin Rackl, Yanick Thurn
- **Categories**: cond-mat.str-el, hep-th, nucl-th
- **TL;DR**: 使用卷积神经网络从虚时格林函数重建谱密度，通过改进的高斯训练数据训练网络，确保输出正半定性，在接近训练数据时优于最大熵方法，但在物理模型识别特征方面不如最大熵。
...
- **arXiv**: [2602.18441](https://arxiv.org/abs/2602.18441)  ·  [PDF](https://arxiv.org/pdf/2602.18441.pdf)
- **Title (EN)**: Updating DMD Operators for Changes in Domain Properties
- **Authors**: Dimitrios Voulanas, Eduardo Gildin
- **Categories**: physics.comp-ph, cs.CE, math.OC
- **TL;DR**: 提出两种轻量级更新策略，无需重新训练即可调整现有DMD模型以适应渗透率变化，实现快速碳封存优化分析
...
- **arXiv**: [2602.18479](https://arxiv.org/abs/2602.18479)  ·  [PDF](https://arxiv.org/pdf/2602.18479.pdf)
- **Title (EN)**: AgentCAT: An LLM Agent for Extracting and Analyzing Catalytic Reaction Data from Chemical Engineering Literature
- **Authors**: Wei Yang, Zihao Liu, Tao Tan, Xiao Hu, Hong Xie, Lulu Li Xin Li, Jianyu Han, Defu Lian, Mao Ye
- **Categories**: physics.chem-ph, cs.AI, cs.DL
- **TL;DR**: AgentCAT是一个从化学工程论文中提取和分析催化反应数据的LLM智能体，通过自然语言交互解决化学工程领域的数据瓶颈问题。
...
- **arXiv**: [2602.18631](https://arxiv.org/abs/2602.18631)  ·  [PDF](https://arxiv.org/pdf/2602.18631.pdf)
- **Title (EN)**: Thermodynamic and Kinetic Bounds for Finite-frequency Fluctuation-Response
- **Authors**: Jiming Zheng, Zhiyue Lu
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文推导了非平衡系统中频率域涨落-响应不等式，将谱信噪比与动力学活性和熵产率联系起来，为通过功率谱测量推断耗散提供了实用方法。
...
- **arXiv**: [2602.18538](https://arxiv.org/abs/2602.18538)  ·  [PDF](https://arxiv.org/pdf/2602.18538.pdf)
- **Title (EN)**: AI/ML-Driven Surface Plasmon Resonance (SPR) and Spectroscopy: Materials Interfaces and Autonomous Experiments
- **Authors**: Rigoberto Advincula, Jihua Chen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: SPR光谱与传感从基础吸附动力学研究发展到电聚合分子印迹聚合物传感，结合AI/ML数据解释和自驱动实验室，实现材料科学闭环发现
...
- **arXiv**: [2602.19093](https://arxiv.org/abs/2602.19093)  ·  [PDF](https://arxiv.org/pdf/2602.19093.pdf)
- **Title (EN)**: Superconducting phase diagram of multi-layer square-planar nickelates
...
- **TL;DR**: 在多层方形平面镍酸盐Nd_{n+1}Ni_nO_{2n+2}中发现n=4-8的超导特征，建立相图并揭示其与无限层镍酸盐的异同
...
- **arXiv**: [2602.18973](https://arxiv.org/abs/2602.18973)  ·  [PDF](https://arxiv.org/pdf/2602.18973.pdf)
- **Title (EN)**: Exact expression for the Berry connection in the projection gauge
- **Authors**: Trey Cole, David Vanderbilt
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 提出一种基于投影规范的非阿贝尔贝里联络的精确表达式，该表达式在晶体动量空间中是局域的，避免了有限差分近似带来的误差，为万尼尔插值方案中的几何性质计算提供了稳定框架。
...
- **arXiv**: [2602.18672](https://arxiv.org/abs/2602.18672)  ·  [PDF](https://arxiv.org/pdf/2602.18672.pdf)
- **Title (EN)**: Is altermagnetism in vanadium oxychalcogenides a lost cause?
- **Authors**: Bishal Thapa, Po-Hao Chang, Kirill Belashchenko, Igor I. Mazin
- **Categories**: cond-mat.str-el
- **TL;DR**: 大多数AV2Q2O化合物不是真正的altermagnet，只有CsV2Te2O是例外，因为大多数化合物的层间耦合导致Kramers简并反铁磁序而非altermagnetism。
...
- **arXiv**: [2602.18482](https://arxiv.org/abs/2602.18482)  ·  [PDF](https://arxiv.org/pdf/2602.18482.pdf)
- **Title (EN)**: Boltzmann Generators for Condensed Matter via Riemannian Flow Matching
- **Authors**: Emil Hoffmann, Maximilian Schebek, Leon Klein, Frank Noé, Jutta Rogal
- **Categories**: physics.comp-ph, cond-mat.stat-mech, cs.LG, stat.ML
- **TL;DR**: 提出一种结合黎曼流匹配与周期性边界条件的方法，用于凝聚相系统的平衡分布采样，通过Hutchinson迹估计器降低计算成本，并在单原子冰系统上验证了有效性。
...
- **arXiv**: [2602.18551](https://arxiv.org/abs/2602.18551)  ·  [PDF](https://arxiv.org/pdf/2602.18551.pdf)
- **Title (EN)**: From Static Spectra to Operando Infrared Dynamics: Physics Informed Flow Modeling and a Benchmark
- **Authors**: Shuquan Ye, Ben Fei, Hongbin Xu, Jiaying Lin, Wanli Ouyang
- **Categories**: physics.chem-ph, cs.AI
- **TL;DR**: 提出ABCC框架，通过双流解耦和化学流建模，从静态光谱预测锂离子电池SEI层的动态演化过程，在OpIRSpec-7K数据集上超越现有方法
...
- **arXiv**: [2602.19023](https://arxiv.org/abs/2602.19023)  ·  [PDF](https://arxiv.org/pdf/2602.19023.pdf)
- **Title (EN)**: Critical Scaling and Metabolic Regulation in a Ginzburg--Landau Theory of Cognitive Dynamics
- **Authors**: Gunn Kim
- **Categories**: cond-mat.stat-mech, physics.bio-ph, q-bio.NC
- **TL;DR**: 该论文提出了一种将生物智能视为由连续代谢通量维持的宏观序参量的唯象有效场论，通过变分自由能建模认知，预测了结构刚度接近不稳定阈值时的普适代数发散行为。
...
- **arXiv**: [2602.18543](https://arxiv.org/abs/2602.18543)  ·  [PDF](https://arxiv.org/pdf/2602.18543.pdf)
- **Title (EN)**: Buried Stressor Engineering for Position-Controlled InGaAs Quantum Dots with Local Density Variation for Integrated Quantum Photonics
...
- **TL;DR**: 该论文报道了通过埋藏应力层方法实现位置可控InGaAs量子点的单片两步外延生长，实现了局部量子点密度变化，为单光子源和微激光器的集成提供了新途径。
...
- **arXiv**: [2602.19282](https://arxiv.org/abs/2602.19282)  ·  [PDF](https://arxiv.org/pdf/2602.19282.pdf)
- **Title (EN)**: Nearly twofold overestimation of the superconducting volume fraction in pressurized Ruddlesden-Popper nickelates
- **Authors**: Aleksandr V. Korolev, Evgeny F. Talantsev
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该论文指出Zhu等人计算超导体积分数的方程和程序存在错误，导致对Ruddlesden-Popper镍酸盐中超导体积分数的高估。
...
- **arXiv**: [2602.19034](https://arxiv.org/abs/2602.19034)  ·  [PDF](https://arxiv.org/pdf/2602.19034.pdf)
- **Title (EN)**: Nonlinear spin-Seebeck diode in $f$-wave magnets, third-order spin-Nernst effects in $g$-wave magnets and spin-Nernst effects in $i$-wave altermagnets
- **Authors**: Motohiko Ezawa
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文研究了不同对称性（d波、f波、g波、i波、p波）的altermagnet中温度梯度诱导的自旋电流效应，发现了非线性自旋Seebeck效应、自旋电流二极管行为等新现象。
...
- **arXiv**: [2602.19147](https://arxiv.org/abs/2602.19147)  ·  [PDF](https://arxiv.org/pdf/2602.19147.pdf)
- **Title (EN)**: Precompression engineering of metal-insulator transition and magnetism in designed breathing kagome systems
- **Authors**: Qingzhuo Duan, Hongdao Zhuge, Ying Liang, Tianxing Ma
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 通过化学预压缩在kagome材料Nb₃XCl₇中引入呼吸效应，实现金属-绝缘体转变和磁性调控，为相关kagome系统的实验研究提供理论指导。
...
- **arXiv**: [2602.18626](https://arxiv.org/abs/2602.18626)  ·  [PDF](https://arxiv.org/pdf/2602.18626.pdf)
- **Title (EN)**: Multiphysics Modelling of the Molten Salt Fast Reactor using NekRS and the Fission Matrix Method
- **Authors**: Maximiliano Dalinger, Elia Merzari, Saya Lee
- **Categories**: physics.comp-ph
- **TL;DR**: 开发MSFR的中子学-热工水力学耦合计算模型，使用降阶模型求解中子学方程，基于Cardinal框架集成NekRS和Fission Matrix方法
...
- **arXiv**: [2602.18590](https://arxiv.org/abs/2602.18590)  ·  [PDF](https://arxiv.org/pdf/2602.18590.pdf)
- **Title (EN)**: Molecular g-Tensors From Spin-Orbit Quasidegenerate N-electron Valence Perturbation Theory: Benchmarks, Intruder-State Mitigation, and Practical Guidelines
- **Authors**: Nicholas Yiching Chiang, Rajat Majumder, Alexander Yu. Sokolov
- **Categories**: physics.chem-ph
- **TL;DR**: 开发了自旋-轨道准简并二阶N电子价微扰理论(SO-QDNEVPT2)用于计算分子g张量，在23个分子基准测试中表现优于传统方法，并提供了实用的计算指南。
...
- **arXiv**: [2602.19045](https://arxiv.org/abs/2602.19045)  ·  [PDF](https://arxiv.org/pdf/2602.19045.pdf)
- **Title (EN)**: peapods: A Rust-Accelerated Monte Carlo Package for Ising Spin Systems
- **Authors**: Yan Ru Pei
- **Categories**: cond-mat.stat-mech, physics.comp-ph
- **TL;DR**: Peapods是一个用于任意维超立方晶格上伊辛模型蒙特卡洛模拟的开源Python包，核心用Rust编写，通过PyO3提供Python接口，实现了多种更新算法和并行计算。
...
- **arXiv**: [2602.18565](https://arxiv.org/abs/2602.18565)  ·  [PDF](https://arxiv.org/pdf/2602.18565.pdf)
- **Title (EN)**: Tuning of Atomic Layer Deposition Pulse Time through Physics-Informed Bayesian Active Learning
- **Authors**: Pouyan Navabi, Christos G. Takoudis
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall, physics.chem-ph
- **TL;DR**: 本文提出了一种物理信息贝叶斯主动学习框架，用于高效优化原子层沉积工艺的脉冲时间，通过将朗缪尔吸附模型集成到高斯过程核中，显著减少了实验次数和前驱体消耗。
...
- **arXiv**: [2602.19371](https://arxiv.org/abs/2602.19371)  ·  [PDF](https://arxiv.org/pdf/2602.19371.pdf)
- **Title (EN)**: Enhanced $T_\mathrm{c}$ in eutectic high-entropy alloy superconductors Hf-Nb-Sc-Ti-Zr
- **Authors**: Issei Kubo, Yuto Watanabe, Shuma Kawashima, Tomohiro Miyaji, Yoshikazu Mizuguchi, Terukazu Nishizaki, Jiro Kitagawa
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究发现Hf-Nb-Sc-Ti-Zr共晶高熵合金的bcc相具有比典型五元bcc HEA更高的超导临界温度，通过热处理可显著提升Tc至9.93K，并实现高临界电流密度
...
- **arXiv**: [2602.19060](https://arxiv.org/abs/2602.19060)  ·  [PDF](https://arxiv.org/pdf/2602.19060.pdf)
- **Title (EN)**: Bridging Quantum and Classical Descriptions of Spin Dynamics in a Dzyaloshinsky-Moriya Trimer
- **Authors**: Robert Wieser, Raúl Sánchez Galán
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究三聚体在Dzyaloshinsky-Moriya相互作用下的自旋动力学，通过统一哈密顿框架连接量子力学和半经典描述，分析从量子到经典过渡的自旋运动特性。
...
- **arXiv**: [2602.19221](https://arxiv.org/abs/2602.19221)  ·  [PDF](https://arxiv.org/pdf/2602.19221.pdf)
- **Title (EN)**: Microscopic origin of hard-plane antiferromagnetism in the Kondo lattice Ce2Rh3Ge5
- **Authors**: Rajesh Tripathi, Ewan Scott, D. T. Adroja, D. Das, C. Ritter, Huanzhi Hu, Michal P. Kwasigroch, Nicholas Corkill, Gheorghe Lucian Pascut, T. Masuda, S. Asai, T. Takabatake, T. Onimaru, T. Shiroka, Francis Pratt, A. M. Strydom, S. Langridge, A. Sundaresan, S. Patil
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: Ce₂Rh₃Ge₅ 在强杂化近藤晶格中实现了硬平面反铁磁有序，其中部分4f矩离域导致RKKY交换克服了单离子易轴偏好，形成了一种罕见的磁各向异性反转现象。
...
- **arXiv**: [2602.18821](https://arxiv.org/abs/2602.18821)  ·  [PDF](https://arxiv.org/pdf/2602.18821.pdf)
- **Title (EN)**: Rigorous Quantum Thermodynamics from Extended Path Integral Coarse-Graining
- **Authors**: Jing Shen, Ziyan Ye, Ming-Zheng Du, Shi-Yu He, Dong H. Zhang, Venkat Kapil, Jia-Xi Zeng, Wei Fang
- **Categories**: physics.chem-ph
- **TL;DR**: EPIGS将路径积分粗粒化方法扩展为精确的量子热力学框架，通过瞬子自由能扰动方案构建温度可转移的有效势，以近经典计算成本准确模拟核量子效应。
...
- **arXiv**: [2602.19741](https://arxiv.org/abs/2602.19741)  ·  [PDF](https://arxiv.org/pdf/2602.19741.pdf)
- **Title (EN)**: Two-parameter families of MPO integrals of motion in Heisenberg spin chains
- **Authors**: Vsevolod I. Yashin
- **Categories**: cond-mat.stat-mech, math-ph, nlin.SI, quant-ph
- **TL;DR**: 本文发现了两参数矩阵乘积算子族，与XXX、XXZ、XYZ海森堡自旋链哈密顿量对易，并描述了寻找此类运动积分的符号代数方法。
...
- **arXiv**: [2602.18599](https://arxiv.org/abs/2602.18599)  ·  [PDF](https://arxiv.org/pdf/2602.18599.pdf)
- **Title (EN)**: When Atoms Choose Their Neighbors: Element-Specific Views of Local Chemical Order in High-Entropy Alloys
- **Authors**: David Morris, Yonggang Yao, Peng Zhang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: XAS光谱技术为高熵合金中的局部化学有序提供元素特异性定量分析，提出了协调数框架，并展示了单原子/近单原子结构随组分增加的自然出现。
...
- **arXiv**: [2602.19376](https://arxiv.org/abs/2602.19376)  ·  [PDF](https://arxiv.org/pdf/2602.19376.pdf)
- **Title (EN)**: Insight into high-entropy effect in body-centered cubic superconducting alloys
- **Authors**: Hanabusa Senga, Yuto Watanabe, Fubuki Iwase, Ryo Masuda, Daichi Kawahara, Toshiki Haruyama, Terukazu Nishizaki, Yoshikazu Mizuguchi, Jiro Kitagawa
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究bcc高熵合金超导体的电子-声子耦合常数与德拜温度之间的负相关关系，并探讨高熵效应假设的适用性
...
- **arXiv**: [2602.19258](https://arxiv.org/abs/2602.19258)  ·  [PDF](https://arxiv.org/pdf/2602.19258.pdf)
- **Title (EN)**: Dynamics and Pinning for Skyrmions in Altermagnets
- **Authors**: J. C. Bellizotti Souza, C. J. O. Reichhardt, A. Saxena, C. Reichhardt
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究反铁磁斯格明子在交变磁体中的动力学、霍尔角和钉扎效应，发现其运动具有四重对称性各向异性，并建立粒子模型解释这些现象。
...
- **arXiv**: [2602.19484](https://arxiv.org/abs/2602.19484)  ·  [PDF](https://arxiv.org/pdf/2602.19484.pdf)
- **Title (EN)**: Toward the Thermodynamic Limit: Neural Operators for Non-equilibrium Dynamics of Mott Insulators
- **Authors**: Miles Waugh, Chuwei Wang, Radu Andrei, Nusair Islam, Taylor Lee Patti, Eugene Demler, Anima Anandkumar
- **Categories**: cond-mat.str-el
- **TL;DR**: 使用傅里叶神经算子(FNO)学习从噪声扰动基态动量分布到脉冲后分布的映射，实现从小型晶格训练到大型系统零样本泛化，突破传统数值模拟的尺寸限制。
...
- **arXiv**: [2602.19637](https://arxiv.org/abs/2602.19637)  ·  [PDF](https://arxiv.org/pdf/2602.19637.pdf)
- **Title (EN)**: Data-Driven Bath Fitting for Hamiltonian-Diagonalization Dynamical Mean-Field Theory
- **Authors**: Taeung Kim, Jeongmoo Lee, Ara Go
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 提出基于机器学习的初始化方法，解决HD-DMFT中非线性浴拟合的瓶颈问题，通过核岭回归直接从目标杂化函数预测近最优离散浴参数，显著提升收敛速度和鲁棒性。
...
- **arXiv**: [2602.18908](https://arxiv.org/abs/2602.18908)  ·  [PDF](https://arxiv.org/pdf/2602.18908.pdf)
- **Title (EN)**: Vibronic Landscape of Excitons in Photosynthetic Antenna
- **Authors**: Manuel J. Llansola-Portoles, James Sturgis, Andrew Gall, Andrew Pascal, Leonas Valkunas, Bruno Robert
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究通过分析紫色光合细菌中捕光蛋白的振动光谱，揭示了激子的振动特性如何影响光合作用中的能量转移效率。
...
- **arXiv**: [2602.19759](https://arxiv.org/abs/2602.19759)  ·  [PDF](https://arxiv.org/pdf/2602.19759.pdf)
- **Title (EN)**: Thermodynamic Geometry of Classical and Quantum Statistics in the Relativistic Regime
- **Authors**: Hosein Mohammadzadeh, Zahra Ebadi, Omid Yahyayi Monem, Mohammad Hossein Naghizadeh Ardabili
- **Categories**: cond-mat.stat-mech, cond-mat.quant-gas
- **TL;DR**: 研究相对论性经典与量子理想气体的热力学几何，分析粒子质量和空间维度的影响，发现热力学曲率在相对论区域仍保持玻色子为正、费米子为负的特征符号，揭示了统计相互作用与相对论动力学的相互作用。
...
- **arXiv**: [2602.18608](https://arxiv.org/abs/2602.18608)  ·  [PDF](https://arxiv.org/pdf/2602.18608.pdf)
- **Title (EN)**: Real-time vacancy concentration evolution revealed via heavy ion irradiation experiments
- **Authors**: Elena Botica-Artalejo, Gregory Wallace, Michael P. Short
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: I3TGS技术可实时监测铜基合金中自离子辐照产生的空位浓度演化，通过表面声波频率变化揭示空位动力学，与模拟结果一致。
...
- **arXiv**: [2602.19399](https://arxiv.org/abs/2602.19399)  ·  [PDF](https://arxiv.org/pdf/2602.19399.pdf)
- **Title (EN)**: Imaging the Superconducting Proximity Effect in S-S'-S Transition Edge Sensors
...
- **arXiv**: [2602.19438](https://arxiv.org/abs/2602.19438)  ·  [PDF](https://arxiv.org/pdf/2602.19438.pdf)
- **Title (EN)**: Pattern of indirect excitons in van der Waals heterostructure
- **Authors**: Zhiwen Zhou, L. H. Fowler-Gerace, W. J. Brunner, E. A. Szwed, L. V. Butov
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在MoSe2/WSe2范德华异质结中观察到空间间接激子形成准周期三角形图案，特征波长约2.6微米
...
- **arXiv**: [2602.19499](https://arxiv.org/abs/2602.19499)  ·  [PDF](https://arxiv.org/pdf/2602.19499.pdf)
- **Title (EN)**: Electron-electron and electron-phonon collision cross sections in CsV3Sb5
- **Authors**: Charles Menil, Andrea Capa Salinas, Stephen D. Wilson, Benoît Fauqué, Kamran Behnia
- **Categories**: cond-mat.str-el
- **TL;DR**: CsV3Sb5是一种具有中等电子关联和强电子-声子散射截面的金属性费米液体，满足维德曼-弗朗兹定律，电子-声子散射符合布洛赫-格吕奈森描述。
...
- **arXiv**: [2602.20058](https://arxiv.org/abs/2602.20058)  ·  [PDF](https://arxiv.org/pdf/2602.20058.pdf)
- **Title (EN)**: The effect of the A-site cation on the phase transition temperature of metal halide perovskites
...
- **TL;DR**: 提出多步热力学积分方法结合机器学习势能，准确计算有机金属卤化物钙钛矿相变自由能，发现相稳定性主要由基态能量差而非材料特异性热效应决定。
...
- **arXiv**: [2602.19356](https://arxiv.org/abs/2602.19356)  ·  [PDF](https://arxiv.org/pdf/2602.19356.pdf)
- **Title (EN)**: The X-ray absorption spectrum of the propargyl radical, C$_3$H$_3^{\cdot}$
- **Authors**: Dorothee Schaffner, Theo Juncker von Buchwald, Jacob Pedersen, Andreas Rasp, Emil Karaev, Valentin von Laffert, Alessio Bruno, Michele Alagia, Stefano Stranges, Ingo Fischer, Sonia Coriani
- **Categories**: physics.chem-ph
- **TL;DR**: 通过实验与计算结合研究丙炔自由基的NEXAFS光谱，揭示了其电子结构和振动特征
...
- **arXiv**: [2602.19865](https://arxiv.org/abs/2602.19865)  ·  [PDF](https://arxiv.org/pdf/2602.19865.pdf)
- **Title (EN)**: Separation of the Kibble-Zurek Mechanism from Quantum Criticality
- **Authors**: R. Jafari, Alireza Akbari
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, quant-ph
- **TL;DR**: Kibble-Zurek机制预测拓扑缺陷数量与淬火时间尺度呈幂律标度，但本文发现这种标度与量子临界点的对应关系并不普遍成立。
...
- **arXiv**: [2602.18712](https://arxiv.org/abs/2602.18712)  ·  [PDF](https://arxiv.org/pdf/2602.18712.pdf)
- **Title (EN)**: A ReaxFF-based thermomechanical analysis of N-carbophenes: phase-change, thermal expansion, and high temperature synthesis pathway
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: N-碳苯烯的热稳定性研究：通过反应分子动力学模拟发现其在1000K以上仍保持稳定，功能化可调控热膨胀性质，并发现从石墨烯到γ-石墨炔的相变路径。
...
- **arXiv**: [2602.19678](https://arxiv.org/abs/2602.19678)  ·  [PDF](https://arxiv.org/pdf/2602.19678.pdf)
- **Title (EN)**: Bridging atomic and mesoscopic length scales with Replica Scanning Tunneling Microscopy: Visualizing the intra-unit cell pair density modulation of superconducting FeSe at micron length scale
...
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall, cond-mat.other, cond-mat.str-el
- **TL;DR**: 提出Replica STM (R-STM)新方法，利用原子尺度电子态密度调制的复制信号，在微米尺度上高效追踪原子级特征，解决传统STM无法同时实现大范围与原子分辨率的问题。
...
- **arXiv**: [2602.19492](https://arxiv.org/abs/2602.19492)  ·  [PDF](https://arxiv.org/pdf/2602.19492.pdf)
- **Title (EN)**: Temporal magnon-qubit Mach-Zehnder interferometer
- **Authors**: Cody Trevillian, Steven Louis, Vasyl Tyberkevych
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 提出了一种基于微波量子比特与磁振子态可控纠缠的时间型磁振子-量子比特马赫-曾德尔干涉仪，用于研究单磁振子退相干
...
- **arXiv**: [2602.19586](https://arxiv.org/abs/2602.19586)  ·  [PDF](https://arxiv.org/pdf/2602.19586.pdf)
- **Title (EN)**: From Quantum Chaos to a Reversed Quantum Disentangled Liquid in a Disorder-Free Spin Ladder
- **Authors**: Hanieh Najafzadeh, Abdollah Langari
- **Categories**: cond-mat.str-el, cond-mat.stat-mech, quant-ph
- **TL;DR**: 该论文研究了无无序系统中的非热化现象，在自旋1/2梯子模型中发现了可重入的动力学相变，包括从可积到量子混沌再到非热态的反转量子解纠缠液体相，为无无序多体局域化提供了微观机制。
...
- **arXiv**: [2602.19411](https://arxiv.org/abs/2602.19411)  ·  [PDF](https://arxiv.org/pdf/2602.19411.pdf)
- **Title (EN)**: MACE-POLAR-1: A Polarisable Electrostatic Foundation Model for Molecular Chemistry
...
- **TL;DR**: 提出了一种结合长程静电相互作用和电荷转移的机器学习分子间势能模型，通过可学习的电荷/自旋密度和极化迭代，在保持计算效率的同时实现对不同电荷/自旋状态系统的准确描述。
...
- **arXiv**: [2602.18789](https://arxiv.org/abs/2602.18789)  ·  [PDF](https://arxiv.org/pdf/2602.18789.pdf)
- **Title (EN)**: EXAFS studies of the local environment of lead and selenium atoms in PbTe$_{1-x}$Se$_x$ solid solution
- **Authors**: A. I. Lebedev, I. A. Sluchinskaya, V. N. Demin, I. Munro
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用EXAFS光谱研究PbTe₁₋ₓSeₓ固溶体中铅和硒原子的局部环境，发现异常大的德拜-沃勒因子和偏离Vegard定律的现象，表明化学因素在固溶体结构中起重要作用。
...
- **arXiv**: [2602.19724](https://arxiv.org/abs/2602.19724)  ·  [PDF](https://arxiv.org/pdf/2602.19724.pdf)
- **Title (EN)**: Anisotropic fully-gapped superconductivity in quasi-one-dimensional Li$_{0.9}$Mo$_6$O$_{17}$
- **Authors**: M. J. Grant, T. M. Huijbregts, R. Nicholls, M. Greenblatt, P. Chudzinski, A. Carrington, N. E. Hussey
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: Li0.9Mo6O17的超导态具有无节点、各向异性全隙特征，支持自旋三重态配对，与高上临界场Hc2一致
...
- **arXiv**: [2602.19568](https://arxiv.org/abs/2602.19568)  ·  [PDF](https://arxiv.org/pdf/2602.19568.pdf)
- **Title (EN)**: Rashba Spin-Orbit Coupling Induced Topological Phases Transition in Honeycomb Nanoribbon Heterojunction
- **Authors**: Hao-Ru Wu, Jhih-Shih You, Yiing-Rei Chen, Hong-Yi Chen
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究Rashba自旋轨道耦合在蜂窝状纳米带异质结构中诱导拓扑相变和边缘态
...
- **arXiv**: [2602.19888](https://arxiv.org/abs/2602.19888)  ·  [PDF](https://arxiv.org/pdf/2602.19888.pdf)
- **Title (EN)**: A Physics-Regularized Neural Network and Kirchhoff Markov Random Field Framework for Inferring Internal Electrochemical States from Operando Spectromicroscopy
...
- **TL;DR**: 开发物理集成数据驱动分析框架，通过μ-XAFS高光谱数据估计锂离子电池复合电极内部电化学状态，揭示电解质浓度依赖的反应传播行为。
...
- **arXiv**: [2602.18840](https://arxiv.org/abs/2602.18840)  ·  [PDF](https://arxiv.org/pdf/2602.18840.pdf)
- **Title (EN)**: Beam-Offset Thermoreflectance with Bayesian Optimization to Measure the Anisotropic Thermal Properties of Semiconductor Superlattices
- **Authors**: A. Chatterjee, N. Spitzer, T. Kruck, P. Song, A. Ludwig, A. D. Wieck, J. Ordonez-Miranda, M. Pawlak
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出一种非接触式光束偏移频域热反射技术，可同时测量半导体超晶格的面内和面外热导率，结合贝叶斯优化将测量不确定度降至1-2%。
...
- **arXiv**: [2602.19791](https://arxiv.org/abs/2602.19791)  ·  [PDF](https://arxiv.org/pdf/2602.19791.pdf)
- **Title (EN)**: Machine learning protocol to identify pairing symmetries via quasiparticle interference imaging in Ising superconductors
- **Authors**: Adam Hložný, Jozef Haniš, Martin Gmitra, Marko Milivojević
- **Categories**: cond-mat.supr-con
- **TL;DR**: 机器学习辅助的准粒子干涉分析为精确学习量子材料中的超导配对对称性提供新途径
...
- **arXiv**: [2602.19693](https://arxiv.org/abs/2602.19693)  ·  [PDF](https://arxiv.org/pdf/2602.19693.pdf)
- **Title (EN)**: Optical properties of single CsPbBr3 perovskite quantum dots synthesized by a modified ligand-assisted reprecipitation method
...
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 改良LARP法合成CsPbBr3钙钛矿量子点，在单量子点尺度上实现优异光学性能，包括稳定发射、最小光谱扩散、高纯度单光子发射等，为热注入法提供更灵活替代方案。
...
- **arXiv**: [2602.19795](https://arxiv.org/abs/2602.19795)  ·  [PDF](https://arxiv.org/pdf/2602.19795.pdf)
- **Title (EN)**: Floquet product mode and eigenphase order
- **Authors**: Felix Möckel, Harald Schmid, Felix von Oppen
- **Categories**: cond-mat.str-el, quant-ph
- **TL;DR**: 研究Floquet量子伊辛模型在破坏可积性扰动下的鲁棒性，重点关注同时存在Majorana零模和π模的相。发现Floquet乘积模比单个Majorana边缘模更稳健，这可以通过有限开边界链的本征相位序和四重态谱统计来解释。
...
- **arXiv**: [2602.19977](https://arxiv.org/abs/2602.19977)  ·  [PDF](https://arxiv.org/pdf/2602.19977.pdf)
- **Title (EN)**: High-Accuracy Molecular Simulations with Machine-Learning Potentials and Semiclassical Approximations to Quantum Dynamics
- **Authors**: Valerii Andreichev, Jindra Dušek, Markus Meuwly, Jeremy O. Richardson
- **Categories**: physics.chem-ph
- **TL;DR**: 机器学习方法构建高精度势能面，结合微扰修正瞬子理论实现高效量子动力学模拟
...
- **arXiv**: [2602.19992](https://arxiv.org/abs/2602.19992)  ·  [PDF](https://arxiv.org/pdf/2602.19992.pdf)
- **Title (EN)**: The interplay of cation/anion and monovalent/divalent selectivity in negatively charged nanopores: local charge inversion and anion leakage
...
- **TL;DR**: 该研究使用Nernst-Planck+局部平衡蒙特卡洛框架，揭示了宽纳米孔中异常摩尔分数效应的微观机制，发现表面电荷模型的关键参数（最近距离和网格间距）决定电荷反转、阴离子泄漏和离子迁移率之间的微妙平衡。
...
- **arXiv**: [2602.18855](https://arxiv.org/abs/2602.18855)  ·  [PDF](https://arxiv.org/pdf/2602.18855.pdf)
- **Title (EN)**: Layer-number parity induced topological phase transition
- **Authors**: Kai Chen, Junyan Guan, Jiamin Guo, He Gao, Zhongming Gu, Jie Zhu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过堆叠拓扑平凡层并在对称性约束下，可实现涌现拓扑相，其中层数本身成为拓扑开关，奇数层系统支持拓扑束缚态连续体。
...
- **arXiv**: [2602.19920](https://arxiv.org/abs/2602.19920)  ·  [PDF](https://arxiv.org/pdf/2602.19920.pdf)
- **Title (EN)**: Periodic drive induced unconventional superconductivity in a half-filled system
- **Authors**: Suryashekhar Kusari, Arti Garg
- **Categories**: cond-mat.supr-con
- **TL;DR**: 通过Floquet工程在二分量晶格上实现半填充系统的非常规d波超导，无需化学掺杂
...
- **arXiv**: [2602.19749](https://arxiv.org/abs/2602.19749)  ·  [PDF](https://arxiv.org/pdf/2602.19749.pdf)
- **Title (EN)**: Quantum Resource Theory of Lasers
- **Authors**: Yannik Brune, Marius Cizauskas, Marc Aßmann
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 该研究从资源理论角度探讨激光的量子相干性，发现自发辐射和退相后激光场态的纯度限制了激光的最大量子相干性，并证明这种相干性直接影响量子比特初始化纯度。
...
- **arXiv**: [2602.19935](https://arxiv.org/abs/2602.19935)  ·  [PDF](https://arxiv.org/pdf/2602.19935.pdf)
- **Title (EN)**: Anisotropic magnons in a layered honeycomb ferromagnet
- **Authors**: Travis J. Williams, Douglas L. Abernathy, Mark D. Lumsden, Jiaqiang Yan, Andrew D. Christianson
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过详细中子散射测量发现，CrSiTe₃中的狄拉克磁振子能隙可能非常小或不存在，先前测量结果受实验因素干扰。研究还揭示了该材料在剥离为单层时磁性转变温度升高的原因，以及通过狄拉克点的面外方向各向异性磁振子特性。
...
- **arXiv**: [2602.20140](https://arxiv.org/abs/2602.20140)  ·  [PDF](https://arxiv.org/pdf/2602.20140.pdf)
- **Title (EN)**: PackFlow: Generative Molecular Crystal Structure Prediction via Reinforcement Learning Alignment
...
- **Categories**: physics.chem-ph
- **TL;DR**: PackFlow是一个用于分子晶体结构预测的流匹配框架，通过联合采样笛卡尔坐标和晶胞参数生成晶体结构，并通过物理对齐技术提高生成质量。
...
- **arXiv**: [2602.18954](https://arxiv.org/abs/2602.18954)  ·  [PDF](https://arxiv.org/pdf/2602.18954.pdf)
- **Title (EN)**: Work-hardening exhaustion as the origin of low toughness in L-PBF alloys: A case study on the role of intrinsic vs. extrinsic defects in SS316L
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: L-PBF增材制造合金虽然具有高强度和高延展性，但断裂韧性显著低于传统锻造材料。研究发现这并非由加工缺陷或残余应力引起，而是由于L-PBF材料过早达到加工硬化饱和，无法通过塑性变形钝化裂纹尖端，导致从韧性断裂向脆性断裂转变。
...
- **arXiv**: [2602.20148](https://arxiv.org/abs/2602.20148)  ·  [PDF](https://arxiv.org/pdf/2602.20148.pdf)
- **Title (EN)**: Vortex Tunneling and Critical State in an Oxide Heterostructure
...
- **TL;DR**: 在KTaO₃表面二维超导体中研究涡旋介导的输运，发现多个涡旋输运区域，包括量子隧穿和热激活行为的转变，以及不同钉扎构型导致的丰富开关电流分布。
...
- **arXiv**: [2602.19796](https://arxiv.org/abs/2602.19796)  ·  [PDF](https://arxiv.org/pdf/2602.19796.pdf)
- **Title (EN)**: Transcendental momentum quantization in semiconducting Rashba nanowires and zero energy states in their normal and superconducting phase
- **Authors**: Nico Leumer, Harald Schmid, Milena Grifoni, Magdalena Marganska
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究半导体纳米线在Rashba自旋轨道耦合下的有限系统性质，包括孤立线和超导邻近效应情况，分析本征态组成、量子化条件及零能态特性。
...
- **arXiv**: [2602.19972](https://arxiv.org/abs/2602.19972)  ·  [PDF](https://arxiv.org/pdf/2602.19972.pdf)
- **Title (EN)**: Non Fermi liquid signatures across strain engineered metal-insulator transition in line-graph lattices
- **Authors**: Shashikant Singh Kunwar, Madhuparna Karmakar
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 该论文研究应变调控下Lieb/Kagome线图晶格中的相变，通过非微扰计算揭示了电子相互作用-应变-温度空间中的低温相和热转变尺度。
...
- **arXiv**: [2602.18979](https://arxiv.org/abs/2602.18979)  ·  [PDF](https://arxiv.org/pdf/2602.18979.pdf)
- **Title (EN)**: A computationally efficient approach for predicting the transport properties of transition-metal alloys at elevated temperatures
- **Authors**: Akshay Korpe, Manish Sudan, Ishtiaque K. Robin, Bikram Bhatia, Garrett Pataky, Thomas Berfield, Osman El-Atwani, Enrique Martinez
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种预测体心立方过渡金属浓缩合金热电性质的新现象学框架，可在300-1300K温度范围内有效估算电阻率、热导率和比热容。
...
- **arXiv**: [2602.19894](https://arxiv.org/abs/2602.19894)  ·  [PDF](https://arxiv.org/pdf/2602.19894.pdf)
- **Title (EN)**: Kerr-like effect induced by quantum-metric nematicity
- **Authors**: Wenhao Liang, Akito Daido, K. T. Law
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在二维非磁系统中，量子度规的向列性（对应电子波包的电四极矩）可以产生类似克尔效应的偏振旋转效应，无需磁序或自旋轨道耦合。
...
- **arXiv**: [2602.20073](https://arxiv.org/abs/2602.20073)  ·  [PDF](https://arxiv.org/pdf/2602.20073.pdf)
- **Title (EN)**: Coexisting magnetic, charge, and superconducting orders in the two-dimensional Hubbard model
- **Authors**: Robin Scholle, Pietro M. Bonetti, Walter Metzner, Demetrio Vilardi
- **Categories**: cond-mat.str-el
- **TL;DR**: 对二维排斥哈伯德模型进行重整化平均场研究，揭示磁性、电荷和超导序的复杂相互作用与共存现象
...
- **arXiv**: [2602.19036](https://arxiv.org/abs/2602.19036)  ·  [PDF](https://arxiv.org/pdf/2602.19036.pdf)
- **Title (EN)**: Hidden Chiral Ferroelectricity in AgNbO$_3$ Perovskite
- **Authors**: Ying Song, Lingzhi Cao, Jinming Zhai, Zhilong Yang, Yali Yang, Laurent Bellaiche, Jiangang He
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: AgNbO₃存在未报道的手性铁电相R3，具有大自发极化和低极化翻转势垒，可实现电场控制手性光学响应
...
- **arXiv**: [2602.19076](https://arxiv.org/abs/2602.19076)  ·  [PDF](https://arxiv.org/pdf/2602.19076.pdf)
- **Title (EN)**: Giant Out-of-Plane Magnetic Orbital Torque of Altermagnets from Spin-Group Symmetry Breaking
- **Authors**: Xukun Feng, Lay Kee Ang, Shengyuan A. Yang, Cong Xiao, X. C. Xie
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 该论文揭示了反铁磁体中的磁轨道力矩效应，这是一种由自旋群对称性破缺和自旋轨道耦合共同产生的新效应，能够产生非常规的面外轨道电流，用于无磁场操控垂直磁化。
...
- **arXiv**: [2406.13610](https://arxiv.org/abs/2406.13610)  ·  [PDF](https://arxiv.org/pdf/2406.13610.pdf)
- **Title (EN)**: Towards the optimization of a perovskite-based room temperature ozone sensor: A multifaceted approach in pursuit of sensitivity, stability, and understanding of mechanism
...
- **TL;DR**: 该研究评估了金属卤化物钙钛矿的气体传感性能与长期稳定性，发现卤化物组成影响传感类型（Br-rich为p型，Cl-based为n型），Mn掺杂通过促进气体吸附显著提升臭氧传感性能，为设计低成本、高性能、耐用的室温气体传感器提供了指导。
...
- **arXiv**: [2602.19153](https://arxiv.org/abs/2602.19153)  ·  [PDF](https://arxiv.org/pdf/2602.19153.pdf)
- **Title (EN)**: Constrained Diffusion for Accelerated Structure Relaxation of Inorganic Solids with Point Defects
...
- **TL;DR**: 提出一种用于模拟点缺陷的生成框架，通过约束感知扩散模型超越传统第一性原理模拟的限制，在Bi2Te3的六种缺陷配置中实现最先进性能
...
- **arXiv**: [2602.19181](https://arxiv.org/abs/2602.19181)  ·  [PDF](https://arxiv.org/pdf/2602.19181.pdf)
- **Title (EN)**: Specific features of the magnetic-field dependences of electrical resistivity in Bi--Mn solid solutions with low Mn content
- **Authors**: A. V. Terekhov, V. M. Yarovyi, Yu. A. Kolesnichenko, K. Rogacki, E. Lähderanta, E. V. Khristenko, A. L. Solovjov
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 首次研究高锰含量Bi₈₈.₀₈Mn₁₁.₉₂样品的磁阻场依赖关系，发现其与低锰含量样品在低温下差异显著，高温下趋于一致，最大磁阻值低于低锰样品
...
- **arXiv**: [2602.19283](https://arxiv.org/abs/2602.19283)  ·  [PDF](https://arxiv.org/pdf/2602.19283.pdf)
- **Title (EN)**: Unraveling the temperature-responsive charge-disproportionation in BaBiO$_3$
- **Authors**: Sumit Sarkar, Priyanka Yadav, Sourav Chowdhury, Rajamani Raghunathan, Ram Janay Choudhary
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: BaBiO₃中Bi位点的电荷歧化随温度变化，低温下Bi-O杂化减弱，电荷转移增强，导致更离子性的静态电荷歧化
...
- **arXiv**: [2602.19347](https://arxiv.org/abs/2602.19347)  ·  [PDF](https://arxiv.org/pdf/2602.19347.pdf)
- **Title (EN)**: Dual energy-differentiated topological transition in artificial red phosphorus chains
- **Authors**: Vít Jakubský, B. Manjarrez-Montañez, Rafael A. Méndez-Sánchez, Yonatan Betancur-Ocampo
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究红磷原子链的谱学和输运性质，揭示了平带态分离、解析能带计算、非平凡拓扑性质，以及能量依赖的拓扑相变和边缘态存在。
...
- **arXiv**: [2602.19592](https://arxiv.org/abs/2602.19592)  ·  [PDF](https://arxiv.org/pdf/2602.19592.pdf)
- **Title (EN)**: Improving Reliability of Machine Learned Interatomic Potentials With Physics-Informed Pretraining
- **Authors**: Qianyu Zheng, Victor Fung
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出一种基于物理知识的预训练策略，利用简单物理势能提升图神经网络分子动力学势能模型的鲁棒性和稳定性
...
- **arXiv**: [2602.19734](https://arxiv.org/abs/2602.19734)  ·  [PDF](https://arxiv.org/pdf/2602.19734.pdf)
- **Title (EN)**: Twist-induced altermagnetism in a metallic van der Waals antiferromagnet
- **Authors**: Alberto M. Ruiz, Andrei Shumilin, Rafael González-Hernández, José J. Baldoví
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 通过扭曲工程在二维金属反铁磁材料Fe₂CoGaTe₂中实现交替磁性，产生138 meV的自旋劈裂，为下一代自旋电子器件提供平台
...
- **arXiv**: [2602.19617](https://arxiv.org/abs/2602.19617)  ·  [PDF](https://arxiv.org/pdf/2602.19617.pdf)
- **Title (EN)**: Rotational anisotropy Raman spectrometer for high-sensitivity crystallographic symmetry analysis
- **Authors**: Di Cheng, Junxiang Li, Shizhuo Luo, Zehao Chen, Xinwei Li
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出旋转各向异性拉曼光谱（RA-Raman），通过全方位角旋转测量克服传统偏振拉曼的限制，实现拉曼张量的完整重构和对称性信息的精确提取。
...
- **arXiv**: [2602.19630](https://arxiv.org/abs/2602.19630)  ·  [PDF](https://arxiv.org/pdf/2602.19630.pdf)
- **Title (EN)**: Coherent Phonon-Driven Band Renormalizations in 1T$'$-MoTe$_2$
- **Authors**: Carl E. Jensen, Christoph Emeis, Stephan Jauernik, Petra Hein, Fabio Caruso, Michael Bauer
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用时间-角度分辨光电子能谱和频域分析研究1T'-MoTe₂中的电子-声子耦合，发现不同声子模式和电子能带的选择性耦合
...
- **arXiv**: [2602.19640](https://arxiv.org/abs/2602.19640)  ·  [PDF](https://arxiv.org/pdf/2602.19640.pdf)
- **Title (EN)**: Theory of strained quantum emitters
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理计算研究4H-SiC中硅空位缺陷在应变下的振动结构和发射光谱变化，发现不同振动模式对应变响应不同，应变可提高Debye-Waller因子，并实现无磁场应变检测。
...
- **arXiv**: [2602.19642](https://arxiv.org/abs/2602.19642)  ·  [PDF](https://arxiv.org/pdf/2602.19642.pdf)
- **Title (EN)**: Investigation of Corroded T91 Steel in Static Lead-Bismuth Eutectic Under an Oxidising Environment
- **Authors**: Minyi Zhang, Weiyue Zhou, Michael P. Short, Paul A. J. Bagot, Michael P. Moody, Felix Hofmann
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究液态铅铋共晶(LBE)在高温氧化条件下对铁素体/马氏体钢的腐蚀机制，发现腐蚀沿晶界进行，Cr和氧扩散是关键因素，表面形成富铁BCC相而非氧化物层。
...
- **arXiv**: [2602.19713](https://arxiv.org/abs/2602.19713)  ·  [PDF](https://arxiv.org/pdf/2602.19713.pdf)
- **Title (EN)**: Strain- and Field-Tunable Nonrelativistic Spin Splitting and Wave-Symmetry-Dependent Spin Transport in Twisted Bilayer Altermagnets
- **Authors**: Shantanu Pathak, Saswata Bhattacharya
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过扭曲双层反铁磁或铁磁单层材料，打破对称性实现非相对论性自旋分裂，无需自旋轨道耦合即可产生高效自旋输运。
...
- **arXiv**: [2602.19793](https://arxiv.org/abs/2602.19793)  ·  [PDF](https://arxiv.org/pdf/2602.19793.pdf)
- **Title (EN)**: Bismuth-substituted Lutetium Iron Garnet Films with Giant Visible-Range Magneto-Optical Sensitivity
...
- **TL;DR**: 该论文报道了铋取代镥铁石榴石(LuBiIG)的生长和磁光特性，该材料在520nm附近表现出高达-0.120 deg/um/mT的极高费尔德常数，适用于先进低温检测和混合量子应用。
...
- **arXiv**: [2602.19820](https://arxiv.org/abs/2602.19820)  ·  [PDF](https://arxiv.org/pdf/2602.19820.pdf)
- **Title (EN)**: Interface stability of beta-Ga2O3 (100) on oxidized Si- and C-terminated 3C-SiC (001) substrates: a first-principles investigation
- **Authors**: Marica Licciardi, Aldo Ugolotti, Emilio Scalise, Leo Miglio
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理模拟研究β-Ga₂O₃/3C-SiC界面结构，考虑3C-SiC(001)表面氧化重构，分析不同堆叠序列和原子键合排列，计算界面粘附能评估热力学稳定性。
...
- **arXiv**: [2602.19932](https://arxiv.org/abs/2602.19932)  ·  [PDF](https://arxiv.org/pdf/2602.19932.pdf)
- **Title (EN)**: Automated structure discovery for Tip Enhanced Raman Spectroscopy
- **Authors**: Harshit Sethi, Markus Junttila, Orlando J Silveira, Adam S Foster
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出基于编码器-解码器模型的机器学习方法，直接从模拟TERS图像预测分子结构，实现分子识别的自动化
...
- **arXiv**: [2602.19955](https://arxiv.org/abs/2602.19955)  ·  [PDF](https://arxiv.org/pdf/2602.19955.pdf)
- **Title (EN)**: Electronic structure of Graphene/Co interfaces
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究利用光电子能谱和低能电子衍射研究了石墨烯-铁磁系统（G/Co/Ir(111)）的电子和结构特性，发现石墨烯的价带主要反映与Co d态的杂化，而C 1s谱线形状对石墨烯层的起伏和碳原子与底层Co的配位非常敏感。
...
- **arXiv**: [2602.20033](https://arxiv.org/abs/2602.20033)  ·  [PDF](https://arxiv.org/pdf/2602.20033.pdf)
- **Title (EN)**: Cr3+ spin dynamics under the octahedral crystal field in van der Waals antiferromagnets
- **Authors**: Rabindra Basnet, Subhashree Chatterjee, Paul Kigaya, Ezana Negusse, J. van Tol, Ramesh C. Budhani
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: CuCrP2S6 (CCPS) 是一种范德华多铁材料，通过磁化率和太赫兹磁共振测量揭示了其Cr3+离子的准二维反铁磁动力学，主要由各向同性的Cr-Cr交换相互作用主导，在尼尔温度以上仍存在短程磁有序。
...
- **arXiv**: [2602.20121](https://arxiv.org/abs/2602.20121)  ·  [PDF](https://arxiv.org/pdf/2602.20121.pdf)
- **Title (EN)**: Tunable dislocations overcome mechano-functional tradeoff in perovskite oxides
- **Authors**: Jiawen Zhang, Wenjun Lu, Xufei Fang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: KTaO3陶瓷中位错密度调控实现脆-韧-脆转变，位错密度约10^14 m⁻²时获得超20%塑性应变，同时位错密度单调降低热导率，揭示力学强度与功能性的权衡关系。
...
- **arXiv**: [2602.20129](https://arxiv.org/abs/2602.20129)  ·  [PDF](https://arxiv.org/pdf/2602.20129.pdf)
- **Title (EN)**: Microstructural Evolution and Crystallization Behavior of Amorphous Medium-Entropy Ti-Nb-Zr-Ag Thin Films
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究通过磁控溅射制备Ti-Nb-Zr和Ti-Nb-Zr-Ag中熵合金薄膜，发现添加Ag可促进早期结晶并增强薄膜的热稳定性，形成具有抗菌功能和多级表面结构的生物医学涂层。
...
- **arXiv**: [2602.20142](https://arxiv.org/abs/2602.20142)  ·  [PDF](https://arxiv.org/pdf/2602.20142.pdf)
- **Title (EN)**: Role of octahedral tilting induced acoustic softening on limiting thermal transport in SrSnO3
