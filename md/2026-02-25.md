---
title: "arXiv Daily · 2026-02-25 · 9 papers"
date: 2026-02-25
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-02-25 · 9 papers

### OrgFlow: Generative Modeling of Organic Crystal Structures from Molecular Graphs
- **arXiv**: [2602.20195](https://arxiv.org/abs/2602.20195)  ·  [PDF](https://arxiv.org/pdf/2602.20195.pdf)
- **Title (EN)**: OrgFlow: Generative Modeling of Organic Crystal Structures from Molecular Graphs
- **Authors**: Mohammadmahdi Vahediahmar, Matthew A. McDonald, Feng Liu
- **Categories**: cond-mat.mtrl-sci, cs.LG
- **TL;DR**: 提出一种基于流匹配的有机晶体结构预测模型，直接从分子图生成晶体结构，性能比现有基线提升10倍以上
...
- **arXiv**: [2602.20385](https://arxiv.org/abs/2602.20385)  ·  [PDF](https://arxiv.org/pdf/2602.20385.pdf)
- **Title (EN)**: Demonstration of High-Performance Ultra-Wide Bandgap SrSnO$_3$ Top-Gated MOSFETs
...
- **TL;DR**: 该论文展示了基于超宽带隙钙钛矿氧化物SrSnO₃的高性能顶栅MOSFET，具有超过65 cm²/V·s的场效应迁移率、194 mA/mm的导通电流、10⁸以上的开关比和0.66 Ω·mm的接触电阻。
...
- **arXiv**: [2602.20432](https://arxiv.org/abs/2602.20432)  ·  [PDF](https://arxiv.org/pdf/2602.20432.pdf)
- **Title (EN)**: Self-driving thin film laboratory: autonomous epitaxial atomic-layer synthesis via real-time computer vision analysis of electron diffraction
- **Authors**: Haotong Liang, Yunlong Sun, Ryan Paxson, Chih-Yu Lee, Alex T. Hall, Zoey Warecki, John Cumings, Hideomi Koinuma, Aaron Gilad Kusne, Mikk Lippmaa, Ichiro Takeuchi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: AI自主导航系统在材料合成中实现实时闭环优化，将实验次数减少30倍以上
...
- **arXiv**: [2602.20485](https://arxiv.org/abs/2602.20485)  ·  [PDF](https://arxiv.org/pdf/2602.20485.pdf)
- **Title (EN)**: Propagation of elastic waves in a flexomagnetic solid
- **Authors**: Swarnava Ghosh
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 该论文提出了考虑微结构和应变梯度相互作用的线性弹性挠曲磁性材料中弹性波传播的理论，揭示了挠曲磁性和微结构导致的反常波传播现象。
...
- **arXiv**: [2602.20320](https://arxiv.org/abs/2602.20320)  ·  [PDF](https://arxiv.org/pdf/2602.20320.pdf)
- **Title (EN)**: Environment-Induced Exciton Renormalization in the Photosystem II Reaction Center
- **Authors**: Tucker Allen, Barry Y. Li, Nadine C. Bradbury, Daniel Neuhauser
- **Categories**: physics.chem-ph
- **TL;DR**: 该论文开发了基于随机采样技术的Bethe-Salpeter方程计算方法，成功应用于包含3238个价电子的光系统II反应中心蛋白-染料复合物的从头算研究。
...
- **arXiv**: [2602.20203](https://arxiv.org/abs/2602.20203)  ·  [PDF](https://arxiv.org/pdf/2602.20203.pdf)
- **Title (EN)**: Casimir-Polder energy landscape: Unipolarizable atom and ring
- **Authors**: Niranjan Warnakulasooriya, John Joseph Marchetta, Prachi Parashar, K. V. Shajesh
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 推导了单极化点原子与单极化介质环之间卡西米尔-波尔德相互作用的广义解析表达式，适用于原子在环对称轴外的任意位置。
...
- **arXiv**: [2602.20265](https://arxiv.org/abs/2602.20265)  ·  [PDF](https://arxiv.org/pdf/2602.20265.pdf)
- **Title (EN)**: Qubit Noise Spectroscopy of Superconducting Dynamics in a Magnetic Field
...
- **TL;DR**: 该研究利用单自旋量子比特的退极化率测量磁噪声，揭示了外加磁场下二维超导体中配对涨落和涡旋动力学的丰富动态现象。
...
- **arXiv**: [2602.20738](https://arxiv.org/abs/2602.20738)  ·  [PDF](https://arxiv.org/pdf/2602.20738.pdf)
- **Title (EN)**: A Novel NPT Thermodynamic Integration Scheme to Derive Rigorous Gibbs Free Energies for Crystalline Solids
...
- **TL;DR**: 提出了一种新的两步法NPT热力学积分方案，消除了传统方法中需要近似NVT-to-NPT校正的步骤，通过引入考虑完整晶胞涨落的NPT参考态，实现了更精确的固体吉布斯自由能计算。
...
- **arXiv**: [2602.20256](https://arxiv.org/abs/2602.20256)  ·  [PDF](https://arxiv.org/pdf/2602.20256.pdf)
- **Title (EN)**: Spectral Decimation of Quantum Many-Body Hamiltonians
...
- **TL;DR**: 提出光谱减缩理论作为量子多体哈密顿量的系统性诊断工具，通过识别特征对称性扇区来探测统计混合谱中的涌现对称性。
