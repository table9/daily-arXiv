---
title: "arXiv Daily · 2026-03-11 · 64 papers"
date: 2026-03-11
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-03-11 · 64 papers

### Rényi exponent landscape of multipartite entanglement in free-fermion systems
- **arXiv**: [2603.08991](https://arxiv.org/abs/2603.08991)  ·  [PDF](https://arxiv.org/pdf/2603.08991.pdf)
- **Title (EN)**: Rényi exponent landscape of multipartite entanglement in free-fermion systems
...
- **arXiv**: [2603.09124](https://arxiv.org/abs/2603.09124)  ·  [PDF](https://arxiv.org/pdf/2603.09124.pdf)
- **Title (EN)**: Canonical Criterion for Third-Order Transitions
- **Authors**: Fangfang Wang, Wei Liu, Kai Qi, Zidong Cui, Ying Tang, Zengru Di
- **Categories**: cond-mat.stat-mech, math-ph
- **TL;DR**: 提出基于涨落的规范框架来识别三阶相变，通过累积量比准则定义其规范对应物，并与微正则分类建立渐近联系。
...
- **arXiv**: [2603.09694](https://arxiv.org/abs/2603.09694)  ·  [PDF](https://arxiv.org/pdf/2603.09694.pdf)
- **Title (EN)**: Asymmetric simple exclusion process with tree-like network branches
- **Authors**: Yuki Ishiguro, Yasunobu Ando
- **Categories**: cond-mat.stat-mech, math-ph
- **TL;DR**: 将ASEP扩展到具有树状分支的一维主干网络模型，推导精确稳态分布，研究网络几何结构对输运性质的影响
...
- **arXiv**: [2603.09841](https://arxiv.org/abs/2603.09841)  ·  [PDF](https://arxiv.org/pdf/2603.09841.pdf)
- **Title (EN)**: Diffusive flux into a stochastically gated tube
- **Authors**: Sean D Lawley
- **Categories**: cond-mat.stat-mech, math.AP, math.PR
- **TL;DR**: 扩展了随机门控扩散反应模型，使其适用于非窄管和不同扩散系数的三维几何情况，推导了精确的通量估计公式
...
- **arXiv**: [2603.08891](https://arxiv.org/abs/2603.08891)  ·  [PDF](https://arxiv.org/pdf/2603.08891.pdf)
- **Title (EN)**: Intrinsic magnetization of the superconducting condensate in Fe(Te,Se)
- **Authors**: Mohammad Javadi Balakan, Shiva Heidari, Genda Gu, Qiang Li, Kenji Watanabe, Takashi Taniguchi, Ji Ung Lee
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.other, cond-mat.str-el
- **TL;DR**: 在Fe(Te,Se)介观环中观察到自旋极化超导凝聚体的内在磁场，表现为超导量子振荡相位中的线性电流依赖和双通量量子化效应。
...
- **arXiv**: [2603.09707](https://arxiv.org/abs/2603.09707)  ·  [PDF](https://arxiv.org/pdf/2603.09707.pdf)
- **Title (EN)**: Optical frequency comb double-resonance spectroscopy of the 9030-9175 cm$^{-1}$ states of ethylene
- **Authors**: Adrian Hjältén, Vinicius Silva de Oliveira, Yuan Cao, Isak Silander, Kevin K. Lehmann, Aleksandra Foltynowicz
- **Categories**: physics.chem-ph
- **TL;DR**: 首次使用光学-光学双共振光谱测量乙烯在3000-9000 cm⁻¹能量范围内的热带跃迁，报告了90个梯型热带跃迁的中心频率和相对强度。
...
- **arXiv**: [2603.09081](https://arxiv.org/abs/2603.09081)  ·  [PDF](https://arxiv.org/pdf/2603.09081.pdf)
- **Title (EN)**: A multi-phase-field model for fiber-reinforced composite laminates based on puck failure theory
- **Authors**: Pavan Kumar Asur Vijaya Kumar, Rafael Fleischhacker, Aamir Dean, Heinz E Pettermann
- **Categories**: physics.comp-ph
- **TL;DR**: 提出了一种基于Puck失效理论的多相场模型，用于预测纤维增强复合材料层合板的失效行为，通过二维多场模型结合网格叠加方法计算不同铺层方向的损伤。
...
- **arXiv**: [2603.08777](https://arxiv.org/abs/2603.08777)  ·  [PDF](https://arxiv.org/pdf/2603.08777.pdf)
- **Title (EN)**: Thermal Hall conductivity from semiclassical spin dynamics simulations: implementation and applications to chiral ferromagnets and Kitaev magnets
- **Authors**: Ignacio Salgado-Linares, Alexander Mook, Léo Mangeolle, Johannes Knolle
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 该研究使用半经典自旋动力学模拟研究磁性系统中的热霍尔输运，通过线性响应框架计算热霍尔电导率，并在手性磁体和反铁磁Kitaev模型中验证方法的有效性。
...
- **arXiv**: [2603.08786](https://arxiv.org/abs/2603.08786)  ·  [PDF](https://arxiv.org/pdf/2603.08786.pdf)
- **Title (EN)**: Pfaffian-based topological invariants for one dimensional semiconductor-superconductor heterostructures
- **Authors**: Binayyak B. Roy, William B. Cason, Nimish Sharma, Sumanta Tewari
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文回顾了基于Pfaffian的$\mathbb{Z}_2$拓扑不变量在一维半导体-超导体纳米线异质结构中的应用，并阐明了它们在有限和含无序系统中的有效性。
...
- **arXiv**: [2603.08851](https://arxiv.org/abs/2603.08851)  ·  [PDF](https://arxiv.org/pdf/2603.08851.pdf)
- **Title (EN)**: Weyl-Transition-Driven Giant Reversible Orbital Hall Conductivity
- **Authors**: Bo Zhao, Hao Wang, Wei Ren, Hongbin Zhang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文发现倾斜Weyl交叉点通过产生不对称的轨道贝里曲率分布，可在零阶产生巨大轨道霍尔电导，并在PtBi₂单层中通过应变实现Weyl相变和轨道霍尔电导的可逆符号反转。
...
- **arXiv**: [2603.09850](https://arxiv.org/abs/2603.09850)  ·  [PDF](https://arxiv.org/pdf/2603.09850.pdf)
- **Title (EN)**: Non-equilibrium generalized Langevin equation for multi-dimensional observables
- **Authors**: Benjamin J. A. Héry, Lucas Tepper, Andrea Guljas, Artem Pavlov, Beate Koksch, Cecilia Clementi, Roland R. Netz
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文基于Mori-Zwanzig形式，推导了非平衡态下多维可观测量$\vec{A}$的广义朗之万方程，包含马尔可夫力、非马尔可夫摩擦力和正交随机力，并研究了三种极限情况下的方程结构。
...
- **arXiv**: [2603.09422](https://arxiv.org/abs/2603.09422)  ·  [PDF](https://arxiv.org/pdf/2603.09422.pdf)
- **Title (EN)**: Temporal Berry Phase and the Emergence of Bose-Glass-Analog Phase in a Clean U(1) Superfluid
- **Authors**: Ryuichi Shindou, Pengwei Zhao, Xiaonuo Fang
- **Categories**: cond-mat.supr-con, cond-mat.quant-gas, cond-mat.stat-mech, cond-mat.str-el
- **TL;DR**: 该论文研究了具有时间Berry相的U(1)非线性σ模型，发现时间Berry相导致时空各向异性的涡旋增殖干涉，产生具有短程空间序但保持时间相位相干性的准无序相，该相与无序玻色子系统中的玻色玻璃相具有相同的超流相相关特性。
...
- **arXiv**: [2603.09713](https://arxiv.org/abs/2603.09713)  ·  [PDF](https://arxiv.org/pdf/2603.09713.pdf)
- **Title (EN)**: Vibrational strong coupling influences product selectivity in a model for post transition state bifurcation reactions
- **Authors**: Subhadip Mondal, Atul Kumar, Srihari Keshavamurthy
- **Categories**: physics.chem-ph, physics.app-ph
- **TL;DR**: 该研究通过将后过渡态分叉反应模型与光学腔耦合，揭示了振动强耦合条件下反应产物选择性的显著改变，分支比可增强近两倍，并展示了腔量子电动力学在调控复杂势能面反应动力学方面的潜力。
...
- **arXiv**: [2603.09410](https://arxiv.org/abs/2603.09410)  ·  [PDF](https://arxiv.org/pdf/2603.09410.pdf)
- **Title (EN)**: Infrared spectroscopy of protonated water clusters via the quantum thermal bath method and highly accurate machine-learned potentials
- **Authors**: T. Baird, R. Vuilleumier, S. Bonella
- **Categories**: physics.comp-ph
- **TL;DR**: 使用机器学习势能面和量子热浴方法计算质子化水团簇红外光谱，提供比传统量子动力学更经济准确的计算方案
...
- **arXiv**: [2603.08934](https://arxiv.org/abs/2603.08934)  ·  [PDF](https://arxiv.org/pdf/2603.08934.pdf)
- **Title (EN)**: Proximate Spin Liquid Ground State Arising from Competing Stripy and 120$^{\circ}$ Spin Correlations in the Triangular Quantum Antiferromagnet ErMgGaO$_4$
...
- **TL;DR**: ErMgGaO₄是一种量子反铁磁体，在约2.5K处显示自旋玻璃转变，具有二维条纹序和120°序共存，低能激发可用J₁-J₂-Δ三角晶格模型描述，接近自旋液体和条纹序相的量子相边界。
...
- **arXiv**: [2603.09295](https://arxiv.org/abs/2603.09295)  ·  [PDF](https://arxiv.org/pdf/2603.09295.pdf)
- **Title (EN)**: Structural and electronic signatures of strain-tunable marginally twisted bilayer graphene
- **Authors**: Pei Ouyang, Jiawei Yu, Qian Li, Guihao Jia, Yuyang Wang, Kebin Xiao, Hongyun Zhang, Zhiqiang Hu, Pierre A. Pantaleón, Zhen Zhan, Shuyun Zhou, Francisco Guinea, Qi-Kun Xue, Wei Li
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 实验研究了小扭转角（0.06°-0.35°）双层石墨烯，发现AA堆叠区有高度局域化电子态，AB区显示均匀多峰结构，并识别出两种应变诱导的畴壁类型及其电子特性。
...
- **arXiv**: [2603.08855](https://arxiv.org/abs/2603.08855)  ·  [PDF](https://arxiv.org/pdf/2603.08855.pdf)
- **Title (EN)**: Ground-State Structure Search of Defective High-Entropy Alloys Using Machine-Learning Potentials and Monte Carlo Sampling
- **Authors**: Siya Zhu, Raymundo Arroyave
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: PAIPAI是一个结合蒙特卡洛和机器学习势的框架，用于高效预测含缺陷高熵合金的原子结构，通过双工作器架构实现快速筛选和精确优化。
...
- **arXiv**: [2603.09500](https://arxiv.org/abs/2603.09500)  ·  [PDF](https://arxiv.org/pdf/2603.09500.pdf)
- **Title (EN)**: Critical point of the transition between $s_\pm$ and $s_{++}$ states of a two-band superconductor with nonmagnetic impurities
- **Authors**: V. A. Shestakov, M. M. Korshunov
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究两带非常规s±超导体中非磁性杂质对热力学势及其导数的影响，发现s±到s++的转变在高温下是平滑交叉，低温下变为一级相变，相图中存在临界终点。
...
- **arXiv**: [2603.09804](https://arxiv.org/abs/2603.09804)  ·  [PDF](https://arxiv.org/pdf/2603.09804.pdf)
- **Title (EN)**: Efficient method for calculation of low-temperature phase boundaries
- **Authors**: Lucas Svensson, Babak Sadigh, Christine Wu, Paul Erhart
- **Categories**: cond-mat.mtrl-sci, physics.chem-ph, physics.comp-ph
- **TL;DR**: 提出结合Clausius-Clapeyron方程与准谐近似的高效框架，用于计算低温相边界，并以二氧化硅相图为例验证方法
...
- **arXiv**: [2603.09528](https://arxiv.org/abs/2603.09528)  ·  [PDF](https://arxiv.org/pdf/2603.09528.pdf)
- **Title (EN)**: A GEMM-based direct solver for finite-difference Poisson problems in non-uniform grids
- **Authors**: Pedro Costa, Duarte Palancha, Joshua Romero, Roberto Verzicco, Massimiliano Fatica
- **Categories**: physics.comp-ph
- **TL;DR**: 提出一种用于三维非均匀笛卡尔网格的大规模并行泊松求解器，通过张量分解和GEMM优化，在异构系统上实现高效计算。
...
- **arXiv**: [2603.09362](https://arxiv.org/abs/2603.09362)  ·  [PDF](https://arxiv.org/pdf/2603.09362.pdf)
- **Title (EN)**: Interplay of Rashba spin-orbit coupling and Coulomb interaction in topological spin-triplet excitonic condensates
- **Authors**: Quoc-Huy Ninh, Huu-Nha Nguyen, Van-Nham Phan
- **Categories**: cond-mat.str-el
- **TL;DR**: 研究Rashba自旋轨道耦合与库仑吸引的协同效应如何稳定二维电子-空穴系统中的拓扑自旋三重态激子凝聚，揭示了从拓扑半金属到拓扑激子凝聚的相变机制。
...
- **arXiv**: [2603.09325](https://arxiv.org/abs/2603.09325)  ·  [PDF](https://arxiv.org/pdf/2603.09325.pdf)
- **Title (EN)**: Orbital-Zeeman cross correlation in $p$- and $d$-wave altermagnets
- **Authors**: Tomonari Mizoguchi, Soshun Ozaki
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 研究反铁磁材料中的轨道-塞曼交叉项，分析其在Rashba金属和拓扑绝缘体表面的行为，发现p波和d波反铁磁序参数对轨道-塞曼项的不同影响。
...
- **arXiv**: [2603.08858](https://arxiv.org/abs/2603.08858)  ·  [PDF](https://arxiv.org/pdf/2603.08858.pdf)
- **Title (EN)**: Uncovering the properties of homo-epitaxial GaN devices through cross-sectional infrared nanoscopy
- **Authors**: Hossein Zandipour, Felix Kaps, Robin Buschbeck, Maximilian Obst, Aditha Senarath, Richarda Niemann, Niclas S. Mueller, Gonzalo Alvarez-Perez, Katja Diaz-Granados, Ryan A Kowalski, Jakob Wetzel, Raghunandan Balasubramanyam Iyer, Matthew Wortel, J. Michael Klopf, Travis Anderson, Alan Jacobs, Mona Ebrish, Lukas M. Eng, Alexander Paarman, Susanne C. Kehr, Joshua D. Caldwell, Thomas G. Folland
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 利用散射型扫描近场光学显微镜(s-SNOM)在中红外和太赫兹波段结合，实现了对GaN p-i-n二极管中载流子和晶格变化的分离表征，展示了高灵敏度的载流子密度检测和亚表面缺陷识别能力。
...
- **arXiv**: [2603.09469](https://arxiv.org/abs/2603.09469)  ·  [PDF](https://arxiv.org/pdf/2603.09469.pdf)
- **Title (EN)**: Phase diagram and Ashkin-Teller universality in the classical square-lattice Heisenberg-compass model
- **Authors**: Yuchen Fan
...
- **arXiv**: [2603.09895](https://arxiv.org/abs/2603.09895)  ·  [PDF](https://arxiv.org/pdf/2603.09895.pdf)
- **Title (EN)**: Critical behavior of the thermal phase transition of U(1) lattice gauge systems
- **Authors**: Greta Sophie Reese, Ludwig Mathey
- **Categories**: cond-mat.supr-con, cond-mat.stat-mech
- **TL;DR**: 该论文通过将超导体相变建模为U(1)晶格规范系统，采用蒙特卡洛模拟研究其临界行为，发现临界指数与中性玻色子的U(1)相变一致，澄清了该系统的普适性类。
...
- **arXiv**: [2603.09247](https://arxiv.org/abs/2603.09247)  ·  [PDF](https://arxiv.org/pdf/2603.09247.pdf)
- **Title (EN)**: Ab initio simulation of the first-order proton-ordering transition in water ice
- **Authors**: Qi Zhang, Sicong Wan, Lei Wang
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 使用机器学习原子间势能结合环更新方法，实现了冰中质子有序-无序转变的平衡采样，预测了83K的一级相变温度，核量子效应使温度降低至接近实验值72K。
...
- **arXiv**: [2603.09442](https://arxiv.org/abs/2603.09442)  ·  [PDF](https://arxiv.org/pdf/2603.09442.pdf)
- **Title (EN)**: Quantum spin ladder with ferromagnetic rungs in Bi$_2$CuO$_3$(SO$_4$)
- **Authors**: Rodolfo A. Rangel Hernandez, Kirill Yu. Povarov, Sergei Zvyagin, Oleg I. Siidra, Alexander A. Tsirlin, Victoria A. Ginga
- **Categories**: cond-mat.str-el
...
- **arXiv**: [2603.09578](https://arxiv.org/abs/2603.09578)  ·  [PDF](https://arxiv.org/pdf/2603.09578.pdf)
- **Title (EN)**: Magneto-optical Response of 5-SL MnBi$_2$Te$_4$ in Spin-Flip States
- **Authors**: Shahid Sattar, Roman Stepanov, A. H. MacDonald, C. M. Canali
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理计算和简化模型，研究了5层MnBi2Te4薄膜中自旋构型、拓扑序和磁光响应的相互作用，发现其拓扑性质可通过顶层和底层自旋相对取向调控。
...
- **arXiv**: [2603.08872](https://arxiv.org/abs/2603.08872)  ·  [PDF](https://arxiv.org/pdf/2603.08872.pdf)
- **Title (EN)**: Aligning van der Waals heterostructures using electron backscatter diffraction
- **Authors**: R. Bangari, M. Mosayebi, J. Buchner, J. D. Caldwell, N. Bassim, T. G. Folland
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究证明电子背散射衍射（EBSD）可作为精确测定范德华材料晶体取向的强大工具，精度优于0.2°，并成功应用于多种低对称性材料，最后通过精确控制扭转角实现了α-MoO3异质结的工程应用。
...
- **arXiv**: [2603.09665](https://arxiv.org/abs/2603.09665)  ·  [PDF](https://arxiv.org/pdf/2603.09665.pdf)
- **Title (EN)**: Evidence of universal spectral collapse at a marginal dynamical regime
- **Authors**: Udomsilp Pinsook, Pakin Tasee, Jakkapat Seeyangnok
- **Categories**: cond-mat.str-el, cond-mat.supr-con
- **TL;DR**: 论文提出强关联材料中的非相干电子谱源于自生动力学无序和竞争涨落，而非传统认为的静态无序。通过推导出普适标度函数ρ(z)=exp(-z²/4)D_ν(z)，并应用于多种材料，发现所有非相干谱都坍缩到ν=-1/2的单一普适曲线上。
...
- **arXiv**: [2603.09502](https://arxiv.org/abs/2603.09502)  ·  [PDF](https://arxiv.org/pdf/2603.09502.pdf)
- **Title (EN)**: DFT calculations of magnetocrystalline anisotropy energy with fixed spin moment
- **Authors**: Justyn Snarski-Adamski, Joanna Marciniak, Wojciech Marciniak, Justyna Rychły-Gruszecka, Mirosław Werwiński
- **Categories**: cond-mat.mtrl-sci, physics.app-ph, physics.comp-ph
- **TL;DR**: 使用完全相对论固定自旋矩方法（FR-FSM）调和不同交换关联势计算的磁晶各向异性能（MAE）差异，为新型永磁体设计提供理论工具。
...
- **arXiv**: [2603.09676](https://arxiv.org/abs/2603.09676)  ·  [PDF](https://arxiv.org/pdf/2603.09676.pdf)
- **Title (EN)**: Gate-tunable anisotropic Josephson diode effect in topological Dirac semimetal Cd$_3$As$_2$ nanowires
- **Authors**: Yan-Liang Hou, An-Qi Wang, Na Li, Chun-Guang Chu, Alexander Brinkman, Zhi-Min Liao, Chuan Li
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文研究了Cd₃As₂纳米线约瑟夫森结中的本征约瑟夫森二极管效应，通过栅压调控和磁场取向依赖测量，结合温度依赖性分析，揭示了拓扑表面态和体态对二极管效应的贡献，并发现该效应可作为探测隐藏拓扑超导态的灵敏探针。
...
- **arXiv**: [2603.08873](https://arxiv.org/abs/2603.08873)  ·  [PDF](https://arxiv.org/pdf/2603.08873.pdf)
- **Title (EN)**: Machine-learning assistant DFT study of half-metallic full-Heusler alloy N2CaNa: structural, electronic, mechanical, and thermodynamics properties
- **Authors**: E. B. Ettah, M. E. Ishaje, K. A. Minakova, V. A. Sirenko, I. S. Bondar
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 采用密度泛函理论研究N2CaNa全赫斯勒合金的结构、电子、机械和热力学性质，发现该材料具有结构稳定性、延展性和热力学稳定性，在自旋电子学和结构工程等领域有应用潜力。
...
- **arXiv**: [2603.09525](https://arxiv.org/abs/2603.09525)  ·  [PDF](https://arxiv.org/pdf/2603.09525.pdf)
- **Title (EN)**: Bulk magnetic properties of distorted square lattice compounds M'-LnTaO4 (Ln = Tb, Dy, Ho, Er)
- **Authors**: Nicola D. Kelly, Ivan da Silva, Siân E. Dutton
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 研究单斜晶系镧系钽酸盐M'-LnTaO4 (Ln = Tb, Dy, Ho, Er)的体磁性质，其中磁性Ln3+离子排列在扭曲的2D正方晶格上
...
- **arXiv**: [2603.09736](https://arxiv.org/abs/2603.09736)  ·  [PDF](https://arxiv.org/pdf/2603.09736.pdf)
- **Title (EN)**: Microscopic origin of $p$-wave magnetism
- **Authors**: Johannes Mitscherling, Jan Priessnitz, Clara K. Geschner, Libor Šmejkal
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 论文揭示了反交变磁体中非相对论性大自旋劈裂的微观机制，通过连接动量空间自旋极化与实空间非共线自旋序的叉积关系，为反交变磁体设计提供指导。
...
- **arXiv**: [2603.08881](https://arxiv.org/abs/2603.08881)  ·  [PDF](https://arxiv.org/pdf/2603.08881.pdf)
- **Title (EN)**: From Word2Vec to Transformers: Text-Derived Composition Embeddings for Filtering Combinatorial Electrocatalysts
- **Authors**: Lei Zhang, Markus Stricker
- **Categories**: cond-mat.mtrl-sci, cs.CL
- **TL;DR**: 论文提出了一种无标签筛选策略，利用科学文本嵌入表示材料成分，通过相似性到两个属性概念（导电性和介电性）来优先选择候选材料，避免了电化学标签的使用。
...
- **arXiv**: [2603.09609](https://arxiv.org/abs/2603.09609)  ·  [PDF](https://arxiv.org/pdf/2603.09609.pdf)
- **Title (EN)**: Analytic treatment of a polaron in a nonparabolic conduction band
- **Authors**: S. N. Klimin, J. Tempere, M. Houtput, I. Zappacosta, S. Ragni, T. Hahn, L. Celiberti, C. Franchini, A. S. Mishchenko
- **Categories**: cond-mat.str-el
- **TL;DR**: 扩展Feynman变分法到紧束缚晶格中的极化子问题，开发多种解析近似方法，在Holstein模型中与数值精确结果进行基准测试
...
- **arXiv**: [2603.09836](https://arxiv.org/abs/2603.09836)  ·  [PDF](https://arxiv.org/pdf/2603.09836.pdf)
- **Title (EN)**: Magnetic field tuning of modulated magnetic orders in CrOCl at the two-dimensional limit
- **Authors**: T. Riccardi, A. Pawbake, S. Badola, F. Petot, B. Grémaud, A. Saul, K. Singh, N. R. Nair, R. S. Chemban, Z. Sofer, J. Coraux, C. Faugeras
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 利用磁拉曼散射光谱研究CrOCl薄层中的磁相序列，发现磁序与晶格匹配的相，观察到强磁致伸缩效应，自旋与晶格耦合在单层极限下依然存在，不同相的稳定区域随层数变化。
...
- **arXiv**: [2603.08950](https://arxiv.org/abs/2603.08950)  ·  [PDF](https://arxiv.org/pdf/2603.08950.pdf)
- **Title (EN)**: Competing Hydrogenation Pathways to Metastable CaH$_6$ Revealed by Machine-Learning-Potential Molecular Dynamics
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 机器学习势分子动力学模拟揭示了钙超氢化物CaH₆和CaH₅.₇₅两种竞争反应路径的形成机制，发现前驱体结构决定产物选择
...
- **arXiv**: [2603.09635](https://arxiv.org/abs/2603.09635)  ·  [PDF](https://arxiv.org/pdf/2603.09635.pdf)
- **Title (EN)**: Pressure-Stabilized MnSb$_2$ with Complex Incommensurate Magnetic Order
- **Authors**: Mingyu Xu, Matt Boswell, Qing-Ping Din, Peng Cheng, Aashish Sapkota, Qiang Zhang, Danielle Yahne, Sergey. L. Bud'ko, Yuji Furukawa, Paul. C. Canfield, Raquel A. Ribeiro, Weiwei Xie
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 高压稳定化的MnSb₂具有复杂的磁性基态，在220K和118K处发生相变，表现出非常规的磁有序和温度依赖的调制演化。
...
- **arXiv**: [2603.09849](https://arxiv.org/abs/2603.09849)  ·  [PDF](https://arxiv.org/pdf/2603.09849.pdf)
- **Title (EN)**: Higher-harmonic acoustic driving of quantum-dot optical transitions beyond Rabi-frequency resonance
- **Authors**: Mateusz Kuniej, Paweł Machnikowski, Michał Gawełczyk
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 提出利用高阶谐波辅助过程实现量子点声学控制的新方案，将所需声学频率从太赫兹降低到吉赫兹范围，为片上量子技术提供可行方案。
...
- **arXiv**: [2603.08953](https://arxiv.org/abs/2603.08953)  ·  [PDF](https://arxiv.org/pdf/2603.08953.pdf)
- **Title (EN)**: Ionic-instability induced color tuning in lead-based, mixed-halide perovskites
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 混合卤化物钙钛矿在光分离过程中可以稳定中间发光能量，实现颜色调控，这对照明应用有实际意义
...
- **arXiv**: [2603.08968](https://arxiv.org/abs/2603.08968)  ·  [PDF](https://arxiv.org/pdf/2603.08968.pdf)
- **Title (EN)**: 3D Mapping of Intragranular Residual Strain and Microstructure in Recrystallized Iron Using Dark-Field X-ray Microscopy
- **Authors**: Virginia Sanna, Yubin Zhang, Wolfgang Ludwig, Aditya Shukla, Abderrahmane Benhadjira, Marilyn Sarkis, Can Yildirim
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 首次使用暗场X射线显微镜直接测量了完全再结晶工业纯铁中的残余弹性应变（约10^-4量级），揭示了晶粒内异质应变分布，并讨论了其对晶界迁移和晶粒生长模型的重要性。
...
- **arXiv**: [2603.09717](https://arxiv.org/abs/2603.09717)  ·  [PDF](https://arxiv.org/pdf/2603.09717.pdf)
- **Title (EN)**: Entanglement Measure Response to Modular Flow and Chiral Topological Phases
- **Authors**: Yunlong Zang
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文研究纠缠哈密顿量驱动的实时动力学中两种纠缠度量的响应，提出了统一的生成函数，并证明其由手性拓扑不变量（手性中心荷和霍尔电导）唯一确定。
...
- **arXiv**: [2603.09050](https://arxiv.org/abs/2603.09050)  ·  [PDF](https://arxiv.org/pdf/2603.09050.pdf)
- **Title (EN)**: Field-Programmable Topological Torons in Chiral Nematic Liquid Crystals
...
- **TL;DR**: 通过定制交流电场在平面液晶盒中实现单个三维双扭曲孤子（toron）的可控创建、操纵和定位，实现亚微米精度的位置和轨迹控制，并展示了三种应用原型。
...
- **arXiv**: [2603.09837](https://arxiv.org/abs/2603.09837)  ·  [PDF](https://arxiv.org/pdf/2603.09837.pdf)
- **Title (EN)**: Disorder-Assisted Adiabaticity in Correlated Many-Particle Systems
- **Authors**: Shang-Jie Liou, Herbert F. Fotso
- **Categories**: cond-mat.str-el, quant-ph
- **TL;DR**: 研究无序如何影响相互作用量子系统中的绝热性，发现无序强度和脉冲持续时间都会抑制系统总能量变化，促进绝热响应，其中三角脉冲效果最佳。
...
- **arXiv**: [2603.09146](https://arxiv.org/abs/2603.09146)  ·  [PDF](https://arxiv.org/pdf/2603.09146.pdf)
- **Title (EN)**: Ultralight High-Entropy Nanowire Scaffolds for Extreme-Temperature Functionality
- **Authors**: Cameron S. Jorgensen, Corisa Kons, William Stallions, Austin C. Houston, Gerd Duscher, Dustin A. Gilbert
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall, physics.app-ph
- **TL;DR**: 该研究通过结合构型熵与结构孔隙率，开发了熵构纳米线超材料，实现了超低密度下的金属功能特性
...
- **arXiv**: [2603.09074](https://arxiv.org/abs/2603.09074)  ·  [PDF](https://arxiv.org/pdf/2603.09074.pdf)
- **Title (EN)**: Spectral Indicators of Piezomagnetically Induced Symmetry Breaking in Altermagnets
- **Authors**: N. Sasabe, H. Koizumi, Y. Ishii, Y. Yamasaki
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文将多极子重整化方法扩展到XMLD，证明交变磁体中的XMLD可理解为压磁效应：磁偶极子与电四极子之间的线性耦合，揭示了高阶磁多极子有序产生的特征XMLD信号。
...
- **arXiv**: [2603.09612](https://arxiv.org/abs/2603.09612)  ·  [PDF](https://arxiv.org/pdf/2603.09612.pdf)
- **Title (EN)**: Nonlinear Hall Effect in Metal-Organic Frameworks
- **Authors**: Sarbajit Mazumdar, Jagadish N S, Awadhesh Narayan, Giorgio Sangiovanni, Ronny Thomale, Arka Bandyopadhyay
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 该论文提出金属有机框架（MOFs）作为实现非线性霍尔效应的多功能平台，通过有效低能模型映射和第一性原理计算，展示了MOFs中狄拉克点附近贝里曲率热点如何产生非线性霍尔响应。
...
- **arXiv**: [2603.09092](https://arxiv.org/abs/2603.09092)  ·  [PDF](https://arxiv.org/pdf/2603.09092.pdf)
- **Title (EN)**: Impact of spin--orbit coupling on orbital diamagnetism in a narrow-gap semiconductor $\mathrm{Pb}_{1-x}\mathrm{Sn}_x\mathrm{Te}$
- **Authors**: Yuki Mitani, Yuki Fuseya
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究自旋轨道耦合对Pb₁₋ₓSnₓTe轨道磁性的影响，发现SOC增强狄拉克型带间贡献，导致更强的抗磁性响应
...
- **arXiv**: [2603.09202](https://arxiv.org/abs/2603.09202)  ·  [PDF](https://arxiv.org/pdf/2603.09202.pdf)
- **Title (EN)**: Material-Property-Field-based Deep Neural Network in Hopfield Framework
- **Authors**: Yanxiao Hu, Ye Sheng, Caichao Ye, Wenxing Qian, Xiaoxin Xu, Yabei Wu, Jiong Yang, William A. Goddard, Wenqing Zhang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出mPFDNN框架，将材料属性场与Hopfield网络结合，构建可解析的深度神经网络，用于材料结构-性质映射。
...
- **arXiv**: [2603.09659](https://arxiv.org/abs/2603.09659)  ·  [PDF](https://arxiv.org/pdf/2603.09659.pdf)
- **Title (EN)**: Pressure-Induced Structural and Magnetic Evolution in Layered Antiferromagnet YbMn$_2$Sb$_2$
...
- **TL;DR**: 压力诱导YbMn₂Sb₂发生结构相变和半导体-金属转变，伴随非常规磁态形成
...
- **arXiv**: [2603.09225](https://arxiv.org/abs/2603.09225)  ·  [PDF](https://arxiv.org/pdf/2603.09225.pdf)
- **Title (EN)**: Optically driven thermodynamic transition from free- to locked-epitaxy
...
- **arXiv**: [2603.09592](https://arxiv.org/abs/2603.09592)  ·  [PDF](https://arxiv.org/pdf/2603.09592.pdf)
- **Title (EN)**: Comprehensive structural and optical analysis of differently oriented Yb-implanted $β$-Ga$_2$O$_3$
- **Authors**: Joanna Matulewicz, Renata Ratajczak, Mahwish Sarwar, Ewa Grzanka, Vitalii Ivanov, Damian Kalita, Cyprian Mieszczynski, Przemyslaw Jozwik, Slawomir Prucnal, Ulrich Kentsch, Rene Heller, Elzbieta Guziewicz
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究Yb掺杂β-Ga₂O₃晶体在不同晶向下的离子注入损伤和光学响应差异，发现(010)取向晶体缺陷最少且存在压应力，而其他取向则表现为张应力和更多缺陷，有趣的是缺陷反而增强Yb³⁺发光。
...
- **arXiv**: [2603.09603](https://arxiv.org/abs/2603.09603)  ·  [PDF](https://arxiv.org/pdf/2603.09603.pdf)
- **Title (EN)**: On the origin of diverse interlayer charge redistribution in transition-metal dichalcogenides
- **Authors**: Yu-Meng Gao, Nie-Wei Wang, Shi-Xuan Yuan, Wen-Xin Xia, Jiang-Long Wang, Xing-Qiang Shi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究揭示了二维层状材料中层间准化学键相互作用导致的不同电荷密度重分布机制，通过系统研究不同d电子填充的过渡金属二硫化物，提出了三种基于不同类型层间相互作用的机制。
...
- **arXiv**: [2603.09666](https://arxiv.org/abs/2603.09666)  ·  [PDF](https://arxiv.org/pdf/2603.09666.pdf)
- **Title (EN)**: Application of dual-tree complex wavelet transform for spectra background reduction
- **Authors**: Kazimierz Skrobas, Kamila Stefanska-Skrobas, Cyprian Mieszczynski, Renata Ratajczak
- **Categories**: cond-mat.mtrl-sci, math-ph
- **TL;DR**: 提出基于双树复小波变换的背景去除方法，用于实验数据处理，相比傅里叶变换技术性能更优
...
- **arXiv**: [2603.09744](https://arxiv.org/abs/2603.09744)  ·  [PDF](https://arxiv.org/pdf/2603.09744.pdf)
- **Title (EN)**: AI-driven Inverse Design of Complex Oxide Thin Films for Semiconductor Devices
- **Authors**: Bonwook Gu, Trinh Ngoc Le, Wonjoong Kim, Zunair Masroor, Han-Bo-Ram Lee
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: IDEAL是一个将生成扩散模型、机器学习原子间势能和图神经网络与原子层沉积技术相结合的反向设计平台，用于半导体电介质材料的精确合成。
...
- **arXiv**: [2603.09755](https://arxiv.org/abs/2603.09755)  ·  [PDF](https://arxiv.org/pdf/2603.09755.pdf)
- **Title (EN)**: Resolving Transient Electron-Phonon Coupling with Time-Resolved Spontaneous Raman Spectroscopy
- **Authors**: Guy Reuveni, Maya Levy Greenberg, Matan Menahem, Olle Hellman, Omer Yaffe
- **Categories**: cond-mat.mtrl-sci, physics.optics
- **TL;DR**: 开发了一种基于时间相关单光子计数的时间分辨自发拉曼技术，用于追踪光激发后的光谱响应，具有亚波数光谱分辨率和几百皮秒时间分辨率，可检测低至10 cm⁻¹的低频拉曼位移。
...
- **arXiv**: [2603.09802](https://arxiv.org/abs/2603.09802)  ·  [PDF](https://arxiv.org/pdf/2603.09802.pdf)
- **Title (EN)**: A new approach for measurement of Cr4+ concentration in Cr4+:YAG transparent materials: some conceptual difficulties and possible solutions
- **Authors**: M. Chaika, R. Lisiecki, K. Lesniewska-Matys, O. Vovk
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出基于吸收光谱估算Cr4+:YAG中Cr4+浓度的新方法，解决传统Smakula Dexter公式因振子强度不确定性和光谱解卷积问题导致的精度不足
...
- **arXiv**: [2603.09823](https://arxiv.org/abs/2603.09823)  ·  [PDF](https://arxiv.org/pdf/2603.09823.pdf)
- **Title (EN)**: Introduction to Spectroscopy of Cr4+:YAG Transparent Ceramics
...
- **arXiv**: [2603.09845](https://arxiv.org/abs/2603.09845)  ·  [PDF](https://arxiv.org/pdf/2603.09845.pdf)
- **Title (EN)**: Materials Acceleration Platform for Electrochemistry (MAP-E): a Platform for Autonomous Electrochemistry
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: MAP-E是一个自主高通量电化学实验平台，通过机器人液体处理、样品转移和多通道恒电位控制，实现无人工干预的腐蚀测试，加速材料发现。
...
- **arXiv**: [2603.09863](https://arxiv.org/abs/2603.09863)  ·  [PDF](https://arxiv.org/pdf/2603.09863.pdf)
- **Title (EN)**: A systematic study of single molecule metallocenes with 4d and 3d transition metal atoms
- **Authors**: Daniela Herrera-Molina, Kushantha P. K. Withanage, Jesus N. Pedroza-Montero, Pardeep Kaur, Mark. R. Pederson, M. F. Islam
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理计算系统研究了4d和3d过渡金属茂金属单分子磁体的电子和磁各向异性特性，发现Mo和Rh具有最大的单轴各向异性(~20K)，各向异性不随d电子数增加而增加，而是取决于d态轨道排序。
...
- **arXiv**: [2603.09871](https://arxiv.org/abs/2603.09871)  ·  [PDF](https://arxiv.org/pdf/2603.09871.pdf)
- **Title (EN)**: Direct Laser Writing of Ferromagnetic Nickel Utilizing the Principle of Sensitized Triplet-Triplet Annihilation Upconversion
...
- **Categories**: cond-mat.mtrl-sci, physics.optics
- **TL;DR**: 该论文提出了一种基于敏化三重态-三重态湮灭上转换的新型光刻胶，可在环境条件下直接激光写入铁磁性镍微结构。
...
- **arXiv**: [2603.09934](https://arxiv.org/abs/2603.09934)  ·  [PDF](https://arxiv.org/pdf/2603.09934.pdf)
- **Title (EN)**: Nanoscale imaging of spin textures with locally varying altermagnetic response in $α$-Fe$_2$O$_3$
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 利用纳米尺度X射线磁圆二色性(XMCD)研究α-Fe₂O₃中交替磁性的纳米尺度调制响应，观察到温度诱导的奈尔矢量重取向导致的XMCD开关效应，并在纳米尺度畴壁和室温下的meron自旋纹理中检测到有限XMCD信号。
