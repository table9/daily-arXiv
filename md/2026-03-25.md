---
title: "arXiv Daily · 2026-03-25 · 88 papers"
date: 2026-03-25
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-03-25 · 88 papers
...
- **arXiv**: [2603.22505](https://arxiv.org/abs/2603.22505)  ·  [PDF](https://arxiv.org/pdf/2603.22505.pdf)
- **Title (EN)**: Cotunneling theory and multiplet excitations: emergence of asymmetric line shape in inelastic scanning tunneling spectroscopy of correlated molecules on surfaces
- **Authors**: Marco Lozano, Manish Kumar, Pavel Jelinek, Diego Soler-Polo
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 扩展共隧穿理论到多参考系统，揭示轨道依赖和非对称耦合可导致非对称STS线形
...
- **arXiv**: [2603.22568](https://arxiv.org/abs/2603.22568)  ·  [PDF](https://arxiv.org/pdf/2603.22568.pdf)
- **Title (EN)**: Magnetic Weyl semimetals: Interplay of band topology and magnetism
- **Authors**: Akihiro Ozawa, Yasufumi Araki, Koji Kobayashi, Kentaro Nomura
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文综述了磁性Weyl半金属的最新理论和实验进展，重点探讨了其电子能带拓扑与磁性相互作用产生的电磁响应现象。
...
- **arXiv**: [2603.22715](https://arxiv.org/abs/2603.22715)  ·  [PDF](https://arxiv.org/pdf/2603.22715.pdf)
- **Title (EN)**: Two-dimensional bound excitons in the real space and Landau quantization space: a comparative study
- **Authors**: Kunxiang Li, Yi-Xiang Wang
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 该研究通过实空间和朗道量子化空间分析单层WSe₂二维激子性质，发现磁场和库仑相互作用会影响激子态中电子-空穴对的主要成分分布。
...
- **arXiv**: [2603.22865](https://arxiv.org/abs/2603.22865)  ·  [PDF](https://arxiv.org/pdf/2603.22865.pdf)
- **Title (EN)**: Electron scattering by a magnetic monopole in solid-state experiments
- **Authors**: P. S. Sidorov, N. A. Vlasov, I. S. Terekhov, A. I. Milstein
- **Categories**: cond-mat.mes-hall, physics.atom-ph
- **TL;DR**: 提出研究二维电子气中磁单极场中电子散射的实验方案，获得程函近似下的微分散射截面，发现与无限长螺线管场相似但电子出现自旋极化
...
- **arXiv**: [2603.22635](https://arxiv.org/abs/2603.22635)  ·  [PDF](https://arxiv.org/pdf/2603.22635.pdf)
- **Title (EN)**: Probing Electromigration of Oxygen Vacancies in YBa$_2$Cu$_3$O$_{7-δ}$ Devices by Multimodal X-ray Techniques
- **Authors**: Caio C. Quaglio-Gomes, Stefan Marinković, Elijah A. Abbey, Davi A. D. Chaves, Anna Palau, Alejandro V. Silhanek, Pedro Schio, Maycon Motta
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 该研究通过多种表征技术揭示了脉冲电迁移在YBCO微桥中引起的氧空位重排、晶体结构变化和铜配位演化，建立了光学对比度与晶胞膨胀空间分布的一致性，并发现光学显微镜无法可靠检测涉及强电阻变化的双极电迁移。
...
- **arXiv**: [2603.22803](https://arxiv.org/abs/2603.22803)  ·  [PDF](https://arxiv.org/pdf/2603.22803.pdf)
- **Title (EN)**: A Residual-Attention Physics-Informed Neural Network for Irregular Interfaces and Multi-Peak Transport Fields
- **Authors**: Baitong Zhou, Ze Tao, Fujun Liu, Xuan Fang
- **Categories**: physics.comp-ph
- **TL;DR**: 本文提出了一种残差注意力物理信息神经网络（RA-PINN），用于解决复杂工程系统中多物理场快速准确预测的问题，相比传统PINN能更好地捕捉局部特征。
...
- **arXiv**: [2603.22389](https://arxiv.org/abs/2603.22389)  ·  [PDF](https://arxiv.org/pdf/2603.22389.pdf)
- **Title (EN)**: Phases of itinerant anyons in Laughlin's quantum Hall states on a lattice
- **Authors**: Tevž Lotrič, Steven H. Simon
- **Categories**: cond-mat.str-el
- **TL;DR**: 研究在分数陈绝缘体中掺杂Laughlin态时产生的巡游任意子相，揭示了能带贝里曲率与任意子色散相互作用对相选择的关键影响，并发现了一种绕过任意子配对形成电荷-2/3复合体的任意子超导机制。
...
- **arXiv**: [2603.22402](https://arxiv.org/abs/2603.22402)  ·  [PDF](https://arxiv.org/pdf/2603.22402.pdf)
- **Title (EN)**: A family tree for hafnia
- **Authors**: Nicolaie Cernov, Jorge Íñiguez-González, Hugo Aramberri
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 压力作为物理标准，用于建立氧化铪多晶型之间的家族关系，揭示新相并识别立方和正交相的祖先结构
...
- **arXiv**: [2603.22424](https://arxiv.org/abs/2603.22424)  ·  [PDF](https://arxiv.org/pdf/2603.22424.pdf)
- **Title (EN)**: How active field theories couple to external potentials
- **Authors**: Yariv Kafri, Julien Tailleur
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文研究了活性场论中耦合外部势能所需的最简单项，通过活性布朗粒子的系统微扰展开，发现了密度与势能梯度之间的非平凡耦合，解释了活性粒子在外部势能下的非平衡特征。
...
- **arXiv**: [2603.22476](https://arxiv.org/abs/2603.22476)  ·  [PDF](https://arxiv.org/pdf/2603.22476.pdf)
- **Title (EN)**: A Density-Based Continuous Local Symmetry Measure
- **Authors**: Duc Anh Lai, Devin A. Matthews
- **Categories**: physics.chem-ph
- **TL;DR**: 提出基于电子密度局域化的局部对称性评估新框架，可定量捕捉全局对称性并揭示局部化学环境中的对称性特征，同时讨论了局部手性概念。
...
- **arXiv**: [2603.22898](https://arxiv.org/abs/2603.22898)  ·  [PDF](https://arxiv.org/pdf/2603.22898.pdf)
- **Title (EN)**: Solitary waves in a phononic integrated circuit
...
- **TL;DR**: 该研究在集成声子波导中产生声学暗孤子，实现了米级传播距离，并首次直接观测到数百次暗孤子碰撞，验证了长期预测的碰撞相移和两种深度依赖碰撞机制。
...
- **arXiv**: [2603.22645](https://arxiv.org/abs/2603.22645)  ·  [PDF](https://arxiv.org/pdf/2603.22645.pdf)
- **Title (EN)**: Triplet superconductivity supported by an X$_9$ high-order Van Hove singularity
...
- **TL;DR**: 研究具有X9型高阶范霍夫奇异点的量子材料，分析其色散关系、态密度，并探讨在哈伯德排斥相互作用下形成三重态超导的可能性。
...
- **arXiv**: [2603.22827](https://arxiv.org/abs/2603.22827)  ·  [PDF](https://arxiv.org/pdf/2603.22827.pdf)
- **Title (EN)**: Wafer-to-Wafer Bonding: Part: I -- The Coupled Physics Problem and the 2D Finite Element Implementation
- **Authors**: Kamalendu Ghosh, Bhavesh Shrimali, Subin Jeong
- **Categories**: physics.comp-ph, physics.app-ph, physics.flu-dyn
- **TL;DR**: 开发了晶圆-晶圆键合的降阶模型，通过耦合板弯曲方程与润滑方程，模拟键合过程中的流体-结构相互作用，揭示非线性动力学特性。
...
- **arXiv**: [2603.22481](https://arxiv.org/abs/2603.22481)  ·  [PDF](https://arxiv.org/pdf/2603.22481.pdf)
- **Title (EN)**: Discovery of BKT correlations in the quantum kagome compound Cs$_2$Cu$_3$SnF$_{12}$
- **Authors**: M. S. Grbić, I. Jakovac, I. Kupčić, H. Tanaka, M. Horvatić
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过核四极共振研究Kagome化合物Cs₂Cu₃SnF₁₂，发现其具有无隙基态和二维BKT型关联，在零磁场下约130K温度范围内存在手性短程序。
...
- **arXiv**: [2603.22487](https://arxiv.org/abs/2603.22487)  ·  [PDF](https://arxiv.org/pdf/2603.22487.pdf)
- **Title (EN)**: Electrochemical and thermal control of continuous phase transitions in P2-NaxNi1/3Mn2/3O2
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 钠层状氧化物在脱钠过程中，钠离子空位的（无序）有序化与宿主结构的对称性变化存在本征耦合，这种相变机制对钠化学扩散性有重要影响。
...
- **arXiv**: [2603.22439](https://arxiv.org/abs/2603.22439)  ·  [PDF](https://arxiv.org/pdf/2603.22439.pdf)
- **Title (EN)**: The damage spreading transition: a hierarchy of renormalization group fixed points
- **Authors**: Adam Nahum, Sthitadhi Roy
- **Categories**: cond-mat.stat-mech, cond-mat.dis-nn, nlin.CD, nlin.CG
- **TL;DR**: 该论文研究了确定性经典细胞自动机中的损伤传播相变，发现该相变比传统定向渗流理论更丰富，包含无限层次结构的局部可观测量，每个层次都有不同的普适临界指数。
...
- **arXiv**: [2603.22521](https://arxiv.org/abs/2603.22521)  ·  [PDF](https://arxiv.org/pdf/2603.22521.pdf)
- **Title (EN)**: Molecular dynamics study of perchloric acid using the extended Madrid-2019 force field
- **Authors**: M. Cruz-Sánchez, S. Blazquez, C. Vega, V. M. Trejos
- **Categories**: physics.chem-ph
- **TL;DR**: 使用扩展的Madrid-2019力场模拟高氯酸溶液，预测热力学、结构和输运性质，在特定浓度范围内与实验数据吻合良好。
...
- **arXiv**: [2603.22961](https://arxiv.org/abs/2603.22961)  ·  [PDF](https://arxiv.org/pdf/2603.22961.pdf)
- **Title (EN)**: Charge Transport Modeling of CdSe/ZnS core/shell Quantum Nanorod Light-Emitting Diodes
- **Authors**: A. G. Melkonyan, G. A. Mantashian, D. B. Hayrapetyan
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该研究通过自洽数值方法分析了具有CdSe-ZnS核壳双纳米棒发射层的量子点LED，揭示了电压调控的电子局域化动力学和量子隧穿效应，展示了其在可调谐光电子应用中的潜力。
...
- **arXiv**: [2603.22662](https://arxiv.org/abs/2603.22662)  ·  [PDF](https://arxiv.org/pdf/2603.22662.pdf)
- **Title (EN)**: A mechanism for nonmonotonic $T_{c,max}(n)$ in multilayer cuprates
- **Authors**: Pavel Kornilovitch
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该论文提出了一种解释层状铜氧化物超导体中最大临界温度Tc_max与导电层数n依赖关系的预形成对机制，认为铜氧平面通过调节晶格各向异性来平衡载流子空穴的吸引能和动能，从而优化Tc_max。
...
- **arXiv**: [2603.23283](https://arxiv.org/abs/2603.23283)  ·  [PDF](https://arxiv.org/pdf/2603.23283.pdf)
- **Title (EN)**: Screened second-order exchange in the uniform electron gas: exact reduction, a single-pole reference model and asymptotic analysis
- **Authors**: Fumihiro Imoto
- **Categories**: physics.comp-ph
- **TL;DR**: 本文推导了均匀电子气中屏蔽二阶交换(SOSEX)能量对于特定单极点屏蔽相互作用类的精确约化，将其简化为三重积分，并建立了约化兼容单极点(RC-SP)模型。
...
- **arXiv**: [2603.22695](https://arxiv.org/abs/2603.22695)  ·  [PDF](https://arxiv.org/pdf/2603.22695.pdf)
- **Title (EN)**: Dimensionality-Dependent Exciton Dispersion in a Single-Band Mott Insulator
...
- **TL;DR**: 通过高分辨率电子能量损失谱直接观测到单带Mott绝缘体Nb3Cl8中维度依赖的激子色散，发现高温相中激子呈现准二维无质量线性色散，低温相中激子分裂为两个三维抛物线色散带。
...
- **arXiv**: [2603.22501](https://arxiv.org/abs/2603.22501)  ·  [PDF](https://arxiv.org/pdf/2603.22501.pdf)
- **Title (EN)**: Chirality Cannot Be Ferroic in Enantiomorphic Space-Groups
- **Authors**: F. Gómez-Ortiz, S. Mamoudou Taganga, E. E. McCabe, A. H. Romero, E. Bousquet
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 手性不能作为一级铁性序参数，因为从非手性母相到手性相的相变不能由布里渊区中心（Γ点）的不稳定性驱动。
...
- **arXiv**: [2603.22559](https://arxiv.org/abs/2603.22559)  ·  [PDF](https://arxiv.org/pdf/2603.22559.pdf)
- **Title (EN)**: Geometric Thermodynamics of Cycles: Curvature and Local Thermodynamic Response
- **Authors**: Eric R. Bittner
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文将经典热力学中的循环过程几何关系统一为平衡热力学流形上的规范二形式投影，建立了循环几何与热力学响应之间的直接联系，并将经典循环几何与随机热力学轨迹连接起来。
...
### Radial Gausslets
- **arXiv**: [2603.22646](https://arxiv.org/abs/2603.22646)  ·  [PDF](https://arxiv.org/pdf/2603.22646.pdf)
- **Title (EN)**: Radial Gausslets
- **Authors**: Steven R. White
- **Categories**: physics.chem-ph, cond-mat.str-el, physics.atom-ph, physics.comp-ph
- **TL;DR**: 论文提出了一种用于原子系统的径向高斯基函数，将原有的一维高斯基推广到三维径向坐标，实现了紧凑的径向基组和两电子相互作用项的对角化。
...
- **arXiv**: [2603.23001](https://arxiv.org/abs/2603.23001)  ·  [PDF](https://arxiv.org/pdf/2603.23001.pdf)
- **Title (EN)**: Exploring Spectral Singularities in Dirac Semimetals: The Role of Non-Hermitian Physics and Dichroism
- **Authors**: Mustafa Sarisaman, Murat Taş, Enes Talha Kırca
- **Categories**: cond-mat.mes-hall, math-ph, physics.optics, quant-ph
- **TL;DR**: 该研究利用非厄米物理和散射技术探索狄拉克半金属的新特性，首次发现双色性狄拉克半金属能产生12种独特的拓扑激光类型，并揭示了轴子θ项在拓扑性质中的明确作用。
...
- **arXiv**: [2603.23314](https://arxiv.org/abs/2603.23314)  ·  [PDF](https://arxiv.org/pdf/2603.23314.pdf)
- **Title (EN)**: Correlation-driven enhancement of pairing in a nematic Hund's metal
- **Authors**: Angelo Valli, Laura Fanfarillo
- **Categories**: cond-mat.supr-con, cond-mat.str-el
- **TL;DR**: 研究揭示了在铁基超导体等多轨道向列金属中，Hund耦合驱动的关联效应如何重塑玻色子介导的超导性，发现Hund关联增强超导能隙的轨道分化，同时抑制向列相驱动的极端轨道极化和相干性崩溃。
...
- **arXiv**: [2603.22736](https://arxiv.org/abs/2603.22736)  ·  [PDF](https://arxiv.org/pdf/2603.22736.pdf)
- **Title (EN)**: Symmetric Mass Generation Transition and its Nonequilibrium Critical Dynamics in a Bilayer Honeycomb Lattice Model
- **Authors**: Zhi-Xuan Li, Yin-Kai Yu, Zi-Xiang Li, Shuai Yin
- **Categories**: cond-mat.str-el, cond-mat.stat-mech, hep-th
- **TL;DR**: 通过量子蒙特卡洛模拟研究双层蜂窝晶格模型中对称质量生成(SMG)相变的平衡与非平衡临界动力学，发现新的普适类并验证非平衡SMG相变仍遵循广义有限时间标度。
...
- **arXiv**: [2603.22520](https://arxiv.org/abs/2603.22520)  ·  [PDF](https://arxiv.org/pdf/2603.22520.pdf)
- **Title (EN)**: AI-supported Degradation Study of Carbon-based Perovskite Solar Cells: Learning the Device Physics of Perovskite Solar Cells: A Drift-Diffusion Guided Autoencoder Approach
- **Authors**: Oliver Zbinden, Sharun Parayil Shaji, Wolfgang Tress
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用机器学习分析钙钛矿太阳能电池在光照老化过程中的电流-电压曲线，预测物理参数变化，建立数字孪生模型来追踪降解迹象
...
- **arXiv**: [2603.22643](https://arxiv.org/abs/2603.22643)  ·  [PDF](https://arxiv.org/pdf/2603.22643.pdf)
- **Title (EN)**: Pseudospectral phenomena and the origin of the non-Hermitian skin effect
- **Authors**: J. Sirker
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, quant-ph
- **TL;DR**: 非厄米趋肤效应(NHSE)并非源于点隙拓扑，而是来自谱不稳定性和非互易性；点隙缠绕与边界局域化之间的常用关系并非普适。
...
- **arXiv**: [2603.22671](https://arxiv.org/abs/2603.22671)  ·  [PDF](https://arxiv.org/pdf/2603.22671.pdf)
- **Title (EN)**: Ab Initio Simulation of Femtosecond Time-Resolved Multi-Pulse Spectroscopies applied to the Heptazine$\cdots$H$_2$O Complex
- **Authors**: Sebastian V. Pios, Maxim F. Gelin, Wolfgang Domcke, Lipeng Chen
- **Categories**: physics.chem-ph
- **TL;DR**: 将准经典门-窗方法从瞬态吸收泵浦-探测光谱推广到多脉冲光谱，应用于泵浦-推-探测和泵浦诱导二维光谱，为七嗪-水复合物提供更丰富的激发态弛豫动力学信息。
...
- **arXiv**: [2603.23002](https://arxiv.org/abs/2603.23002)  ·  [PDF](https://arxiv.org/pdf/2603.23002.pdf)
- **Title (EN)**: Quantum correlations and dissipative blockade of polaritons in a tunable fiber cavity
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文通过光子关联测量研究腔极化激元的量子关联特性，发现极化激元相互作用对腔-激子失谐有强烈依赖，并观察到从反聚束到聚束的转变，在双极化激元Feshbach共振时出现与激光失谐无关的反聚束现象。
...
- **arXiv**: [2603.23377](https://arxiv.org/abs/2603.23377)  ·  [PDF](https://arxiv.org/pdf/2603.23377.pdf)
- **Title (EN)**: Glassy magnetic freezing of interacting clusters in LK-99-family materials
- **Authors**: Serafim Teknowijoyo, Domenico Napoletani, Vahan Nikoghosyan, Armen Gulian
- **Categories**: cond-mat.supr-con
- **TL;DR**: 铜掺杂磷灰石材料中观察到可重复的磁化异常，但分析表明这些现象并非超导性，而是源于硫化铜（covellite）相引起的玻璃态磁性冻结。
...
- **arXiv**: [2603.22830](https://arxiv.org/abs/2603.22830)  ·  [PDF](https://arxiv.org/pdf/2603.22830.pdf)
- **Title (EN)**: Profound impacts of interlayer interactions in bilayer altermagnetic V2S2O
...
- **TL;DR**: 双层V2S2O交替磁体中，层间相互作用显著影响电子结构、压磁效应和自旋输运性质，特别是降低自旋极化率并引入栅压调控的不对称性。
...
- **arXiv**: [2603.22919](https://arxiv.org/abs/2603.22919)  ·  [PDF](https://arxiv.org/pdf/2603.22919.pdf)
- **Title (EN)**: Non-Hermitian skin effect in periodic, random, and quasiperiodic systems
- **Authors**: F. Iwase
- **Categories**: cond-mat.str-el, quant-ph
- **TL;DR**: 研究比较了周期、随机和准周期（斐波那契）结构在非厄米趋肤效应下的表现，发现准周期结构能抑制边界积累同时保持拓扑间隙清晰
...
- **arXiv**: [2603.22553](https://arxiv.org/abs/2603.22553)  ·  [PDF](https://arxiv.org/pdf/2603.22553.pdf)
- **Title (EN)**: LPC3D: An Enhanced Parallel Software for Large-Scale Simulation of Adsorption in Porous Carbons and Supercapacitors
- **Authors**: El Hassane Lahrar, Mathieu Salanne, Rudolf Weeber, Céline Merlet
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: LPC3D软件的新Python实现，使用PyStencils生成优化的C++/CUDA代码，用于介观尺度多孔碳超级电容器模拟，可处理从单个碳颗粒到数百微米尺度的系统。
...
- **arXiv**: [2603.22989](https://arxiv.org/abs/2603.22989)  ·  [PDF](https://arxiv.org/pdf/2603.22989.pdf)
- **Title (EN)**: Genuine and spurious (non-)ergodicity in single particle tracking
- **Authors**: Wei Wang, Qing Wei, Igor M. Sokolov, Ralf Metzler, Aleksei Chechkin
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文指出传统MSD-TAMSD准则在判断随机过程遍历性时存在缺陷，提出使用MSI-TAMSD新准则能更准确表征系统的真实(非)遍历性。
...
- **arXiv**: [2603.23331](https://arxiv.org/abs/2603.23331)  ·  [PDF](https://arxiv.org/pdf/2603.23331.pdf)
- **Title (EN)**: Vectorial Imaging of the Photodissociation of 2-Bromobutane Oriented via Hexapolar State Selection
...
- **Categories**: physics.chem-ph
- **TL;DR**: 该研究通过光解取向的2-溴丁烷分子，分析光解碎片的速度、跃迁偶极矩和永久偶极矩三个矢量间的空间关联，探究手性分子光解过程的取向效应。
...
- **arXiv**: [2603.23148](https://arxiv.org/abs/2603.23148)  ·  [PDF](https://arxiv.org/pdf/2603.23148.pdf)
- **Title (EN)**: Pre-Patterned Superconducting Contacts for Clean Superconductor-Topological Material Interfaces Enabling Long-Range Josephson Coupling
...
- **TL;DR**: 该论文提出了一种预图案化超导底部接触架构，通过在转移范德华晶体前先定义MoRe/Au电极，避免了传统顶部接触方法导致的界面退化问题，在WTe2和Bi1.5Sb0.5Te1.7Se1.3基约瑟夫森结中实现了更好的性能。
...
- **arXiv**: [2603.23400](https://arxiv.org/abs/2603.23400)  ·  [PDF](https://arxiv.org/pdf/2603.23400.pdf)
- **Title (EN)**: A Zero-Bias Superconducting Voltage Amplifier Based on the Bipolar Thermoelectric Effect
- **Authors**: Giacomo Trupiano, Giorgio De Simoni, Francesco Giazotto
- **Categories**: cond-mat.supr-con, cond-mat.mes-hall
- **TL;DR**: 提出一种零偏置超导电压放大器，利用非对称隧道结中的负微分电阻效应，通过热梯度获取能量实现电压放大，无需外部电偏置。
...
- **arXiv**: [2603.22848](https://arxiv.org/abs/2603.22848)  ·  [PDF](https://arxiv.org/pdf/2603.22848.pdf)
- **Title (EN)**: Ultrafast electrically controlled magnetism in charge-order-induced ferroelectric altermagnet
- **Authors**: Yuhao Gu, Yu-Hui Song, Yihao Wang, Ze-Feng Gao, Huan-Cheng Yang, Peng-Jie Guo, Zhong-Yi Lu
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 预测LiV₂F₆同时具有交变磁性和电荷序诱导铁电性，可实现超快电控磁性
...
- **arXiv**: [2603.22921](https://arxiv.org/abs/2603.22921)  ·  [PDF](https://arxiv.org/pdf/2603.22921.pdf)
- **Title (EN)**: Synergistic chemical and optical switching of chiral symmetry breaking in 1\textit{T}-TaS$_2
- **Authors**: Qingzheng Qiu, Mengxian Zhao, Roman Mankowsky, Henrik Till Lemke, Serhane Zerdane, Mathias Sander, Zihao Tao, Qizhi Li, Xiquan Zheng, Shilong Zhang, Qian Xiao, Xinyi Jiang, Yang Yang, Sheng Meng, Yingying Peng
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过化学掺杂与飞秒光激发结合，实现了手性电荷密度波态的非热开关控制，揭示了声子介导的微观机制
...
- **arXiv**: [2603.22571](https://arxiv.org/abs/2603.22571)  ·  [PDF](https://arxiv.org/pdf/2603.22571.pdf)
- **Title (EN)**: Origin of the tetragonal-to-hexagonal phase transitions in Fe-doped BaTiO$_3$
- **Authors**: Zhiyuan Li, Ruiwen Xie, Hongbin Zhang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: Fe掺杂BaTiO₃中四方到六方相变的计算研究：4% Fe浓度时发生相变，氧空位使相变浓度降至2%，Jahn-Teller畸变促进相变，容忍因子抑制六方相形成
...
- **arXiv**: [2603.23021](https://arxiv.org/abs/2603.23021)  ·  [PDF](https://arxiv.org/pdf/2603.23021.pdf)
- **Title (EN)**: Dynamics of Aligning Active Matter: Mapping to a Schrödinger Equation and Exact Diagonalization
- **Authors**: Tara Steinhöfel, Horst-Holger Boltz, Thomas Ihle
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文重新审视Fokker-Planck与Schrödinger方程的经典联系，通过精确对角化方法研究小尺度全连接自推进粒子系统的弛豫模式，推导出比现有近似更准确的解析结果，并将方法扩展到非互易相互作用系统。
...
- **arXiv**: [2603.23399](https://arxiv.org/abs/2603.23399)  ·  [PDF](https://arxiv.org/pdf/2603.23399.pdf)
- **Title (EN)**: Exact density-functional theory as parallel ensemble variational hierarchies: from Lieb's formulation to Kohn-Sham theory
- **Authors**: Nan Sheng
- **Categories**: physics.chem-ph, math-ph
- **TL;DR**: 论文重新组织精确密度泛函理论，区分相互作用与非相互作用两个变分层次，澄清Kohn-Sham辅助构造与精确理论的关系。
...
- **arXiv**: [2603.23174](https://arxiv.org/abs/2603.23174)  ·  [PDF](https://arxiv.org/pdf/2603.23174.pdf)
- **Title (EN)**: A $Γ$-valley Moiré Platform for Tunable Square Lattice Hubbard Model
- **Authors**: Rui Shi, Kejie Bao, Huan Wang, Jing Wang
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: Γ-谷扭曲双层结构为模拟方晶格Hubbard模型提供了高度可调的平台，通过层间位移场可调控有效跃迁比t'/t
...
- **arXiv**: [2603.23402](https://arxiv.org/abs/2603.23402)  ·  [PDF](https://arxiv.org/pdf/2603.23402.pdf)
- **Title (EN)**: Magnetic flux distribution, quasiparticle spectroscopy, and quality factors in Nb films for superconducting qubits
...
- **TL;DR**: 比较三种不同沉积温度下生长的铌薄膜，通过磁光成像和伦敦穿透深度测量关联材料特性与内部品质因子，发现低品质因子薄膜存在局域带隙内态，高品质因子薄膜则相反。
...
- **arXiv**: [2603.23029](https://arxiv.org/abs/2603.23029)  ·  [PDF](https://arxiv.org/pdf/2603.23029.pdf)
- **Title (EN)**: Fine-tuning of universal machine-learning interatomic potentials for 2D high-entropy alloys
- **Authors**: Chun Zhou, Hannu-Pekka Komsa
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 研究探讨了通用机器学习原子间势（MLIPs）在二维过渡金属硫化物高熵合金（2D-HEAs）中的适用性，并开发了有效的微调策略，使模型在预测混合能方面达到接近DFT的精度。
...
- **arXiv**: [2603.23130](https://arxiv.org/abs/2603.23130)  ·  [PDF](https://arxiv.org/pdf/2603.23130.pdf)
- **Title (EN)**: Complex magnetic interactions in geometrically frustrated TbOF
- **Authors**: Pim Witte, Denis Sheptyakov, Elsa Lhotel, Nongnuch Artrith, Robin de Hoogh, Giuditta Perversi, Kim Lefmann, Machteld E. Kamminga
- **Categories**: cond-mat.str-el
- **TL;DR**: TbOF是一种独特的受挫混合阴离子晶格，表现出非常规磁性，通过实验和计算揭示了其复杂的磁相图和结构-磁性相互作用。
...
- **arXiv**: [2603.22575](https://arxiv.org/abs/2603.22575)  ·  [PDF](https://arxiv.org/pdf/2603.22575.pdf)
- **Title (EN)**: Influence Functional Approach to Non-Perturbative Exciton Binding Renormalization from Phonons
...
- **TL;DR**: 构建多体模型哈密顿量研究声子如何随温度重正化激子结合能，结合GW近似和密度泛函微扰理论进行第一性原理参数化，使用路径积分蒙特卡洛方法计算静态准粒子性质。
...
- **arXiv**: [2603.23058](https://arxiv.org/abs/2603.23058)  ·  [PDF](https://arxiv.org/pdf/2603.23058.pdf)
- **Title (EN)**: Basis dependence of eigenstate thermalization
- **Authors**: Lennart Dabelow, Christian Eidecker-Dunkel, Peter Reimann
- **Categories**: cond-mat.stat-mech, quant-ph
- **TL;DR**: 本研究表明，在具有简并性的多体系统中，本征态热化假设的成立与否依赖于基矢选择，不同基矢下热化本征态的比例可能完全不同。
...
- **arXiv**: [2603.23427](https://arxiv.org/abs/2603.23427)  ·  [PDF](https://arxiv.org/pdf/2603.23427.pdf)
- **Title (EN)**: Elucidating the Synergetic Interplay between Average Intermolecular Coupling and Coupling Disorder in Short-Time Exciton Transfer
- **Authors**: Siwei Wang, Guangming Liu, Hsing-Ta Chen
- **Categories**: physics.chem-ph, quant-ph
- **TL;DR**: 该研究开发了一个分析框架，用于描述一维晶格中短时激子动力学，考虑了在位能量无序和分子间耦合涨落，揭示了短时弹道传输主要由非对角无序主导。
...
- **arXiv**: [2603.23235](https://arxiv.org/abs/2603.23235)  ·  [PDF](https://arxiv.org/pdf/2603.23235.pdf)
- **Title (EN)**: Enhanced spin-current generation in Dirac altermagnets through Klein tunneling
- **Authors**: Tomas T. Osterholt, Lumen Eek, Cristiane Morais Smith, Rembert A. Duine
- **Categories**: cond-mat.mes-hall
- **TL;DR**: Dirac altermagnets中Klein隧道的自旋依赖性可用于高效控制自旋电流极化，特别是g波对称性下势垒可显著增强自旋电流极化，实现门电压调控。
...
- **arXiv**: [2603.23466](https://arxiv.org/abs/2603.23466)  ·  [PDF](https://arxiv.org/pdf/2603.23466.pdf)
- **Title (EN)**: Reaching for the performance limit of hybrid density functional theory for molecular chemistry
- **Authors**: Jiashu Liang, Martin Head-Gordon
- **Categories**: physics.chem-ph, physics.comp-ph, quant-ph
- **TL;DR**: 开发COACH泛函的新协议，通过约束执行、灵活泛函形式和现代优化，在RSH meta-GGA框架中实现更好的精度和可转移性
...
- **arXiv**: [2603.23145](https://arxiv.org/abs/2603.23145)  ·  [PDF](https://arxiv.org/pdf/2603.23145.pdf)
- **Title (EN)**: Impurity quadrupole moments as local probes of flux sectors in the Kitaev spin liquid
- **Authors**: Masahiro O. Takahashi, Wen-Han Kao, Satoshi Fujimoto, Natalia B. Perkins
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文提出利用磁性杂质的四极矩作为探测量子自旋液体中通量构型的直接探针，通过SO(6) Majorana表示和自洽平均场近似，展示了杂质四极矩在通量区转变点的跃变行为。
...
- **arXiv**: [2603.22628](https://arxiv.org/abs/2603.22628)  ·  [PDF](https://arxiv.org/pdf/2603.22628.pdf)
- **Title (EN)**: Dynamical Simulation of On-axis Transmission Kikuchi and Spot Diffraction Patterns, Based on Accurate Diffraction Geometry Calibration
- **Authors**: Tianbi Zhang, Raynald Gauvin, Aimo Winkelmann, T. Ben Britton
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究开发了基于几何和全对比动力学模拟的透射菊池衍射分析方法，通过直接电子探测器校准衍射几何，准确模拟实验图案中的多种衍射特征，旨在改进图案索引算法和对透射菊池图案形成物理过程的理解。
...
- **arXiv**: [2603.23169](https://arxiv.org/abs/2603.23169)  ·  [PDF](https://arxiv.org/pdf/2603.23169.pdf)
- **Title (EN)**: Amplification based on the noise-induced negative differential resistance in a Zener diode
- **Authors**: Alexandre Dumont, Bertrand Reulet
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 通过噪声反馈在12V齐纳二极管中诱导负微分电阻，构建音频频率电压放大器
...
- **arXiv**: [2603.23452](https://arxiv.org/abs/2603.23452)  ·  [PDF](https://arxiv.org/pdf/2603.23452.pdf)
- **Title (EN)**: A unified variational framework for the inverse Kohn-Sham problem
- **Authors**: Nan Sheng
- **Categories**: physics.chem-ph, math-ph
- **TL;DR**: 该论文为逆Kohn-Sham问题建立了一个统一的变分框架，将现有的多种反演方法（如Wu-Yang、Zhao-Morrison-Parr等）纳入同一理论体系，通过变分对偶结构解释KS势的作用。
...
- **arXiv**: [2603.23264](https://arxiv.org/abs/2603.23264)  ·  [PDF](https://arxiv.org/pdf/2603.23264.pdf)
- **Title (EN)**: Tunable Goos--Hänchen shifts and group delay time in single-barrier silicene
- **Authors**: Youssef Fattasse, Hocine Bahlouli, Clarence Cortes, David Laroze, Ahmed Jellal
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 研究硅烯中狄拉克费米子通过矩形静电势垒时的Goos-Hänchen位移和群延迟时间，发现量子干涉效应导致位移振荡，群延迟时间显示共振特征，表明静电势垒可调控二维狄拉克材料的输运特性。
...
- **arXiv**: [2603.23154](https://arxiv.org/abs/2603.23154)  ·  [PDF](https://arxiv.org/pdf/2603.23154.pdf)
- **Title (EN)**: From Quantum Dimers to the $π$-flux Toric Code via Deconfined Multicriticality
- **Authors**: Ankush Chaubey, Sergej Moroz, Subhro Bhattacharjee
- **Categories**: cond-mat.str-el, cond-mat.stat-mech, hep-th
- **TL;DR**: 该论文通过张量积正则化方法，在二维RK二聚体模型中实现了从二聚体晶体到Z2拓扑液体的相变，发现了多个量子相变点，包括一个去禁闭多临界点。
...
- **arXiv**: [2603.22632](https://arxiv.org/abs/2603.22632)  ·  [PDF](https://arxiv.org/pdf/2603.22632.pdf)
- **Title (EN)**: Generalized thermodynamic closure in ultrafast phonon dynamics
- **Authors**: Sheng Qu, Jiyong Kim, Jaco J. Geuchies, Sergey Kovalev, Jan-Christoph Deinert, Thales de Oliveira, Alexey Ponomaryov, Min Chen, Nilesh Awari, Igor Ilyakov, Mischa Bonn, Heejae Kim
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 实验证明强驱动声子模式存在广义热力学描述，其中相干性和能量共同组织非平衡演化，揭示了相干扩展的热力学机制
...
- **arXiv**: [2603.23225](https://arxiv.org/abs/2603.23225)  ·  [PDF](https://arxiv.org/pdf/2603.23225.pdf)
- **Title (EN)**: Dynamics of O(2) excitations in a non-reciprocal medium
- **Authors**: Ylann Rouzaire, Daniel JG Pearce, Ignacio Pagonabarraga, Demian Levis
- **Categories**: cond-mat.stat-mech, cond-mat.soft, nlin.PS
- **TL;DR**: 研究非互易性在O(2)模型中的涌现动力学，建立了激发轨迹控制的第一原理，揭示了非互易性如何影响模式演化和缺陷稳定性。
...
- **arXiv**: [2603.23274](https://arxiv.org/abs/2603.23274)  ·  [PDF](https://arxiv.org/pdf/2603.23274.pdf)
- **Title (EN)**: Comment on 'Observation of Shapiro Steps in the Charge Density Wave State Induced by Strain on a Piezoelectric Substrate'
- **Authors**: D. Yu. Saltykova, M. V. Nikitin, V. Ya. Pokrovskii, S. G. Zybtsev, V. V. Kolesov, V. V. Kashin, I. E. Kuznetsova, I. A. Nedospasov
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: NbSe3纳米线中的电荷密度波滑动与表面声波同步的实验演示
...
- **arXiv**: [2603.23163](https://arxiv.org/abs/2603.23163)  ·  [PDF](https://arxiv.org/pdf/2603.23163.pdf)
- **Title (EN)**: Open Quantum Cluster Embedding Theory
- **Authors**: Petar Brinić, Hugo U. R. Strand, Jakša Vučičević
- **Categories**: cond-mat.str-el
- **TL;DR**: 提出量子簇嵌入理论，通过嵌入簇方法计算强关联电子系统的动力学响应函数，避免解析延拓问题
...
- **arXiv**: [2603.22696](https://arxiv.org/abs/2603.22696)  ·  [PDF](https://arxiv.org/pdf/2603.22696.pdf)
- **Title (EN)**: Distinct memory properties in spin-wave reservoir computing based on synthetic antiferromagnet
- **Authors**: Takumu Shinkai, Satoshi Iihama, Kensuke Hayashi, Takahiro Moriyama, Shigemi Mizukami, Natsuhiko Yoshinaga
- **Categories**: cond-mat.mtrl-sci, physics.app-ph
- **TL;DR**: 该研究探索了合成反铁磁体中的自旋波物理储层计算，发现其声学和光学模式能提供两种不同的记忆特性
...
- **arXiv**: [2603.23254](https://arxiv.org/abs/2603.23254)  ·  [PDF](https://arxiv.org/pdf/2603.23254.pdf)
- **Title (EN)**: A $q$-Caputo Fractional Generalization of Tsallis Entropy: Series Representation and Non-Negativity Domains
- **Authors**: Matias P. Gonzalez, Micolta-Riascos Bayron
- **Categories**: cond-mat.stat-mech, cs.IT, math-ph
- **TL;DR**: 提出了一种基于q-Caputo算子的Tsallis熵分数阶推广，通过q-Caputo分数阶微积分算子作用于生成函数∑p_i^x在x=1处得到，导出了用q-Gamma函数表示的闭式级数表达式。
...
- **arXiv**: [2603.23392](https://arxiv.org/abs/2603.23392)  ·  [PDF](https://arxiv.org/pdf/2603.23392.pdf)
- **Title (EN)**: Strain-Engineered Deterministic Quantum Dots for Telecom O-Band Emission Using Buried Stressors
- **Authors**: Imad Limame, Ching-Wen Shih, Kartik Gaur, Martin Podhorský, Sarthak Tripathi, Setthanat Wijitpatima, Aris Koulas-Simos, Chirag C. Palekar, Petr Klenovský, Stephan Reitzenstein
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 利用埋入式AlAs/Al₂O₃应力层实现位置可控的InGaAs/GaAs量子点，产生O波段（~1.3μm）单光子发射，无需应变降低层，具有空间控制和光谱可调性。
...
- **arXiv**: [2603.23281](https://arxiv.org/abs/2603.23281)  ·  [PDF](https://arxiv.org/pdf/2603.23281.pdf)
- **Title (EN)**: Fermiology, charge transfer energy, and robust paramagnons in high-$T_c$ cuprate superconductors
- **Authors**: Maciej Fidrysiak
- **Categories**: cond-mat.str-el
- **TL;DR**: 该研究通过Hubbard和t-J-U模型，将铜氧化物超导体中稳健的顺磁子能量与材料微观参数（次近邻与最近邻跃迁积分比r和电荷转移能Δ_CT）联系起来，解释了不同铜酸盐中磁激发带宽可比性的原因。
...
- **arXiv**: [2603.22723](https://arxiv.org/abs/2603.22723)  ·  [PDF](https://arxiv.org/pdf/2603.22723.pdf)
- **Title (EN)**: Weak Coupling of Diffusional and Phonon-like Modes in Liquids Revealed by Dynamic Kapitza Length
- **Authors**: Tao Chen, Puqing Jiang
- **Categories**: cond-mat.mtrl-sci, cond-mat.stat-mech
- **TL;DR**: 通过方波脉冲热反射技术测量固-液界面热导，发现其随调制频率增加而增大，揭示了液体中存在扩散模式和类声子模式两种能量传输通道，挑战了传统完全平衡的液体模式假设。
...
- **arXiv**: [2603.23320](https://arxiv.org/abs/2603.23320)  ·  [PDF](https://arxiv.org/pdf/2603.23320.pdf)
- **Title (EN)**: Internal stress drives ferromagnetic-like ordering in networks of proliferating bacteria
- **Authors**: Nicola Pellicciotta, Luca Angelani, Roberto Di Leonardo
- **Categories**: cond-mat.stat-mech, physics.bio-ph
- **TL;DR**: 该研究通过大肠杆菌在微通道网络中的生长实验，揭示了增殖活性物质与平衡统计力学之间的对应关系，竞争性体积限制驱动了跨代持续的生长模式形成。
...
- **arXiv**: [2603.23350](https://arxiv.org/abs/2603.23350)  ·  [PDF](https://arxiv.org/pdf/2603.23350.pdf)
- **Title (EN)**: Multistage spin correlations in the $s$ = 1/2 stuffed hyper-star lattice Li$_{2}$Cu$_{2}$(MoO$_{4}$)$_{3}$
...
- **Categories**: cond-mat.str-el
- **TL;DR**: 三维星晶格材料Li₂Cu₂(MoO₄)₃在15.8K以下经历从短程自旋关联到无序驱动的类随机单重态交叉，并在0.32K附近形成准冻结态
...
- **arXiv**: [2603.22725](https://arxiv.org/abs/2603.22725)  ·  [PDF](https://arxiv.org/pdf/2603.22725.pdf)
- **Title (EN)**: First-Principles Theory of Chirality-Induced Spin Selectivity at Molecule-Metal Interfaces in Photoemission
- **Authors**: Amos Afugu, Gyanu P. Kafle, Zhen-Fei Liu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 光电子能谱自旋极化主要反映杂化界面电子结构而非分子手性本身
...
- **arXiv**: [2603.23347](https://arxiv.org/abs/2603.23347)  ·  [PDF](https://arxiv.org/pdf/2603.23347.pdf)
- **Title (EN)**: The Fermi-Pasta-Ulam-Tsingou problem after 70 years: Universal laws of thermalization in lattice systems
- **Authors**: Weicheng Fu, Zhen Wang, Wei Lin, Dahai He, Jiao Wang, Yong Zhang, Hong Zhao
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文总结了弱非线性晶格系统热化的当前理解，将系统分为两类：具有扩展模式的系统在热力学极限下必然热化，而具有局域模式的系统在弱非线性下可视为热绝缘体。
...
- **arXiv**: [2603.23110](https://arxiv.org/abs/2603.23110)  ·  [PDF](https://arxiv.org/pdf/2603.23110.pdf)
- **Title (EN)**: Formation of Ag and Au Plasmonic Nanoparticles by Ion Implantation in Ga$_2$O$_3$ thin films
- **Authors**: Inês Freitas, Ana Sofia Sousa, Duarte Magalhães Esteves, Mamour Sall, Ângelo Rafael Granadeiro da Costa, Joana Madureira, Sandra Cabo Verde, Katharina Lorenz, Marco Peres
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 首次通过离子注入在Ga₂O₃薄膜中形成银和金等离子体纳米颗粒，并研究了其光学特性
...
- **arXiv**: [2603.23403](https://arxiv.org/abs/2603.23403)  ·  [PDF](https://arxiv.org/pdf/2603.23403.pdf)
- **Title (EN)**: Topological Filtering and Emergent Kondo Scale
- **Authors**: Ryosuke Yoshii, Rio Oto
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 拓扑孤子诱导的Kondo效应：一维狄拉克系统中符号变化质量项产生的孤子具有局域零模，其扩展波函数导致动量依赖的交换耦合，产生抑制高能散射的非平凡形状因子，从而形成能量依赖的有效Kondo耦合，使孤子的实空间结构直接控制涌现的Kondo能标。
...
- **arXiv**: [2603.22740](https://arxiv.org/abs/2603.22740)  ·  [PDF](https://arxiv.org/pdf/2603.22740.pdf)
- **Title (EN)**: Hydrogenation-induced gigantic resistance decrease of palladium films deposited by high pressure magnetron sputtering
- **Authors**: Yusuke Ikeda, Takuya Kawada, Yuki Shiomi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过高工作氩气压力沉积的钯薄膜在氢化后电阻显著降低，变化比高达1/335，创下新高纪录
...
- **arXiv**: [2603.22748](https://arxiv.org/abs/2603.22748)  ·  [PDF](https://arxiv.org/pdf/2603.22748.pdf)
- **Title (EN)**: Experimental investigation of magnetic properties of MnFeCo$_{4}$Si$_{2}$ discovered by GNoME
- **Authors**: Shuhei Naganuma, Jiro Kitagawa
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文通过实验验证了GNoME AI模型预测的磁性化合物MnFeCo₄Si₂，证实其为软铁磁体，居里温度1039K
...
- **arXiv**: [2603.22849](https://arxiv.org/abs/2603.22849)  ·  [PDF](https://arxiv.org/pdf/2603.22849.pdf)
- **Title (EN)**: Mechanical Origin of High-Temperature Thermal Stability in Platinum Oxides
- **Authors**: Fangyuan Ma, Mengzhao Sun, Xuejian Gong, Jun Cai, Zhujun Wang, Di Zhou
- **Categories**: cond-mat.mtrl-sci, cond-mat.soft
- **TL;DR**: 二维铂氧化物通过结构转变实现热稳定性提升，其机制源于弹性网络从过约束到等静力状态的转变，形成共度莫尔超晶格以释放弹性应变能。
...
- **arXiv**: [2603.23137](https://arxiv.org/abs/2603.23137)  ·  [PDF](https://arxiv.org/pdf/2603.23137.pdf)
- **Title (EN)**: Open Quantum System Theory of Muon Spin Relaxation in Materials
- **Authors**: Elvis F. Arguelles, Osamu Sugino
- **Categories**: cond-mat.mtrl-sci, cond-mat.other
- **TL;DR**: 提出非马尔可夫μ子自旋弛豫理论，将μ子视为开放量子自旋系统，处理时间相关的局域磁场环境，超越强碰撞近似，可分离静态和动态分量，识别非马尔可夫特征。
...
- **arXiv**: [2603.23165](https://arxiv.org/abs/2603.23165)  ·  [PDF](https://arxiv.org/pdf/2603.23165.pdf)
- **Title (EN)**: Field-induced spin-flip and spin-flop transitions in NdFeO3
- **Authors**: Mariana M. Gomes, Rui Vilarinho, E. Miranda, Ana S. Silva, Christelle Kadlec, Filip Kadlec, Miroslav Lebeda, Petr Proschek, Matus Mihalik, Marian Mihalik, Diparkan Jana, Fadi Choueikani, Clement Faugeras, José Antonio Paixão, Ester de Prado, Stanislav Kamba, Joaquim Agostinho Moreira
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该研究展示了磁场方向如何驱动NdFeO3中复杂的磁相变序列，揭示了4f-3d各向异性耦合对磁相变路径的控制作用。
...
- **arXiv**: [2603.23248](https://arxiv.org/abs/2603.23248)  ·  [PDF](https://arxiv.org/pdf/2603.23248.pdf)
- **Title (EN)**: Virtual materials testing of ASSB cathodes combining AI-based stochastic 3D modeling and numerical simulations
- **Authors**: Anina Dufter, Sabrina Weber, Orkun Furat, Johannes Schubert, René Rekers, Maximilian Luczak, Erik Glatt, Andreas Wiegmann, Anja Bielefeld, Volker Schmidt
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出虚拟材料测试框架，通过生成大量3D微观结构并数值模拟其宏观性能，建立几何描述符与有效性能之间的回归模型，用于优化全固态电池阴极微观结构
...
- **arXiv**: [2603.23340](https://arxiv.org/abs/2603.23340)  ·  [PDF](https://arxiv.org/pdf/2603.23340.pdf)
- **Title (EN)**: Experimental Insights into the Limiting Mechanism of Vacancy Transport in Sodium Metal Anodes for Solid State Batteries
- **Authors**: Ansgar Lowack, Rafael Anton, Bingchen Xue, Kristian Nikolowski, Cornelius Dirksen, Mareike Partsch, Alexander Michaelis
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 钠金属陶瓷固态电池在放电时存在电极剥离问题，研究发现临界电流密度受界面热力学限制而非体相扩散，添加锡-钠合金中间层可降低活化能，提高电池稳定性。
...
- **arXiv**: [2603.23341](https://arxiv.org/abs/2603.23341)  ·  [PDF](https://arxiv.org/pdf/2603.23341.pdf)
- **Title (EN)**: Reliable and High Performance IGZO and In2O3 Transistors via Channel Capping
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 展示了一种兼容400°C BEOL热预算的可靠氧化铟镓锌和氧化铟晶体管器件与工艺策略，通过充分利用氧化物材料固有特性，实现了无性能退化的高性能晶体管。
...
- **arXiv**: [2603.23367](https://arxiv.org/abs/2603.23367)  ·  [PDF](https://arxiv.org/pdf/2603.23367.pdf)
- **Title (EN)**: AlphaDiffract: Automated Crystallographic Analysis of Powder X-ray Diffraction Data
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: AlphaDiffract：基于深度学习从粉末X射线衍射数据直接预测晶体系统、空间群和晶格参数的框架，在实验数据上表现出色
...
### Ultrafast Sintering
- **arXiv**: [2603.23423](https://arxiv.org/abs/2603.23423)  ·  [PDF](https://arxiv.org/pdf/2603.23423.pdf)
- **Title (EN)**: Ultrafast Sintering
- **Authors**: Jian Luo
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 这篇论文综述了超快烧结技术的最新进展，分析了其机理、多种实现方法，并指出了未来的科学问题和技术机遇，特别是在高熵陶瓷材料领域的应用潜力。
...
- **arXiv**: [2603.23426](https://arxiv.org/abs/2603.23426)  ·  [PDF](https://arxiv.org/pdf/2603.23426.pdf)
- **Title (EN)**: Ferromagnetic Spin Glass State and Anomalous Hall Effect in Topological Semimetal Candidate Mn2Sb2Te5
- **Authors**: M. M. Sharma, Ankush Saxena, S. M. Huang, Santosh Karki Chhetri, Jin Hu, V. P. S. Awana
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: Mn2Sb2Te5单晶表现出自旋玻璃态和场致铁磁性，具有反常霍尔效应，为研究磁性与拓扑态的相互作用提供了平台。
...
- **arXiv**: [2603.23442](https://arxiv.org/abs/2603.23442)  ·  [PDF](https://arxiv.org/pdf/2603.23442.pdf)
- **Title (EN)**: Structural Chart of Copper-Silver Nanoalloys through machine learning
- **Authors**: Manoj Settem, Emanuele Telari, Antonio Tinti, Riccardo Ferrando, Alberto Giacomello
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发了一个计算框架来构建纳米合金的结构图，以38原子AgCu纳米合金为模型系统，通过并行回火分子动力学采样和机器学习分类，可视化不同结构和成分，构建了有限温度结构图。
...
- **arXiv**: [2603.23486](https://arxiv.org/abs/2603.23486)  ·  [PDF](https://arxiv.org/pdf/2603.23486.pdf)
- **Title (EN)**: Quantum Saturation of the Electro-Optic Effect
- **Authors**: Aiden Ross, Sankalpa Hazra, Albert Suceava, Dylan Sotir, Darrell G. Schlom, Venkatraman Gopalan, Long-Qing Chen
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 量子涨落可被利用来设计在低温下保持高性能的电光材料，通过将铁电相边界调至0K，在25K以下实现大且温度不敏感的电光响应。
...
- **arXiv**: [2603.23494](https://arxiv.org/abs/2603.23494)  ·  [PDF](https://arxiv.org/pdf/2603.23494.pdf)
- **Title (EN)**: Active learning-enabled multi-objective design of thermally conductive and mechanically compliant polymers
- **Authors**: Yuhan Liu, Jiaxin Xu, Renzheng Zhang, Meng Jiang, Tengfei Luo
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 开发基于多目标贝叶斯优化的主动学习框架，用于发现同时具有高热导率和低弹性模量的聚合物材料
