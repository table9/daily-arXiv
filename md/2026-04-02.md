---
title: "arXiv Daily · 2026-04-02 · 77 papers"
date: 2026-04-02
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-04-02 · 77 papers

### Magnetoelectric Control of Toroidal Moment in Ferroaxial Crystal PbMn$_{2}$Ni$_{6}$Te$_{3}$O$_{18}$
- **arXiv**: [2604.00526](https://arxiv.org/abs/2604.00526)  ·  [PDF](https://arxiv.org/pdf/2604.00526.pdf)
- **Title (EN)**: Magnetoelectric Control of Toroidal Moment in Ferroaxial Crystal PbMn$_{2}$Ni$_{6}$Te$_{3}$O$_{18}$
- **Authors**: Shungo Aoyagi, Shunsuke Kitou, Taka-hisa Arima, Yusuke Tokunaga
- **Categories**: cond-mat.str-el
- **TL;DR**: 通过电场和磁场控制PbMn₂Ni₆Te₃O₁₈中的磁环矩取向，利用方向二色性可视化磁铁环畴，揭示磁环矩、晶体铁轴矩和磁电单极子之间的本征耦合
...
- **arXiv**: [2604.00910](https://arxiv.org/abs/2604.00910)  ·  [PDF](https://arxiv.org/pdf/2604.00910.pdf)
- **Title (EN)**: The $\mathbb{Z}_N^{\times 3}$ symmetry protected boundary modes in two-dimensional Potts paramagnets
- **Authors**: Hrant Topchyan
- **Categories**: cond-mat.str-el, hep-th, math-ph
- **TL;DR**: 该论文构建并分析了一维边界哈密顿量，这些哈密顿量源于二维对称保护拓扑相，具有三角晶格上的$\mathbb{Z}_N^{\times 3}$对称性。通过上同调变换获得边缘模式的晶格模型，其结构由$N$的算术性质决定。
...
- **arXiv**: [2604.00244](https://arxiv.org/abs/2604.00244)  ·  [PDF](https://arxiv.org/pdf/2604.00244.pdf)
- **Title (EN)**: Optical frequency comb Fourier transform spectroscopy of the CH$_2$$^{79}$Br$^{81}$Br, CH$_2$$^{79}$Br$_2$, and CH$_2$$^{81}$Br$_2$ isotopologues in the 1180-1210 cm$^{-1}$ region
...
- **TL;DR**: 首次使用光频梳傅里叶变换光谱测量二溴甲烷在1180-1210 cm⁻¹区域的高分辨率吸收截面，解析了同位素特异性振转特征，并通过经验拟合和从头算方法建立了精确的光谱模型。
...
- **arXiv**: [2604.00608](https://arxiv.org/abs/2604.00608)  ·  [PDF](https://arxiv.org/pdf/2604.00608.pdf)
- **Title (EN)**: Directional-dependent Berezinskii-Kosterlitz-Thouless transition at EuO/KTaO$_3$(111) interfaces
...
- **TL;DR**: 二维超导界面中BKT转变温度随电流方向变化，揭示自发晶格对称性破缺和准一维相分离
...
- **arXiv**: [2604.00029](https://arxiv.org/abs/2604.00029)  ·  [PDF](https://arxiv.org/pdf/2604.00029.pdf)
- **Title (EN)**: Spatio-Temporal Uncertainty-Modulated Physics-Informed Neural Networks for Solving Hyperbolic Conservation Laws with Strong Shocks
- **Authors**: Darui Zhao, Ze Tao, Fujun Liu
- **Categories**: physics.comp-ph
- **TL;DR**: UM-PINN：一种基于时空不确定性调制的PINN方法，通过概率框架和多任务学习解决激波捕捉问题，相比基线方法精度提升数个数量级。
...
- **arXiv**: [2604.00233](https://arxiv.org/abs/2604.00233)  ·  [PDF](https://arxiv.org/pdf/2604.00233.pdf)
- **Title (EN)**: Propagation-mediated amplification of \{11\={2}0\}-biased inversion domain boundary alignment in polarity-mixed GaN lateral overgrowth
- **Authors**: Harim Song, Donghoi Kim, Chinkyo Kim
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究GaN极性反转域界在混合极性条件下的取向偏好，发现{11¯20}取向偏差随传播距离增强，表明传播过程本身会放大取向选择，而非仅由圆形边界几何决定。
...
- **arXiv**: [2604.00113](https://arxiv.org/abs/2604.00113)  ·  [PDF](https://arxiv.org/pdf/2604.00113.pdf)
- **Title (EN)**: Evidence of Metallic Wigner Crystal in Rhombohedral Graphene
...
- **TL;DR**: 在菱面体多层石墨烯中通过门控位移场调控能带，首次实验观测到金属性维格纳晶体（mWC），其中巡游空穴与钉扎的电子晶格共存。
...
- **arXiv**: [2604.00262](https://arxiv.org/abs/2604.00262)  ·  [PDF](https://arxiv.org/pdf/2604.00262.pdf)
- **Title (EN)**: Dielectric response and viscosity due to dipolar interactions
- **Authors**: David S. Dean, Haim Diamant
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该论文揭示了高极性液体中粘度与介电函数之间的直接预测关系，通过随机场理论建立了介电弛豫与粘度的理论联系。
...
- **arXiv**: [2604.00991](https://arxiv.org/abs/2604.00991)  ·  [PDF](https://arxiv.org/pdf/2604.00991.pdf)
- **Title (EN)**: Excitations across the equilibrium and photoinduced `hidden' states of magnetoresistive manganites
...
- **Categories**: cond-mat.str-el
- **TL;DR**: 利用超快激光脉冲在La2/3Ca1/3MnO3中诱导出长寿命的"隐藏"相，通过激光-RIXS技术揭示了该相中极化子软化、Jahn-Teller畸变部分抑制等特征，建立了极化子相图。
...
- **arXiv**: [2604.00405](https://arxiv.org/abs/2604.00405)  ·  [PDF](https://arxiv.org/pdf/2604.00405.pdf)
- **Title (EN)**: Reliable and Efficient Automated Transition-State Searches with Machine-Learned Interatomic Potentials
- **Authors**: Jonah Marks, Jonathon Vandezande, Joseph Gomes
- **Categories**: physics.chem-ph
- **TL;DR**: 本文系统评估了六种机器学习原子间势能函数与两种反应路径搜索算法在58个多样化反应中的表现，发现基于Open Molecules 2025数据集训练的模型（特别是MACE-OMol25）在有机系统中达到96.6%成功率，计算成本降低94-96%，为自动化反应发现提供了实用工具。
...
- **arXiv**: [2604.00762](https://arxiv.org/abs/2604.00762)  ·  [PDF](https://arxiv.org/pdf/2604.00762.pdf)
- **Title (EN)**: Improving YBa$_2$Cu$_3$O$_{7-δ}$ annealing times through a combining-temperatures route
- **Authors**: R. F. Luccas, L. Gallo
- **Categories**: cond-mat.supr-con
- **TL;DR**: 研究YBa₂Cu₃O₇₋δ材料在300-800°C温度范围内的恒温氧化过程，发现高温促进快速吸氧但饱和水平低，低温氧化慢但能达到更好氧化状态。提出结合高低温度的两步氧化协议，可显著缩短达到特定δ值的时间。
...
- **arXiv**: [2604.00149](https://arxiv.org/abs/2604.00149)  ·  [PDF](https://arxiv.org/pdf/2604.00149.pdf)
- **Title (EN)**: Towards Verifiable and Self-Correcting AI Physicists for Quantum Many-Body Simulations
- **Authors**: Ken Deng, Xiangfei Wang, Guijing Duan, Chen Mo, Junkun Huang, Runqing Zhang, Ling Qian, Zhiguo Huang, Jize Han, Di Luo
- **Categories**: physics.comp-ph
- **TL;DR**: PhysVEC是一个用于可验证和错误纠正的AI驱动物理研究的多智能体框架，包含编程验证器和科学验证器，在量子多体物理任务上显著优于基线方法。
...
- **arXiv**: [2604.00238](https://arxiv.org/abs/2604.00238)  ·  [PDF](https://arxiv.org/pdf/2604.00238.pdf)
- **Title (EN)**: Stress Asymmetry in Hard Magnetic Soft Materials
...
- **arXiv**: [2604.00115](https://arxiv.org/abs/2604.00115)  ·  [PDF](https://arxiv.org/pdf/2604.00115.pdf)
- **Title (EN)**: A footprint of zero-point entropy in higher-temperature magnetic thermodynamics
- **Authors**: Sergey Syzranov, Arthur P. Ramirez
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci, cond-mat.stat-mech, cond-mat.str-el
- **TL;DR**: 论文提出通过麦克斯韦关系检验零点熵的存在性，为识别自旋液体候选材料和自旋冰提供新方法
...
- **arXiv**: [2604.00114](https://arxiv.org/abs/2604.00114)  ·  [PDF](https://arxiv.org/pdf/2604.00114.pdf)
- **Title (EN)**: Crystals Caught Doping: Metallic Wigner Crystals in Rhombohedral Graphene
- **Authors**: Junkai Dong, Tomohiro Soejima, Daniel E. Parker, Ashvin Vishwanath
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 该论文提出了一种金属性维格纳晶体（MWC）理论，解释了当维格纳晶体发生自掺杂时，会从不导电的绝缘态转变为导电的金属态。
...
- **arXiv**: [2604.00294](https://arxiv.org/abs/2604.00294)  ·  [PDF](https://arxiv.org/pdf/2604.00294.pdf)
- **Title (EN)**: Self-similar summation of virial expansions
- **Authors**: V. I. Yukalov, E. P. Yukalova
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 提出基于自相似逼近理论的新方法，用于对发散维里展开进行求和，克服传统Padé逼近的缺陷
...
- **arXiv**: [2604.01085](https://arxiv.org/abs/2604.01085)  ·  [PDF](https://arxiv.org/pdf/2604.01085.pdf)
- **Title (EN)**: The multichannel Dyson equation for double ionisation spectroscopies
- **Authors**: Pierre Sellié, J. Arjan Berger, Pina Romaniello
- **Categories**: cond-mat.str-el
- **TL;DR**: 该论文提出使用多通道Dyson方程超越RPA近似，通过耦合粒子-粒子二体格林函数与四体格林函数的3空穴-1电子和3电子-1空穴通道，能够同时描述光电子能谱中的准粒子和卫星峰。
...
- **arXiv**: [2604.00522](https://arxiv.org/abs/2604.00522)  ·  [PDF](https://arxiv.org/pdf/2604.00522.pdf)
- **Title (EN)**: Stochastic GW with the Orthogonalized Projector Augmented Wave Method
- **Authors**: Dimitri Bazile, Minh Nguyen, Yuji Kon, Tucker Allen, Daniel Neuhauser
- **Categories**: physics.chem-ph
- **TL;DR**: 提出了基于正交化投影缀加波方法的随机GW方法（OPAW-sGW），相比传统范数守恒赝势sGW，能在更粗的实空间网格上获得精确的准粒子带隙
...
- **arXiv**: [2604.00838](https://arxiv.org/abs/2604.00838)  ·  [PDF](https://arxiv.org/pdf/2604.00838.pdf)
- **Title (EN)**: Emergent superconductivity at 16.3 K in an altermagnetic candidate Na$_{2-x}$V$_2$Se$_2$O with broken inversion symmetry
...
- **arXiv**: [2604.00285](https://arxiv.org/abs/2604.00285)  ·  [PDF](https://arxiv.org/pdf/2604.00285.pdf)
- **Title (EN)**: Geometry-informed neural atlas for boundary value problems of complex 3D geometries
- **Authors**: WaiChing Sun
- **Categories**: physics.comp-ph, math.DG
- **TL;DR**: 提出一种基于学习的几何表示方法，使用重叠的体积坐标图表和神经解码器替代传统体积网格划分，支持多种求解器而无需重新网格化。
...
- **arXiv**: [2604.00288](https://arxiv.org/abs/2604.00288)  ·  [PDF](https://arxiv.org/pdf/2604.00288.pdf)
- **Title (EN)**: Spatially modulated morphotropic phase boundaries in a compressively strained multiferroic thin film
...
- **TL;DR**: 在压缩应变BiFeO3薄膜中观察到两种相界：平坦的MPB线和新型锯齿状相界，揭示了原子尺度极化旋转和晶格位错，相场模拟表明其形成源于Landau能与弹性能的平衡。
...
- **arXiv**: [2604.00217](https://arxiv.org/abs/2604.00217)  ·  [PDF](https://arxiv.org/pdf/2604.00217.pdf)
- **Title (EN)**: Dielectric control of ultrafast carrier dynamics and transport in graphene
- **Authors**: Hai I. Wang, Xiaoyu Jia, Anand Nivedan, Mischa Bonn, Aron W. Cummings, Alessandro Principi, Klaas-Jan Tielrooij
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 通过调控石墨烯的介电环境，可以控制超快载流子动力学而不改变费米能级、光功率或环境温度，从而优化光电探测器性能
...
- **arXiv**: [2604.00354](https://arxiv.org/abs/2604.00354)  ·  [PDF](https://arxiv.org/pdf/2604.00354.pdf)
- **Title (EN)**: Unified Gauge-Geometry Symmetry for Equilibrium Statistical Mechanics
...
- **arXiv**: [2604.01223](https://arxiv.org/abs/2604.01223)  ·  [PDF](https://arxiv.org/pdf/2604.01223.pdf)
- **Title (EN)**: Electronic structure and correlation of La$_4$Co$_2$NiO$_8$Cl$_2$: a theoretical proposal for a La$_4$Ni$_3$O$_{10}$-like high-temperature superconductor
- **Authors**: Si-Yong Jia, Jing-Xuan Wang, Jian-Hong She, Rong-Qiang He, Zhong-Yi Lu
- **Categories**: cond-mat.str-el, cond-mat.supr-con
- **TL;DR**: 该研究提出了一种新型钴基材料La₄Co₂NiO₈Cl₂，通过电子掺杂高压三层钴酸盐La₄Co₃O₁₀，其结构和电子性质与高压下的La₄Ni₃O₁₀相似，可能具有高温超导性。
...
- **arXiv**: [2604.00709](https://arxiv.org/abs/2604.00709)  ·  [PDF](https://arxiv.org/pdf/2604.00709.pdf)
- **Title (EN)**: Role of anisotropic electronic friction in laser-driven hydrogen recombination on copper
- **Authors**: Alexander Spears, Wojciech G. Stark, Reinhard J. Maurer
- **Categories**: physics.chem-ph
- **TL;DR**: 机器学习模拟框架比较铜表面激光驱动氢析出反应中各向同性与各向异性电子摩擦模型，发现各向异性摩擦显著影响能量转移速率和反应概率，但对最终能量分布影响不大。
...
- **arXiv**: [2604.01027](https://arxiv.org/abs/2604.01027)  ·  [PDF](https://arxiv.org/pdf/2604.01027.pdf)
- **Title (EN)**: Detecting pairing symmetry of bilayer nickelates using electronic Raman scattering
- **Authors**: Jun Zhan, Matías Bejas, Andreas P. Schnyder, Andrés Greco, Xianxin Wu, Jiangping Hu
- **Categories**: cond-mat.supr-con
- **TL;DR**: 该研究通过电子拉曼散射分析双层镍酸盐La₃Ni₂O₇的超导配对对称性，发现拉曼响应能区分不同配对对称性并识别口袋依赖的能隙幅度。
...
- **arXiv**: [2604.00576](https://arxiv.org/abs/2604.00576)  ·  [PDF](https://arxiv.org/pdf/2604.00576.pdf)
- **Title (EN)**: Discovery of Symbolic Hamiltonian Expressions with Buckingham-Symplectic Networks
- **Authors**: Joe Germany, Joseph Bakarji, Sara Najem
- **Categories**: physics.comp-ph, nlin.SI, physics.data-an
- **TL;DR**: BuSyNet：结合能量量纲约束和正则变换的深度学习架构，用于从轨迹数据中发现符号化的哈密顿量表达式
...
- **arXiv**: [2604.00325](https://arxiv.org/abs/2604.00325)  ·  [PDF](https://arxiv.org/pdf/2604.00325.pdf)
- **Title (EN)**: Metallic d-wave altermagnetism in WFeB: a platform for electrically switchable perpendicular spin-splitter response
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: WFeB被鉴定为金属性d波交变磁体，属于TiNiSi型家族，具有约100 meV的非相对论性自旋分裂，支持强自旋分裂输运响应，可实现电流诱导的奈尔矢量确定性切换。
...
- **arXiv**: [2604.00221](https://arxiv.org/abs/2604.00221)  ·  [PDF](https://arxiv.org/pdf/2604.00221.pdf)
- **Title (EN)**: Field-unmasked quantum geometry in a symmetry-forbidden photocurrent
...
- **TL;DR**: 通过缺陷调控实现磁场选择性的对称性破缺，揭示了手性量子材料中隐藏的量子几何响应
...
- **arXiv**: [2604.00358](https://arxiv.org/abs/2604.00358)  ·  [PDF](https://arxiv.org/pdf/2604.00358.pdf)
- **Title (EN)**: Anomalous waiting-time distributions in postselection-free quantum many-body dynamics under continuous monitoring
- **Authors**: Kazuki Yamamoto, Ryusuke Hamazaki
- **Categories**: cond-mat.stat-mech, cond-mat.quant-gas, quant-ph
- **TL;DR**: 该论文研究了连续监测量子多体系统中量子跳跃的等待时间分布，发现半链子系统表现出异常尾部分布，与整个系统的泊松分布形成鲜明对比，揭示了测量强度对系统尺寸依赖性的定性变化。
...
- **arXiv**: [2604.00841](https://arxiv.org/abs/2604.00841)  ·  [PDF](https://arxiv.org/pdf/2604.00841.pdf)
- **Title (EN)**: Thermodynamics-Informed Accurate pKa Prediction and Protonation State Generation in PlayMolecule AI
- **Authors**: Francesco Pesce, Stephen Farr, Gianni de Fabritiis
- **Categories**: physics.chem-ph
- **TL;DR**: AcepKa是基于Uni-pKa框架的先进pKa预测应用，集成在PlayMolecule AI平台中，通过建模完整的质子化系综确保热力学一致性，并包含GPU加速的构象生成器和3D感知的质子化功能。
...
- **arXiv**: [2604.01062](https://arxiv.org/abs/2604.01062)  ·  [PDF](https://arxiv.org/pdf/2604.01062.pdf)
- **Title (EN)**: Uniaxial Compression-Induced Anisotropy and Electronic Dimensionality in the Iron-Based Superconductor FeSe
- **Authors**: Alexy Bertrand, Masaki Mito, Kazuma Nakamura, Mahmoud Abdel-Hafiez
- **Categories**: cond-mat.supr-con
- **TL;DR**: FeSe的超导转变温度在不同压缩模式下呈现方向依赖性：面内压缩抑制超导，而面外压缩和静水压则提升Tc，这与电子结构维度变化有关
...
- **arXiv**: [2604.00668](https://arxiv.org/abs/2604.00668)  ·  [PDF](https://arxiv.org/pdf/2604.00668.pdf)
- **Title (EN)**: Moment-preserving particle merging via non-negative least squares
- **Authors**: Georgii Oblapenko, Manuel Torrilhon
- **Categories**: physics.comp-ph, physics.flu-dyn, physics.plasm-ph
- **TL;DR**: 提出一种新的粒子合并算法，通过求解非负最小二乘问题来守恒粒子分布的任意速度和空间矩，并扩展到保持精确和近似碰撞率，应用于稀薄气体动力学模拟中显著降低合并引起的误差。
...
- **arXiv**: [2604.00359](https://arxiv.org/abs/2604.00359)  ·  [PDF](https://arxiv.org/pdf/2604.00359.pdf)
- **Title (EN)**: AI-assisted Human-in-the-Loop Web Platform for Structural Characterization in Hard drive design
...
- **TL;DR**: 开发了一个可调谐的人机协同工作流框架，用于STEM图像的模块化和自适应分析，实现多层薄膜厚度和界面粗糙度的自动化测量
...
- **arXiv**: [2604.00232](https://arxiv.org/abs/2604.00232)  ·  [PDF](https://arxiv.org/pdf/2604.00232.pdf)
- **Title (EN)**: Directly visualizing the energy level structure of quantum dot molecules
- **Authors**: Heun Mo Yoo, Tanner M. Janda, Connor Nasseraddin, Jason R. Petta
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 该论文展示了一种能够映射双量子点能级结构的光谱技术，可测量能级失谐、点间隧穿耦合和磁场的影响，在一电子和两电子体系中观测到原子到分子态的转变以及能级分裂。
...
- **arXiv**: [2604.00552](https://arxiv.org/abs/2604.00552)  ·  [PDF](https://arxiv.org/pdf/2604.00552.pdf)
- **Title (EN)**: Emergent Macroscopic Nonreciprocity from Identical Active Particles via Spontaneous Symmetry Breaking
- **Authors**: Wei-Chen Guo, Zuo Wang, Pei-Fang Wu, Li-Jun Lang, Bao-Quan Ai, Liang He
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 单物种非互易性在宏观尺度通常作用有限，但自发对称破缺能显著增强其宏观效应，导致活性粒子系统中出现新的凝聚态和行波带结构。
...
- **arXiv**: [2604.01189](https://arxiv.org/abs/2604.01189)  ·  [PDF](https://arxiv.org/pdf/2604.01189.pdf)
- **Title (EN)**: Analytic nuclear gradients including oriented external electric fields in a molecule-fixed frame
- **Authors**: Duc Anh Lai, Devin A. Matthews
- **Categories**: physics.chem-ph
- **TL;DR**: 提出两种分子参考系（主轴系和局部参考系）来定义分子框架内的定向电场，消除电场与分子相对取向的模糊性，并推导实现外部电场下的解析核梯度，应用于场依赖的几何优化。
...
- **arXiv**: [2604.01145](https://arxiv.org/abs/2604.01145)  ·  [PDF](https://arxiv.org/pdf/2604.01145.pdf)
- **Title (EN)**: FerBo: a noise resilient qubit hybridizing Andreev and fluxonium states
...
- **TL;DR**: 提出一种新型超导量子电路FerBo，通过铁磁-玻色混合机制，在宽参数范围内同时抑制弛豫和退相干
...
- **arXiv**: [2604.00675](https://arxiv.org/abs/2604.00675)  ·  [PDF](https://arxiv.org/pdf/2604.00675.pdf)
- **Title (EN)**: Procela: Epistemic Governance in Mechanistic Simulations Under Structural Uncertainty
- **Authors**: Kinson Vernet
- **Categories**: physics.comp-ph, cs.AI, cs.CE
- **TL;DR**: Procela是一个Python框架，让模拟能够测试自身假设，通过变量作为认知权威、机制编码竞争本体论、治理系统动态调整拓扑结构，应用于抗菌素耐药性传播研究。
...
- **arXiv**: [2604.00369](https://arxiv.org/abs/2604.00369)  ·  [PDF](https://arxiv.org/pdf/2604.00369.pdf)
- **Title (EN)**: Comparative study of room temperature and quench condensed bismuth films: morphology and electronic characteristics
- **Authors**: Yulia Kirina, Prakash Sharma, Wyatt Thomas, Tristan Anderson, Arya G. Pour, Victoria Soghomonian, Jean J. Heremans
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 比较在296K（室温）和77K（淬火冷凝）衬底温度下沉积的铋薄膜在三种不同衬底上的性能差异，发现温度变化显著影响薄膜的结晶性、形貌和电学性质。
...
- **arXiv**: [2604.00366](https://arxiv.org/abs/2604.00366)  ·  [PDF](https://arxiv.org/pdf/2604.00366.pdf)
- **Title (EN)**: Nonlinear Frequency-Momentum Topology and Doubling of Multifold Exceptional Points
- **Authors**: Tsuneya Yoshida
- **Categories**: cond-mat.mes-hall, cond-mat.str-el, physics.optics
- **TL;DR**: 该论文建立了n重异常点的加倍定理，引入了频率-动量绕数作为新的拓扑不变量，统一证明了在无对称性和多种对称性约束下的加倍定理，并揭示了PT对称EP2s的ℤ拓扑结构。
...
- **arXiv**: [2604.00732](https://arxiv.org/abs/2604.00732)  ·  [PDF](https://arxiv.org/pdf/2604.00732.pdf)
- **Title (EN)**: Tunable information insulation induced by constraint mismatch
- **Authors**: Akshay Panda, Anwesha Chattopadhyay
- **Categories**: cond-mat.stat-mech, quant-ph
- **TL;DR**: 研究具有双约束的两个1D PXP链复合模型，连接点形成无限运动学屏障阻止量子信息交换，但可通过放松约束使其渗透。多个冻结连接点将希尔伯特空间分裂为指数增长的Krylov碎片，每个对称性分解的能级统计严格泊松分布。发现手性保护的零能模和数量倍增的疤痕态，并引入具有空间可调热与非热区域的新颖Fock态。
...
- **arXiv**: [2604.00782](https://arxiv.org/abs/2604.00782)  ·  [PDF](https://arxiv.org/pdf/2604.00782.pdf)
- **Title (EN)**: A P-Adaptive Hybridizable Discontinuous Galerkin Spectral Element Method for Electrostatic Particle-in-Cell Simulations
- **Authors**: Tobias Ott, Marcel Pfeiffer, Stephen Copplestone
- **Categories**: physics.comp-ph
- **TL;DR**: 提出了一种p自适应高阶可杂交间断伽辽金谱元法(HDG-SEM)，用于静电等离子体模拟中的泊松方程求解，通过局部多项式阶数自适应减少全局自由度
...
- **arXiv**: [2604.00412](https://arxiv.org/abs/2604.00412)  ·  [PDF](https://arxiv.org/pdf/2604.00412.pdf)
- **Title (EN)**: Robust $d$-wave altermagnetism in $\mathrm{RbCr_2Se_2O}$
- **Authors**: San-Dong Guo
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: RbCr₂Se₂O是稳健的d波交变磁性金属，其C型和G型反铁磁构型能量差异大，可通过面内单轴应变产生净磁矩，为实验区分G型构型提供策略。
...
- **arXiv**: [2604.00409](https://arxiv.org/abs/2604.00409)  ·  [PDF](https://arxiv.org/pdf/2604.00409.pdf)
- **Title (EN)**: Gate-Tunable Photoresponse of Graphene Josephson Junctions at Terahertz Frequencies
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 石墨烯约瑟夫森结在太赫兹频率下表现出强光电响应，为太赫兹量子传感开辟新途径
...
- **arXiv**: [2604.00777](https://arxiv.org/abs/2604.00777)  ·  [PDF](https://arxiv.org/pdf/2604.00777.pdf)
- **Title (EN)**: Negative Differential Heat Conductivity in a Harmonic Chain Coupled to a Particle Reservoir
- **Authors**: Simon Krekels, Christian Maes, Ion Santra, Ruoxun Zhai
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 在耦合不同温度的熱浴時，負微分熱導率通常歸因於連接介質的非線性相互作用。本研究表明，這種效應可以純粹來自熱浴的性質及其與介質的耦合。
...
- **arXiv**: [2604.00815](https://arxiv.org/abs/2604.00815)  ·  [PDF](https://arxiv.org/pdf/2604.00815.pdf)
- **Title (EN)**: Stable Determinant Monte Carlo Simulations at Large Inverse Temperature $β$
- **Authors**: Thomas Luu, Johann Ostmeyer, Petar Sinilkov, Finn L. Temmen
- **Categories**: physics.comp-ph, cond-mat.str-el, hep-lat
- **TL;DR**: 提出一种基于矩阵分解的数值稳定方法，解决低温下DQMC计算中的精度损失和不稳定性问题，使模拟温度可达β≳90。

At low temperatures $T$ where $1/T=β\gg1$ the naïve implementation of determinant quantum Monte Carlo (DQMC) methods suffers from loss of precision and numerical instabilities when evaluating the fermion determinant.
...
- **arXiv**: [2604.00461](https://arxiv.org/abs/2604.00461)  ·  [PDF](https://arxiv.org/pdf/2604.00461.pdf)
- **Title (EN)**: Bipolar plates for the next generation of proton exchange membrane fuel cells (PEMFCs): A review of the latest processing methods for unconventional flow channels
- **Authors**: Zahra Kazemi, Kamran Behdinan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 该论文综述了聚合物电解质膜燃料电池（PEMFC）双极板制造技术的最新进展，特别关注增材制造等先进制造方法，以解决传统制造工艺在制造复杂几何结构方面的局限性，推动实验室创新向工业规模生产的转化。
...
- **arXiv**: [2604.00486](https://arxiv.org/abs/2604.00486)  ·  [PDF](https://arxiv.org/pdf/2604.00486.pdf)
- **Title (EN)**: Electronic Raman scattering from 2D metals with broken inversion symmetry
- **Authors**: Mojdeh Saleh, Saurabh Maiti
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 论文研究了非中心对称金属中电子拉曼散射(eRS)的理论，发现由于SU(2)对称性破缺，eRS可以直接探测自旋激发，无需激光共振调谐。以石墨烯系统为例，其信号比传统2D电子气体强数个数量级。
...
- **arXiv**: [2604.00858](https://arxiv.org/abs/2604.00858)  ·  [PDF](https://arxiv.org/pdf/2604.00858.pdf)
- **Title (EN)**: Statistical Physics of Coding for the Integers
- **Authors**: Neri Merhav
- **Categories**: cond-mat.stat-mech, cs.IT
- **TL;DR**: 该论文研究基于zeta分布的自然数压缩编码范式，提出统计力学解释（Hagedorn系统和玻色气体），开发接近理想码长的简单编码方案，分析块编码的微正则熵函数和大偏差率函数，揭示Hagedorn型相变导致的系综部分等价性。
...
- **arXiv**: [2604.01119](https://arxiv.org/abs/2604.01119)  ·  [PDF](https://arxiv.org/pdf/2604.01119.pdf)
- **Title (EN)**: A multiphysics model for triboelectric nanogenerator design with explicit surface roughness representation
...
- **Categories**: physics.comp-ph, cond-mat.mtrl-sci, cs.CE, physics.app-ph
- **TL;DR**: 提出耦合机械接触与静电分析的多物理场有限元框架，精确模拟表面粗糙度对摩擦纳米发电机性能的影响，相比解析模型能更准确预测真实接触面积和电学响应。
...
- **arXiv**: [2604.00463](https://arxiv.org/abs/2604.00463)  ·  [PDF](https://arxiv.org/pdf/2604.00463.pdf)
- **Title (EN)**: Radio-Frequency-Driven Reshaping of the Mesoscale Charge-Density-Wave Landscape in 1T-TaS2 Thin-Film Devices
- **Authors**: Maedeh Taheri, Zahra Ebrahim Nataj, Nick Sesing, Topojit Debnath, Tina T. Salguero, Roger K. Lake, Alexander A. Balandin
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: RF驱动通过改变电荷密度波畴结构，调控1T-TaS2薄膜的输运特性，实现集体电子-声子序的可控调节
...
- **arXiv**: [2604.00678](https://arxiv.org/abs/2604.00678)  ·  [PDF](https://arxiv.org/pdf/2604.00678.pdf)
- **Title (EN)**: Electronic transport in BN-encasulated graphene limited by remote phonon scattering
- **Authors**: Khalid Dinar, Francesco Macheda, Alberto Guandalini, Matthieu Paillet, Christophe Consejo, Frederic Teppe, Benoit Jouault, Thibault Sohier, Sébastien Nanot
- **Categories**: cond-mat.mes-hall
- **TL;DR**: hBN封装石墨烯中，BN的声子通过远程散射显著影响电阻率，特别是在150K至室温区间，低载流子密度下影响更明显
...
- **arXiv**: [2604.00870](https://arxiv.org/abs/2604.00870)  ·  [PDF](https://arxiv.org/pdf/2604.00870.pdf)
- **Title (EN)**: The Klein bottle ratio of two-dimensional ferromagnetic Potts models
- **Authors**: Zi-Han Wang, Li-Ping Yang
- **Categories**: cond-mat.stat-mech, cond-mat.str-el
- **TL;DR**: 使用张量网络重正化群方法研究二维5态铁磁Potts模型的弱一级相变，通过Klein瓶比g、转移矩阵谱和纠缠熵分析临界行为，提取中心荷并区分连续相变与弱一级相变。
...
- **arXiv**: [2604.01017](https://arxiv.org/abs/2604.01017)  ·  [PDF](https://arxiv.org/pdf/2604.01017.pdf)
- **Title (EN)**: Parameter-Efficient Fine-Tuning of Machine-Learning Interatomic Potentials for Phonon and Thermal Properties
- **Authors**: Jonas Grandel, Philipp Benner, Janine George
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 研究不同微调策略对机器学习原子间势能预测声子带结构、热性质及势能面的影响，提出Equitrain微调框架，在53个材料系统中验证其优越性。
...
- **arXiv**: [2604.00482](https://arxiv.org/abs/2604.00482)  ·  [PDF](https://arxiv.org/pdf/2604.00482.pdf)
- **Title (EN)**: Magnetoelastic instabilities in kagome antiferromagnet Mn3-xGa
- **Authors**: Linxuan Song, Feng Zhou, Guilin Lu, Liang Yao, Xuekui Xi, Yong-Chang Lau, Youguo Shi, Wenhong Wang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过调节Mn浓度，在六方Mn3-xGa合金中发现了一系列成分控制的涌现现象，包括零热膨胀行为和场辅助结构相变，这些晶格不稳定性伴随着磁性和输运异常，霍尔符号反转源于晶体对称性破缺而非磁重取向。
...
- **arXiv**: [2604.00705](https://arxiv.org/abs/2604.00705)  ·  [PDF](https://arxiv.org/pdf/2604.00705.pdf)
- **Title (EN)**: Topological magnetotransport in modified-Haldane systems
- **Authors**: A. Uzair, Muzamil Shah, Imtiaz Khan, Kashif Sabeeh
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该研究通过改进的Haldane模型理论分析了二维量子材料的量子磁输运和磁光特性，揭示了拓扑相变在朗道能级和磁光吸收谱中的特征，并展示了在硅烯和TMDC单层中的电可调拓扑相变潜力。
...
- **arXiv**: [2604.00930](https://arxiv.org/abs/2604.00930)  ·  [PDF](https://arxiv.org/pdf/2604.00930.pdf)
- **Title (EN)**: Absence of $O (2)$ symmetry in the Vicsek model
- **Authors**: Yushin Takahashi, Kota Mitsui, Tsuyoshi Mizohata, Hideyuki Miyahara
- **Categories**: cond-mat.stat-mech, physics.bio-ph
- **TL;DR**: Vicsek模型缺乏O(2)对称性，原论文报道的相变在自适应选择全局相位时消失
...
- **arXiv**: [2604.01013](https://arxiv.org/abs/2604.01013)  ·  [PDF](https://arxiv.org/pdf/2604.01013.pdf)
- **Title (EN)**: Observation of acoustic magneto-chiral anisotropy in $α$-quartz
- **Authors**: M. Altangerel, S. Badoux, C. Proust, D. Vignolles, G. L. J. A. Rikken
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 实验观测到α-石英中超声传播的磁手性各向异性，使用高分辨率超声光谱仪测量，提出宏观Becquerel-like模型解释效应大小和频率依赖性
...
- **arXiv**: [2604.01140](https://arxiv.org/abs/2604.01140)  ·  [PDF](https://arxiv.org/pdf/2604.01140.pdf)
- **Title (EN)**: Principal component analysis of wavefunction snapshots in non-equilibrium dynamics
- **Authors**: Dharmesh Yadav, Devendra Singh Bhakuni, Bijay Kumar Agarwalla
- **Categories**: cond-mat.stat-mech, physics.comp-ph, physics.data-an, quant-ph
- **TL;DR**: 提出一种基于主成分分析的量子动力学分析方法，通过特定数据变换最大化信息含量，建立主成分与可观测量之间的联系，解释降维方案揭示的动力学特征。
...
- **arXiv**: [2604.00483](https://arxiv.org/abs/2604.00483)  ·  [PDF](https://arxiv.org/pdf/2604.00483.pdf)
- **Title (EN)**: Revealing buried ferroelectric topologies by depth-resolved electron diffraction imaging
...
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: 提出深度分辨电子衍射成像(DREDI)技术，首次实现纳米到毫米尺度连续极化映射，揭示BiFeO3薄膜中隐藏的拓扑极性纹理三维演化
...
- **arXiv**: [2604.00755](https://arxiv.org/abs/2604.00755)  ·  [PDF](https://arxiv.org/pdf/2604.00755.pdf)
- **Title (EN)**: Andreev-enhanced conductance quantization and gate-tunable induced superconducting gap in germanium
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在Ge/SiGe量子阱异质结构中，通过分裂栅量子点接触研究超导-半导体界面的安德烈夫反射和邻近效应，观察到电导量子化增强和可调超导能隙。
...
- **arXiv**: [2604.00571](https://arxiv.org/abs/2604.00571)  ·  [PDF](https://arxiv.org/pdf/2604.00571.pdf)
- **Title (EN)**: Beyond Beryllium: AI-Accelerated Materials Discovery for Interstellar Spacecraft Shielding
- **Authors**: Yue Li, Xu Pan, Kaiyuan Guo
- **Categories**: cond-mat.mtrl-sci, physics.pop-ph
- **TL;DR**: 该研究使用DFT和GNN筛选20种候选材料，发现h-BN和B4C兼具机械防护和中子屏蔽功能，提出石墨烯/h-BN/聚合物层状异质结构屏蔽设计，相比原铍方案减重47%。
...
- **arXiv**: [2604.00839](https://arxiv.org/abs/2604.00839)  ·  [PDF](https://arxiv.org/pdf/2604.00839.pdf)
- **Title (EN)**: Impact of gate voltage on switching field of perpendicular magnetic tunnel junctions with a synthetic antiferromagnetic free layer
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该研究通过微磁模拟和实验，分析了具有合成反铁磁自由层的垂直磁隧道结中电压辅助场切换机制，揭示了VCMA、STT和焦耳加热在不同RA产品器件中的主导作用，为SOT-MRAM优化提供了统一分析框架。
...
- **arXiv**: [2604.00596](https://arxiv.org/abs/2604.00596)  ·  [PDF](https://arxiv.org/pdf/2604.00596.pdf)
- **Title (EN)**: Nodal-Line Semimetals: Emerging Opportunities for Topological Electronics and Beyond
- **Authors**: Ashutosh S. Wadge, Pardeep K. Tanwar, Giuseppe Cuono, Carmine Autieri
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 这篇综述全面概述了节点线半金属的理论框架和实验实现，重点讨论对称性保护、对称性破缺后果，以及它们在电子结构测量和输运现象中的特征。
...
- **arXiv**: [2604.00895](https://arxiv.org/abs/2604.00895)  ·  [PDF](https://arxiv.org/pdf/2604.00895.pdf)
- **Title (EN)**: The effect of staggered nonlinearity on the Su-Schrieffer-Heeger model
- **Authors**: Ahmed Alharthy, RW Bomantara
- **Categories**: cond-mat.mes-hall, cond-mat.other, quant-ph
- **TL;DR**: SSH模型中加入子晶格依赖的局域非线性，通过半解析和数值方法研究其谱性质，发现非线性诱导的拓扑相变、边缘态能量与非线性参数无关等新奇现象。
...
- **arXiv**: [2604.00347](https://arxiv.org/abs/2604.00347)  ·  [PDF](https://arxiv.org/pdf/2604.00347.pdf)
- **Title (EN)**: Lieb-Schultz-Mattis Anomalies and Anomaly Matching
- **Authors**: Liujun Zou, Meng Cheng
- **Categories**: cond-mat.str-el, cond-mat.quant-gas, hep-th, math-ph
- **TL;DR**: 本文综述了Lieb-Schultz-Mattis（LSM）异常及其匹配机制，涵盖从量子自旋链到高维系统、无序系统、费米子系统等各类量子多体系统。
...
- **arXiv**: [2604.00629](https://arxiv.org/abs/2604.00629)  ·  [PDF](https://arxiv.org/pdf/2604.00629.pdf)
- **Title (EN)**: Strain-tunable multipiezo effects in Janus monolayer Cr2SSe: Selective reversal of valley polarization and single-spin-channel anomalous valley Hall effect
- **Authors**: Quan Shen, Jianing Tan, Tao Yao, Wenhu Liao, Jiansheng Dong
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: Cr2SSe Janus单层膜具有应变可调的多压电效应和独特的谷电子特性，通过应变可实现谷极化的选择性反转和独立控制。
...
- **arXiv**: [2604.00905](https://arxiv.org/abs/2604.00905)  ·  [PDF](https://arxiv.org/pdf/2604.00905.pdf)
- **Title (EN)**: The origin of KPZ-scaling in arrays of polariton condensates
- **Authors**: Denis Novokreschenov, Alexey Kavokin
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该研究揭示了极化子凝聚体中KPZ标度行为的起源，发现Goldstone模的粒子数涨落是导致一阶关联函数幂律行为的关键机制。
...
- **arXiv**: [2604.00636](https://arxiv.org/abs/2604.00636)  ·  [PDF](https://arxiv.org/pdf/2604.00636.pdf)
- **Title (EN)**: Spontaneous structural reconstructions and properties of ultrathin triangular ZnSe nanoplatelets
- **Authors**: Alexander I. Lebedev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 通过第一性原理计算发现ZnSe纳米片的新型六方结构，能量低于已知结构，并研究了其与L-半胱氨酸分子吸附后的结构重构和光学活性增强
...
- **arXiv**: [2604.00922](https://arxiv.org/abs/2604.00922)  ·  [PDF](https://arxiv.org/pdf/2604.00922.pdf)
- **Title (EN)**: Nonreciprocal spin waves of helical magnetization states in CoFeB/NiFe bilayers
- **Authors**: Claudia Negrete, Omar J. Suarez, Attila Kákay, Jorge A. Otálora
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文研究了CoFeB/NiFe双层结构中螺旋平衡态的非互易自旋波特性，包括频率偏移。研究发现层间交换相互作用在频率偏移中起关键作用，而不仅仅是文献中通常认为的偶极相互作用。
...
- **arXiv**: [2604.00665](https://arxiv.org/abs/2604.00665)  ·  [PDF](https://arxiv.org/pdf/2604.00665.pdf)
- **Title (EN)**: Microscopic Theory of Superionic Phase Transitions: Nonadiabatic Dynamics and Many-Body Effects
- **Authors**: Jiaming Hu, Zhichao Guo, Jingyi Liang, Bartomeu Monserrat
- **Categories**: cond-mat.mtrl-sci
...
- **arXiv**: [2604.01063](https://arxiv.org/abs/2604.01063)  ·  [PDF](https://arxiv.org/pdf/2604.01063.pdf)
- **Title (EN)**: Simultaneous operation of an 18-qubit modular array in germanium
...
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 研究人员在锗基半导体上实现了18量子比特阵列，采用可扩展的2xN架构，实现了高保真度单量子比特门操作和可控Z门，生成了三量子比特GHZ态，证明了自旋量子比特阵列的可扩展性。
...
- **arXiv**: [2604.00695](https://arxiv.org/abs/2604.00695)  ·  [PDF](https://arxiv.org/pdf/2604.00695.pdf)
- **Title (EN)**: A comparison of the spin-phonon behaviour of Fe$_2$P-based magnetocaloric materials
- **Authors**: Mikael S. Andersson, Simon R. Larsen, Erna K. Delczeg-Czirjak, Antonio Corona, Jacques Ollivier, Wiebke Lohstroh, Helen Y. Playford, Cheng Li, Pascale P. Deen, Johan Cedervall
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究Fe₂P和FeMnP₀.₅₅Si₀.₄₅的磁相变机制，揭示Fe₃g位点是磁相变的主要驱动因素，并发现这些材料中存在两个不同长度尺度的磁过程，这对磁热效应有重要影响。
...
- **arXiv**: [2604.00775](https://arxiv.org/abs/2604.00775)  ·  [PDF](https://arxiv.org/pdf/2604.00775.pdf)
- **Title (EN)**: First principles study of thermoelectric properties of $\text{Nb}_2\text{Co}_2\text{InSb}$ and $\text{Nb}_2\text{Co}_2\text{GaSb}$ double half-Heuslers
- **Authors**: Rajeev Ranjan
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 研究通过引入质量无序来降低NbCoSn基半赫斯勒合金的晶格热导率，开发了Nb₂Co₂InSb和Nb₂Co₂GaSb两种双半赫斯勒化合物，显著提升了热电性能。
...
- **arXiv**: [2604.00793](https://arxiv.org/abs/2604.00793)  ·  [PDF](https://arxiv.org/pdf/2604.00793.pdf)
- **Title (EN)**: Laser-generated CuPdAgPtAu High-Entropy Alloy Nanoparticles -- Thermal Segregation Threshold and Elemental Segregation
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 激光液相烧结合成的高熵合金纳米颗粒通过快速淬火抑制热力学相分离，形成亚稳态固溶体，加热后可诱导相分离，具有高温催化应用潜力。
...
- **arXiv**: [2604.00907](https://arxiv.org/abs/2604.00907)  ·  [PDF](https://arxiv.org/pdf/2604.00907.pdf)
- **Title (EN)**: Cryogenic stabilization of molecular hydrogen in dense cubic ice
...
- **TL;DR**: 立方冰作为致密分子固体，可在近环境压力下稳定储存分子氢，无需永久孔隙或化学键合
