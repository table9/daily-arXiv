---
title: "arXiv Daily · 2026-07-03 · 68 papers"
date: 2026-07-03
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-07-03 · 68 papers

### Ising superconductivity and anomalous metallic states in a bulk crystal with artificial unidirectional stacking layers
- **arXiv**: [2607.01302](https://arxiv.org/abs/2607.01302)  ·  [PDF](https://arxiv.org/pdf/2607.01302.pdf)
- **Title (EN)**: Ising superconductivity and anomalous metallic states in a bulk crystal with artificial unidirectional stacking layers
...
- **TL;DR**: 本文通过合成Sr0.75ClNbS2超导体，首次在块体晶体中实现了单向平行AA堆叠，打破了传统AB堆叠，从而在三维块体中重现了单分子层的电子环境，实现了强伊辛自旋轨道耦合和极端超导各向异性（γ~77），面内上临界场远超泡利顺磁极限，并发现了磁场诱导的异常金属态。
...
- **arXiv**: [2607.01947](https://arxiv.org/abs/2607.01947)  ·  [PDF](https://arxiv.org/pdf/2607.01947.pdf)
- **Title (EN)**: Fermiology and spin polarization of topological surface states in PtBi$_2$
...
- **TL;DR**: 通过自旋和角分辨光电子能谱，证实了PtBi₂中费米弧表面态是单重简并且自旋极化的，并发现了显著的表面终止依赖性，这为拓扑超导提供了关键条件。
...
- **arXiv**: [2607.02267](https://arxiv.org/abs/2607.02267)  ·  [PDF](https://arxiv.org/pdf/2607.02267.pdf)
- **Title (EN)**: Disorder-induced superconductivity in graphene
- **Authors**: Jannes van Poppelen, Tomas Löthman, Annica M. Black-Schaffer
- **Categories**: cond-mat.supr-con, cond-mat.dis-nn
- **TL;DR**: 本研究表明，通过在单层石墨烯中引入低浓度的空位或氢化无序，即使原本需要极强相互作用的半金属体系也能在弱吸引相互作用下实现超导，且宏观相位相干性源于纯几何起源的超流刚度。
...
- **arXiv**: [2607.01720](https://arxiv.org/abs/2607.01720)  ·  [PDF](https://arxiv.org/pdf/2607.01720.pdf)
- **Title (EN)**: Ultrasonic Observation of Slowing Down of Multipole Fluctuations in Sr$_2$RuO$_4$
- **Authors**: Ryosuke Kurihara, Mitsuhiro Akatsu, Shunsuke Yaoita, Keisuke Mitsumoto, Yuichi Nemoto, Yoshiyuki Yoshida, Hiroshi Yaguchi, Terutaka Goto
- **Categories**: cond-mat.str-el, cond-mat.supr-con
- **TL;DR**: 本研究通过超声测量发现，非常规超导体Sr₂RuO₄在超导转变温度附近出现横波超声衰减系数的增大，并表现出朗道-哈尔拉特尼科夫型频率依赖关系，特征弛豫时间约10⁻¹⁰秒。在10T磁场下超导被抑制，但衰减系数仍在低温下增大，表明与多极矩自由度相关的涨落减速。基于群论分析，提出电十六极矩在其中起关键作用，并探讨了多组分超导序参量与多极矩自由度的关系。
...
- **arXiv**: [2607.01362](https://arxiv.org/abs/2607.01362)  ·  [PDF](https://arxiv.org/pdf/2607.01362.pdf)
- **Title (EN)**: Enerzyme: A Framework for Efficient Training of Reactive Neural Network Potentials for Enzyme Catalysis with Application to Methyltransferases
- **Authors**: Weiliang Luo, Heather J. Kulik
- **Categories**: physics.chem-ph, cs.LG, q-bio.BM
- **TL;DR**: 本文提出了Enerzyme/Enerzymette集成软件框架，用于高效训练神经网络势能（NNP）进行酶反应机理研究。该系统结合自动化QM簇模型构建、反应数据集生成和静电感知NNP架构，以S-腺苷-L-甲硫氨酸依赖甲基转移酶（MTases）为案例，证明不到1000个数据点即可对多达545个原子的簇实现近化学精度，并展示了NNP在电荷转移、极化学习和跨底物迁移性方面的优势。
...
- **arXiv**: [2607.01545](https://arxiv.org/abs/2607.01545)  ·  [PDF](https://arxiv.org/pdf/2607.01545.pdf)
- **Title (EN)**: Learning Effective Soliton Dynamics from Scattering Data
- **Authors**: Seth Minor, Vanja Dukic, David M. Bortz
- **Categories**: physics.comp-ph, nlin.SI, stat.ML
- **TL;DR**: 本文提出将逆散射变换（IST）框架与弱形式系统辨识方法相结合，直接从观测的散射数据中发现有效孤子动力学模型，无需预设散射方程知识，并通过浅水波方程合成与实验数据验证了方法的有效性。
...
- **arXiv**: [2607.01341](https://arxiv.org/abs/2607.01341)  ·  [PDF](https://arxiv.org/pdf/2607.01341.pdf)
- **Title (EN)**: From Dirac Cones to Semions: An Exact Finite-Size Theory of Parity-Anomaly Transport in Chiral Spin Liquids
- **Authors**: Kumar Ghosh
- **Categories**: cond-mat.str-el, hep-th, quant-ph
- **TL;DR**: 本文解决了手性自旋液体中陈数、Chern-Simons规范场能级和自旋响应之间混淆的问题，通过推导有限柱面上能隙狄拉克锥的宇称奇行列式，证明了拓扑响应的有限周长修正严格为指数形式，并在Kagome晶格上通过精确部分子能带计算和DMRG磁通泵浦实验验证了理论预测。
...
- **arXiv**: [2607.01284](https://arxiv.org/abs/2607.01284)  ·  [PDF](https://arxiv.org/pdf/2607.01284.pdf)
- **Title (EN)**: On the limits of the energetic coupling between field dislocation mechanics and phase field crystal
- **Authors**: Aymane Graini, Jorge Viñals, Manas V. Upadhyay
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文分析了FDM与PFC模型之间的能量耦合机制，发现耦合项仅作用于相容（无旋）变形场，而对携带位错拓扑信息的不相容（无散）变形场不敏感，导致该耦合无法有效整合位错力学与晶体学。
...
- **arXiv**: [2607.01439](https://arxiv.org/abs/2607.01439)  ·  [PDF](https://arxiv.org/pdf/2607.01439.pdf)
- **Title (EN)**: Fabrication of high-quality topological insulator nanodevices from bulk-insulating air-sensitive Sb-Bi$_2$Se$_3$
- **Authors**: Linh T. Dang, Ayushi Solanki, Yongjian Wang, Oliver Breunig, Yoichi Ando
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 该论文研究了Sb取代的Bi₂Se₃（SBS）这种非补偿拓扑绝缘体材料在微加工过程中的热影响，并提出了一种室温制备工艺，以保持其低载流子密度和良好量子输运特性，适用于Majorana束缚态探测平台。
...
- **arXiv**: [2607.01310](https://arxiv.org/abs/2607.01310)  ·  [PDF](https://arxiv.org/pdf/2607.01310.pdf)
- **Title (EN)**: A Fuzzy Sphere Journey in Critical Phenomena
- **Authors**: Yin-Chen He, W. Zhu
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, hep-lat, hep-th
- **TL;DR**: 本文综述了模糊球正则化方法在2+1D临界现象研究中的应用，特别是三维共形场论。该方法不仅计算效率高，还揭示了3D CFT、非对易几何和量子霍尔效应之间的意外联系。
...
- **arXiv**: [2607.01529](https://arxiv.org/abs/2607.01529)  ·  [PDF](https://arxiv.org/pdf/2607.01529.pdf)
- **Title (EN)**: Symmetry and Topology in Wavepacket Dynamics near Conical Intersections
- **Authors**: Christopher Daggett, Jonathan Rawlinson, Lukas Muechler
- **Categories**: physics.chem-ph
- **TL;DR**: 本文研究拓扑结构是否直接影响化学动力学，通过对称性分析发现，圆锥交叉附近的节线结构在高度对称环境下是稳健的，但对称性破缺后通常不会持续存在。
...
- **arXiv**: [2607.01591](https://arxiv.org/abs/2607.01591)  ·  [PDF](https://arxiv.org/pdf/2607.01591.pdf)
- **Title (EN)**: Verification and Performance Assessment of NuDEAL, a GPU-Accelerated Deterministic Transport Framework on Unstructured Meshes
- **Authors**: Kyung Min Kim, Jaeuk Im, Han Gyu Lee, Yeon Sang Jung
- **Categories**: physics.comp-ph
- **TL;DR**: 本文在统一框架NuDEAL中开发了三种GPU加速确定性求解器（MOC/HFEM、DGMOC、DFEM-SN），用于先进反应堆的中子学分析。DFEM-SN精度最高（特征值误差&lt;50 pcm），MOC/HFEM和DGMOC效率优越（单GPU运行时间与大型CPU集群相当），证明了非结构化网格上的确定性GPU求解器兼具精度与可扩展性。
...
- **arXiv**: [2607.01344](https://arxiv.org/abs/2607.01344)  ·  [PDF](https://arxiv.org/pdf/2607.01344.pdf)
- **Title (EN)**: Quantum Tunneling-induced Hybridization and Coherent Dynamics of Jackiw-Rebbi Zero Modes in a Modified Su-Schrieffer-Heeger Chain
- **Authors**: Surajit Mandal
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文研究改进SSH模型中JR零模式的隧穿诱导杂化与相干动力学，发现两个JR零模式通过量子隧穿产生对称-反对称杂化态，形成可控的拓扑量子态转移平台。
...
- **arXiv**: [2607.01398](https://arxiv.org/abs/2607.01398)  ·  [PDF](https://arxiv.org/pdf/2607.01398.pdf)
- **Title (EN)**: Microscopic origins of inertial magnetization dynamics
- **Authors**: Caleb Webb, Ling Gan, Shufeng Zhang
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过非马尔可夫量子主方程证明，铁磁体中的惯性磁化动力学源于与光学声子的相干相互作用，解释了皮秒时间尺度上的进动现象，并建立了磁振子-声子耦合作为惯性磁化的微观基础。
...
- **arXiv**: [2607.01441](https://arxiv.org/abs/2607.01441)  ·  [PDF](https://arxiv.org/pdf/2607.01441.pdf)
- **Title (EN)**: Resonant cooling of nuclear spins by optically-oriented holes in MAPbI$_3$ perovskite crystals
- **Authors**: Mladen Kotur, Dmitri R. Yakovlev, Nataliia E. Kopteva, Bekir Turedi, Maksym V. Kovalenko, Manfred Bayer
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 在MAPbI₃钙钛矿晶体中，通过光生自旋极化空穴实现了核自旋的共振冷却，由Hanle效应在变频率螺旋度调制激发下证实，且共振磁场随调制频率增加而增大。
...
- **arXiv**: [2607.01404](https://arxiv.org/abs/2607.01404)  ·  [PDF](https://arxiv.org/pdf/2607.01404.pdf)
- **Title (EN)**: First passage time for an underdamped harmonic oscillator and application to the power of an information engine
- **Authors**: Aubin Archambault, Caroline Crauste-Thibierge, Alberto Imparato, Sergio Ciliberto, Ludovic Bellon
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文研究了欠阻尼谐振子中首次通过时间 $t_{fp}$ 的分布，结合特征值分析和哈密顿近似方法，理论预测与微悬臂梁实验高度吻合，并应用于信息引擎功率的精确估计。
...
- **arXiv**: [2607.01801](https://arxiv.org/abs/2607.01801)  ·  [PDF](https://arxiv.org/pdf/2607.01801.pdf)
- **Title (EN)**: Benchmarking SOPPA-based methods for the calculation of static and dynamic polarizabilities
- **Authors**: Joep van den Brink, Michael Hilding Estes, Stephan P. A. Sauer
- **Categories**: physics.chem-ph
- **TL;DR**: 本文计算了41种分子的静态和频率依赖极化率，比较了RPA、RPA(D)、HRPA、HRPA(D)、SOPPA、SOPPA(CC2)和SOPPA(CCSD)七种方法，并以CCSD和实验数据为基准。结果表明，芳香族与非芳香族分子在方法性能上存在显著差异：HRPA精度最差，HRPA(D)和SOPPA(CCSD)整体最优。静态极化率方面，HRPA(D)对非芳香族最好，SOPPA(CCSD)对芳香族最好；频率依赖方面，HRPA(D)对非芳香族最准，RPA在高频下对芳香族最准。RPA对芳香族的良好表现归因于其对最低电子激发能的过高估计。
...
- **arXiv**: [2607.01713](https://arxiv.org/abs/2607.01713)  ·  [PDF](https://arxiv.org/pdf/2607.01713.pdf)
- **Title (EN)**: Predicting Novel Stable Materials for Experimental Synthesis
- **Authors**: Yuqi An, Sihong Zhu, Joseph Montoya, Xingyu Guo, Zhenbin Wang
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 本文提出了一个层次筛选框架，结合PBE热力学稳定性、通用机器学习原子间势的动力学稳定性筛选以及SCAN热力学精炼，将Sci. Data 9, 302 (2022)中的894种稳定材料逐步筛选为25个高置信度实验合成候选材料，弥合了理论预测与实验合成之间的差距。
...
- **arXiv**: [2607.01434](https://arxiv.org/abs/2607.01434)  ·  [PDF](https://arxiv.org/pdf/2607.01434.pdf)
- **Title (EN)**: Generalized quantum geometry formulated through interacting vertex correlations
- **Authors**: Alejandro S. Miñarro, Gervasi Herranz
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文提出将量子几何的概念从布洛赫能带扩展到更一般的参数空间（如集体玻色子涨落、外场或结构畸变），建立了广义量子几何张量与相互作用顶点关联的框架，并举例说明了在Hubbard-Stratonovich玻色子场和Jahn-Teller构型空间中的应用。
...
- **arXiv**: [2607.01407](https://arxiv.org/abs/2607.01407)  ·  [PDF](https://arxiv.org/pdf/2607.01407.pdf)
- **Title (EN)**: Vitriflow: calibrated amorphous structure ensembles from melt-quench simulation
- **Authors**: Jonathon Cottom, Robin Delhomme, Emilia Olsson
- **Categories**: cond-mat.mtrl-sci, cond-mat.dis-nn
- **TL;DR**: 本文提出vitriflow——一种将熔淬分子动力学中隐式数值选择转化为显式决策链的计算材料学方法，通过在材料特定描述符空间中耦合数值稳定性、协议标定、伪影筛选和统计收敛，为a-SiO₂、a-Si₃N₄和a-Sm₂O₃等非晶体系提供可复现的生成路线。
...
- **arXiv**: [2607.01691](https://arxiv.org/abs/2607.01691)  ·  [PDF](https://arxiv.org/pdf/2607.01691.pdf)
- **Title (EN)**: Quantum Heat Under the Microscope: A Perspective on Cryogenic Scanning Thermal Microscopy
- **Authors**: Valentin Fonck, Jean Spiece, Pascal Gehring
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文综述了低温纳米尺度局域热传输表征技术的现状与局限，并提出发展低温扫描热显微镜（SThM）的必要性，通过五个案例展示了该技术对理解奇异量子相和推动变革性技术的潜力。
...
- **arXiv**: [2607.01405](https://arxiv.org/abs/2607.01405)  ·  [PDF](https://arxiv.org/pdf/2607.01405.pdf)
- **Title (EN)**: First passage time distribution in underdamped harmonic oscillators
- **Authors**: Aubin Archambault, Caroline Crauste-Thibierge, Alberto Imparato, Sergio Ciliberto, Ludovic Bellon
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文推导了欠阻尼谐振子首次通过时间$t_{fp}$（越过阈值$x_B$）的分布，针对不同品质因子$Q$采用不同方法：极高$Q$时基于能量扩散模型，中等$Q$时基于Kramers算符特征值分析，短时间时采用哈密顿近似，理论预测与数值模拟高度吻合。
...
- **arXiv**: [2607.02058](https://arxiv.org/abs/2607.02058)  ·  [PDF](https://arxiv.org/pdf/2607.02058.pdf)
- **Title (EN)**: On the Symplectic Propagation of the Spin-MInt Algorithm for Non-Adiabatic Quantum Dynamics
- **Authors**: James R. Rampton, Lauren E. Cook, Timothy J. H. Hele
- **Categories**: physics.chem-ph, quant-ph
- **TL;DR**: 本文直接证明了Spin-MInt算法在一般K电子态下的辛结构保持性质，基于su(K)李-泊松代数的余伴随轨道理论框架，首次通过显式验证辛条件MJMT=J来证明该算法的辛性。
...
- **arXiv**: [2607.02236](https://arxiv.org/abs/2607.02236)  ·  [PDF](https://arxiv.org/pdf/2607.02236.pdf)
- **Title (EN)**: Efficient Large-Scale STEM-EELS Simulations With Torched-TACAW
- **Authors**: Martin Osmera, João Vaz, Paul M. Zeiger, Ján Rusz
- **Categories**: cond-mat.mtrl-sci, physics.comp-ph
- **TL;DR**: 本文提出了torched-TACAW，一个用于大规模超低损耗EELS模拟的开源实现，结合机器学习力场的分子动力学、超胞分区和实时多切片处理，实现了在有限内存和低数据吞吐量下接近ab initio质量的原子级分辨率模拟。
...
- **arXiv**: [2607.01519](https://arxiv.org/abs/2607.01519)  ·  [PDF](https://arxiv.org/pdf/2607.01519.pdf)
- **Title (EN)**: Nonperturbative Nonlinear Hall Effect in Nonequilibrium Steady States
- **Authors**: Lei Geng, Martin Eckstein, Lei Chen, Shouvik Sur, Silke Paschen, Qimiao Si, Philipp Werner
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 本文发展了一种基于非平衡稳态格林函数的非微扰方法，用于研究强直流电场驱动下晶格系统中的非线性霍尔效应，超越了传统的恒定弛豫时间近似，揭示了强场区域中相互作用和电子-声子自能对霍尔信号的显著影响。
...
- **arXiv**: [2607.01623](https://arxiv.org/abs/2607.01623)  ·  [PDF](https://arxiv.org/pdf/2607.01623.pdf)
- **Title (EN)**: Phase-selective orbital-charge conversion in $\mathrm{MoTe_2}$
- **Authors**: J. L. Costa, E. Santos, G. R. Gallo, G. Rodrigues-Junior, R. O. Cunha, E. L. T. França, R. Cardias, T. G. Rappoport, J. B. S. Mendes, A. Azevedo
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall
- **TL;DR**: MoTe₂薄膜在约4.5nm临界厚度处发生从金属1T'相到半导体2H相的结构相变，只有金属相展现出轨道Rashba-Edelstein效应引起的额外横向电荷转换信号。
...
- **arXiv**: [2607.02021](https://arxiv.org/abs/2607.02021)  ·  [PDF](https://arxiv.org/pdf/2607.02021.pdf)
- **Title (EN)**: An efficient formalism for inertial spin waves: Dzyaloshinskii-Moriya antiferromagnets as case studies
- **Authors**: De-Yun Zhao, Ri-Xing Wang, Meng-Qiu Cai, Mikhail Cherkasskii, Peng-Bin He
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文为惯性自旋波建立了系统的理论框架，通过椭圆角定义了手性和极化，并系统研究了单轴反铁磁体中不同磁构型下的进动和章动自旋波特性。
...
- **arXiv**: [2607.02023](https://arxiv.org/abs/2607.02023)  ·  [PDF](https://arxiv.org/pdf/2607.02023.pdf)
- **Title (EN)**: Sandpile Models on complex networks
- **Authors**: Komlan Fiagbe, Jean-François de Kemmeter, Timoteo Carletti
- **Categories**: cond-mat.stat-mech, nlin.AO
- **TL;DR**: 本文通过发展一个显式引入耗散效应的分支过程框架，研究了复杂网络上的沙堆模型，发现耗散、聚类和稀疏连接会根本性地重塑雪崩规模分布，并确定了分支过程描述的定量极限。
...
- **arXiv**: [2607.02316](https://arxiv.org/abs/2607.02316)  ·  [PDF](https://arxiv.org/pdf/2607.02316.pdf)
- **Title (EN)**: Molecular interpretability of the bulk electrochemical impedance of concentrated electrolytes
...
- **TL;DR**: 本文提出了一种基于“ itinerant oscillator”（IO）模型和广义Langevin方程的新方法，通过计算频率依赖电导率的矩来分析电化学阻抗谱（EIS）中的电解质体相贡献。该方法无需浓度假设，能更准确地从分子动力学模拟中揭示离子液体的温度依赖β弛豫过程，并通过阻抗模型直接反映时间尺度分布。
...
- **arXiv**: [2607.01673](https://arxiv.org/abs/2607.01673)  ·  [PDF](https://arxiv.org/pdf/2607.01673.pdf)
- **Title (EN)**: Intrinsically low thermal conductivity of stoichiometric lithium niobate:Experimental measurement and microscopic origin
- **Authors**: Wenjiang Zhou, Fuwei Yang, Yuxi Wang, Weiheng Li, Wujuan Yan, Kexin Zhang, Bai Song
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文结合频域热反射（FDTR）实验与机器学习原子模拟，系统研究了化学计量比铌酸锂（sLN）中的热输运特性。sLN的室温热导率远低于硅等经典半导体，且温度依赖性表明热输运由本征声子-声子散射主导。通过与超高导热材料立方砷化硼对比，发现sLN低热导率的根源在于更强的非谐性和更大的散射相空间，而非谐性性质。薄膜中低于1微米时出现显著的尺寸效应，10 nm厚度时热导率降至体材料的一半。
...
- **arXiv**: [2607.02077](https://arxiv.org/abs/2607.02077)  ·  [PDF](https://arxiv.org/pdf/2607.02077.pdf)
- **Title (EN)**: Anisotropic tunneling through magnetic barriers in 8-Pmmn borophene
- **Authors**: Rachid El Aitouni, Sanae Zriouel, Clarence Cortes, David Laroze, Ahmed Jellal
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 本文理论研究了8-Pmmn硼烯中由铁磁条产生的磁势垒引起的电子隧穿现象，揭示了各向异性Dirac锥导致的强方向性传输，并展示了通过磁势垒参数调控载流子输运的可能性。
...
- **arXiv**: [2607.02154](https://arxiv.org/abs/2607.02154)  ·  [PDF](https://arxiv.org/pdf/2607.02154.pdf)
- **Title (EN)**: Path-Measure Dynamics of Attention-Driven World Models: A Nonlocal Onsager--Machlup Approach
- **Authors**: Gunn Kim
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文研究注意力机制引入记忆后潜变量动力学的非马尔可夫性，通过隐式线性马尔可夫增广得到非局域Onsager-Machlup作用量，并在短记忆极限下恢复局域理论。
...
- **arXiv**: [2607.01815](https://arxiv.org/abs/2607.01815)  ·  [PDF](https://arxiv.org/pdf/2607.01815.pdf)
- **Title (EN)**: Evidence for Deconfined Magnetic Order in the Kitaev-$J_3$ Model
- **Authors**: Jiucai Wang, Chuan Chen
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文通过变分蒙特卡洛和vison准粒子分析，研究了Kitaev-J₃蜂窝模型，发现退禁闭磁性相（zigzag和反铁磁序）可与Kitaev自旋液体的ℤ₂拓扑结构共存，并揭示了vison对凝聚导致磁性有序的微观机制，为Na₂Co₂TeO₆等材料的反常低温热输运提供了理论解释。
...
- **arXiv**: [2607.01682](https://arxiv.org/abs/2607.01682)  ·  [PDF](https://arxiv.org/pdf/2607.01682.pdf)
- **Title (EN)**: Many-body benchmarking of DFT local-registry energetics in bilayer InSe
- **Authors**: Jeonghwan Ahn, Abdulgani Annaberdiyev, Jovan Nelson, Nathaniel P. Stern, Hyeondeok Shin
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过扩散量子蒙特卡洛（DMC）方法对双层InSe的局部堆叠能量景观进行基准测试，发现DFT严重低估了不同堆叠构型之间的能量差异（最大可达60 meV/f.u.），表明基于DFT的莫尔模型可能显著低估局部堆叠能量起伏，影响对扭曲层状材料中结构弛豫、畴形成和电子重构的预测。
...
- **arXiv**: [2607.02094](https://arxiv.org/abs/2607.02094)  ·  [PDF](https://arxiv.org/pdf/2607.02094.pdf)
- **Title (EN)**: The Wigner function for Integer quantum Hall effect
- **Authors**: Yao Wang, Qi-Ming Fu, Huawei Fan, Li Yu, Kang Li
- **Categories**: cond-mat.mes-hall
...
- **arXiv**: [2607.02171](https://arxiv.org/abs/2607.02171)  ·  [PDF](https://arxiv.org/pdf/2607.02171.pdf)
- **Title (EN)**: Theory of collective learning in populations of adaptive agents
- **Authors**: Gerhard Jung, Johann Asnacios, Misaki Ozawa, Olivier Dauchot, Eric Bertin
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 本文研究了智能活性剂群体通过交换策略参数和记忆信息进行分散式学习以实现宏观状态的过程，推导了策略分布的演化方程，并发现有效奖励函数决定了策略分布的演化。理论结果与多尺度微观模型和智能体模拟吻合良好，揭示了群体多样性和奖励波动对学习性能的影响，并与复制者方程、Moran模型等生物进化模型建立了联系。
...
- **arXiv**: [2607.02114](https://arxiv.org/abs/2607.02114)  ·  [PDF](https://arxiv.org/pdf/2607.02114.pdf)
- **Title (EN)**: Plaid-Like Spin Splitting and Chirality of Magnon Bands in Antiferromagnetic MnTe$_2$
...
- **TL;DR**: 通过旋光性和角度分辨拉曼散射，实验证实MnTe₂中存在交替磁体特有的手性自旋波激发，并揭示了动量空间中的格子状自旋劈裂结构。
...
- **arXiv**: [2607.02100](https://arxiv.org/abs/2607.02100)  ·  [PDF](https://arxiv.org/pdf/2607.02100.pdf)
- **Title (EN)**: Quantum-geometric shift of quasiequilibrium: Origin of nonreciprocal current driven by quantum-metric dipole
- **Authors**: Sota Kitamura, Takahiro Anan, Takahiro Morimoto
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文通过结合绝热微扰论和非平衡格林函数方法，从量子度规角度研究非线性直流电输运，发现由量子度规偶极子驱动的纵向非互易电流，并将其物理起源归因于偏压场下电子波包有限展宽导致的偏移准平衡态。
...
- **arXiv**: [2607.02216](https://arxiv.org/abs/2607.02216)  ·  [PDF](https://arxiv.org/pdf/2607.02216.pdf)
- **Title (EN)**: Exact amplitude relations for diffusion-limited aggregation
- **Authors**: Thomas C Halsey
- **Categories**: cond-mat.stat-mech, nlin.PS
- **TL;DR**: 本文通过Hastings-Levitov方法证明了二维扩散限制聚集(DLA)中调和测度的三阶矩通用振幅与团簇分形维度之间存在强关联，该结论适用于标准圆形DLA和圆柱形（周期性边界条件）DLA。
...
- **arXiv**: [2607.02117](https://arxiv.org/abs/2607.02117)  ·  [PDF](https://arxiv.org/pdf/2607.02117.pdf)
- **Title (EN)**: Unconventional Mixed-Parity Magnetism in Rare-Earth Tetraborides
- **Authors**: Dong-Choon Ryu, Jae-Ho Han, Bongjae Kim, Chang-Jong Kang
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 本文揭示了TbB₄中一种全新的混合宇称自旋劈裂机制：面内自旋分量呈现奇宇称p/f波纹理，而面外分量保持偶宇称d波交磁特性，这种非相对论性效应源于标量自旋手性引起的交错Berry相位，并导致体Edelstein效应、自旋霍尔响应及Berry曲率偶极子等独特输运现象。
...
- **arXiv**: [2607.01779](https://arxiv.org/abs/2607.01779)  ·  [PDF](https://arxiv.org/pdf/2607.01779.pdf)
- **Title (EN)**: Density functional study of native point defects in CaO
- **Authors**: Yunhwa Jo, Minseok Choi
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 使用第一性原理密度泛函计算研究了CaO中本征点缺陷的结构、电子和光学性质，发现氧空位在贫氧条件下更易形成，钙空位在富氧条件下占主导，空位复合物热力学稳定且能解释多种实验观测到的光学峰。
...
- **arXiv**: [2607.02112](https://arxiv.org/abs/2607.02112)  ·  [PDF](https://arxiv.org/pdf/2607.02112.pdf)
- **Title (EN)**: A 2048-spin bulk acoustic wave Ising machine for number partitioning and Sudoku
- **Authors**: Venkatesh Vadde, Roman Ovcharov, Victor H. González, Roman Khymyn, Artem Litvinenko, Johan Åkerman
- **Categories**: cond-mat.mes-hall, cs.AR, physics.app-ph
- **TL;DR**: 本文提出了一种基于微波固态延迟线的时分伊辛机，利用体声波延迟线实现2048个自旋的全连接，具有高热稳定性、低功耗、低成本等优势，在MAX-CUT、数划分和数独问题上表现出色。
...
- **arXiv**: [2607.02221](https://arxiv.org/abs/2607.02221)  ·  [PDF](https://arxiv.org/pdf/2607.02221.pdf)
- **Title (EN)**: Alternative routes to universal diversity scaling in component systems: from proteomes to large language models
- **Authors**: Andrea Mazzolini, Leonardo Agasso, Filippo Valle, Michele Caselle, Marco Cosentino Lagomarsino, Matteo Osella
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文研究了复杂系统中多样性增长的两个普适统计规律——系统规模增加时不同组分数量的亚线性增长及其方差与均值的平方成正比——并证明这些规律既可由创新驱动增长模型产生，也可由潜在异质性模型产生，两者在宏观上难以区分。
...
- **arXiv**: [2607.02136](https://arxiv.org/abs/2607.02136)  ·  [PDF](https://arxiv.org/pdf/2607.02136.pdf)
- **Title (EN)**: Phonon spectral function of Holstein polaron: Investigation of many-body effects with self-energy and vertex correction
- **Authors**: Lawrence Rai, Sudhakar Pandey
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文研究一维Holstein极化子在反绝热区中多体效应对声子谱函数的影响，发现电子自能和顶点修正分别抑制和增强极化子谱权重，两者在小波矢区域几乎抵消，而在大波矢区域自能占主导导致谱权重显著抑制。
...
- **arXiv**: [2607.01841](https://arxiv.org/abs/2607.01841)  ·  [PDF](https://arxiv.org/pdf/2607.01841.pdf)
- **Title (EN)**: Quantifying angular momentum of coherently driven circular phonons
...
- **TL;DR**: 利用超快X射线衍射技术，本文首次定量测量了非磁性SrTiO3中由圆偏振太赫兹脉冲激发的氧离子环状运动，发现氧离子贡献了约90%的声子角动量，解释了太赫兹诱导磁性的机制。
...
- **arXiv**: [2607.02120](https://arxiv.org/abs/2607.02120)  ·  [PDF](https://arxiv.org/pdf/2607.02120.pdf)
- **Title (EN)**: Electrical transport in ultra-thin films: from Fuchs-Sondheimer to quantum-confinement
- **Authors**: Alessio Zaccone
- **Categories**: cond-mat.mes-hall, cond-mat.dis-nn, cond-mat.mtrl-sci, physics.app-ph, quant-ph
- **TL;DR**: 本文综述了超薄膜从经典尺寸效应（Fuchs-Sondheimer表面散射和Mayadas-Shatzkes晶界散射）到量子限域效应的转变，重点介绍了倒易空间限域理论及其与经典模型的统一描述，并总结了支持该理论的实验证据及其对纳米电子器件的影响。
...
- **arXiv**: [2607.02268](https://arxiv.org/abs/2607.02268)  ·  [PDF](https://arxiv.org/pdf/2607.02268.pdf)
- **Title (EN)**: How wrong is too wrong: A numerical study on the relevance of positional memory in the generalized Langevin equation
- **Authors**: Abhir Mehrotra, Fabian Koch, Tanja Schilling
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文证明，同时包含平均力势、线性记忆核和满足Kubo第二涨落-耗散定理的随机力的广义朗之万方程不可能精确成立。通过模型分析表明，除线性记忆外的高阶记忆项对动力学至关重要，不可忽略。
...
- **arXiv**: [2607.02183](https://arxiv.org/abs/2607.02183)  ·  [PDF](https://arxiv.org/pdf/2607.02183.pdf)
- **Title (EN)**: A density matrix renormalization group approach to quantum point contacts
- **Authors**: Nair Aucar Boidi, Mikhail Kiselev
- **Categories**: cond-mat.str-el
- **TL;DR**: 使用 DMRG 和修正向量方法，研究了谐波势与排斥相互作用在一维费米子系统中的竞争，分析了从势阱到量子势垒的转变及其对局域态密度的影响。
...
- **arXiv**: [2607.01997](https://arxiv.org/abs/2607.01997)  ·  [PDF](https://arxiv.org/pdf/2607.01997.pdf)
- **Title (EN)**: HVAF Spraying of NiTi Coatings: Microstructure, Phase Transformation and Shape Memory Behavior
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文首次成功制备了100-300微米厚的NiTi形状记忆合金涂层，采用高速空气燃料热喷涂法在低碳钢上沉积，尽管涂层存在不均匀微观结构、空隙、氧化物颗粒、高密度位错缺陷和内应力，但经过退火处理后表现出马氏体相变、热驱动和形状记忆效应，且具有良好附着力。
...
- **arXiv**: [2607.02188](https://arxiv.org/abs/2607.02188)  ·  [PDF](https://arxiv.org/pdf/2607.02188.pdf)
- **Title (EN)**: Entropy of Non-Abelian Anyons from Slow Quasiparticle Dynamics in Quantum Hall Interferometers
- **Authors**: Eran Sela, Mitali Banerjee
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文提出一种基于干涉仪中嵌入反点的方案，通过非局域电荷测量提取分数量子霍尔态中非阿贝尔任意子的特征熵（ΔS = k_B log d），适用于中间温度范围。
...
- **arXiv**: [2607.02282](https://arxiv.org/abs/2607.02282)  ·  [PDF](https://arxiv.org/pdf/2607.02282.pdf)
- **Title (EN)**: Velocity and force autocorrelations in Brownian dynamics with a Lorentz force
- **Authors**: Filippo Faedi, Abhinav Sharma
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文推导了有外磁场时布朗粒子的速度自相关张量(VACT)与力自相关张量(FACT)之间的普适关系，发现过阻尼条件下VACT的扩散部分与FACT的反对称部分耦合，耦合强度由回旋频率与热化率之比决定。通过带电二聚体模型验证，发现磁场可导致瞬态抑制（最终恢复）或持久的振荡、负迁移率及长期扩散抑制。
...
- **arXiv**: [2607.02326](https://arxiv.org/abs/2607.02326)  ·  [PDF](https://arxiv.org/pdf/2607.02326.pdf)
- **Title (EN)**: Fundamental limitations of single-particle Green's-function zeroes as probes of many-body topology
- **Authors**: Emile Pangburn, Olivier Gingras
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文证明，基于单粒子格林函数的拓扑不变量无法可靠诊断相互作用多体态的拓扑性质。通过耦合相互作用SSH链的实例，发现自旋-自旋相互作用可平庸化多体基态而不影响格林函数拓扑不变量。这种失效源于格林函数无法探测负责拓扑简并的Fock区电子激发，因此格林函数零点与物理拓扑准粒子无关，不能普遍表征相互作用拓扑相。
...
- **arXiv**: [2607.02012](https://arxiv.org/abs/2607.02012)  ·  [PDF](https://arxiv.org/pdf/2607.02012.pdf)
- **Title (EN)**: Transition-Metal Tailored $Ga_{2}O_{2}$ Monolayer: From Room-Temperature Gas Sensing to Chemical Scavenging
- **Authors**: Afreen Anamul Haque, Aniket Singha
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过第一性原理DFT计算，研究了七种过渡金属(Pd, Zn, Zr, Mo, Ag, Ti, Pt)替代掺杂的Ga₂O₂单层膜在有毒气体检测和清除方面的性能。Ag掺杂对NO具有超高选择性，可实现室温可重复检测；Zr和Mo掺杂可选择性清除氧化性气体，Ti和Pt则是通用清除剂。这些材料为大气监测和解毒提供了实用平台。
...
- **arXiv**: [2607.02265](https://arxiv.org/abs/2607.02265)  ·  [PDF](https://arxiv.org/pdf/2607.02265.pdf)
- **Title (EN)**: Josephson and Spin Currents in Coupled Polariton Condensates
- **Authors**: A. Kudlis, I. Yu. Chestnov, A. N. Osipov, A. V. Yulin, I. A. Shelykh
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文分析了耦合自旋激子极化激元凝聚体在平板和正多边形环结构中的粒子流和自旋流，揭示了隐藏的自旋逆流、键依赖的自旋流模式，并利用电流分辨诊断对平衡相进行表征。
...
- **arXiv**: [2607.02358](https://arxiv.org/abs/2607.02358)  ·  [PDF](https://arxiv.org/pdf/2607.02358.pdf)
- **Title (EN)**: Contrarian Majority Dynamics: Violation of Detailed Balance and Nonequilibrium Steady States
- **Authors**: Serge Galam
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文从统计力学角度重新审视了带有逆向者（contrarian）的Galam多数投票模型（GMM），揭示了三个基本特征：（1）构建了等价的单智能体随机动力学；（2）澄清GMM演化方程并非平均场近似结果，而是迭代平均场动力学；（3）证明了该动力学违背细致平衡，且同时更新版本甚至违背Kolmogorov循环条件，确认了稳态为非平衡稳态。
...
- **arXiv**: [2607.02449](https://arxiv.org/abs/2607.02449)  ·  [PDF](https://arxiv.org/pdf/2607.02449.pdf)
- **Title (EN)**: Anomalous thermopower from the drag of overdamped collective modes
- **Authors**: G. Mirarchi, G. Seibold, M. Grilli, S. Caprara
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文提出过阻尼集体模式的类声子拖曳机制可解释高温超导铜氧化物中塞贝克系数比在低温下的对数发散异常，支持过阻尼电荷密度涨落是奇异金属行为起源的观点。
...
- **arXiv**: [2607.02022](https://arxiv.org/abs/2607.02022)  ·  [PDF](https://arxiv.org/pdf/2607.02022.pdf)
- **Title (EN)**: A depth resolved investigation of hydrogen uptake in carbon based nanostructures by soft-to-hard photoemission spectroscopy
- **Authors**: Orlando Castellano, Alice Apponi, Luca Cecchini, Daniele Paoloni, Simone Ritarossi, Francesco Pandolfi, Ilaria Rago, Tien-Lin Lee, Samuel Jeong, Yoshikazu Ito, Carlo Mariani, Gianluca Cavoto, Francesco Offi, Alessandro Ruocco
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文利用软X射线到硬X射线的光电子能谱，对纳米多孔石墨烯（NPG）和垂直排列碳纳米管（CNTs）的氢化行为进行了深度分辨分析。研究发现，两种材料的氢化主要集中在最外层表面，形成的sp³富集层厚度仅相当于单层石墨烯的一小部分（NPG）到约一个石墨层（CNTs），表明氢渗透深度有限。
...
- **arXiv**: [2607.02378](https://arxiv.org/abs/2607.02378)  ·  [PDF](https://arxiv.org/pdf/2607.02378.pdf)
- **Title (EN)**: Coupled Spin-Orbital $p$-Wave Magnetism via Structural and Magnetic Chirality
- **Authors**: Tom G. Saunderson, Börge Göbel, Ersoy Şaşıoğlu, Samir Lounis
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文揭示了手性晶体中自旋-轨道耦合如何将轨道手性与自旋手性耦合，定义了相对手性η这一新的对称性自由度，并预言了两种p波自旋劈裂相及其不同的电导特征。
...
- **arXiv**: [2607.02359](https://arxiv.org/abs/2607.02359)  ·  [PDF](https://arxiv.org/pdf/2607.02359.pdf)
- **Title (EN)**: Correlation and entanglement dynamics of free fermions in disguise
- **Authors**: Dávid Szász-Schagrin, Pablo Bayona-Pena, Lorenzo Piroli, Eric Vernier
- **Categories**: cond-mat.stat-mech, quant-ph
- **TL;DR**: 本文研究可映射为自由费米子的自旋链在量子淬火后的非平衡动力学，发现由于能量本征值的指数简并性，标准可积系统框架需要修正。作者提出了广义Gibbs系综中准动量分布的解析计算方法，并基于准粒子图像提出了纠缠增长公式的修正猜想，通过数值张量网络计算验证了理论预测。
...
- **arXiv**: [2607.02071](https://arxiv.org/abs/2607.02071)  ·  [PDF](https://arxiv.org/pdf/2607.02071.pdf)
- **Title (EN)**: Anisotropic nanoscale coherent polariton transport in CrSBr
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究通过实验与理论结合，展示了在范德华反铁磁体CrSBr中，激子与薄片光子模式自杂化形成的腔极化激元在纳米尺度上的各向异性传输。利用阴极发光光谱，以纳米分辨率精确测绘了极化激元景观，发现其相干传输遵循CrSBr的C₂v对称性，仅沿晶体a轴方向进行，而b轴方向无相干特征。
...
- **arXiv**: [2607.02418](https://arxiv.org/abs/2607.02418)  ·  [PDF](https://arxiv.org/pdf/2607.02418.pdf)
- **Title (EN)**: Intrinsic orbital Hall effect in a nonuniform electric field
- **Authors**: Min Ju Park, Jongjun M. Lee, Hyun-Woo Lee
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 本文建立了电子系统中轨道角动量输运与布洛赫波函数几何性质之间的解析联系，揭示了轨道霍尔效应电导率可由轨道贝里曲率和量子度量等几何量表达，并展示了高阶轨道霍尔响应对各向异性样品取向的增强敏感性。
...
- **arXiv**: [2607.02506](https://arxiv.org/abs/2607.02506)  ·  [PDF](https://arxiv.org/pdf/2607.02506.pdf)
- **Title (EN)**: On the emergence of quantum many-body chaos for tunably-broken integrability
...
- **TL;DR**: 本文通过可调参数破坏可积性，在自由费米子电路中掺杂可积性破坏门，研究量子多体混沌的涌现机制。利用OTOC揭示了从早期可积行为到晚期混沌的微观机制，并确定了特征时间尺度、长度尺度以及蝴蝶速度等混沌特征对破坏参数的依赖。
...
- **arXiv**: [2607.02178](https://arxiv.org/abs/2607.02178)  ·  [PDF](https://arxiv.org/pdf/2607.02178.pdf)
- **Title (EN)**: Coherent two-dimensional electronic spectroscopy integrated with confocal back focal plane microscopy
...
- **TL;DR**: 本文介绍了一种集成共聚焦背焦平面成像显微镜的泵浦-探测反射几何相干二维电子光谱装置，实现了角度分辨、20 fs脉冲压缩，并在WSe₂单层上验证了其性能，适用于研究二维材料中的激子和激子-极化激元。
...
- **arXiv**: [2607.02219](https://arxiv.org/abs/2607.02219)  ·  [PDF](https://arxiv.org/pdf/2607.02219.pdf)
- **Title (EN)**: Differentiable inverse design of short-range order in high-entropy alloys: from target sro to target property
- **Authors**: Tiancheng Ding, Conrard Giresse Tetsassi Feugmo
- **Categories**: cond-mat.mtrl-sci, cond-mat.dis-nn, cond-mat.stat-mech
- **TL;DR**: 本文提出了一种基于梯度下降的短程有序（SRO）结构构建方法，替代传统的随机交换搜索。该方法将原子占据视为连续变量，速度更快、精度更高，并支持多元素合金。结合一个预测力学性能的小型神经网络，实现了从目标性能到结构的闭环优化。开源工具包名为 anisro。
...
- **arXiv**: [2607.02256](https://arxiv.org/abs/2607.02256)  ·  [PDF](https://arxiv.org/pdf/2607.02256.pdf)
- **Title (EN)**: From Bloch to Néel: Anisotropy-dependent Domain-Wall Character in FePd Thin Films
- **Authors**: Annika Stellhorn, Alicia Backs, Ekaterina Klyushina, Connie Bednarski-Meinke, Steffen Tober, Denis Vasiukov, Oskar Stepancic, Vítor Alexandre de Oliveira Lima, Lukas Aniansson, Paul Steadman, Manuel Valvidares, Jörg Schwenke, Claudiu Bulbucan, Elizabeth Blackburn
- **Categories**: cond-mat.mtrl-sci, cond-mat.str-el
- **TL;DR**: 本文通过X射线磁性共振散射等技术，研究了L1₀-FePd薄膜中随深度变化的畴壁结构。发现高磁晶各向异性样品（Q=1.8）表现出从混合Bloch-Néel到纯Néel型畴壁的平滑过渡，而另一样品（Q=1.45）则为纯Néel型，揭示了长程结构有序对磁畴壁形成的关键作用。
...
- **arXiv**: [2607.02224](https://arxiv.org/abs/2607.02224)  ·  [PDF](https://arxiv.org/pdf/2607.02224.pdf)
- **Title (EN)**: Ultrafast Demagnetization Governed by Spin Fluctuations in CaRuO$_{3}$/SrTiO$_{3}$ Superlattice
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文发现在CaRuO₃/SrTiO₃超晶格中，退磁速率随温度、泵浦通量和外加磁场增加而反常加速，通过结合三温度模型与自洽重整化理论，揭示了自旋涨落驱动的电子-自旋散射增强机制，为超快自旋动力学调控提供了新范式。
...
- **arXiv**: [2607.02238](https://arxiv.org/abs/2607.02238)  ·  [PDF](https://arxiv.org/pdf/2607.02238.pdf)
- **Title (EN)**: Interfacial Strain and Structural Defects Govern the Performance of Tantalum Superconducting Waveguide Resonators
- **Authors**: Moritz Singer, Harsh Gupta, Benedikt Schoof, Elena Willinger, Anton Orekhov, Marc Tornow
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文研究了溅射沉积的α-Ta薄膜在不同温度及种子层上的结构-性能关系，发现界面应变和缺陷显著影响超导量子比特的射频性能，内禀品质因数最高达150万，揭示了界面工程对低损耗量子计算电路的关键作用。
...
- **arXiv**: [2607.02415](https://arxiv.org/abs/2607.02415)  ·  [PDF](https://arxiv.org/pdf/2607.02415.pdf)
- **Title (EN)**: Bottlenecks in Hamiltonian-Adaptive Resolution Simulation Method for Modeling Interfaces
- **Authors**: Hari Haran Sudhakar, Alessandra Serva, Rocio Semino
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文深入分析了H-AdResS方法在界面模拟中的参数选择影响，发现Langevin恒温器可靠而Nosé-Hoover产生伪影，短程静电模型会导致非物理结果，并讨论了键合自由度插值等局限性。
