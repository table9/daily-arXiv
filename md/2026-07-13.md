---
title: "arXiv Daily · 2026-07-13 · 56 papers"
date: 2026-07-13
layout: post
tags: [arxiv, daily]
---

# arXiv Daily · 2026-07-13 · 56 papers

### Tunable responsivity and bandwidth in microwave kinetic inductance detectors via readout current nonlinearity
- **arXiv**: [2607.09178](https://arxiv.org/abs/2607.09178)  ·  [PDF](https://arxiv.org/pdf/2607.09178.pdf)
- **Title (EN)**: Tunable responsivity and bandwidth in microwave kinetic inductance detectors via readout current nonlinearity
- **Authors**: Maclean Rouble, Peter Day, Matt Dobbs, Joshua Montgomery, Sofiia Savchyn, Graeme Smecher
- **Categories**: cond-mat.supr-con, astro-ph.IM
- **TL;DR**: 本文研究通过将读出功率和频率调谐至谐振器分岔点附近，利用非线性频率位移产生的正反馈效应，使MKID的光学响应增强了10倍，同时提供了可选择操作状态的映射图。
...
- **arXiv**: [2607.09437](https://arxiv.org/abs/2607.09437)  ·  [PDF](https://arxiv.org/pdf/2607.09437.pdf)
- **Title (EN)**: Anisotropic Superconductivity with Enhanced Critical Field in Strained RuO2
- **Authors**: Younes Ghorbani, Samuel Poage, Xuehsi Gao, Luka Mitrovic, Neha Wadehra, Benjamin Gregory, Suchismita Sarker, Betul Pamuk, Andrej Singer, Darrell G. Schlom, Chun Ning Lau, Kaveh Ahadi
- **Categories**: cond-mat.supr-con, cond-mat.mtrl-sci
- **TL;DR**: RuO2在外延生长应变下出现超导，且超导特性与生长取向和输运方向密切相关，同时观察到面内磁场下Pauli顺磁极限的强烈违背，归因于强自旋轨道散射。
...
- **arXiv**: [2607.09572](https://arxiv.org/abs/2607.09572)  ·  [PDF](https://arxiv.org/pdf/2607.09572.pdf)
- **Title (EN)**: A Cloud-Accessible Open-Source Framework for the Electromagnetic Modelling of Applied Superconductors
- **Authors**: Yusen Guo, Alberto Paganini, Harold S. Ruiz
- **Categories**: cond-mat.supr-con, math-ph
- **TL;DR**: 本文提出了H-cloud形式体系，一个基于有限元方法的云可访问开源框架，用于应用超导体的电磁建模。该方法在Nédélec有限元离散中表述II类超导体的非线性电磁响应，通过Firedrake、UFL和PETSc实现，可在本地和云端（如Google Colab）运行。在圆柱超导体磁化基准测试中验证，并与COMSOL模型对比，磁化回路误差约1%，峰值误差低于1.5%。该框架为超导模拟提供了可复现、可移植的开源方案。
...
- **arXiv**: [2607.08845](https://arxiv.org/abs/2607.08845)  ·  [PDF](https://arxiv.org/pdf/2607.08845.pdf)
- **Title (EN)**: Probing Cooper pair momentum by quasiparticle steering with planar Josephson junctions
- **Authors**: Isidora Araya Day, Anton R. Akhmerov, Antonio R. L. Manesco
- **Categories**: cond-mat.mes-hall, cond-mat.supr-con
- **TL;DR**: 本文证明在弹道平面约瑟夫森结中，Andreev束缚态会以相位可控的角度射入邻近的正常区域，该角度与√(Δ/μ)成正比，远大于传统的库珀对动量尺度Δ/μ，为凝聚态动量转移提供了新的运动学探测手段。
...
- **arXiv**: [2607.09356](https://arxiv.org/abs/2607.09356)  ·  [PDF](https://arxiv.org/pdf/2607.09356.pdf)
- **Title (EN)**: Scale-Bridging Phase-Field Modeling of Microstructure Evolution by FE$^2$ Computational Homogenization
- **Authors**: Geralf Hütter, Fenil Lathiya, Vincent von Oertzen, Bjoern Kiefer
- **Categories**: physics.comp-ph
- **TL;DR**: 本文提出了一种用于相场理论的一致均匀化框架，通过Hill-Mandel型微力条件建立微观-宏观关系，并基于FE²方法实现计算，在Allen-Cahn模型和应力驱动马氏体相变模型中验证了其宏观场预测的准确性。
...
- **arXiv**: [2607.08927](https://arxiv.org/abs/2607.08927)  ·  [PDF](https://arxiv.org/pdf/2607.08927.pdf)
- **Title (EN)**: Molecular Tuning of Charge-Transfer Resonance in Plasmonic Nanocavities
- **Authors**: Hasher Irshada, Francesco Ciccarello, Konstantin Malchow, Christophe Galland, Katrine Qvortrup
- **Categories**: physics.chem-ph, cond-mat.mes-hall, physics.optics
- **TL;DR**: 本文通过设计不同电子结构的联苯硫醇分子自组装单层，结合SERS、vSFG和DFT计算，系统研究了分子-金属纳米腔中电荷转移共振的能量条件，揭示了电荷转移增强拉曼散射受基底功函数和激发能量共同决定的界面共振条件。
...
- **arXiv**: [2607.08825](https://arxiv.org/abs/2607.08825)  ·  [PDF](https://arxiv.org/pdf/2607.08825.pdf)
- **Title (EN)**: Quantum Oscillation Signatures of $\mathbb{Z}_2$ Monopole Charge in Nodal-Ring Semimetals
- **Authors**: Aravind Karthigeyan, Yoonseok Hwang, Bohm-Jung Yang, Junyeong Ahn
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文研究了三维节点线半金属中拓扑荷的磁量子振荡探测方法，发现通过调节磁场方向可以分别检测Berry相位（w₁）和Z₂单极荷（w₂），并在ABC堆叠石墨炔中预言了可观测的实验信号。
...
- **arXiv**: [2607.08822](https://arxiv.org/abs/2607.08822)  ·  [PDF](https://arxiv.org/pdf/2607.08822.pdf)
- **Title (EN)**: Energetics of fractional anomalous Hall crystals in rhombohedral graphene
- **Authors**: Félix Desrochers, Ashvin Vishwanath
- **Categories**: cond-mat.str-el, cond-mat.mes-hall
- **TL;DR**: 本文通过变分波函数和蒙特卡洛计算，证明了分数量子反常霍尔晶体（FAHCs）在菱方五层石墨烯（R5G）中是能量上竞争性的候选态，并揭示了其稳定性源于母体量子霍尔液体与墨西哥帽色散之间的协同效应。
...
- **arXiv**: [2607.08860](https://arxiv.org/abs/2607.08860)  ·  [PDF](https://arxiv.org/pdf/2607.08860.pdf)
- **Title (EN)**: Ferroelastic instability in rutile TiO2 and thermodynamic suppression of the CaCl2-type phase
- **Authors**: Jared Pohlmann, Anjy-Joe Olatunbosun, Kenneth Park
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过第一性原理计算揭示了金红石TiO₂在高压下存在CaCl₂型（Pnnm）铁弹不稳定性，但由于热力学竞争，该相仅作为瞬态中间相存在，解释了其实验上难以观测的原因。
...
- **arXiv**: [2607.08787](https://arxiv.org/abs/2607.08787)  ·  [PDF](https://arxiv.org/pdf/2607.08787.pdf)
- **Title (EN)**: Brownian Bridge for Coherent State Path Integral Monte Carlo
- **Authors**: Riccardo Fantoni
- **Categories**: cond-mat.stat-mech, cond-mat.mtrl-sci, physics.chem-ph, physics.comp-ph, quant-ph
- **TL;DR**: 本文提出了一种基于布朗桥构造的相干态路径积分蒙特卡罗算法，用于精确计算平面氦流体在低温下的热力学性质，结果与传统平面波路径积分蒙特卡罗方法吻合良好。
...
- **arXiv**: [2607.09511](https://arxiv.org/abs/2607.09511)  ·  [PDF](https://arxiv.org/pdf/2607.09511.pdf)
- **Title (EN)**: Majorana parity qubit in coupled minimal Kitaev chains
...
- **TL;DR**: 本文在双量子点Kitaev链中实现了Majorana parity qubit的相干控制，观察到宇称振荡，建立了首个Majorana qubit的相干操控。
...
- **arXiv**: [2607.09238](https://arxiv.org/abs/2607.09238)  ·  [PDF](https://arxiv.org/pdf/2607.09238.pdf)
- **Title (EN)**: Serially Improved GTOs for Molecular Applications (SIGMA): basis sets from monovalent ions
- **Authors**: Ignacio Ema, Guillermo Ramirez, Rafael Lopez, Jose Manuel Garcia-de-la-Vega
- **Categories**: physics.chem-ph, physics.comp-ph
- **TL;DR**: 本文提出了一套名为iσXZ1的新型离子基组，专门用于含单价离子的分子计算。该基组在SIGMA基组基础上，明确区分了阳离子和阴离子的电子结构，并配套开发了用于分辨率恒等（RI）计算的辅助基组。在碱金属卤化物团簇上的测试表明，iσXZ1基组在结构、能量和电子性质方面准确度优于传统基组，且对近线性依赖问题具有出色的鲁棒性，可稳定计算多达792个NaCl单元的系统。
...
- **arXiv**: [2607.08840](https://arxiv.org/abs/2607.08840)  ·  [PDF](https://arxiv.org/pdf/2607.08840.pdf)
- **Title (EN)**: Fermion-mediated Casimir effect on mesoscopic rings implementing non-Clifford SWAP$^α$ gates
- **Authors**: Liang Du, Qing-Dong Jiang, Yijia Wu
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文提出在介观环中，通过Aharonov-Bohm效应可原位调控费米子介导的Casimir相互作用的强度和符号，实现长程相互作用，并应用于自旋量子比特的非 Clifford SWAP^α 门，降低量子计算和纠错的开销。
...
- **arXiv**: [2607.08826](https://arxiv.org/abs/2607.08826)  ·  [PDF](https://arxiv.org/pdf/2607.08826.pdf)
- **Title (EN)**: The monopole plasma resonance: a smoking gun of 3D $U(1)$ quantum spin liquids
- **Authors**: Anish Koley, Saranyo Moitra, Inti Sodemann Villadiego
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文发现3D U(1)自旋液体中的涌现磁单极子携带真实电荷，形成等离子体，在低频表现出类似金属的等离子体共振，可作为检测这类物态的特征信号，并在候选材料Ce₂Zr₂O₇中讨论了观测条件。
...
- **arXiv**: [2607.08868](https://arxiv.org/abs/2607.08868)  ·  [PDF](https://arxiv.org/pdf/2607.08868.pdf)
- **Title (EN)**: Grain-boundary-mediated kinetic arrest in graphite-to-diamond transformation
- **Authors**: Zuzanna Malinowska-Trzmielak, Vilmos Neuman, Mark Wilson
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过大规模分子动力学模拟揭示，石墨的晶粒结构（而非仅压力和温度）控制着石墨-金刚石转变路径：晶界促进局部sp³成核，但金刚石生长在晶界处受阻，导致混合sp²-sp³亚稳态的形成，而大晶粒或单晶石墨则倾向于协同转变为金刚石。
...
- **arXiv**: [2607.08827](https://arxiv.org/abs/2607.08827)  ·  [PDF](https://arxiv.org/pdf/2607.08827.pdf)
- **Title (EN)**: Exact Lindbladian Dynamics from Conformal Embeddings and Topological Defects in Conformal Field Theory
- **Authors**: Chen Bai
- **Categories**: cond-mat.stat-mech, cond-mat.str-el, hep-th, quant-ph
- **TL;DR**: 本文识别了(1+1)维共形场论中的内在共形结构，通过Majorana费米子线性模跳跃、Wess-Zumino-Witten模型的共形嵌入和Verlinde拓扑缺陷线等例子，实现了开放量子多体系统的精确可解动力学。
...
- **arXiv**: [2607.08926](https://arxiv.org/abs/2607.08926)  ·  [PDF](https://arxiv.org/pdf/2607.08926.pdf)
- **Title (EN)**: Interface-induced spin-resolved type-II band alignment and enhanced magnetic anisotropy in MSe2/WTe2 (M = V, Cr, Mn, Fe and Co) van der Waals heterobilayers
- **Authors**: Paras Poswal, Ranjit Pati, Neeraj Shukla
- **Categories**: cond-mat.mtrl-sci, cond-mat.mes-hall, physics.comp-ph
- **TL;DR**: 本文通过第一性原理计算研究了MSe2/WTe2 (M=V, Cr, Mn, Fe, Co)范德华异质双层膜的结构、电子和磁性性质。发现MnSe2/WTe2和FeSe2/WTe2具有半金属性，CoSe2/WTe2居里温度最高(273.87 K)，界面工程使这些异质双层膜成为下一代低维自旋电子学应用的有前途候选材料。
...
- **arXiv**: [2607.09396](https://arxiv.org/abs/2607.09396)  ·  [PDF](https://arxiv.org/pdf/2607.09396.pdf)
- **Title (EN)**: Quantum phases in endofullerene zigzag chains
- **Authors**: Tobias Serwatka, Muhammad Shaeer Moeed, Roger G. Melko, Pierre-Nicholas Roy
- **Categories**: physics.chem-ph, cond-mat.mes-hall, cond-mat.quant-gas, cond-mat.stat-mech
- **TL;DR**: 本文利用密度矩阵重整化群计算，研究弯曲（锯齿形）内嵌富勒烯链中偶极分子的量子相。发现LiF在60°&lt;γ≤180°范围内保持铁电序，但在γ=60°时几何阻挫导致反铁电Néel相；需要超越最近邻近似才能捕捉到这一重取向。对于受限水，o-D₂O再现了两种有序相，而p-H₂O因大转动常数在任何角度都无法形成有序。这些结果表明工程化内嵌富勒烯层可承载多样的偶极有序量子相。
...
- **arXiv**: [2607.08829](https://arxiv.org/abs/2607.08829)  ·  [PDF](https://arxiv.org/pdf/2607.08829.pdf)
- **Title (EN)**: Magnetic Field Control of the Néel Vector and Magnon Visibility in Altermagnetic MnTe
- **Authors**: Tobias Weber, Niclas Heinsdorf, Shane Smolenski, Sawyer Beltz, Alexandre Ivanov, Andrea Piovano, Victor Mecoli, Sean Knapp, Ruiqi Tang, Amir Henderson, A. K. M. Ashiquzzaman Shawon, Taylor Pierce-James, Na Hyun Jo, Denis Karaiskaj
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文通过非弹性中子散射和线性自旋波理论，研究了α-MnTe交变磁体中自旋波谱的磁场依赖性。发现面内磁场可连续重定向Néel矢量，但磁振子能量和线宽基本不变，仅通过横向动量投影显著改变谱强度，表明α-MnTe可实现可重构的磁振子耦合。
...
- **arXiv**: [2607.08881](https://arxiv.org/abs/2607.08881)  ·  [PDF](https://arxiv.org/pdf/2607.08881.pdf)
- **Title (EN)**: High density two-component glasses of organic semiconductors prepared by physical vapor deposition
- **Authors**: Yejung Lee, Shinian Cheng, M. D. Ediger
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究通过光谱椭偏法系统表征了共蒸镀NPD和TPD多组分玻璃在全部组成范围内的密度、热稳定性和光学性质，发现其形成高密度、高热稳定性玻璃，且性质变化符合表面平衡机制。
...
- **arXiv**: [2607.08957](https://arxiv.org/abs/2607.08957)  ·  [PDF](https://arxiv.org/pdf/2607.08957.pdf)
- **Title (EN)**: Structural Origin of Water Heat Capacity Anomaly from Classical and Quantum Simulations
- **Authors**: Kam-Tung Chan, Dylan A. Folkner, Margaret L. Berrens, Alexei A. Stuchebrukhov, Lee-Ping Wang, Davide Donadio
- **Categories**: cond-mat.stat-mech, cond-mat.soft
- **TL;DR**: 本研究利用经典和路径积分分子动力学结合机器学习势，发现核量子效应主要通过抑制高频振动影响水的等压热容，而热容的异常温度依赖性源于结构涨落，并通过两态模型揭示了约4 kJ/mol的焓变尺度。
...
- **arXiv**: [2607.09559](https://arxiv.org/abs/2607.09559)  ·  [PDF](https://arxiv.org/pdf/2607.09559.pdf)
- **Title (EN)**: Disorder-Induced Localization of Molecular Polaritons Despite Spectroscopic Strong Coupling
- **Authors**: Amitav Sahu, Tönu Pullerits
- **Categories**: physics.chem-ph
- **TL;DR**: 本文理论研究表明，在无序和耗散条件下，分子极化子的集体扩展特性需要集体Rabi分裂大于约8倍无序宽度加上约2倍腔-分子线宽不匹配，这一条件比传统光谱强耦合更严格。
...
- **arXiv**: [2607.09019](https://arxiv.org/abs/2607.09019)  ·  [PDF](https://arxiv.org/pdf/2607.09019.pdf)
- **Title (EN)**: A new perspective on the anomalous Hall effect
- **Authors**: Jason G. Kattan, Matthew Albert, J. E. Sipe
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文利用基于极化、磁化和自由电荷与电流的微观概念的形式体系，重新审视了磁性导体中的反常霍尔效应及其在有限频率下的推广。电子自由度在二次量子化场论中处理，哈密顿量包含静态且晶胞周期性的磁场，该磁场编码了晶体中的磁序并打破时间反演对称性。研究微观层面的束缚和自由载流子对有限频率空间均匀电场的响应动力学。描述长波响应的电导率张量包含三项：与极化响应相关的Kubo项、与自由电流响应纵向部分相关的金属Drude项，以及与横向部分相关的反常霍尔电导率。还对铁磁性体心立方铁相进行了数值计算。
...
- **arXiv**: [2607.08862](https://arxiv.org/abs/2607.08862)  ·  [PDF](https://arxiv.org/pdf/2607.08862.pdf)
- **Title (EN)**: Loop-current orderings in SU($N$) two-leg fermionic ladder through duality symmetries
- **Authors**: M. Habchy, F. Rose, P. Lecheminant
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文研究了半填充SU(N)双腿费米子梯子中环流有序相的形成，发现了非微扰对偶对称性，并证明环流相可通过密度-电流对偶与常规密度波相关联，且对于N&gt;2的情况，这些相在Hund耦合作用下稳定存在。
...
- **arXiv**: [2607.08890](https://arxiv.org/abs/2607.08890)  ·  [PDF](https://arxiv.org/pdf/2607.08890.pdf)
- **Title (EN)**: Hybrid DiffractGPT-Rietveld Refinement Framework for Automated X-ray Diffraction Analysis
- **Authors**: Charles Rhys Campbell, Justin Ely, Jaehyung Lee, Frank M. Abel, Kamal Choudhary
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: AGAPI-XRD是一个混合框架，集成了DiffractGPT生成式结构预测、数据库模式匹配（JARVIS-DFT和COD）、自动Rietveld精修和ALIGNN-FF弛豫，通过统一API实现从粉末XRD数据到晶体结构的端到端自动化确定。
...
- **arXiv**: [2607.09079](https://arxiv.org/abs/2607.09079)  ·  [PDF](https://arxiv.org/pdf/2607.09079.pdf)
- **Title (EN)**: Predictive Renormalization-Group Theory of Universality Classes in Nonlinear Systems
- **Authors**: Ko Okumura
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文发展了一套重整化群（RG）框架，用以解释非线性系统中普遍存在的标度行为。该框架通过尺度不变性产生RG不动点，并通过重复RG变换消除非标度不变结构，使广泛方程类流向相同不动点从而形成普适类。在有限时间奇点、长时间渐近行为、非线性扩散等多个系统中验证，并做出可证伪预测。
...
- **arXiv**: [2607.09592](https://arxiv.org/abs/2607.09592)  ·  [PDF](https://arxiv.org/pdf/2607.09592.pdf)
- **Title (EN)**: A Semiclassical Gaussian Wavepacket Method for Non-Adiabatic Molecular Dynamics
- **Authors**: Lorenzo Bocchi, Jia-Xi Zeng, Michele Ceotto
- **Categories**: physics.chem-ph, quant-ph
- **TL;DR**: 本文提出了两种基于双耦合高斯波包的非绝热半经典方法，通过变分和标准冻结高斯近似推导运动方程，在电子转移和光解离模型中验证了变分方法的准确性。
...
- **arXiv**: [2607.09055](https://arxiv.org/abs/2607.09055)  ·  [PDF](https://arxiv.org/pdf/2607.09055.pdf)
- **Title (EN)**: Negligible current-induced torque from the bulk and interface of Al
- **Authors**: Taiyang Zhang, Lujun Zhu, Zhihao Yan, Lijun Zhu
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文通过实验证明，Al的体相和界面均未对相邻Co和FePt层产生可检测的扭矩，表明Al中轨道-自旋转换极小，轨道霍尔效应、界面轨道Rashba效应和自旋涡度耦合的扭矩贡献缺乏普遍性和有效性。
...
- **arXiv**: [2607.09003](https://arxiv.org/abs/2607.09003)  ·  [PDF](https://arxiv.org/pdf/2607.09003.pdf)
- **Title (EN)**: Magnetic devil's staircase in UAgBi$_{2}$
- **Authors**: G. S. Freitas, K. Kirchner, C. Girod, D. R. Yahne, W. Simeth, C. S. T. Kengle, F. B. Carneiro, P. G. Pagliuso, J. D. Thompson, M. Janoschek, O. Zaharko, S. M. Thomas, P. F. S. Rosa
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 本文研究了UAgBi₂材料中由竞争相互作用导致的磁场和温度诱导的多级磁相变，发现了至少七种近乎简并的磁态，并构建了相图，证实其行为符合轴向次近邻伊辛（ANNNI）模型描述的磁“魔鬼阶梯”，是5f电子系统中罕见的实验实现。
...
- **arXiv**: [2607.09274](https://arxiv.org/abs/2607.09274)  ·  [PDF](https://arxiv.org/pdf/2607.09274.pdf)
- **Title (EN)**: The scales of disorder in perfect quasicrystals
- **Authors**: Alan Rodrigo Mendoza Sosa, Atahualpa S. Kraemer, Michael Schmiedeberg, Erdal C. Oğuz
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 该研究揭示，高对称性准晶的旋转对称性会抑制其局部准周期统计特征，但保留长程有序性。随着旋转对称性N→∞，有序性被隐藏，形成统计上不可区分的几何临界点。有限N下，存在统计单胞和有序-无序交叉长度两个涌现尺度，为晶体、准晶体和非晶态物质建立了定量联系框架。
...
- **arXiv**: [2607.09140](https://arxiv.org/abs/2607.09140)  ·  [PDF](https://arxiv.org/pdf/2607.09140.pdf)
- **Title (EN)**: Quantum Hopfion rings in the cluster mean-field approximation
- **Authors**: Vladyslav M. Kuchkin, Thomas L. Schmidt
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 本研究通过簇平均场近似(CMFA)结合对称化方法，成功计算了二维和三维自旋纹理（kπ-斯格明子和霍普夫子环）中的量子涨落，揭示了经典微磁模型的局限性，并提出正则化微磁方程作为扩展框架。
...
- **arXiv**: [2607.09182](https://arxiv.org/abs/2607.09182)  ·  [PDF](https://arxiv.org/pdf/2607.09182.pdf)
- **Title (EN)**: Topological phase transition driven by Hatsugai-Kohmoto interaction on the Kagome lattice
- **Authors**: Zhuo-Xuan Yang, Jiangfan Wang
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文通过在Kagome晶格上结合Kane-Mele型自旋轨道耦合与Hatsugai-Kohmoto相互作用，构建了一个精确可解模型。在1/3填充下发现了由电子相互作用驱动的连续拓扑量子相变，从弱关联的Z2拓扑绝缘体转变为强关联但具有非平凡自旋陈数Cs=2的绝缘体；在半填充下则呈现非费米液体到Mott绝缘体的转变。
...
- **arXiv**: [2607.08929](https://arxiv.org/abs/2607.08929)  ·  [PDF](https://arxiv.org/pdf/2607.08929.pdf)
- **Title (EN)**: Fast Homoepitaxy on (100) \b{eta}-Ga2O3 Substrates with Large Grown-In Offcut
- **Authors**: M. Brooks Tellekamp, Drew Haven, David Joyce, John Mangum, Henry Garland, Robert Lavelle, Kevin Schulte, Anna Sacchi, Matt Young, Andriy Zakutayev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文通过在(100)方向的β-Ga₂O₃衬底上引入大角度原生斜切（最高13.4°），解决了该方向生长速率慢（比其他方向慢10-30倍）的问题，实现了与快速方向相当的MBE生长速率。制备的器件具有低掺杂浓度（2×10¹⁵ cm⁻³）和优异击穿场强（1.56 MV/cm），验证了(100)取向衬底用于功率器件的可行性。
...
- **arXiv**: [2607.09341](https://arxiv.org/abs/2607.09341)  ·  [PDF](https://arxiv.org/pdf/2607.09341.pdf)
- **Title (EN)**: Is the Eyring Plot Misleading? A Case for Arrhenius Analysis of Activation Parameters
- **Authors**: Titus S. van Erp
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文质疑了物理化学中普遍认为Eyring方程比Arrhenius方程更基础的观点。作者指出，尽管Eyring方程在统计力学和量子力学中有推导基础，但其线性拟合不如Arrhenius方程精确；Eyring方程中的普朗克常数源于配分函数归一化惯例，并非本质量子效应；反应物与过渡态配分函数维度不匹配导致ΔG‡存在解释问题。作者提出一种替代表示法，使Arrhenius拟合得到的活化焓和熵比Eyring拟合值更具物理意义。
...
- **arXiv**: [2607.09244](https://arxiv.org/abs/2607.09244)  ·  [PDF](https://arxiv.org/pdf/2607.09244.pdf)
- **Title (EN)**: Screening-controlled dynamical criticality in the quantum Hall regime
- **Authors**: Tanima Chanda, Simrandeep Kaur, Anantbir Virk, Kenji Watanabe, Takashi Taniguchi, G. J. Sreejith, Yuval Gefen, Aveek Bid
- **Categories**: cond-mat.mes-hall, cond-mat.str-el
- **TL;DR**: 本文通过结合温度标度和电流标度，在量子霍尔相变中分别提取动力学指数z和局域长度指数γ，并利用石墨烯器件中库仑相互作用的几何屏蔽调控，发现屏蔽效应仅改变动力学指数z（从~1变为~2），而局域长度指数γ保持~2.4不变。
...
- **arXiv**: [2607.09395](https://arxiv.org/abs/2607.09395)  ·  [PDF](https://arxiv.org/pdf/2607.09395.pdf)
- **Title (EN)**: Sixteenfold Classification of Many-Body Multipoles from Rotation-Compatible Canonical Symmetries
- **Authors**: Shingo Kuniyoshi, Rikuto Oiwa, Satoru Hayami
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文提出了一种基于规范变换和粒子-空穴变换的十六重分类框架，用于区分多体算符空间中不同身体数的物理扇区，弥补了传统多极框架的不足。
...
- **arXiv**: [2607.09292](https://arxiv.org/abs/2607.09292)  ·  [PDF](https://arxiv.org/pdf/2607.09292.pdf)
- **Title (EN)**: Kinetic Cellular Model of Corrosion
- **Authors**: Orkan Sezer, Andrew Horsfield
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文提出了一种广义速率方程方法，用于扩展金属水溶液腐蚀模拟的时空尺度，能够统一相场、元胞自动机等方法，并描述Nernst-Planck和Butler-Volmer方程的行为，在1D/2D示例中与其他方法吻合良好。
...
- **arXiv**: [2607.09411](https://arxiv.org/abs/2607.09411)  ·  [PDF](https://arxiv.org/pdf/2607.09411.pdf)
- **Title (EN)**: Finite-time cooling and accessibility of the stripe phase in the Ising antiferromagnet
- **Authors**: Tom Poisblaud
- **Categories**: cond-mat.stat-mech
- **TL;DR**: 本文研究了三角晶格 $J_1-J_2$ Ising 反铁磁体在局域 Metropolis 更新下的有限速率冷却动力学。发现即便平衡态下次近邻耦合 $J_2/J_1$ 会选定条纹相，但有限时间尺度下系统未必能自动达到该相。定义了动力学条纹形成时间 $n^*(L,J_2/J_1)$，该时间随系统尺寸增大而显著变慢，随 $J_2/J_1$ 增大而加快。尺寸依赖性与粗化控制过程一致。失败的轨迹并非完全无序，常包含局域条纹有序畴被残留壁或竞争取向分隔。将通常混为一谈的三个过程（能量简并提升、局域约束恢复、全局条纹取向选择）区分开来。
...
- **arXiv**: [2607.09256](https://arxiv.org/abs/2607.09256)  ·  [PDF](https://arxiv.org/pdf/2607.09256.pdf)
- **Title (EN)**: Terahertz field-driven nonlinear Hall effect and other second order transport phenomena in two-dimensional tellurene
- **Authors**: M. D. Moldavskaya, L. E. Golub, E. Mönch, Chang Niu, Peide D. Ye, J. Wunderlich, S. D. Ganichev
- **Categories**: cond-mat.mes-hall, cond-mat.mtrl-sci
- **TL;DR**: 本文研究了二维碲烯薄片中太赫兹场驱动的二阶非线性电子输运现象，包括非线性霍尔效应。实验发现直流电流与辐射电场平方成正比，由NLHE、NLL和NLD三种贡献组成，且与线性光生伏打效应等价。电流可通过栅压调控，低温下显著增强，微观机制包括斜散射、侧跳和贝里曲率偶极子。
...
- **arXiv**: [2607.09421](https://arxiv.org/abs/2607.09421)  ·  [PDF](https://arxiv.org/pdf/2607.09421.pdf)
- **Title (EN)**: Short-range magnetic order and multi-stage phase transitions in the easy-plane van der Waals magnet CrCl$_3$
- **Authors**: T. B. Mazitov, M. I. Panin, A. S. Pakhomov, M. V. Bakhmetiev, E. O. Chiglintsev, A. I. Chernov, A. A. Katanin
- **Categories**: cond-mat.str-el, cond-mat.mtrl-sci
- **TL;DR**: 本文结合宽带铁磁共振光谱、SQUID磁强计实验和DFT+DMFT理论计算，系统研究了准二维易平面范德华磁体CrCl₃中自旋关联的演化和多级磁相变特性，发现室温下存在巨大寿命的局域磁矩，以及层间交换作用随温度从铁磁向反铁磁的转变。
...
- **arXiv**: [2607.09304](https://arxiv.org/abs/2607.09304)  ·  [PDF](https://arxiv.org/pdf/2607.09304.pdf)
- **Title (EN)**: Learning to Converge: Warm-Starting DFTB Self-Consistent Charges with Machine Learning
- **Authors**: Maximilian L. Ach, Karsten Reuter, Chiara Panosetti
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 提出了一种机器学习方法，通过预测最优初始原子电荷来加速DFTB模拟中的自洽电荷迭代收敛，在多种化学体系中显著提升了计算效率。
...
- **arXiv**: [2607.09416](https://arxiv.org/abs/2607.09416)  ·  [PDF](https://arxiv.org/pdf/2607.09416.pdf)
- **Title (EN)**: The Statistical physics of unsaturated soil water: kinetic theory and non commutative pore water dynamics
- **Authors**: Riccardo Rigon
- **Categories**: cond-mat.stat-mech, physics.geo-ph
- **TL;DR**: 本文建立了非饱和土壤中水分运动的统计力学理论，从微观孔隙尺度到连续介质尺度，推导出孔隙占据率g(r,x,t)的场方程。通过一个无量纲数Da(r,x)统一了Richards方程、毛细管束模型、滞后效应和优先流等长期独立建模的现象。
...
- **arXiv**: [2607.09419](https://arxiv.org/abs/2607.09419)  ·  [PDF](https://arxiv.org/pdf/2607.09419.pdf)
- **Title (EN)**: Coherent dynamics of individual excitons in a quantum dot embedded in a nanopost
...
- **Categories**: cond-mat.mes-hall
- **TL;DR**: 本文利用四波混频显微镜测量了嵌入GaAs纳米柱中的单个InAs量子点内的激子-双激子系统的相干超快动力学，证明了这种宽带光子结构是探测固态量子系统相干耦合和激发态相干动力学的优秀平台。
...
- **arXiv**: [2607.09427](https://arxiv.org/abs/2607.09427)  ·  [PDF](https://arxiv.org/pdf/2607.09427.pdf)
- **Title (EN)**: Effective theories for many-body systems with nonuniform symmetries
- **Authors**: Aleksander Głódkowski
- **Categories**: cond-mat.str-el, cond-mat.quant-gas, hep-th
- **TL;DR**: 本文建立了处理非均匀对称性（与时空平移不对易的对称性）的多体系统统一框架，发现这类对称性不引入新的无带隙模式，而是通过约束现有自由度来重塑红外动力学，导致集体激发谱修正（如Tkachenko振荡）和反常输运现象（如慢扩散和软化声模）。
...
- **arXiv**: [2607.09321](https://arxiv.org/abs/2607.09321)  ·  [PDF](https://arxiv.org/pdf/2607.09321.pdf)
- **Title (EN)**: Semi-Empirical Kinetic Model for Phase Selection in Rapidly Solidified Multicomponent Concentrated Alloys
- **Authors**: O. I. Kushnerov, S. I. Ryabtsev, V. F. Bashev
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文提出了一个半经验动力学框架，用于预测多元浓缩合金在快速凝固过程中的相选择，该框架基于临界冷却速率、拓扑依赖的结晶路径排序和玻璃形成能力校正，能有效捕捉晶格类型变化、动力学抑制相分离和识别多相结晶竞争。
...
- **arXiv**: [2607.09615](https://arxiv.org/abs/2607.09615)  ·  [PDF](https://arxiv.org/pdf/2607.09615.pdf)
- **Title (EN)**: Fluctuation theorems for thermally isolated driven quantum systems: nonadiabaticity, excess work and strong inequalities
- **Authors**: J. V. M. Steimetz, M. Campisi, M. V. S. Bonança
- **Categories**: cond-mat.stat-mech, quant-ph
- **TL;DR**: 该论文在量子框架下扩展了Jarzynski的积分涨落定理，推导了详细的涨落定理，并建立了随机量与绝热度参数（相对熵）和过剩功（内摩擦）之间的平均关系，进而讨论了相关热力学不等式与第二定律的关联。
...
- **arXiv**: [2607.09465](https://arxiv.org/abs/2607.09465)  ·  [PDF](https://arxiv.org/pdf/2607.09465.pdf)
- **Title (EN)**: Strongly correlated quantum matter: t--J model, real-space pairing, spin-dependent masses, and atomicity in chemical bond and nanosystems
- **Authors**: Józef Spałek
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文回顾了作者近五十年在强关联费米子系统领域的研究，重点包括：(i) 首次推导出t-J模型，涵盖Mott-Hubbard绝缘体中的Anderson动力学交换自旋相互作用及实空间配对，后应用于高温超导；(ii) 重费米子系统中准粒子自旋依赖的重质量概念；(iii) Mott-Hubbard相变统计热力学的首个非平凡模型。此外还讨论了化学键中的原子性及关联纳米系统的EDABI方法。
...
- **arXiv**: [2607.09413](https://arxiv.org/abs/2607.09413)  ·  [PDF](https://arxiv.org/pdf/2607.09413.pdf)
- **Title (EN)**: Unlocking ultrafast spin dynamics in a rare-earth magnet
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究通过飞秒泵浦-探测磁光光谱学，证明选择性激发稀土离子Gd³⁺的局域4f电子态可在38飞秒内实现超快退磁，比传统元素Gd快两个数量级以上，揭示了光学激发路径对超快磁响应的决定性作用。
...
- **arXiv**: [2607.09570](https://arxiv.org/abs/2607.09570)  ·  [PDF](https://arxiv.org/pdf/2607.09570.pdf)
- **Title (EN)**: Confinement drives valley splitting above 4K in buried silicon quantum wells
- **Authors**: Davide Degli Esposti, Emma Catherine Brann, Asser Elsayed, Davide Costa, Mark Friesen, Giordano Scappucci
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 本文测量了埋层硅量子阱中单电子自旋量子点的能量尺度，发现通过强静电约束可以将谷分裂提升数百微电子伏，为自旋量子比特的扩展和穿梭架构提供了可行路径。
...
- **arXiv**: [2607.09470](https://arxiv.org/abs/2607.09470)  ·  [PDF](https://arxiv.org/pdf/2607.09470.pdf)
- **Title (EN)**: Symmetry-Protected Pinch Curves in Classical Spin Liquids
- **Authors**: Takumi Fukushima, Han Yan
- **Categories**: cond-mat.str-el, cond-mat.stat-mech
- **TL;DR**: 本文提出了一种新型自旋液体——"pinch-curve自旋液体"，其奇异点沿动量空间中的一维代数曲线分布，而非传统自旋液体中的孤立点。通过晶格模型和蒙特卡洛模拟验证了该理论，并发现了红外高斯定律相变现象。
...
- **arXiv**: [2607.09425](https://arxiv.org/abs/2607.09425)  ·  [PDF](https://arxiv.org/pdf/2607.09425.pdf)
- **Title (EN)**: Electronic manipulation of polar order in electron crystal
...
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本文在半导体LuFe₂O₄中通过电流脉冲实现了电荷有序方向的操作与读取，展示了基于电子晶体的非互易电阻记忆器件，为电荷有序电子学开辟了新途径。
...
- **arXiv**: [2607.09652](https://arxiv.org/abs/2607.09652)  ·  [PDF](https://arxiv.org/pdf/2607.09652.pdf)
- **Title (EN)**: Silicon-Germanium Heterostructures with Enhanced Valley Splitting for Spin Qubits
- **Authors**: David W. Kanaar, Efrain Martinez, Peihong Zhang, Mark F. Gyure
- **Categories**: cond-mat.mes-hall, quant-ph
- **TL;DR**: 本文提出一种器件级优化策略，通过结合窄量子阱、小Ge尖峰和纯Ge帽层的非传统Si/SiGe异质结构设计，将谷分裂值提升至1-5 meV，远超以往理论结果，并通过大规模器件模拟和DFT计算验证，有望消除谷分裂对SiGe自旋量子比特可扩展性的根本限制。
...
- **arXiv**: [2607.09504](https://arxiv.org/abs/2607.09504)  ·  [PDF](https://arxiv.org/pdf/2607.09504.pdf)
- **Title (EN)**: Quantum Chaos with a Macroscopic Zero-Mode Sector
- **Authors**: Cheryne Jonay, Kun W. Kim, Frank Pollmann, Alexander Altland
- **Categories**: cond-mat.str-el, cond-mat.stat-mech
- **TL;DR**: 本文发现手性对称约束自旋链中的零能模被混沌能级排斥打开一个尖锐能隙，并通过East-West模型、随机矩阵理论和线性响应谱学验证了这一机制。
...
- **arXiv**: [2607.09466](https://arxiv.org/abs/2607.09466)  ·  [PDF](https://arxiv.org/pdf/2607.09466.pdf)
- **Title (EN)**: Unraveling atomic-resolution valence electron energy-loss spectroscopic imaging in a single-crystal CaNb2O6
- **Authors**: Sz-Chian Liou, Xiang-Lin Huang, Vladimir P. Oleshko, I-Ching Lin, Yin-Ping Lan, Hsin-An Chen, Guo-Jiun Shu
- **Categories**: cond-mat.mtrl-sci
- **TL;DR**: 本研究利用球差校正扫描透射电子显微镜结合混合像素直接电子探测器的能量过滤光谱仪，在CaNb2O6单晶中实现了从纳米到原子尺度的低损耗电子能量损失谱成像，观测到了体积等离激元、plexcitons以及原子分辨的零损失峰成像，并发现[NbO6]八面体直接贡献于带间跃迁的横向分布图。
...
- **arXiv**: [2607.09542](https://arxiv.org/abs/2607.09542)  ·  [PDF](https://arxiv.org/pdf/2607.09542.pdf)
- **Title (EN)**: A nonstandard statistics for strongly correlated systems: Two simple examples
- **Authors**: Józef Spałek, Piotr Kuterba, Mateusz Wójcik, Danuta Goc-Jagło, Maciej Fidrysiak, Leszek Spałek, Włodzimierz Wójcik
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文研究了两种强关联费米子统计情况：非费米液体（NFL）和统计自旋液体（SSL），计算了它们的熵和统计分布函数，并分析了二维正方格子填充和温度的影响，特别关注半填充时向Mott绝缘体态的转变。
...
- **arXiv**: [2607.09580](https://arxiv.org/abs/2607.09580)  ·  [PDF](https://arxiv.org/pdf/2607.09580.pdf)
- **Title (EN)**: Thermalization in a Height-Conserving Quantum Dimer Model
- **Authors**: Junsheng Feng, Jie Ren, Zheng Yan
- **Categories**: cond-mat.str-el
- **TL;DR**: 本文研究高度守恒量子二聚体模型中的热化问题，发现谱统计和本征态热化可以表现出不一致的行为，即“约束量子混沌”现象。
